...
(function (MixinAuthorizableEvents) {
    ...
    MixinAuthorizableEvents["OwnershipTransferred"] = "OwnershipTransferred";
...
var MixinAuthorizableContract = /** @class */ (function (_super) {
    ...
    function MixinAuthorizableContract(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) {
        if (deployedBytecode === void 0) { deployedBytecode = MixinAuthorizableContract.deployedBytecode; }
        var _this = _super.call(this, 'MixinAuthorizable', MixinAuthorizableContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) || this;
        _this._methodABIIndex = {};
        utils_1.classUtils.bindAll(_this, ['_abiEncoderByFunctionSignature', 'address', '_web3Wrapper']);
        _this._subscriptionManager = new base_contract_1.SubscriptionManager(MixinAuthorizableContract.ABI(), _this._web3Wrapper);
        MixinAuthorizableContract.ABI().forEach(function (item, index) {
    ...
    MixinAuthorizableContract.deployFrom0xArtifactAsync = function (artifact, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                ...
                return [2 /*return*/, MixinAuthorizableContract.deployAsync(bytecode, abi, provider, txDefaults, logDecodeDependenciesAbiOnly)];
            });
        });
    };
    MixinAuthorizableContract.deployWithLibrariesFrom0xArtifactAsync = function (artifact, libraryArtifacts, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, MixinAuthorizableContract._deployLibrariesAsync(artifact, libraryArtifacts, new web3_wrapper_1.Web3Wrapper(provider), txDefaults)];
                    case 1:
    ...
    MixinAuthorizableContract.deployAsync = function (bytecode, abi, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        contractInstance = new MixinAuthorizableContract(txReceipt.contractAddress, provider, txDefaults, logDecodeDependencies);
    ...
    MixinAuthorizableContract._deployLibrariesAsync = function (artifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses) {
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, MixinAuthorizableContract._deployLibrariesAsync(libraryArtifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses)];
                    case 5:
                        // Deploy any dependent libraries used by this library.
                        _g.sent();
    ...
    MixinAuthorizableContract.prototype.getFunctionSignature = function (methodName) {
        var index = this._methodABIIndex[methodName];
        var methodAbi = MixinAuthorizableContract.ABI()[index]; // tslint:disable-line:no-unnecessary-type-assertion
        var functionSignature = base_contract_1.methodAbiToFunctionSignature(methodAbi);
        return functionSignature;
    };
    MixinAuthorizableContract.prototype.getABIDecodedTransactionData = function (methodName, callData) {
    ...
    MixinAuthorizableContract.prototype.getABIDecodedReturnData = function (methodName, callData) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
    ...
    MixinAuthorizableContract.prototype.getSelector = function (methodName) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
     ...
     */
    MixinAuthorizableContract.prototype.addAuthorizedAddress = function (target) {
        var self = this;
    ...
    ;
    MixinAuthorizableContract.prototype.authorities = function (index_0) {
        var self = this;
    ...
    ;
    MixinAuthorizableContract.prototype.authorized = function (index_0) {
        var self = this;
    ...
    * @returns Array of authorized addresses.
     */
    MixinAuthorizableContract.prototype.getAuthorizedAddresses = function () {
        var self = this;
    ...
    ;
    MixinAuthorizableContract.prototype.owner = function () {
        var self = this;
     ...
     */
    MixinAuthorizableContract.prototype.removeAuthorizedAddress = function (target) {
        var self = this;
        assert_1.assert.isString('target', target);
     ...
     */
    MixinAuthorizableContract.prototype.removeAuthorizedAddressAtIndex = function (target, index) {
        var self = this;
        assert_1.assert.isString('target', target);
    ...
    ;
    MixinAuthorizableContract.prototype.transferOwnership = function (newOwner) {
        var self = this;
     ...
     */
    MixinAuthorizableContract.prototype.subscribe = function (eventName, indexFilterValues, callback, isVerbose, blockPollingIntervalMs) {
        if (isVerbose === void 0) { isVerbose = false; }
        assert_1.assert.doesBelongToStringEnum('eventName', eventName, MixinAuthorizableEvents);
        ...
        var subscriptionToken = this._subscriptionManager.subscribe(this.address, eventName, indexFilterValues, MixinAuthorizableContract.ABI(), callback, isVerbose, blockPollingIntervalMs);
     ...
     */
    MixinAuthorizableContract.prototype.unsubscribe = function (subscriptionToken) {
        this._subscriptionManager.unsubscribe(subscriptionToken);
    };
    /**
     * Cancels all existing subscriptions
     */
    MixinAuthorizableContract.prototype.unsubscribeAll = function () {
     ...
     */
    MixinAuthorizableContract.prototype.getLogsAsync = function (eventName, blockRange, indexFilterValues) {
        return __awaiter(this, void 0, void 0, function () {
            var logs;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        assert_1.assert.doesConformToSchema('indexFilterValues', indexFilterValues, json_schemas_1.schemas.indexFilterValuesSchema);
                        return [4 /*yield*/, this._subscriptionManager.getLogsAsync(this.address, eventName, blockRange, indexFilterValues, MixinAuthorizableContract.ABI())];
                    case 1:
                        logs = _a.sent();
    ...
    MixinAuthorizableContract.contractName = 'MixinAuthorizable';
