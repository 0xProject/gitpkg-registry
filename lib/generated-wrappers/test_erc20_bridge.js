...
var TestERC20BridgeEvents;
(function (TestERC20BridgeEvents) {
    TestERC20BridgeEvents["BridgeWithdrawTo"] = "BridgeWithdrawTo";
    TestERC20BridgeEvents["ERC20BridgeTransfer"] = "ERC20BridgeTransfer";
})(TestERC20BridgeEvents = exports.TestERC20BridgeEvents || (exports.TestERC20BridgeEvents = {}));
/* istanbul ignore next */
// tslint:disable:array-type
// tslint:disable:no-parameter-reassignment
// tslint:disable-next-line:class-name
var TestERC20BridgeContract = /** @class */ (function (_super) {
    __extends(TestERC20BridgeContract, _super);
    function TestERC20BridgeContract(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) {
        if (deployedBytecode === void 0) { deployedBytecode = TestERC20BridgeContract.deployedBytecode; }
        var _this = _super.call(this, 'TestERC20Bridge', TestERC20BridgeContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) || this;
        _this._methodABIIndex = {};
        utils_1.classUtils.bindAll(_this, ['_abiEncoderByFunctionSignature', 'address', '_web3Wrapper']);
        _this._subscriptionManager = new base_contract_1.SubscriptionManager(TestERC20BridgeContract.ABI(), _this._web3Wrapper);
        TestERC20BridgeContract.ABI().forEach(function (item, index) {
    ...
    TestERC20BridgeContract.deployFrom0xArtifactAsync = function (artifact, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                ...
                return [2 /*return*/, TestERC20BridgeContract.deployAsync(bytecode, abi, provider, txDefaults, logDecodeDependenciesAbiOnly)];
            });
        });
    };
    TestERC20BridgeContract.deployWithLibrariesFrom0xArtifactAsync = function (artifact, libraryArtifacts, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, TestERC20BridgeContract._deployLibrariesAsync(artifact, libraryArtifacts, new web3_wrapper_1.Web3Wrapper(provider), txDefaults)];
                    case 1:
    ...
    TestERC20BridgeContract.deployAsync = function (bytecode, abi, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        txReceipt = _a.sent();
                        utils_1.logUtils.log("TestERC20Bridge successfully deployed at " + txReceipt.contractAddress);
                        contractInstance = new TestERC20BridgeContract(txReceipt.contractAddress, provider, txDefaults, logDecodeDependencies);
     ...
     */
    TestERC20BridgeContract.ABI = function () {
        var abi = [
            {
                inputs: [],
                outputs: [],
    ...
    TestERC20BridgeContract._deployLibrariesAsync = function (artifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses) {
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, TestERC20BridgeContract._deployLibrariesAsync(libraryArtifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses)];
                    case 5:
                        // Deploy any dependent libraries used by this library.
                        _g.sent();
    ...
    TestERC20BridgeContract.prototype.getFunctionSignature = function (methodName) {
        var index = this._methodABIIndex[methodName];
        var methodAbi = TestERC20BridgeContract.ABI()[index]; // tslint:disable-line:no-unnecessary-type-assertion
        var functionSignature = base_contract_1.methodAbiToFunctionSignature(methodAbi);
        return functionSignature;
    };
    TestERC20BridgeContract.prototype.getABIDecodedTransactionData = function (methodName, callData) {
    ...
    TestERC20BridgeContract.prototype.getABIDecodedReturnData = function (methodName, callData) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
    ...
    TestERC20BridgeContract.prototype.getSelector = function (methodName) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
        return abiEncoder.getSelector();
    };
    TestERC20BridgeContract.prototype.bridgeTransferFrom = function (tokenAddress, from, to, amount, bridgeData) {
        var self = this;
    ...
    ;
    TestERC20BridgeContract.prototype.setTestTokenBalance = function (owner, balance) {
        var self = this;
        assert_1.assert.isString('owner', owner);
        assert_1.assert.isBigNumber('balance', balance);
        var functionSignature = 'setTestTokenBalance(address,uint256)';
        return {
            sendTransactionAsync: function (txData, opts) {
                if (opts === void 0) { opts = { shouldValidate: true }; }
                return __awaiter(this, void 0, void 0, function () {
    ...
    ;
    TestERC20BridgeContract.prototype.testToken = function () {
        var self = this;
        var functionSignature = 'testToken()';
        return {
            callAsync: function (callData, defaultBlock) {
                if (callData === void 0) { callData = {}; }
                return __awaiter(this, void 0, void 0, function () {
    ...
    ;
    /**
     * Subscribe to an event type emitted by the TestERC20Bridge contract.
     * @param eventName The TestERC20Bridge contract event you would like to subscribe to.
     ...
     */
    TestERC20BridgeContract.prototype.subscribe = function (eventName, indexFilterValues, callback, isVerbose, blockPollingIntervalMs) {
        if (isVerbose === void 0) { isVerbose = false; }
        assert_1.assert.doesBelongToStringEnum('eventName', eventName, TestERC20BridgeEvents);
        ...
        var subscriptionToken = this._subscriptionManager.subscribe(this.address, eventName, indexFilterValues, TestERC20BridgeContract.ABI(), callback, isVerbose, blockPollingIntervalMs);
     ...
     */
    TestERC20BridgeContract.prototype.unsubscribe = function (subscriptionToken) {
        this._subscriptionManager.unsubscribe(subscriptionToken);
    };
    /**
     * Cancels all existing subscriptions
     */
    TestERC20BridgeContract.prototype.unsubscribeAll = function () {
     ...
     */
    TestERC20BridgeContract.prototype.getLogsAsync = function (eventName, blockRange, indexFilterValues) {
        return __awaiter(this, void 0, void 0, function () {
            var logs;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        assert_1.assert.doesConformToSchema('indexFilterValues', indexFilterValues, json_schemas_1.schemas.indexFilterValuesSchema);
                        return [4 /*yield*/, this._subscriptionManager.getLogsAsync(this.address, eventName, blockRange, indexFilterValues, TestERC20BridgeContract.ABI())];
                    case 1:
                        logs = _a.sent();
    ...
    TestERC20BridgeContract.contractName = 'TestERC20Bridge';
    return TestERC20BridgeContract;
}(base_contract_1.BaseContract));
exports.TestERC20BridgeContract = TestERC20BridgeContract;
// tslint:disable:max-file-line-count
// tslint:enable:no-unbound-method no-parameter-reassignment no-consecutive-blank-lines ordered-imports align
// tslint:enable:trailing-comma whitespace no-trailing-whitespace
//# sourceMappingURL=test_erc20_bridge.js.map