 ...
 * maker/taker asset amounts (returning 0).
     ...
     */
    sampleBuysFromBalancerGlobal(poolAddress, takerToken, makerToken) {
        const self = this;
        assert_1.assert.isString('poolAddress', poolAddress);
        assert_1.assert.isString('takerToken', takerToken);
        assert_1.assert.isString('makerToken', makerToken);
        const functionSignature = 'sampleBuysFromBalancerGlobal(address,address,address)';
        return {
            sendTransactionAsync(txData, opts = { shouldValidate: true }) {
                return __awaiter(this, void 0, void 0, function* () {
                    const txDataWithDefaults = yield self._applyDefaultsToTxDataAsync(Object.assign({ data: this.getABIEncodedTransactionData() }, txData), this.estimateGasAsync.bind(this));
     ...
     * Sample buy quotes from Balancer V2.
      ...
      * @param makerToken Address of the maker token (what to buy).
     */
    sampleBuysFromBalancerV2Global(poolInfo, takerToken, makerToken) {
        const self = this;
        assert_1.assert.isString('takerToken', takerToken);
        assert_1.assert.isString('makerToken', makerToken);
        const functionSignature = 'sampleBuysFromBalancerV2Global((bytes32,address),address,address)';
        return {
            sendTransactionAsync(txData, opts = { shouldValidate: true }) {
                return __awaiter(this, void 0, void 0, function* () {
                    const txDataWithDefaults = yield self._applyDefaultsToTxDataAsync(Object.assign({ data: this.getABIEncodedTransactionData() }, txData), this.estimateGasAsync.bind(this));
     ...
     * Sample buy quotes from Bancor. Unimplemented
      ...
      * @param makerToken Address of the maker token (what to buy).
     */
    sampleBuysFromBancorGlobal(opts, takerToken, makerToken) {
        const self = this;
        assert_1.assert.isString('takerToken', takerToken);
        assert_1.assert.isString('makerToken', makerToken);
        const functionSignature = 'sampleBuysFromBancorGlobal((address,address[][]),address,address)';
        return {
            sendTransactionAsync(txData, opts = { shouldValidate: true }) {
                return __awaiter(this, void 0, void 0, function* () {
                    const txDataWithDefaults = yield self._applyDefaultsToTxDataAsync(Object.assign({ data: this.getABIEncodedTransactionData() }, txData), this.estimateGasAsync.bind(this));
    ...
    ;
    sampleBuysFromCompoundGlobal(cToken, takerToken, makerToken) {
        const self = this;
        assert_1.assert.isString('cToken', cToken);
        assert_1.assert.isString('takerToken', takerToken);
        assert_1.assert.isString('makerToken', makerToken);
        const functionSignature = 'sampleBuysFromCompoundGlobal(address,address,address)';
        return {
            sendTransactionAsync(txData, opts = { shouldValidate: true }) {
                return __awaiter(this, void 0, void 0, function* () {
                    const txDataWithDefaults = yield self._applyDefaultsToTxDataAsync(Object.assign({ data: this.getABIEncodedTransactionData() }, txData), this.estimateGasAsync.bind(this));
     ...
     */
    sampleBuysFromCurveGlobal(curveInfo, fromTokenIdx, toTokenIdx) {
        const self = this;
        assert_1.assert.isBigNumber('fromTokenIdx', fromTokenIdx);
        assert_1.assert.isBigNumber('toTokenIdx', toTokenIdx);
        const functionSignature = 'sampleBuysFromCurveGlobal((address,bytes4,bytes4),int128,int128)';
        return {
            sendTransactionAsync(txData, opts = { shouldValidate: true }) {
                return __awaiter(this, void 0, void 0, function* () {
                    const txDataWithDefaults = yield self._applyDefaultsToTxDataAsync(Object.assign({ data: this.getABIEncodedTransactionData() }, txData), this.estimateGasAsync.bind(this));
     ...
     * Sample buy quotes from DODO.
      ...
      * @param makerToken Address of the maker token (what to buy).
     */
    sampleBuysFromDODOGlobal(opts, takerToken, makerToken) {
        const self = this;
        assert_1.assert.isString('takerToken', takerToken);
        assert_1.assert.isString('makerToken', makerToken);
        const functionSignature = 'sampleBuysFromDODOGlobal((address,address),address,address)';
        return {
            sendTransactionAsync(txData, opts = { shouldValidate: true }) {
                return __awaiter(this, void 0, void 0, function* () {
                    const txDataWithDefaults = yield self._applyDefaultsToTxDataAsync(Object.assign({ data: this.getABIEncodedTransactionData() }, txData), this.estimateGasAsync.bind(this));
     ...
     * Sample buy quotes from DODO.
      ...
      * @param makerToken Address of the maker token (what to buy).
     */
    sampleBuysFromDODOV2Global(registry, offset, takerToken, makerToken) {
        const self = this;
        assert_1.assert.isString('registry', registry);
        assert_1.assert.isBigNumber('offset', offset);
        assert_1.assert.isString('takerToken', takerToken);
        assert_1.assert.isString('makerToken', makerToken);
        const functionSignature = 'sampleBuysFromDODOV2Global(address,uint256,address,address)';
        return {
            sendTransactionAsync(txData, opts = { shouldValidate: true }) {
                return __awaiter(this, void 0, void 0, function* () {
                    const txDataWithDefaults = yield self._applyDefaultsToTxDataAsync(Object.assign({ data: this.getABIEncodedTransactionData() }, txData), this.estimateGasAsync.bind(this));
     ...
     */
    sampleBuysFromKyberDmmGlobal(router, path) {
        const self = this;
        assert_1.assert.isString('router', router);
        assert_1.assert.isArray('path', path);
        const functionSignature = 'sampleBuysFromKyberDmmGlobal(address,address[])';
        return {
            sendTransactionAsync(txData, opts = { shouldValidate: true }) {
                return __awaiter(this, void 0, void 0, function* () {
                    const txDataWithDefaults = yield self._applyDefaultsToTxDataAsync(Object.assign({ data: this.getABIEncodedTransactionData() }, txData), this.estimateGasAsync.bind(this));
     ...
     * Sample buy quotes from Kyber.
      ...
      * @param makerToken Address of the maker token (what to buy).
     */
    sampleBuysFromKyberNetworkGlobal(opts, takerToken, makerToken) {
        const self = this;
        assert_1.assert.isString('takerToken', takerToken);
        assert_1.assert.isString('makerToken', makerToken);
        const functionSignature = 'sampleBuysFromKyberNetworkGlobal((uint256,address,address,address,bytes),address,address)';
        return {
            sendTransactionAsync(txData, opts = { shouldValidate: true }) {
                return __awaiter(this, void 0, void 0, function* () {
                    const txDataWithDefaults = yield self._applyDefaultsToTxDataAsync(Object.assign({ data: this.getABIEncodedTransactionData() }, txData), this.estimateGasAsync.bind(this));
     ...
     * Sample buy quotes from Lido.
      ...
      * @param makerToken Address of the maker token (what to buy).
     */
    sampleBuysFromLidoGlobal(lidoInfo, takerToken, makerToken) {
        const self = this;
        assert_1.assert.isString('takerToken', takerToken);
        assert_1.assert.isString('makerToken', makerToken);
        const functionSignature = 'sampleBuysFromLidoGlobal((address,address),address,address)';
        return {
            sendTransactionAsync(txData, opts = { shouldValidate: true }) {
                return __awaiter(this, void 0, void 0, function* () {
                    const txDataWithDefaults = yield self._applyDefaultsToTxDataAsync(Object.assign({ data: this.getABIEncodedTransactionData() }, txData), this.estimateGasAsync.bind(this));
    ...
    sampleBuysFromLiquidityProviderGlobal(providerAddress, takerToken, makerToken) {
        ...
        assert_1.assert.isString('takerToken', takerToken);
        assert_1.assert.isString('makerToken', makerToken);
        const functionSignature = 'sampleBuysFromLiquidityProviderGlobal(address,address,address)';
        return {
            sendTransactionAsync(txData, opts = { shouldValidate: true }) {
                return __awaiter(this, void 0, void 0, function* () {
                    const txDataWithDefaults = yield self._applyDefaultsToTxDataAsync(Object.assign({ data: this.getABIEncodedTransactionData() }, txData), this.estimateGasAsync.bind(this));
     ...
     * Sample buy quotes from MStable contract
      ...
      * @param makerToken Address of the maker token (what to buy).
     */
    sampleBuysFromMStableGlobal(router, takerToken, makerToken) {
        const self = this;
        assert_1.assert.isString('router', router);
        assert_1.assert.isString('takerToken', takerToken);
        assert_1.assert.isString('makerToken', makerToken);
        const functionSignature = 'sampleBuysFromMStableGlobal(address,address,address)';
        return {
            sendTransactionAsync(txData, opts = { shouldValidate: true }) {
                return __awaiter(this, void 0, void 0, function* () {
                    const txDataWithDefaults = yield self._applyDefaultsToTxDataAsync(Object.assign({ data: this.getABIEncodedTransactionData() }, txData), this.estimateGasAsync.bind(this));
    ...
    ;
    sampleBuysFromMakerPsmGlobal(psmInfo, takerToken, makerToken) {
        const self = this;
        assert_1.assert.isString('takerToken', takerToken);
        assert_1.assert.isString('makerToken', makerToken);
        const functionSignature = 'sampleBuysFromMakerPsmGlobal((address,bytes32,address),address,address)';
        return {
            sendTransactionAsync(txData, opts = { shouldValidate: true }) {
                return __awaiter(this, void 0, void 0, function* () {
                    const txDataWithDefaults = yield self._applyDefaultsToTxDataAsync(Object.assign({ data: this.getABIEncodedTransactionData() }, txData), this.estimateGasAsync.bind(this));
     ...
     * Sample buy quotes from Mooniswap.
      ...
      * @param makerToken Address of the maker token (what to buy).
     */
    sampleBuysFromMooniswapGlobal(registry, takerToken, makerToken) {
        const self = this;
        assert_1.assert.isString('registry', registry);
        assert_1.assert.isString('takerToken', takerToken);
        assert_1.assert.isString('makerToken', makerToken);
        const functionSignature = 'sampleBuysFromMooniswapGlobal(address,address,address)';
        return {
            sendTransactionAsync(txData, opts = { shouldValidate: true }) {
                return __awaiter(this, void 0, void 0, function* () {
                    const txDataWithDefaults = yield self._applyDefaultsToTxDataAsync(Object.assign({ data: this.getABIEncodedTransactionData() }, txData), this.estimateGasAsync.bind(this));
     ...
     * Sample buy quotes from Shell pool contract
      ...
      * @param makerToken Address of the maker token (what to buy).
     */
    sampleBuysFromShellGlobal(pool, takerToken, makerToken) {
        const self = this;
        assert_1.assert.isString('pool', pool);
        assert_1.assert.isString('takerToken', takerToken);
        assert_1.assert.isString('makerToken', makerToken);
        const functionSignature = 'sampleBuysFromShellGlobal(address,address,address)';
        return {
            sendTransactionAsync(txData, opts = { shouldValidate: true }) {
                return __awaiter(this, void 0, void 0, function* () {
                    const txDataWithDefaults = yield self._applyDefaultsToTxDataAsync(Object.assign({ data: this.getABIEncodedTransactionData() }, txData), this.estimateGasAsync.bind(this));
     ...
     * Sample buy quotes from Smoothy.
      ...
      * @param toTokenIdx Index of the maker token (what to buy).
     */
    sampleBuysFromSmoothyGlobal(smoothyInfo, fromTokenIdx, toTokenIdx) {
        const self = this;
        assert_1.assert.isBigNumber('fromTokenIdx', fromTokenIdx);
        assert_1.assert.isBigNumber('toTokenIdx', toTokenIdx);
        const functionSignature = 'sampleBuysFromSmoothyGlobal((address,bytes4,bytes4),int128,int128)';
        return {
            sendTransactionAsync(txData, opts = { shouldValidate: true }) {
                return __awaiter(this, void 0, void 0, function* () {
                    const txDataWithDefaults = yield self._applyDefaultsToTxDataAsync(Object.assign({ data: this.getABIEncodedTransactionData() }, txData), this.estimateGasAsync.bind(this));
    ...
    sampleBuysFromUniswapGlobal(router, takerToken, makerToken) {
        ...
        assert_1.assert.isString('takerToken', takerToken);
        assert_1.assert.isString('makerToken', makerToken);
        const functionSignature = 'sampleBuysFromUniswapGlobal(address,address,address)';
        return {
            sendTransactionAsync(txData, opts = { shouldValidate: true }) {
                return __awaiter(this, void 0, void 0, function* () {
                    const txDataWithDefaults = yield self._applyDefaultsToTxDataAsync(Object.assign({ data: this.getABIEncodedTransactionData() }, txData), this.estimateGasAsync.bind(this));
    ...
    sampleBuysFromUniswapV2Global(router, path) {
        ...
        assert_1.assert.isString('router', router);
        assert_1.assert.isArray('path', path);
        const functionSignature = 'sampleBuysFromUniswapV2Global(address,address[])';
        return {
            sendTransactionAsync(txData, opts = { shouldValidate: true }) {
                return __awaiter(this, void 0, void 0, function* () {
                    const txDataWithDefaults = yield self._applyDefaultsToTxDataAsync(Object.assign({ data: this.getABIEncodedTransactionData() }, txData), this.estimateGasAsync.bind(this));
     ...
     * Sample buy quotes from UniswapV3.
      ...
      * @param path Token route. Should be takerToken -> makerToken.
     */
    sampleBuysFromUniswapV3Global(quoter, path) {
        const self = this;
        assert_1.assert.isString('quoter', quoter);
        assert_1.assert.isArray('path', path);
        const functionSignature = 'sampleBuysFromUniswapV3Global(address,address[])';
        return {
            sendTransactionAsync(txData, opts = { shouldValidate: true }) {
                return __awaiter(this, void 0, void 0, function* () {
                    const txDataWithDefaults = yield self._applyDefaultsToTxDataAsync(Object.assign({ data: this.getABIEncodedTransactionData() }, txData), this.estimateGasAsync.bind(this));
     ...
     * Sample sell quotes from Balancer.
      ...
      * @param makerToken Address of the maker token (what to buy).
     */
    sampleSellsFromBalancerGlobal(poolAddress, takerToken, makerToken) {
        const self = this;
        assert_1.assert.isString('poolAddress', poolAddress);
        assert_1.assert.isString('takerToken', takerToken);
        assert_1.assert.isString('makerToken', makerToken);
        const functionSignature = 'sampleSellsFromBalancerGlobal(address,address,address)';
        return {
            sendTransactionAsync(txData, opts = { shouldValidate: true }) {
                return __awaiter(this, void 0, void 0, function* () {
                    const txDataWithDefaults = yield self._applyDefaultsToTxDataAsync(Object.assign({ data: this.getABIEncodedTransactionData() }, txData), this.estimateGasAsync.bind(this));
     ...
     * Sample sell quotes from Balancer V2.
      ...
      * @param makerToken Address of the maker token (what to buy).
     */
    sampleSellsFromBalancerV2Global(poolInfo, takerToken, makerToken) {
        const self = this;
        assert_1.assert.isString('takerToken', takerToken);
        assert_1.assert.isString('makerToken', makerToken);
        const functionSignature = 'sampleSellsFromBalancerV2Global((bytes32,address),address,address)';
        return {
            sendTransactionAsync(txData, opts = { shouldValidate: true }) {
                return __awaiter(this, void 0, void 0, function* () {
                    const txDataWithDefaults = yield self._applyDefaultsToTxDataAsync(Object.assign({ data: this.getABIEncodedTransactionData() }, txData), this.estimateGasAsync.bind(this));
     ...
     * Sample sell quotes from Bancor.
      ...
      * @param makerToken Address of the maker token (what to buy).
     */
    sampleSellsFromBancorGlobal(opts, takerToken, makerToken) {
        const self = this;
        assert_1.assert.isString('takerToken', takerToken);
        assert_1.assert.isString('makerToken', makerToken);
        const functionSignature = 'sampleSellsFromBancorGlobal((address,address[][]),address,address)';
        return {
            sendTransactionAsync(txData, opts = { shouldValidate: true }) {
                return __awaiter(this, void 0, void 0, function* () {
                    const txDataWithDefaults = yield self._applyDefaultsToTxDataAsync(Object.assign({ data: this.getABIEncodedTransactionData() }, txData), this.estimateGasAsync.bind(this));
    ...
    ;
    sampleSellsFromCompoundGlobal(cToken, takerToken, makerToken) {
        const self = this;
        assert_1.assert.isString('cToken', cToken);
        assert_1.assert.isString('takerToken', takerToken);
        assert_1.assert.isString('makerToken', makerToken);
        const functionSignature = 'sampleSellsFromCompoundGlobal(address,address,address)';
        return {
            sendTransactionAsync(txData, opts = { shouldValidate: true }) {
                return __awaiter(this, void 0, void 0, function* () {
                    const txDataWithDefaults = yield self._applyDefaultsToTxDataAsync(Object.assign({ data: this.getABIEncodedTransactionData() }, txData), this.estimateGasAsync.bind(this));
     ...
     * Sample sell quotes from Curve.
      ...
      * @param toTokenIdx Index of the maker token (what to buy).
     */
    sampleSellsFromCurveGlobal(curveInfo, fromTokenIdx, toTokenIdx) {
        const self = this;
        assert_1.assert.isBigNumber('fromTokenIdx', fromTokenIdx);
        assert_1.assert.isBigNumber('toTokenIdx', toTokenIdx);
        const functionSignature = 'sampleSellsFromCurveGlobal((address,bytes4,bytes4),int128,int128)';
        return {
            sendTransactionAsync(txData, opts = { shouldValidate: true }) {
                return __awaiter(this, void 0, void 0, function* () {
                    const txDataWithDefaults = yield self._applyDefaultsToTxDataAsync(Object.assign({ data: this.getABIEncodedTransactionData() }, txData), this.estimateGasAsync.bind(this));
     ...
     * Sample sell quotes from DODO.
      ...
      * @param makerToken Address of the maker token (what to buy).
     */
    sampleSellsFromDODOGlobal(opts, takerToken, makerToken) {
        const self = this;
        assert_1.assert.isString('takerToken', takerToken);
        assert_1.assert.isString('makerToken', makerToken);
        const functionSignature = 'sampleSellsFromDODOGlobal((address,address),address,address)';
        return {
            sendTransactionAsync(txData, opts = { shouldValidate: true }) {
                return __awaiter(this, void 0, void 0, function* () {
                    const txDataWithDefaults = yield self._applyDefaultsToTxDataAsync(Object.assign({ data: this.getABIEncodedTransactionData() }, txData), this.estimateGasAsync.bind(this));
     ...
     * Sample sell quotes from DODO V2.
      ...
      * @param makerToken Address of the maker token (what to buy).
     */
    sampleSellsFromDODOV2Global(registry, offset, takerToken, makerToken) {
        const self = this;
        assert_1.assert.isString('registry', registry);
        assert_1.assert.isBigNumber('offset', offset);
        assert_1.assert.isString('takerToken', takerToken);
        assert_1.assert.isString('makerToken', makerToken);
        const functionSignature = 'sampleSellsFromDODOV2Global(address,uint256,address,address)';
        return {
            sendTransactionAsync(txData, opts = { shouldValidate: true }) {
                return __awaiter(this, void 0, void 0, function* () {
                    const txDataWithDefaults = yield self._applyDefaultsToTxDataAsync(Object.assign({ data: this.getABIEncodedTransactionData() }, txData), this.estimateGasAsync.bind(this));
     ...
     * Sample sell quotes from KyberDmm.
      ...
      * @param path Token route. Should be takerToken -> makerToken
     */
    sampleSellsFromKyberDmmGlobal(router, path) {
        const self = this;
        assert_1.assert.isString('router', router);
        assert_1.assert.isArray('path', path);
        const functionSignature = 'sampleSellsFromKyberDmmGlobal(address,address[])';
        return {
            sendTransactionAsync(txData, opts = { shouldValidate: true }) {
                return __awaiter(this, void 0, void 0, function* () {
                    const txDataWithDefaults = yield self._applyDefaultsToTxDataAsync(Object.assign({ data: this.getABIEncodedTransactionData() }, txData), this.estimateGasAsync.bind(this));
     ...
     * Sample sell quotes from Kyber.
      ...
      * @param makerToken Address of the maker token (what to buy).
     */
    sampleSellsFromKyberNetworkGlobal(opts, takerToken, makerToken) {
        const self = this;
        assert_1.assert.isString('takerToken', takerToken);
        assert_1.assert.isString('makerToken', makerToken);
        const functionSignature = 'sampleSellsFromKyberNetworkGlobal((uint256,address,address,address,bytes),address,address)';
        return {
            sendTransactionAsync(txData, opts = { shouldValidate: true }) {
                return __awaiter(this, void 0, void 0, function* () {
                    const txDataWithDefaults = yield self._applyDefaultsToTxDataAsync(Object.assign({ data: this.getABIEncodedTransactionData() }, txData), this.estimateGasAsync.bind(this));
     ...
     * Sample sell quotes from Lido
      ...
      * @param makerToken Address of the maker token (what to buy).
     */
    sampleSellsFromLidoGlobal(lidoInfo, takerToken, makerToken) {
        const self = this;
        assert_1.assert.isString('takerToken', takerToken);
        assert_1.assert.isString('makerToken', makerToken);
        const functionSignature = 'sampleSellsFromLidoGlobal((address,address),address,address)';
        return {
            sendTransactionAsync(txData, opts = { shouldValidate: true }) {
                return __awaiter(this, void 0, void 0, function* () {
                    const txDataWithDefaults = yield self._applyDefaultsToTxDataAsync(Object.assign({ data: this.getABIEncodedTransactionData() }, txData), this.estimateGasAsync.bind(this));
    ...
    sampleSellsFromLiquidityProviderGlobal(providerAddress, takerToken, makerToken) {
        ...
        assert_1.assert.isString('takerToken', takerToken);
        assert_1.assert.isString('makerToken', makerToken);
        const functionSignature = 'sampleSellsFromLiquidityProviderGlobal(address,address,address)';
        return {
            sendTransactionAsync(txData, opts = { shouldValidate: true }) {
                return __awaiter(this, void 0, void 0, function* () {
                    const txDataWithDefaults = yield self._applyDefaultsToTxDataAsync(Object.assign({ data: this.getABIEncodedTransactionData() }, txData), this.estimateGasAsync.bind(this));
     ...
     * Sample sell quotes from the mStable contract
      ...
      * @param makerToken Address of the maker token (what to buy).
     */
    sampleSellsFromMStableGlobal(router, takerToken, makerToken) {
        const self = this;
        assert_1.assert.isString('router', router);
        assert_1.assert.isString('takerToken', takerToken);
        assert_1.assert.isString('makerToken', makerToken);
        const functionSignature = 'sampleSellsFromMStableGlobal(address,address,address)';
        return {
            sendTransactionAsync(txData, opts = { shouldValidate: true }) {
                return __awaiter(this, void 0, void 0, function* () {
                    const txDataWithDefaults = yield self._applyDefaultsToTxDataAsync(Object.assign({ data: this.getABIEncodedTransactionData() }, txData), this.estimateGasAsync.bind(this));
     ...
     */
    sampleSellsFromMakerPsmGlobal(psmInfo, takerToken, makerToken) {
        const self = this;
        assert_1.assert.isString('takerToken', takerToken);
        assert_1.assert.isString('makerToken', makerToken);
        const functionSignature = 'sampleSellsFromMakerPsmGlobal((address,bytes32,address),address,address)';
        return {
            sendTransactionAsync(txData, opts = { shouldValidate: true }) {
                return __awaiter(this, void 0, void 0, function* () {
                    const txDataWithDefaults = yield self._applyDefaultsToTxDataAsync(Object.assign({ data: this.getABIEncodedTransactionData() }, txData), this.estimateGasAsync.bind(this));
     ...
     * Sample sell quotes from Mooniswap.
      ...
      * @param makerToken Address of the maker token (what to buy).
     */
    sampleSellsFromMooniswapGlobal(registry, takerToken, makerToken) {
        const self = this;
        assert_1.assert.isString('registry', registry);
        assert_1.assert.isString('takerToken', takerToken);
        assert_1.assert.isString('makerToken', makerToken);
        const functionSignature = 'sampleSellsFromMooniswapGlobal(address,address,address)';
        return {
            sendTransactionAsync(txData, opts = { shouldValidate: true }) {
                return __awaiter(this, void 0, void 0, function* () {
                    const txDataWithDefaults = yield self._applyDefaultsToTxDataAsync(Object.assign({ data: this.getABIEncodedTransactionData() }, txData), this.estimateGasAsync.bind(this));
     ...
     * Sample sell quotes from the Shell pool contract
      ...
      * @param makerToken Address of the maker token (what to buy).
     */
    sampleSellsFromShellGlobal(pool, takerToken, makerToken) {
        const self = this;
        assert_1.assert.isString('pool', pool);
        assert_1.assert.isString('takerToken', takerToken);
        assert_1.assert.isString('makerToken', makerToken);
        const functionSignature = 'sampleSellsFromShellGlobal(address,address,address)';
        return {
            sendTransactionAsync(txData, opts = { shouldValidate: true }) {
                return __awaiter(this, void 0, void 0, function* () {
                    const txDataWithDefaults = yield self._applyDefaultsToTxDataAsync(Object.assign({ data: this.getABIEncodedTransactionData() }, txData), this.estimateGasAsync.bind(this));
     ...
     * Sample sell quotes from Smoothy.
      ...
      * @param toTokenIdx Index of the maker token (what to buy).
     */
    sampleSellsFromSmoothyGlobal(smoothyInfo, fromTokenIdx, toTokenIdx) {
        const self = this;
        assert_1.assert.isBigNumber('fromTokenIdx', fromTokenIdx);
        assert_1.assert.isBigNumber('toTokenIdx', toTokenIdx);
        const functionSignature = 'sampleSellsFromSmoothyGlobal((address,bytes4,bytes4),int128,int128)';
        return {
            sendTransactionAsync(txData, opts = { shouldValidate: true }) {
                return __awaiter(this, void 0, void 0, function* () {
                    const txDataWithDefaults = yield self._applyDefaultsToTxDataAsync(Object.assign({ data: this.getABIEncodedTransactionData() }, txData), this.estimateGasAsync.bind(this));
    ...
    sampleSellsFromUniswapGlobal(router, takerToken, makerToken) {
        ...
        assert_1.assert.isString('takerToken', takerToken);
        assert_1.assert.isString('makerToken', makerToken);
        const functionSignature = 'sampleSellsFromUniswapGlobal(address,address,address)';
        return {
            sendTransactionAsync(txData, opts = { shouldValidate: true }) {
                return __awaiter(this, void 0, void 0, function* () {
                    const txDataWithDefaults = yield self._applyDefaultsToTxDataAsync(Object.assign({ data: this.getABIEncodedTransactionData() }, txData), this.estimateGasAsync.bind(this));
    ...
    sampleSellsFromUniswapV2Global(router, path) {
        ...
        assert_1.assert.isString('router', router);
        assert_1.assert.isArray('path', path);
        const functionSignature = 'sampleSellsFromUniswapV2Global(address,address[])';
        return {
            sendTransactionAsync(txData, opts = { shouldValidate: true }) {
                return __awaiter(this, void 0, void 0, function* () {
                    const txDataWithDefaults = yield self._applyDefaultsToTxDataAsync(Object.assign({ data: this.getABIEncodedTransactionData() }, txData), this.estimateGasAsync.bind(this));
     ...
     * Sample sell quotes from UniswapV3.
      ...
      * @param path Token route. Should be takerToken -> makerToken
     */
    sampleSellsFromUniswapV3Global(quoter, path) {
        const self = this;
        assert_1.assert.isString('quoter', quoter);
        assert_1.assert.isArray('path', path);
        const functionSignature = 'sampleSellsFromUniswapV3Global(address,address[])';
        return {
            sendTransactionAsync(txData, opts = { shouldValidate: true }) {
                return __awaiter(this, void 0, void 0, function* () {
                    const txDataWithDefaults = yield self._applyDefaultsToTxDataAsync(Object.assign({ data: this.getABIEncodedTransactionData() }, txData), this.estimateGasAsync.bind(this));
    ...
    setSampleValues(sampleValues) {
        const self = this;
        assert_1.assert.isArray('sampleValues', sampleValues);
        const functionSignature = 'setSampleValues(uint256[])';
        return {
            sendTransactionAsync(txData, opts = { shouldValidate: true }) {
                return __awaiter(this, void 0, void 0, function* () {
                    const txDataWithDefaults = yield self._applyDefaultsToTxDataAsync(Object.assign({ data: this.getABIEncodedTransactionData() }, txData), this.estimateGasAsync.bind(this));
            ...
            getABIEncodedTransactionData() {
                return self._strictEncodeArguments(functionSignature, [sampleValues
                ]);
            },
        };
    }
