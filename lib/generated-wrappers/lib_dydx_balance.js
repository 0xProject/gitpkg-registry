...
var LibDydxBalanceContract = /** @class */ (function (_super) {
    __extends(LibDydxBalanceContract, _super);
    function LibDydxBalanceContract(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) {
        if (deployedBytecode === void 0) { deployedBytecode = LibDydxBalanceContract.deployedBytecode; }
        var _this = _super.call(this, 'LibDydxBalance', LibDydxBalanceContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) || this;
        _this._methodABIIndex = {};
        utils_1.classUtils.bindAll(_this, ['_abiEncoderByFunctionSignature', 'address', '_web3Wrapper']);
        LibDydxBalanceContract.ABI().forEach(function (item, index) {
    ...
    LibDydxBalanceContract.deployFrom0xArtifactAsync = function (artifact, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                ...
                return [2 /*return*/, LibDydxBalanceContract.deployAsync(bytecode, abi, provider, txDefaults, logDecodeDependenciesAbiOnly)];
            });
        });
    };
    LibDydxBalanceContract.deployWithLibrariesFrom0xArtifactAsync = function (artifact, libraryArtifacts, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, LibDydxBalanceContract._deployLibrariesAsync(artifact, libraryArtifacts, new web3_wrapper_1.Web3Wrapper(provider), txDefaults)];
                    case 1:
    ...
    LibDydxBalanceContract.deployAsync = function (bytecode, abi, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        txReceipt = _a.sent();
                        utils_1.logUtils.log("LibDydxBalance successfully deployed at " + txReceipt.contractAddress);
                        contractInstance = new LibDydxBalanceContract(txReceipt.contractAddress, provider, txDefaults, logDecodeDependencies);
     ...
     */
    LibDydxBalanceContract.ABI = function () {
        var abi = [
            {
                constant: true,
                inputs: [
    ...
    LibDydxBalanceContract._deployLibrariesAsync = function (artifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses) {
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, LibDydxBalanceContract._deployLibrariesAsync(libraryArtifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses)];
                    case 5:
                        // Deploy any dependent libraries used by this library.
                        _g.sent();
    ...
    LibDydxBalanceContract.prototype.getFunctionSignature = function (methodName) {
        var index = this._methodABIIndex[methodName];
        var methodAbi = LibDydxBalanceContract.ABI()[index]; // tslint:disable-line:no-unnecessary-type-assertion
        var functionSignature = base_contract_1.methodAbiToFunctionSignature(methodAbi);
        return functionSignature;
    };
    LibDydxBalanceContract.prototype.getABIDecodedTransactionData = function (methodName, callData) {
    ...
    LibDydxBalanceContract.prototype.getABIDecodedReturnData = function (methodName, callData) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
    ...
    LibDydxBalanceContract.prototype.getSelector = function (methodName) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
    ...
    * @returns allowance The maker asset allowance.
     */
    LibDydxBalanceContract.prototype.getDydxMakerAllowance = function (makerAddress, bridgeAddress, dydx) {
        var self = this;
        ...
        var functionSignature = 'getDydxMakerAllowance(address,address,address)';
        return {
    ...
    ;
    LibDydxBalanceContract.prototype.getDydxMakerBalance = function (order, dydx) {
        var self = this;
        assert_1.assert.isString('dydx', dydx);
    ...
    ;
    LibDydxBalanceContract.contractName = 'LibDydxBalance';
    return LibDydxBalanceContract;
}(base_contract_1.BaseContract));
exports.LibDydxBalanceContract = LibDydxBalanceContract;
// tslint:disable:max-file-line-count
// tslint:enable:no-unbound-method no-parameter-reassignment no-consecutive-blank-lines ordered-imports align
// tslint:enable:trailing-comma whitespace no-trailing-whitespace
//# sourceMappingURL=lib_dydx_balance.js.map