...
export declare class ERC20BridgeSamplerContract extends BaseContract {
    ...
    ETH(): ContractTxFunctionObj<string>;
    /**
 ...
 * maker/taker asset amounts (returning 0).
     ...
     * Sample buy quotes from BancorV3.
      ...
      * @param makerTokenAmounts Maker token buy amount for each sample.
     */
    sampleBuysFromBancorV3(weth: string, router: string, path: string[], makerTokenAmounts: BigNumber[]): ContractTxFunctionObj<BigNumber[]>;
    sampleBuysFromCompound(cToken: string, takerToken: string, makerToken: string, makerTokenAmounts: BigNumber[]): ContractTxFunctionObj<BigNumber[]>;
    /**
    ...
    sampleBuysFromGMX(reader: string, vault: string, path: string[], makerTokenAmounts: BigNumber[]): ContractTxFunctionObj<BigNumber[]>;
    /**
    ...
    sampleBuysFromPlatypus(pool: string, path: string[], makerTokenAmounts: BigNumber[]): ContractTxFunctionObj<BigNumber[]>;
    /**
     ...
     * Sample buy quotes from UniswapV3.
      ...
      * @param makerTokenAmounts Maker token buy amount for each sample.
     */
    sampleBuysFromUniswapV3(quoter: string, path: string[], makerTokenAmounts: BigNumber[]): ContractTxFunctionObj<[string[], BigNumber[], BigNumber[]]>;
    /**
     * Sample buy quotes from Velodrome.
      ...
      * @param makerTokenAmounts Maker token buy amount for each sample.
     */
    sampleBuysFromVelodrome(router: string, takerToken: string, makerToken: string, makerTokenAmounts: BigNumber[]): ContractTxFunctionObj<[boolean, BigNumber[]]>;
    /**
     * Sample buy quotes from Balancer V2 supporting multihops.
      ...
      * @param makerTokenAmounts Maker token buy amount for each sample.
     */
    sampleMultihopBuysFromBalancerV2(vault: string, swapSteps: Array<{
        poolId: string;
        assetInIndex: BigNumber;
        assetOutIndex: BigNumber;
        amount: BigNumber;
        userData: string;
    }>, swapAssets: string[], makerTokenAmounts: BigNumber[]): ContractTxFunctionObj<BigNumber[]>;
    /**
     ...
     */
    sampleMultihopSellsFromBalancerV2(vault: string, swapSteps: Array<{
        poolId: string;
        assetInIndex: BigNumber;
        assetOutIndex: BigNumber;
        amount: BigNumber;
        userData: string;
    }>, swapAssets: string[], takerTokenAmounts: BigNumber[]): ContractTxFunctionObj<BigNumber[]>;
    /**
     ...
     * Sample sell quotes from BancorV3.
      ...
      * @param takerTokenAmounts Taker token sell amount for each sample.
     */
    sampleSellsFromBancorV3(weth: string, router: string, path: string[], takerTokenAmounts: BigNumber[]): ContractTxFunctionObj<BigNumber[]>;
    sampleSellsFromCompound(cToken: string, takerToken: string, makerToken: string, takerTokenAmounts: BigNumber[]): ContractTxFunctionObj<BigNumber[]>;
    /**
    ...
    sampleSellsFromGMX(reader: string, vault: string, path: string[], takerTokenAmounts: BigNumber[]): ContractTxFunctionObj<BigNumber[]>;
    /**
    ...
    sampleSellsFromPlatypus(pool: string, path: string[], takerTokenAmounts: BigNumber[]): ContractTxFunctionObj<BigNumber[]>;
    /**
     ...
     * Sample sell quotes from UniswapV3.
      ...
      * @param takerTokenAmounts Taker token sell amount for each sample.
     */
    sampleSellsFromUniswapV3(quoter: string, path: string[], takerTokenAmounts: BigNumber[]): ContractTxFunctionObj<[string[], BigNumber[], BigNumber[]]>;
    /**
     ...
     *     ascending order).
     */
    sampleSellsFromVelodrome(router: string, takerToken: string, makerToken: string, takerTokenAmounts: BigNumber[]): ContractTxFunctionObj<[boolean, BigNumber[]]>;
