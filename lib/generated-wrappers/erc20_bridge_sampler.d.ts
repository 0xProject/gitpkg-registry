 ...
 * maker/taker asset amounts (returning 0).
     ...
     * Sample buy quotes from Lido.
      ...
      * @param makerTokenAmounts Maker token buy amount for each sample.
     */
    sampleBuysFromLido(lido: string, takerToken: string, makerToken: string, makerTokenAmounts: BigNumber[]): ContractTxFunctionObj<[BigNumber[], BigNumber[]]>;
    /**
     ...
     * Sample sell quotes from Lido
      ...
      * @param takerTokenAmounts Taker token sell amount for each sample.
     */
    sampleSellsFromLido(lido: string, takerToken: string, makerToken: string, takerTokenAmounts: BigNumber[]): ContractTxFunctionObj<[BigNumber[], BigNumber[]]>;
    /**
    ...
    sampleSwapFromLido(sellToken: string, buyToken: string, bridgeData: string, takerTokenAmount: BigNumber): ContractTxFunctionObj<BigNumber>;
