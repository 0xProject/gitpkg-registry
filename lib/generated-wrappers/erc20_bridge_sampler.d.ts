 ...
 * maker/taker asset amounts (returning 0).
     ...
     * Sample buy quotes from UniswapV3.
      ...
      * @param makerTokenAmounts Maker token buy amount for each sample.
     */
    sampleBuysFromUniswapV3(quoter: string, path: string[], makerTokenAmounts: BigNumber[]): ContractTxFunctionObj<[BigNumber[], string[]]>;
     ...
     * Sample sell quotes from UniswapV3.
      ...
      * @param takerTokenAmounts Taker token sell amount for each sample.
     */
    sampleSellsFromUniswapV3(quoter: string, path: string[], takerTokenAmounts: BigNumber[]): ContractTxFunctionObj<[BigNumber[], string[]]>;
