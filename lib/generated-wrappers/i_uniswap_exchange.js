...
var IUniswapExchangeContract = /** @class */ (function (_super) {
    __extends(IUniswapExchangeContract, _super);
    function IUniswapExchangeContract(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) {
        if (deployedBytecode === void 0) { deployedBytecode = IUniswapExchangeContract.deployedBytecode; }
        var _this = _super.call(this, 'IUniswapExchange', IUniswapExchangeContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) || this;
        _this._methodABIIndex = {};
        utils_1.classUtils.bindAll(_this, ['_abiEncoderByFunctionSignature', 'address', '_web3Wrapper']);
        IUniswapExchangeContract.ABI().forEach(function (item, index) {
    ...
    IUniswapExchangeContract.deployFrom0xArtifactAsync = function (artifact, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                ...
                return [2 /*return*/, IUniswapExchangeContract.deployAsync(bytecode, abi, provider, txDefaults, logDecodeDependenciesAbiOnly)];
            });
        });
    };
    IUniswapExchangeContract.deployWithLibrariesFrom0xArtifactAsync = function (artifact, libraryArtifacts, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, IUniswapExchangeContract._deployLibrariesAsync(artifact, libraryArtifacts, new web3_wrapper_1.Web3Wrapper(provider), txDefaults)];
                    case 1:
    ...
    IUniswapExchangeContract.deployAsync = function (bytecode, abi, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        txReceipt = _a.sent();
                        utils_1.logUtils.log("IUniswapExchange successfully deployed at " + txReceipt.contractAddress);
                        contractInstance = new IUniswapExchangeContract(txReceipt.contractAddress, provider, txDefaults, logDecodeDependencies);
     ...
     */
    IUniswapExchangeContract.ABI = function () {
        var abi = [
            {
                constant: false,
                inputs: [
    ...
    IUniswapExchangeContract._deployLibrariesAsync = function (artifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses) {
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, IUniswapExchangeContract._deployLibrariesAsync(libraryArtifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses)];
                    case 5:
                        // Deploy any dependent libraries used by this library.
                        _g.sent();
    ...
    IUniswapExchangeContract.prototype.getFunctionSignature = function (methodName) {
        var index = this._methodABIIndex[methodName];
        var methodAbi = IUniswapExchangeContract.ABI()[index]; // tslint:disable-line:no-unnecessary-type-assertion
        var functionSignature = base_contract_1.methodAbiToFunctionSignature(methodAbi);
        return functionSignature;
    };
    IUniswapExchangeContract.prototype.getABIDecodedTransactionData = function (methodName, callData) {
    ...
    IUniswapExchangeContract.prototype.getABIDecodedReturnData = function (methodName, callData) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
    ...
    IUniswapExchangeContract.prototype.getSelector = function (methodName) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
 ...
 * to `recipient`.
    ...
    * @returns tokensBought Amount of tokens bought.
     */
    IUniswapExchangeContract.prototype.ethToTokenTransferInput = function (minTokensBought, deadline, recipient) {
        var self = this;
        ...
        var functionSignature = 'ethToTokenTransferInput(uint256,uint256,address)';
        return {
    ...
    * @returns ethBought Amount of tokens bought.
     */
    IUniswapExchangeContract.prototype.tokenToEthSwapInput = function (tokensSold, minEthBought, deadline) {
        var self = this;
        assert_1.assert.isBigNumber('tokensSold', tokensSold);
        assert_1.assert.isBigNumber('minEthBought', minEthBought);
        assert_1.assert.isBigNumber('deadline', deadline);
        var functionSignature = 'tokenToEthSwapInput(uint256,uint256,uint256)';
        return {
            sendTransactionAsync: function (txData, opts) {
                if (opts === void 0) { opts = { shouldValidate: true }; }
                return __awaiter(this, void 0, void 0, function () {
 ...
 * and transfer them to `recipient`.
    ...
    * @returns tokensBought Amount of tokens bought.
     */
    IUniswapExchangeContract.prototype.tokenToTokenTransferInput = function (tokensSold, minTokensBought, minEthBought, deadline, recipient, toTokenAddress) {
        var self = this;
        assert_1.assert.isBigNumber('tokensSold', tokensSold);
        assert_1.assert.isBigNumber('minTokensBought', minTokensBought);
        assert_1.assert.isBigNumber('minEthBought', minEthBought);
        ...
        var functionSignature = 'tokenToTokenTransferInput(uint256,uint256,uint256,uint256,address,address)';
        return {
            sendTransactionAsync: function (txData, opts) {
                if (opts === void 0) { opts = { shouldValidate: true }; }
                return __awaiter(this, void 0, void 0, function () {
    ...
    ;
    IUniswapExchangeContract.contractName = 'IUniswapExchange';
    return IUniswapExchangeContract;
}(base_contract_1.BaseContract));
exports.IUniswapExchangeContract = IUniswapExchangeContract;
// tslint:disable:max-file-line-count
// tslint:enable:no-unbound-method no-parameter-reassignment no-consecutive-blank-lines ordered-imports align
// tslint:enable:trailing-comma whitespace no-trailing-whitespace
//# sourceMappingURL=i_uniswap_exchange.js.map