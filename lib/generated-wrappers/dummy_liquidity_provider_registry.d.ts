...
export declare class DummyLiquidityProviderRegistryContract extends BaseContract {
     ...
     */
    getLiquidityProviderForMarket(xToken: string, yToken: string): ContractTxFunctionObj<string>;
    /**
     ...
     */
    setLiquidityProviderForMarket(xToken: string, yToken: string, poolAddress: string): ContractTxFunctionObj<void>;
