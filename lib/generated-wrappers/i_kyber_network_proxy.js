...
var IKyberNetworkProxyContract = /** @class */ (function (_super) {
    __extends(IKyberNetworkProxyContract, _super);
    function IKyberNetworkProxyContract(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) {
        if (deployedBytecode === void 0) { deployedBytecode = IKyberNetworkProxyContract.deployedBytecode; }
        var _this = _super.call(this, 'IKyberNetworkProxy', IKyberNetworkProxyContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) || this;
        _this._methodABIIndex = {};
        utils_1.classUtils.bindAll(_this, ['_abiEncoderByFunctionSignature', 'address', '_web3Wrapper']);
        IKyberNetworkProxyContract.ABI().forEach(function (item, index) {
    ...
    IKyberNetworkProxyContract.deployFrom0xArtifactAsync = function (artifact, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                ...
                return [2 /*return*/, IKyberNetworkProxyContract.deployAsync(bytecode, abi, provider, txDefaults, logDecodeDependenciesAbiOnly)];
            });
        });
    };
    IKyberNetworkProxyContract.deployWithLibrariesFrom0xArtifactAsync = function (artifact, libraryArtifacts, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, IKyberNetworkProxyContract._deployLibrariesAsync(artifact, libraryArtifacts, new web3_wrapper_1.Web3Wrapper(provider), txDefaults)];
                    case 1:
    ...
    IKyberNetworkProxyContract.deployAsync = function (bytecode, abi, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        txReceipt = _a.sent();
                        utils_1.logUtils.log("IKyberNetworkProxy successfully deployed at " + txReceipt.contractAddress);
                        contractInstance = new IKyberNetworkProxyContract(txReceipt.contractAddress, provider, txDefaults, logDecodeDependencies);
     ...
     */
    IKyberNetworkProxyContract.ABI = function () {
        var abi = [
            {
                constant: false,
                inputs: [
    ...
    IKyberNetworkProxyContract._deployLibrariesAsync = function (artifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses) {
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, IKyberNetworkProxyContract._deployLibrariesAsync(libraryArtifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses)];
                    case 5:
                        // Deploy any dependent libraries used by this library.
                        _g.sent();
    ...
    IKyberNetworkProxyContract.prototype.getFunctionSignature = function (methodName) {
        var index = this._methodABIIndex[methodName];
        var methodAbi = IKyberNetworkProxyContract.ABI()[index]; // tslint:disable-line:no-unnecessary-type-assertion
        var functionSignature = base_contract_1.methodAbiToFunctionSignature(methodAbi);
        return functionSignature;
    };
    IKyberNetworkProxyContract.prototype.getABIDecodedTransactionData = function (methodName, callData) {
    ...
    IKyberNetworkProxyContract.prototype.getABIDecodedReturnData = function (methodName, callData) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
    ...
    IKyberNetworkProxyContract.prototype.getSelector = function (methodName) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
    ...
    /**
     * Sells `sellTokenAddress` tokens for `buyTokenAddress` tokens.
    ...
    * @returns boughtAmount Amount of tokens bought.
     */
    IKyberNetworkProxyContract.prototype.trade = function (sellTokenAddress, sellAmount, buyTokenAddress, recipientAddress, maxBuyTokenAmount, minConversionRate, walletId) {
        var self = this;
        ...
        assert_1.assert.isString('recipientAddress', recipientAddress);
        assert_1.assert.isBigNumber('maxBuyTokenAmount', maxBuyTokenAmount);
        assert_1.assert.isBigNumber('minConversionRate', minConversionRate);
        assert_1.assert.isString('walletId', walletId);
        var functionSignature = 'trade(address,uint256,address,address,uint256,uint256,address)';
        return {
    ...
    ;
    IKyberNetworkProxyContract.contractName = 'IKyberNetworkProxy';
    return IKyberNetworkProxyContract;
}(base_contract_1.BaseContract));
exports.IKyberNetworkProxyContract = IKyberNetworkProxyContract;
// tslint:disable:max-file-line-count
// tslint:enable:no-unbound-method no-parameter-reassignment no-consecutive-blank-lines ordered-imports align
// tslint:enable:trailing-comma whitespace no-trailing-whitespace
//# sourceMappingURL=i_kyber_network_proxy.js.map