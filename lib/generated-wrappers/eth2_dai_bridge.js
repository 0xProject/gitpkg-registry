...
var Eth2DaiBridgeEvents;
(function (Eth2DaiBridgeEvents) {
    Eth2DaiBridgeEvents["ERC20BridgeTransfer"] = "ERC20BridgeTransfer";
})(Eth2DaiBridgeEvents = exports.Eth2DaiBridgeEvents || (exports.Eth2DaiBridgeEvents = {}));
/* istanbul ignore next */
// tslint:disable:array-type
// tslint:disable:no-parameter-reassignment
// tslint:disable-next-line:class-name
var Eth2DaiBridgeContract = /** @class */ (function (_super) {
    __extends(Eth2DaiBridgeContract, _super);
    function Eth2DaiBridgeContract(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) {
        if (deployedBytecode === void 0) { deployedBytecode = Eth2DaiBridgeContract.deployedBytecode; }
        var _this = _super.call(this, 'Eth2DaiBridge', Eth2DaiBridgeContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) || this;
        _this._methodABIIndex = {};
        utils_1.classUtils.bindAll(_this, ['_abiEncoderByFunctionSignature', 'address', '_web3Wrapper']);
        _this._subscriptionManager = new base_contract_1.SubscriptionManager(Eth2DaiBridgeContract.ABI(), _this._web3Wrapper);
        Eth2DaiBridgeContract.ABI().forEach(function (item, index) {
    ...
    Eth2DaiBridgeContract.deployFrom0xArtifactAsync = function (artifact, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                ...
                return [2 /*return*/, Eth2DaiBridgeContract.deployAsync(bytecode, abi, provider, txDefaults, logDecodeDependenciesAbiOnly)];
            });
        });
    };
    Eth2DaiBridgeContract.deployWithLibrariesFrom0xArtifactAsync = function (artifact, libraryArtifacts, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, Eth2DaiBridgeContract._deployLibrariesAsync(artifact, libraryArtifacts, new web3_wrapper_1.Web3Wrapper(provider), txDefaults)];
                    case 1:
    ...
    Eth2DaiBridgeContract.deployAsync = function (bytecode, abi, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        contractInstance = new Eth2DaiBridgeContract(txReceipt.contractAddress, provider, txDefaults, logDecodeDependencies);
     ...
     */
    Eth2DaiBridgeContract.ABI = function () {
        var abi = [
            {
                anonymous: false,
                inputs: [
    ...
    Eth2DaiBridgeContract._deployLibrariesAsync = function (artifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses) {
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, Eth2DaiBridgeContract._deployLibrariesAsync(libraryArtifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses)];
                    case 5:
                        // Deploy any dependent libraries used by this library.
                        _g.sent();
    ...
    Eth2DaiBridgeContract.prototype.getFunctionSignature = function (methodName) {
        var index = this._methodABIIndex[methodName];
        var methodAbi = Eth2DaiBridgeContract.ABI()[index]; // tslint:disable-line:no-unnecessary-type-assertion
        var functionSignature = base_contract_1.methodAbiToFunctionSignature(methodAbi);
        return functionSignature;
    };
    Eth2DaiBridgeContract.prototype.getABIDecodedTransactionData = function (methodName, callData) {
    ...
    Eth2DaiBridgeContract.prototype.getABIDecodedReturnData = function (methodName, callData) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
    ...
    Eth2DaiBridgeContract.prototype.getSelector = function (methodName) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
 ...
 * tokens to `to`.
    ...
    * @returns success The magic bytes if successful.
     */
    Eth2DaiBridgeContract.prototype.bridgeTransferFrom = function (toTokenAddress, from, to, amount, bridgeData) {
        var self = this;
 ...
 * and sign for itself in orders. Always succeeds.
    * @returns magicValue Magic success bytes, always.
     */
    Eth2DaiBridgeContract.prototype.isValidSignature = function (index_0, index_1) {
        var self = this;
    ...
    ;
    /**
     * Subscribe to an event type emitted by the Eth2DaiBridge contract.
     * @param eventName The Eth2DaiBridge contract event you would like to subscribe to.
     ...
     */
    Eth2DaiBridgeContract.prototype.subscribe = function (eventName, indexFilterValues, callback, isVerbose, blockPollingIntervalMs) {
        if (isVerbose === void 0) { isVerbose = false; }
        assert_1.assert.doesBelongToStringEnum('eventName', eventName, Eth2DaiBridgeEvents);
        ...
        var subscriptionToken = this._subscriptionManager.subscribe(this.address, eventName, indexFilterValues, Eth2DaiBridgeContract.ABI(), callback, isVerbose, blockPollingIntervalMs);
     ...
     */
    Eth2DaiBridgeContract.prototype.unsubscribe = function (subscriptionToken) {
        this._subscriptionManager.unsubscribe(subscriptionToken);
    };
    /**
     * Cancels all existing subscriptions
     */
    Eth2DaiBridgeContract.prototype.unsubscribeAll = function () {
     ...
     */
    Eth2DaiBridgeContract.prototype.getLogsAsync = function (eventName, blockRange, indexFilterValues) {
        return __awaiter(this, void 0, void 0, function () {
            var logs;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        assert_1.assert.doesConformToSchema('indexFilterValues', indexFilterValues, json_schemas_1.schemas.indexFilterValuesSchema);
                        return [4 /*yield*/, this._subscriptionManager.getLogsAsync(this.address, eventName, blockRange, indexFilterValues, Eth2DaiBridgeContract.ABI())];
                    case 1:
                        logs = _a.sent();
