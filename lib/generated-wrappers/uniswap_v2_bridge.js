...
var UniswapV2BridgeEvents;
(function (UniswapV2BridgeEvents) {
    UniswapV2BridgeEvents["ERC20BridgeTransfer"] = "ERC20BridgeTransfer";
})(UniswapV2BridgeEvents = exports.UniswapV2BridgeEvents || (exports.UniswapV2BridgeEvents = {}));
/* istanbul ignore next */
// tslint:disable:array-type
// tslint:disable:no-parameter-reassignment
// tslint:disable-next-line:class-name
var UniswapV2BridgeContract = /** @class */ (function (_super) {
    __extends(UniswapV2BridgeContract, _super);
    function UniswapV2BridgeContract(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) {
        if (deployedBytecode === void 0) { deployedBytecode = UniswapV2BridgeContract.deployedBytecode; }
        var _this = _super.call(this, 'UniswapV2Bridge', UniswapV2BridgeContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) || this;
        _this._methodABIIndex = {};
        utils_1.classUtils.bindAll(_this, ['_abiEncoderByFunctionSignature', 'address', '_web3Wrapper']);
        _this._subscriptionManager = new base_contract_1.SubscriptionManager(UniswapV2BridgeContract.ABI(), _this._web3Wrapper);
        UniswapV2BridgeContract.ABI().forEach(function (item, index) {
    ...
    UniswapV2BridgeContract.deployFrom0xArtifactAsync = function (artifact, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                ...
                return [2 /*return*/, UniswapV2BridgeContract.deployAsync(bytecode, abi, provider, txDefaults, logDecodeDependenciesAbiOnly)];
            });
        });
    };
    UniswapV2BridgeContract.deployWithLibrariesFrom0xArtifactAsync = function (artifact, libraryArtifacts, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, UniswapV2BridgeContract._deployLibrariesAsync(artifact, libraryArtifacts, new web3_wrapper_1.Web3Wrapper(provider), txDefaults)];
                    case 1:
    ...
    UniswapV2BridgeContract.deployAsync = function (bytecode, abi, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        contractInstance = new UniswapV2BridgeContract(txReceipt.contractAddress, provider, txDefaults, logDecodeDependencies);
     ...
     */
    UniswapV2BridgeContract.ABI = function () {
        var abi = [
            {
                anonymous: false,
                inputs: [
    ...
    UniswapV2BridgeContract._deployLibrariesAsync = function (artifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses) {
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, UniswapV2BridgeContract._deployLibrariesAsync(libraryArtifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses)];
                    case 5:
                        // Deploy any dependent libraries used by this library.
                        _g.sent();
    ...
    UniswapV2BridgeContract.prototype.getFunctionSignature = function (methodName) {
        var index = this._methodABIIndex[methodName];
        var methodAbi = UniswapV2BridgeContract.ABI()[index]; // tslint:disable-line:no-unnecessary-type-assertion
        var functionSignature = base_contract_1.methodAbiToFunctionSignature(methodAbi);
        return functionSignature;
    };
    UniswapV2BridgeContract.prototype.getABIDecodedTransactionData = function (methodName, callData) {
    ...
    UniswapV2BridgeContract.prototype.getABIDecodedReturnData = function (methodName, callData) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
    ...
    UniswapV2BridgeContract.prototype.getSelector = function (methodName) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
 ...
 * token encoded in the bridge data.
    ...
    * @returns success The magic bytes if successful.
     */
    UniswapV2BridgeContract.prototype.bridgeTransferFrom = function (toTokenAddress, from, to, amount, bridgeData) {
        var self = this;
 ...
 * and sign for itself in orders. Always succeeds.
    * @returns magicValue Success bytes, always.
     */
    UniswapV2BridgeContract.prototype.isValidSignature = function (index_0, index_1) {
        var self = this;
     ...
     */
    UniswapV2BridgeContract.prototype.subscribe = function (eventName, indexFilterValues, callback, isVerbose, blockPollingIntervalMs) {
        if (isVerbose === void 0) { isVerbose = false; }
        assert_1.assert.doesBelongToStringEnum('eventName', eventName, UniswapV2BridgeEvents);
        ...
        var subscriptionToken = this._subscriptionManager.subscribe(this.address, eventName, indexFilterValues, UniswapV2BridgeContract.ABI(), callback, isVerbose, blockPollingIntervalMs);
     ...
     */
    UniswapV2BridgeContract.prototype.unsubscribe = function (subscriptionToken) {
        this._subscriptionManager.unsubscribe(subscriptionToken);
    };
    /**
     * Cancels all existing subscriptions
     */
    UniswapV2BridgeContract.prototype.unsubscribeAll = function () {
     ...
     */
    UniswapV2BridgeContract.prototype.getLogsAsync = function (eventName, blockRange, indexFilterValues) {
        return __awaiter(this, void 0, void 0, function () {
            var logs;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        assert_1.assert.doesConformToSchema('indexFilterValues', indexFilterValues, json_schemas_1.schemas.indexFilterValuesSchema);
                        return [4 /*yield*/, this._subscriptionManager.getLogsAsync(this.address, eventName, blockRange, indexFilterValues, UniswapV2BridgeContract.ABI())];
                    case 1:
                        logs = _a.sent();
    ...
    return UniswapV2BridgeContract;
