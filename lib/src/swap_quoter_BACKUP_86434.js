...
class SwapQuoter {
    ...
    constructor(supportedProvider, orderbook, options = {}) {
        ...
        this._contractAddresses = options.contractAddresses || Object.assign({}, contract_addresses_1.getContractAddressesForChainOrThrow(chainId), BRIDGE_ADDRESSES_BY_CHAIN[chainId]);
    ...
    _getSwapQuoteAsync(makerAssetData, takerAssetData, assetFillAmount, marketOperation, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!constants_1.IS_PRICE_AWARE_RFQ_ENABLED && // Price-aware RFQ is disabled.
...
//# sourceMappingURL=swap_quoter_BACKUP_86434.js.map