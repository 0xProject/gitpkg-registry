...
import { SwapQuoteOrder } from '../types';
/**
 ...
 */
export declare function getFQTTransformerDataFromOptimizedOrders(orders: SwapQuoteOrder[]): Pick<FillQuoteTransformerData, 'bridgeOrders' | 'limitOrders' | 'rfqOrders' | 'fillSequence'>;
/**
