    ...
    ForwarderSwapQuoteConsumer.prototype.getCalldataOrThrowAsync = function (quote, opts) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                ethAmountWithFees = affiliate_fee_utils_1.affiliateFeeUtils.getTotalEthAmountWithAffiliateFee(__assign({}, worstCaseQuoteInfo, (quote.type === types_1.MarketOperation.Buy
                    ? {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        feeAmount = affiliate_fee_utils_1.affiliateFeeUtils.getFeeAmount(__assign({}, quote.worstCaseQuoteInfo, (quote.type === types_1.MarketOperation.Buy
                            ? {
                                // tslint:disable-next-line: custom-no-magic-numbers
