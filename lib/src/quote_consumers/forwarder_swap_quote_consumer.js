...
exports.ForwarderSwapQuoteConsumer = void 0;
    ...
    ForwarderSwapQuoteConsumer.prototype.getCalldataOrThrowAsync = function (quote, opts) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                extensionContractOpts = __assign(__assign({}, constants_1.constants.DEFAULT_FORWARDER_SWAP_QUOTE_GET_OPTS), opts).extensionContractOpts;
                ...
                ethAmountWithFees = affiliate_fee_utils_1.affiliateFeeUtils.getTotalEthAmountWithAffiliateFee(__assign(__assign({}, worstCaseQuoteInfo), (quote.type === types_1.MarketOperation.Buy
                    ? {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        assert_1.assert.isValidForwarderSwapQuote('quote', quote, this._getEtherTokenAssetDataOrThrow());
                        _a = __assign(__assign({}, constants_1.constants.DEFAULT_FORWARDER_SWAP_QUOTE_EXECUTE_OPTS), opts), providedEthAmount = _a.ethAmount, takerAddress = _a.takerAddress, gasLimit = _a.gasLimit, extensionContractOpts = _a.extensionContractOpts;
                        assert_1.assert.isValidForwarderExtensionContractOpts('extensionContractOpts', extensionContractOpts);
                        feeRecipient = extensionContractOpts.feeRecipient, feePercentage = extensionContractOpts.feePercentage;
                    ...
                    case 1:
                        ...
                        feeAmount = affiliate_fee_utils_1.affiliateFeeUtils.getFeeAmount(__assign(__assign({}, quote.worstCaseQuoteInfo), (quote.type === types_1.MarketOperation.Buy
                            ? {
                                // tslint:disable-next-line: custom-no-magic-numbers
