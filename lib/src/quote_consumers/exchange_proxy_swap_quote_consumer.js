    ...
    getCalldataOrThrowAsync(quote, opts = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (isDirectSwapCompatible(quote, optsWithDefaults, [types_2.ERC20BridgeSource.LiquidityProvider])) {
                ...
                return {
                    calldataHexString: this._exchangeProxy
                        .sellToLiquidityProvider(isFromETH ? order_utils_1.ETH_TOKEN_ADDRESS : sellToken, isToETH ? order_utils_1.ETH_TOKEN_ADDRESS : buyToken, target, NULL_ADDRESS, sellAmount, minBuyAmount, NULL_BYTES)
                        .getABIEncodedTransactionData(),
                    ethAmount: isFromETH ? sellAmount : ZERO_AMOUNT,
                    toAddress: this._exchangeProxy.address,
                    allowanceTarget: this.contractAddresses.exchangeProxyAllowanceTarget,
            ...
            const calldataHexString = this._exchangeProxy
                .transformERC20(isFromETH ? order_utils_1.ETH_TOKEN_ADDRESS : sellToken, isToETH ? order_utils_1.ETH_TOKEN_ADDRESS : buyToken, shouldSellEntireBalance ? MAX_UINT256 : sellAmount, minBuyAmount, transforms)
                .getABIEncodedTransactionData();
            return {
                calldataHexString,
                ethAmount,
