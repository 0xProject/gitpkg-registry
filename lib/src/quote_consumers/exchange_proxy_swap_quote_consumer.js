...
class ExchangeProxySwapQuoteConsumer {
    ...
    getCalldataOrThrowAsync(quote, opts = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (isDirectSwapCompatible(quote, optsWithDefaults, [types_2.ERC20BridgeSource.Curve, types_2.ERC20BridgeSource.Swerve])) {
                const fillData = quote.orders[0].fills[0].fillData;
                return {
                    calldataHexString: this._exchangeProxy
                        .sellToLiquidityProvider(isFromETH ? protocol_utils_1.ETH_TOKEN_ADDRESS : sellToken, isToETH ? protocol_utils_1.ETH_TOKEN_ADDRESS : buyToken, constants_2.CURVE_LIQUIDITY_PROVIDER, NULL_ADDRESS, sellAmount, minBuyAmount, protocol_utils_1.encodeCurveLiquidityProviderData({
