...
const DUMMY_WETH_CONTRACT = new contract_wrappers_1.WETH9Contract(NULL_ADDRESS, constants_1.DUMMY_PROVIDER);
class ExchangeProxySwapQuoteConsumer {
    constructor(contractAddresses, options) {
        ...
        this.contractAddresses = contractAddresses;
        this._exchangeProxy = new contract_wrappers_1.IZeroExContract(contractAddresses.exchangeProxy, constants_1.DUMMY_PROVIDER);
        this._multiplex = new contracts_zero_ex_1.MultiplexFeatureContract(contractAddresses.exchangeProxy, constants_1.DUMMY_PROVIDER);
    ...
    getCalldataOrThrowAsync(quote, opts = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.chainId === contract_addresses_1.ChainId.Mainnet &&
                quote_consumer_utils_1.isDirectSwapCompatible(quote, optsWithDefaults, [types_1.ERC20BridgeSource.UniswapV2, types_1.ERC20BridgeSource.SushiSwap])) {
            ...
            if (this.chainId === contract_addresses_1.ChainId.Mainnet &&
                quote_consumer_utils_1.isDirectSwapCompatible(quote, optsWithDefaults, [types_1.ERC20BridgeSource.UniswapV3])) {
                const fillData = slippedOrders[0].fillData;
            ...
            if ([contract_addresses_1.ChainId.Mainnet, contract_addresses_1.ChainId.BSC].includes(this.chainId) &&
                quote_consumer_utils_1.isDirectSwapCompatible(quote, optsWithDefaults, [types_1.ERC20BridgeSource.LiquidityProvider])) {
                const fillData = slippedOrders[0].fillData;
            ...
            if (this.chainId === contract_addresses_1.ChainId.Mainnet &&
                quote_consumer_utils_1.isDirectSwapCompatible(quote, optsWithDefaults, [types_1.ERC20BridgeSource.Curve, types_1.ERC20BridgeSource.Swerve]) &&
                ...
                ![sellToken, buyToken].includes(tokens_1.WRAPPED_NETWORK_TOKEN_BY_CHAIN_ID[contract_addresses_1.ChainId.Mainnet])) {
            ...
            if (this.chainId === contract_addresses_1.ChainId.Mainnet &&
                quote_consumer_utils_1.isDirectSwapCompatible(quote, optsWithDefaults, [types_1.ERC20BridgeSource.Mooniswap])) {
                const fillData = slippedOrders[0].fills[0].fillData;
                return {
                    calldataHexString: this._exchangeProxy
            ...
            if (isToETH) {
                ...
                transforms.push({
                    deploymentNonce: this.transformerNonces.wethTransformer,
                    data: protocol_utils_1.encodeWethTransformerData({
                        token: tokens_1.WRAPPED_NETWORK_TOKEN_BY_CHAIN_ID[this.chainId],
                        amount: MAX_UINT256,
                    }),
                });
            }
            ...
            if (feeType === types_2.AffiliateFeeType.PositiveSlippageFee && feeRecipient !== NULL_ADDRESS) {
            ...
            else if (feeType === types_2.AffiliateFeeType.PercentageFee && feeRecipient !== NULL_ADDRESS) {
...
function slipNonNativeOrders(quote) {
    ...
    return quote.orders.map(o => {
        if (o.source === types_1.ERC20BridgeSource.Native) {
            return o;
        }
        return Object.assign(Object.assign({}, o), (quote.type === types_2.MarketOperation.Sell
...
function getMaxQuoteSlippageRate(quote) {
    if (quote.type === types_2.MarketOperation.Buy) {
