...
class ExchangeProxySwapQuoteConsumer {
    ...
    getCalldataOrThrowAsync(quote, opts = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // VIP routes.
            if (isDirectSwapCompatible(quote, this.chainId, optsWithDefaults, [
            ...
            if (isDirectSwapCompatible(quote, this.chainId, optsWithDefaults, [types_2.ERC20BridgeSource.LiquidityProvider])) {
                const fillData = quote.orders[0].fillData;
            ...
            if (isDirectSwapCompatible(quote, this.chainId, optsWithDefaults, [types_2.ERC20BridgeSource.Mooniswap])) {
                const fillData = quote.orders[0].fills[0].fillData;
                return {
                    calldataHexString: this._exchangeProxy
...
function isDirectSwapCompatible(quote, chainId, opts, directSources) {
    // Must not be a mtx.
