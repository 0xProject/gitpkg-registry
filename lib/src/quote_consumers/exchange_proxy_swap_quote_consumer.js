...
class ExchangeProxySwapQuoteConsumer {
    ...
    getCalldataOrThrowAsync(quote, opts = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const { affiliateFee, isFromETH, isToETH } = Object.assign({}, constants_1.constants.DEFAULT_EXCHANGE_PROXY_EXTENSION_CONTRACT_OPTS, opts.extensionContractOpts);
            ...
            if (quote.isTwoHop) {
                ...
                transforms.push({
                    ...
                    data: order_utils_1.encodeFillQuoteTransformerData({
                        sellToken,
                        buyToken: utils_2.getTokenFromAssetData(firstHopOrder.makerAssetData),
                ...
                transforms.push({
                    deploymentNonce: this.transformerNonces.fillQuoteTransformer,
                    data: order_utils_1.encodeFillQuoteTransformerData({
                        sellToken: utils_2.getTokenFromAssetData(secondHopOrder.takerAssetData),
                        buyToken,
                        side: order_utils_1.FillQuoteTransformerSide.Sell,
            ...
            transforms.push({
                ...
                data: order_utils_1.encodePayTakerTransformerData({
                    tokens: [sellToken, buyToken, order_utils_1.ETH_TOKEN_ADDRESS].concat(quote.isTwoHop ? utils_2.getTokenFromAssetData(quote.orders[0].makerAssetData) : []),
                    amounts: [],
                }),
            });
            const minBuyAmount = utils_1.BigNumber.max(0, quote.worstCaseQuoteInfo.makerAssetAmount.minus(buyTokenFeeAmount));
 ...
 */
function findTransformerNonce(transformer, deployer = NULL_ADDRESS) {
