...
var ExchangeProxySwapQuoteConsumer = /** @class */ (function () {
    function ExchangeProxySwapQuoteConsumer(supportedProvider, contractAddresses, options) {
        ...
        this.transformerNonces = {
            ...
            affiliateFeeTransformer: findTransformerNonce(contractAddresses.transformers.affiliateFeeTransformer, contractAddresses.exchangeProxyTransformerDeployer),
        };
    }
    ExchangeProxySwapQuoteConsumer.prototype.getCalldataOrThrowAsync = function (quote, opts) {
        if (opts === void 0) { opts = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var _a, affiliateFee, isFromETH, isToETH, sellToken, buyToken, sellAmount, transforms, buyTokenFeeAmount, sellTokenFeeAmount, feeRecipient, minBuyAmount, calldataHexString, ethAmount;
            return __generator(this, function (_b) {
                assert_1.assert.isValidSwapQuote('quote', quote);
                _a = __assign({}, constants_1.constants.DEFAULT_EXCHANGE_PROXY_EXTENSION_CONTRACT_OPTS, opts.extensionContractOpts), affiliateFee = _a.affiliateFee, isFromETH = _a.isFromETH, isToETH = _a.isToETH;
                ...
                buyTokenFeeAmount = affiliateFee.buyTokenFeeAmount, sellTokenFeeAmount = affiliateFee.sellTokenFeeAmount, feeRecipient = affiliateFee.recipient;
                ...
                transforms.push({
                    ...
                    data: order_utils_1.encodePayTakerTransformerData({
                        tokens: [sellToken, buyToken, order_utils_1.ETH_TOKEN_ADDRESS],
                        amounts: [],
                    }),
                });
                minBuyAmount = utils_1.BigNumber.max(0, quote.worstCaseQuoteInfo.makerAssetAmount.minus(buyTokenFeeAmount));
