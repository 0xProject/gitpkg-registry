            ...
            if (isDirectUniswapCompatible(quote, optsWithDefaults)) {
                ...
                return {
                    calldataHexString: this._exchangeProxy
                        ...
                        return a;
                    }), sellAmount, quote.worstCaseQuoteInfo.makerAssetAmount, source === types_2.ERC20BridgeSource.SushiSwap)
...
function isDirectUniswapCompatible(quote, opts) {
    // Must not be a mtx.
    ...
    if (![types_2.ERC20BridgeSource.UniswapV2, types_2.ERC20BridgeSource.SushiSwap].includes(fill.source)) {
        return false;
    }
    return true;
}
