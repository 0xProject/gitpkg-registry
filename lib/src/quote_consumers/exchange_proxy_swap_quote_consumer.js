...
class ExchangeProxySwapQuoteConsumer {
    constructor(contractAddresses, options = {}) {
        ...
        this._transformERC20Feature = new contracts_zero_ex_1.TransformERC20FeatureContract(contractAddresses.exchangeProxy, FAKE_PROVIDER);
    ...
    getCalldataOrThrowAsync(quote, opts = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const calldataHexString = this._transformERC20Feature
                .transformERC20Staging(isFromETH ? protocol_utils_1.ETH_TOKEN_ADDRESS : sellToken, isToETH ? protocol_utils_1.ETH_TOKEN_ADDRESS : buyToken, shouldSellEntireBalance ? MAX_UINT256 : sellAmount, minBuyAmount, transforms)
                .getABIEncodedTransactionData();
            return {
                calldataHexString,
                ethAmount,
