...
const PANCAKE_SWAP_FORKS = [types_2.ERC20BridgeSource.PancakeSwap, types_2.ERC20BridgeSource.BakerySwap, types_2.ERC20BridgeSource.SushiSwap];
    ...
    getCalldataOrThrowAsync(quote, opts = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.chainId === contract_addresses_1.ChainId.Mainnet &&
                isDirectSwapCompatible(quote, optsWithDefaults, [types_2.ERC20BridgeSource.UniswapV2, types_2.ERC20BridgeSource.SushiSwap])) {
            ...
            if (this.chainId === contract_addresses_1.ChainId.Mainnet &&
                isDirectSwapCompatible(quote, optsWithDefaults, [types_2.ERC20BridgeSource.LiquidityProvider])) {
                const fillData = quote.orders[0].fillData;
            ...
            if (this.chainId === contract_addresses_1.ChainId.Mainnet &&
                isDirectSwapCompatible(quote, optsWithDefaults, [types_2.ERC20BridgeSource.Curve, types_2.ERC20BridgeSource.Swerve])) {
            ...
            if (this.chainId === contract_addresses_1.ChainId.Mainnet &&
                isDirectSwapCompatible(quote, optsWithDefaults, [types_2.ERC20BridgeSource.Mooniswap])) {
                const fillData = quote.orders[0].fills[0].fillData;
                return {
                    calldataHexString: this._exchangeProxy
...
function isDirectSwapCompatible(quote, opts, directSources) {
    ...
    if (opts.affiliateFee.feeType === types_1.AffiliateFeeType.PositiveSlippageFee) {
        return false;
    }
    ...
    for (const order of orders) {
        if (isOptimizedBridgeOrder(order)) {
            fqtData.bridgeOrders.push({
                ...
                source: orders_1.erc20BridgeSourceToBridgeSource(order.source),
            });
        }
