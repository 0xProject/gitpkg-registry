...
const DUMMY_WETH_CONTRACT = new contract_wrappers_1.WETH9Contract(NULL_ADDRESS, {
    sendAsync() {
        return;
    },
});
class ExchangeProxySwapQuoteConsumer {
    constructor(supportedProvider, contractAddresses, options = {}) {
        ...
        this._multiplex = new contracts_zero_ex_1.MultiplexFeatureContract(contractAddresses.exchangeProxy, supportedProvider);
