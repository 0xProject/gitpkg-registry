    ...
    getCalldataOrThrowAsync(quote, opts = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            switch (this.chainId) {
                ...
                case CELO_CHAIN_ID:
                    calldataHexString = this._exchangeProxy
                        .transformERC20(isFromETH ? protocol_utils_1.ETH_TOKEN_ADDRESS : sellToken, isToETH ? '0x471EcE3750Da237f93B8E339c536989b8978a438' : buyToken, shouldSellEntireBalance ? MAX_UINT256 : sellAmount, minBuyAmount, transforms)
                        .getABIEncodedTransactionData();
                    break;
                default:
                    calldataHexString = this._exchangeProxy
