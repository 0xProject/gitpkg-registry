...
(function () { return __awaiter(_this, void 0, void 0, function () {
    var rpcSubprovider, provider, pkSubprovider, normalizedFromAddress, txDefaults;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                rpcSubprovider = new subproviders_1.RPCSubprovider(args['rpc-url']);
                provider = new subproviders_1.Web3ProviderEngine();
                if (args.pk !== undefined && args.pk !== '') {
                    pkSubprovider = new subproviders_1.PrivateKeyWalletSubprovider(args.pk);
                    provider.addProvider(pkSubprovider);
                }
                provider.addProvider(rpcSubprovider);
                utils_1.providerUtils.startProviderEngine(provider);
                normalizedFromAddress = args.from.toLowerCase();
                txDefaults = {
