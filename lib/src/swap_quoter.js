...
class SwapQuoter {
    ...
    constructor(supportedProvider, orderbook, options = {}) {
        ...
        this._quoteRequestorHttpClient = axios_1.default.create(Object.assign({ httpAgent: new http_1.Agent({ keepAlive: true, timeout: constants_1.KEEP_ALIVE_TTL }), httpsAgent: new https_1.Agent({ keepAlive: true, timeout: constants_1.KEEP_ALIVE_TTL, rejectUnauthorized: false }) }, (rfqt ? rfqt.axiosInstanceOpts : {})));
    }
    ...
    getSwapQuoteAsync(makerToken, takerToken, assetFillAmount, marketOperation, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const calcOpts = Object.assign(Object.assign({}, cloneOpts), { feeSchedule: _.mapValues(opts.feeSchedule, gasCost => (fillData) => gasCost === undefined ? 0 : gasPrice.times(gasCost(fillData))), exchangeProxyOverhead: flags => gasPrice.times(opts.exchangeProxyOverhead(flags)) });
