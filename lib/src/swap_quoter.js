...
var SwapQuoter = /** @class */ (function () {
    ...
    function SwapQuoter(supportedProvider, orderbook, options) {
        ...
        this._rfqtSkipBuyRequests =
            rfqt && rfqt.skipBuyRequests !== undefined
                ...
                : (function (r) { return r !== undefined && r.skipBuyRequests === true; })(constants_1.constants.DEFAULT_SWAP_QUOTER_OPTS.rfqt);
        ...
        this._quoteRequestor = new quote_requestor_1.QuoteRequestor(rfqt ? rfqt.makerAssetOfferings || {} : {}, rfqt ? rfqt.warningLogger : undefined, rfqt ? rfqt.infoLogger : undefined, expiryBufferMs);
    ...
    SwapQuoter.prototype._getSwapQuoteAsync = function (makerAssetData, takerAssetData, assetFillAmount, marketOperation, options) {
        return __awaiter(this, void 0, void 0, function () {
            var opts, gasPrice, orderBatchPromises, orderBatches, unsortedOrders, orders, swapQuote, calcOpts;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 3:
                        ...
                        if (opts.rfqt &&
                            ...
                            !(marketOperation === types_1.MarketOperation.Buy && this._rfqtSkipBuyRequests)) {
                            if (!opts.rfqt.takerAddress || opts.rfqt.takerAddress === constants_1.constants.NULL_ADDRESS) {
                                throw new Error('RFQ-T requests must specify a taker address');
                            }
                            orderBatchPromises.push(this._quoteRequestor
    ...
    SwapQuoter.prototype._shouldEnableIndicativeRfqt = function (opts, op) {
        return (opts !== undefined &&
            opts.isIndicative !== undefined &&
            opts.isIndicative &&
            this._rfqtTakerApiKeyWhitelist.includes(opts.apiKey) &&
            !(op === types_1.MarketOperation.Buy && this._rfqtSkipBuyRequests));
    };
    return SwapQuoter;
}());
