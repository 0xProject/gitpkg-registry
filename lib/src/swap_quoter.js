...
var SwapQuoter = /** @class */ (function () {
    ...
    function SwapQuoter(supportedProvider, orderbook, options) {
        ...
        this._quoteRequestor = new quote_requestor_1.QuoteRequestor(options.rfqt ? options.rfqt.makerEndpoints || [] : [], options.rfqt ? options.rfqt.warningLogger || undefined : undefined);
