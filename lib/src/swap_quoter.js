...
class SwapQuoter {
    ...
    getPricesForAssetDataAsync(makerAssetDatas, takerAssetData, takerAssetAmount, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            let gasPrice;
            if (!!options.gasPrice) {
            ...
            const prices = this._swapQuoteCalculator.getPricesAsync(dummyOrders, takerAssetAmount, gasPrice, calculateSwapQuoteOpts);
            return prices;
        });
    }
