...
class SwapQuoter {
    ...
    constructor(supportedProvider, orderbook, options = {}) {
        ...
        this._marketOperationUtils = new market_operation_utils_1.MarketOperationUtils(new sampler_1.DexOrderSampler(samplerContract, samplerOverrides, provider, undefined, undefined, undefined, tokenAdjacencyGraph, liquidityProviderRegistry), this._contractAddresses, {
            chainId,
