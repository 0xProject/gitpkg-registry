...
var SwapQuoter = /** @class */ (function () {
    ...
    function SwapQuoter(supportedProvider, orderbook, options) {
        ...
        var _a = _.merge({}, constants_1.constants.DEFAULT_SWAP_QUOTER_OPTS, options), chainId = _a.chainId, expiryBufferMs = _a.expiryBufferMs, permittedOrderFeeTypes = _a.permittedOrderFeeTypes, samplerGasLimit = _a.samplerGasLimit, liquidityProviderRegistryAddress = _a.liquidityProviderRegistryAddress, rfqt = _a.rfqt;
        ...
        var sampler = new sampler_1.DexOrderSampler(new contract_wrappers_1.IERC20BridgeSamplerContract(this._contractAddresses.erc20BridgeSampler, this.provider, {
            gas: samplerGasLimit,
        }));
