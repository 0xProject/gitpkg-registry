...
class SwapQuoter {
    ...
    constructor(supportedProvider, orderbook, options = {}) {
        ...
        const { chainId, expiryBufferMs, permittedOrderFeeTypes, samplerGasLimit, rfqt, tokenAdjacencyGraph, liquidityProviderRegistry, } = _.merge({}, constants_1.constants.DEFAULT_SWAP_QUOTER_OPTS, options);
        ...
        this._marketOperationUtils = new market_operation_utils_1.MarketOperationUtils(new sampler_1.DexOrderSampler(this.chainId, samplerContract, samplerOverrides, undefined, // balancer pool cache
    ...
    getSwapQuoteAsync(makerToken, takerToken, assetFillAmount, marketOperation, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (calcOpts.rfqt !== undefined) {
                calcOpts.rfqt.quoteRequestor = new quote_requestor_1.QuoteRequestor(rfqtOptions ? rfqtOptions.makerAssetOfferings || {} : {}, rfqtOptions ? rfqtOptions.altRfqCreds : undefined, rfqtOptions ? rfqtOptions.warningLogger : undefined, rfqtOptions ? rfqtOptions.infoLogger : undefined, this.expiryBufferMs);
            }
    ...
    _validateRfqtOpts(sourceFilters, rfqt) {
        ...
        // never be excluded.
        if (nativeExclusivelyRFQT === true && !sourceFilters.isAllowed(types_2.ERC20BridgeSource.Native)) {
