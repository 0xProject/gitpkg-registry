...
var SwapQuoter = /** @class */ (function () {
    ...
    function SwapQuoter(supportedProvider, orderbook, options) {
        ...
        var samplerBytecode = _.get(artifacts_1.artifacts.ERC20BridgeSampler, 'compilerOutput.evm.deployedBytecode.object');
        ...
        var samplerContract = new wrappers_1.ERC20BridgeSamplerContract(this._contractAddresses.erc20BridgeSampler, this.provider, {
            gas: samplerGasLimit,
        });
