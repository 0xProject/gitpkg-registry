...
var SwapQuoter = /** @class */ (function () {
    ...
    function SwapQuoter(supportedProvider, orderbook, options) {
        ...
        var _a = _.merge({}, constants_1.constants.DEFAULT_SWAP_QUOTER_OPTS, options), chainId = _a.chainId, expiryBufferMs = _a.expiryBufferMs, permittedOrderFeeTypes = _a.permittedOrderFeeTypes, samplerGasLimit = _a.samplerGasLimit, liquidityProviderRegistryAddress = _a.liquidityProviderRegistryAddress;
        ...
        this._quoteRequestor = new quote_requestor_1.QuoteRequestor(options.rfqt ? options.rfqt.makerEndpoints || [] : []);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        utils_1.logUtils.log(__filename + ": _getSwapQuouteAsync(): rfqt is " + JSON.stringify(opts.rfqt, null, '\t'));
                        if (opts.rfqt &&
                    ...
                    case 4:
                        ...
                        utils_1.logUtils.log("Order batches: " + JSON.stringify(orderBatches));
                        unsortedOrders = orderBatches.reduce(function (_orders, batch) { return _orders.concat.apply(_orders, __spread(batch)); });
                        utils_1.logUtils.log("Unsorted orders: " + JSON.stringify(unsortedOrders));
                        orders = sorting_utils_1.sortingUtils.sortOrders(unsortedOrders);
                        utils_1.logUtils.log("Sorted orders: " + JSON.stringify(orders));
    ...
    SwapQuoter.prototype._shouldEnableIndicativeRfqt = function (opts) {
        var shouldReturnTrue = opts !== undefined && !opts.intentOnFilling && this._rfqtTakerApiKeyWhitelist.includes(opts.apiKey);
        utils_1.logUtils.log(__filename + ": _shouldEnableIndicativeRfqt() returning " + shouldReturnTrue);
