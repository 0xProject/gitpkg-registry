...
var SwapQuoter = /** @class */ (function () {
     ...
     */
    function SwapQuoter(supportedProvider, orderbook, options, quoteRequestor) {
        ...
        this._quoteRequestor = quoteRequestor || new quote_requestor_1.QuoteRequestor(this.rfqtMakerEndpoints);
    ...
    SwapQuoter.prototype._getSwapQuoteAsync = function (makerAssetData, takerAssetData, assetFillAmount, marketOperation, options) {
        return __awaiter(this, void 0, void 0, function () {
            var calculateSwapQuoteOpts, gasPrice, orders, _a, _b, swapQuote;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 4:
                        orders = _c.sent();
                        if (!(options.intentOnFilling && options.apiKey)) return [3 /*break*/, 6];
                        if (!options.apiKey) {
                        ...
                        _b = (_a = orders).concat;
                        return [4 /*yield*/, this._quoteRequestor.requestRfqtFirmQuotesAsync(makerAssetData, takerAssetData, assetFillAmount, marketOperation, options.intentOnFilling, options.apiKey, options.takerAddress)];
                    case 5:
                        orders = _b.apply(_a, [_c.sent()]);
                        _c.label = 6;
                    case 6:
                        // if no native orders, pass in a dummy order for the sampler to have required metadata for sampling
                        if (orders.length === 0) {
                            orders = [
                                orders_1.createDummyOrderForSampler(makerAssetData, takerAssetData, this._contractAddresses.uniswapBridge),
                            ];
                        }
                        if (!(marketOperation === types_1.MarketOperation.Buy)) return [3 /*break*/, 8];
                        return [4 /*yield*/, this._swapQuoteCalculator.calculateMarketBuySwapQuoteAsync(orders, assetFillAmount, gasPrice, calculateSwapQuoteOpts)];
                    case 7:
                        swapQuote = _c.sent();
                        return [3 /*break*/, 10];
                    case 8: return [4 /*yield*/, this._swapQuoteCalculator.calculateMarketSellSwapQuoteAsync(orders, assetFillAmount, gasPrice, calculateSwapQuoteOpts)];
                    case 9:
                        swapQuote = _c.sent();
                        _c.label = 10;
                    case 10: return [2 /*return*/, swapQuote];
                }
            });
        });
    };
