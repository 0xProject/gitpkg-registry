...
var SwapQuoter = /** @class */ (function () {
    ...
    function SwapQuoter(supportedProvider, orderbook, options) {
        ...
        this._quoteRequestor =
            options.quoteRequestor || new quote_requestor_1.QuoteRequestor(options.rfqt ? options.rfqt.makerEndpoints || [] : []);
    ...
    SwapQuoter.prototype._getSwapQuoteAsync = function (makerAssetData, takerAssetData, assetFillAmount, marketOperation, options) {
        return __awaiter(this, void 0, void 0, function () {
            var opts, gasPrice, orderBatchPromises, orderBatches, unsortedOrders, orders, swapQuote;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 3:
                        ...
                        if (opts.rfqt &&
                            ...
                            orderBatchPromises.push(this._quoteRequestor.requestRfqtFirmQuotesAsync(makerAssetData, takerAssetData, assetFillAmount, marketOperation, opts.apiKey, opts.rfqt.takerAddress));
                        }
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, this._swapQuoteCalculator.calculateMarketBuySwapQuoteAsync(orders, assetFillAmount, gasPrice, opts)];
                    case 5:
                        swapQuote = _a.sent();
                        return [3 /*break*/, 8];
                    case 6: return [4 /*yield*/, this._swapQuoteCalculator.calculateMarketSellSwapQuoteAsync(orders, assetFillAmount, gasPrice, opts)];
                    case 7:
                        swapQuote = _a.sent();
                        _a.label = 8;
