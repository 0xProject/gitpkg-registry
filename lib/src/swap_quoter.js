...
var SwapQuoter = /** @class */ (function () {
    ...
    function SwapQuoter(supportedProvider, orderbook, options) {
        ...
        this._marketOperationUtils = new market_operation_utils_1.MarketOperationUtils(new sampler_1.DexOrderSampler(samplerContract, samplerOverrides, new bancor_service_1.BancorService(provider)), this._contractAddresses, {
            chainId: chainId,
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        makerAssetData = order_utils_1.assetDataUtils.encodeERC20AssetData(makerTokenAddress);
                        takerAssetData = order_utils_1.assetDataUtils.encodeERC20AssetData(takerTokenAddress);
                        if (!(options.excludedSources && options.excludedSources.includes(types_2.ERC20BridgeSource.Native))) return [3 /*break*/, 2];
