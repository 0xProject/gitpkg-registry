                ...
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        if (opts.rfqt &&
                            ...
                            orderBatchPromises.push(this._quoteRequestor.requestRfqtFirmQuotesAsync(makerAssetData, takerAssetData, assetFillAmount, marketOperation, opts.rfqt).then(function (firmQuotes) { return firmQuotes.map(function (quote) { return quote.signedOrder; }); }));
                        }
