...
var SwapQuoter = /** @class */ (function () {
    ...
    SwapQuoter.prototype._getSwapQuoteAsync = function (makerAssetData, takerAssetData, assetFillAmount, marketOperation, options) {
        return __awaiter(this, void 0, void 0, function () {
            var calculateSwapQuoteOpts, gasPrice, prunedOrders, swapQuote;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        calculateSwapQuoteOpts = _.merge({}, constants_1.constants.DEFAULT_SWAP_QUOTE_REQUEST_OPTS, options);
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, this._swapQuoteCalculator.calculateMarketBuySwapQuoteAsync(prunedOrders, assetFillAmount, gasPrice, calculateSwapQuoteOpts)];
                    case 5:
                        swapQuote = _a.sent();
                        return [3 /*break*/, 8];
                    case 6: return [4 /*yield*/, this._swapQuoteCalculator.calculateMarketSellSwapQuoteAsync(prunedOrders, assetFillAmount, gasPrice, calculateSwapQuoteOpts)];
                    case 7:
                        swapQuote = _a.sent();
                        _a.label = 8;
