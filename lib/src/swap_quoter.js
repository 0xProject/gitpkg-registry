...
class SwapQuoter {
    ...
    constructor(supportedProvider, orderbook, options = {}) {
        ...
        const defaultCodeOverrides = samplerBytecode
            ? {
                [constants_2.SAMPLER_ADDRESS]: { code: samplerBytecode },
            }
            : {};
        ...
        const samplerContract = new wrappers_1.ERC20BridgeSamplerContract(constants_2.SAMPLER_ADDRESS, this.provider, {
            gas: samplerGasLimit,
        }, {}, undefined, {
