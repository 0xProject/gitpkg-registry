...
var SwapQuoter = /** @class */ (function () {
    ...
    function SwapQuoter(supportedProvider, orderbook, options) {
        ...
        this._protocolFeeUtils = new protocol_fee_utils_1.ProtocolFeeUtils(constants_1.constants.PROTOCOL_FEE_UTILS_POLLING_INTERVAL_IN_MS, options.ethGasStationUrl);
