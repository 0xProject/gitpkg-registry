...
var bancor_service_1 = require("./utils/market_operation_utils/bancor_service");
var orders_1 = require("./utils/market_operation_utils/orders");
var sampler_1 = require("./utils/market_operation_utils/sampler");
...
var SwapQuoter = /** @class */ (function () {
    ...
    function SwapQuoter(supportedProvider, orderbook, options) {
        ...
        var _b = _.merge({}, constants_1.constants.DEFAULT_SWAP_QUOTER_OPTS, options), chainId = _b.chainId, expiryBufferMs = _b.expiryBufferMs, permittedOrderFeeTypes = _b.permittedOrderFeeTypes, samplerGasLimit = _b.samplerGasLimit, liquidityProviderRegistryAddress = _b.liquidityProviderRegistryAddress, rfqt = _b.rfqt;
        ...
        var samplerBytecode = _.get(contract_artifacts_1.ERC20BridgeSampler, 'compilerOutput.evm.deployedBytecode.object');
        var defaultCodeOverrides = samplerBytecode
            ? (_a = {},
                _a[this._contractAddresses.erc20BridgeSampler] = { code: samplerBytecode },
                _a) : {};
        var samplerOverrides = _.assign({ block: ethereum_types_1.BlockParamLiteral.Latest, overrides: defaultCodeOverrides }, options.samplerOverrides);
        var samplerContract = new contract_wrappers_1.ERC20BridgeSamplerContract(this._contractAddresses.erc20BridgeSampler, this.provider, {
            gas: samplerGasLimit,
        });
        var bancorService = options.ethereumRpcUrl ? new bancor_service_1.BancorService(provider) : undefined;
        this._marketOperationUtils = new market_operation_utils_1.MarketOperationUtils(new sampler_1.DexOrderSampler(samplerContract, samplerOverrides, bancorService), this._contractAddresses, {
            chainId: chainId,
    ...
    SwapQuoter.prototype.getBatchMarketBuySwapQuoteForAssetDataAsync = function (makerAssetDatas, takerAssetData, makerAssetBuyAmount, options) {
        if (options === void 0) { options = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var gasPrice, calculateSwapQuoteOpts, apiOrders, allOrders, allPrunedOrders, swapQuotes;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        makerAssetBuyAmount.map(function (a, i) { return assert_1.assert.isBigNumber("makerAssetBuyAmount[" + i + "]", a); });
                        calculateSwapQuoteOpts = _.merge({}, constants_1.constants.DEFAULT_SWAP_QUOTE_REQUEST_OPTS, options);
                        if (!!!options.gasPrice) return [3 /*break*/, 1];
                        gasPrice = options.gasPrice;
                        assert_1.assert.isBigNumber('gasPrice', gasPrice);
                        return [3 /*break*/, 3];
                    case 1: return [4 /*yield*/, this.getGasPriceEstimationOrThrowAsync()];
                    case 2:
                        gasPrice = _a.sent();
                        _a.label = 3;
                    ...
                    case 4:
                        ...
                        allPrunedOrders = allOrders.map(function (orders, i) {
                            ...
                            if (prunedOrders.length === 0) {
                                return [
                                    orders_1.createDummyOrderForSampler(makerAssetDatas[i], takerAssetData, _this._contractAddresses.uniswapBridge),
                                ];
                            }
                            else {
                        ...
                        return [4 /*yield*/, this._swapQuoteCalculator.calculateBatchMarketBuySwapQuoteAsync(allPrunedOrders, makerAssetBuyAmount, gasPrice, calculateSwapQuoteOpts)];
                    case 5:
                        swapQuotes = _a.sent();
    ...
    SwapQuoter.prototype.getMarketBuySwapQuoteAsync = function (makerTokenAddress, takerTokenAddress, makerAssetBuyAmount, options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, this.getMarketBuySwapQuoteForAssetDataAsync(makerAssetData, takerAssetData, makerAssetBuyAmount, options)];
            });
        });
    };
    /**
    ...
    SwapQuoter.prototype.getMarketSellSwapQuoteAsync = function (makerTokenAddress, takerTokenAddress, takerAssetSellAmount, options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                makerAssetData = order_utils_1.assetDataUtils.encodeERC20AssetData(makerTokenAddress);
                takerAssetData = order_utils_1.assetDataUtils.encodeERC20AssetData(takerTokenAddress);
                return [2 /*return*/, this.getMarketSellSwapQuoteForAssetDataAsync(makerAssetData, takerAssetData, takerAssetSellAmount, options)];
            });
        });
    };
    /**
     ...
     */
    SwapQuoter.prototype.getBidAskLiquidityForMakerTakerAssetPairAsync = function (makerTokenAddress, takerTokenAddress, takerAssetAmount, options) {
        if (options === void 0) { options = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var makerAssetData, takerAssetData, _a, sellOrders, buyOrders, _b, getMarketDepthSide, _c, bids, asks;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        makerAssetData = order_utils_1.assetDataUtils.encodeERC20AssetData(makerTokenAddress);
                        takerAssetData = order_utils_1.assetDataUtils.encodeERC20AssetData(takerTokenAddress);
                        if (!(options.excludedSources && options.excludedSources.includes(types_2.ERC20BridgeSource.Native))) return [3 /*break*/, 1];
                        _b = Promise.resolve([[], []]);
                        return [3 /*break*/, 3];
                    ...
                    case 2:
                        ...
                        _d.label = 3;
                    case 3:
                        _a = __read.apply(void 0, [_b, 2]), sellOrders = _a[0], buyOrders = _a[1];
                        ...
                        getMarketDepthSide = function (marketSideLiquidity) {
                            var dexQuotes = marketSideLiquidity.dexQuotes, nativeOrders = marketSideLiquidity.nativeOrders, orderFillableAmounts = marketSideLiquidity.orderFillableAmounts, side = marketSideLiquidity.side;
                            return __spread(dexQuotes, [
                                nativeOrders.map(function (o, i) {
                                    // When sell order fillable amount is taker
                                    // When buy order fillable amount is maker
                                    var scaleFactor = orderFillableAmounts[i].div(side === types_1.MarketOperation.Sell ? o.takerAssetAmount : o.makerAssetAmount);
                                    return {
                        ...
                        return [4 /*yield*/, Promise.all([
                                this._marketOperationUtils.getMarketBuyLiquidityAsync((buyOrders || []).map(function (o) { return o.order; }), takerAssetAmount, options),
                                this._marketOperationUtils.getMarketSellLiquidityAsync((sellOrders || []).map(function (o) { return o.order; }), takerAssetAmount, options),
                            ])];
                    case 4:
                        _c = __read.apply(void 0, [_d.sent(), 2]), bids = _c[0], asks = _c[1];
                        return [2 /*return*/, {
     ...
     */
    SwapQuoter.prototype.getGasPriceEstimationOrThrowAsync = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this._protocolFeeUtils.getGasPriceEstimationOrThrowAsync()];
            });
        });
    };
    /**
    ...
    SwapQuoter.prototype._getSignedOrdersAsync = function (makerAssetData, takerAssetData) {
        return __awaiter(this, void 0, void 0, function () {
            var apiOrders, orders, prunedOrders;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        assert_1.assert.isString('makerAssetData', makerAssetData);
    ...
    SwapQuoter.prototype._getSwapQuoteAsync = function (makerAssetData, takerAssetData, assetFillAmount, marketOperation, options) {
        return __awaiter(this, void 0, void 0, function () {
            var opts, gasPrice, orderBatchPromises, skipOpenOrderbook, rfqtOptions, quoteRequestor, orderBatches, unsortedOrders, orders, swapQuote, calcOpts;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        opts = _.merge({}, constants_1.constants.DEFAULT_SWAP_QUOTE_REQUEST_OPTS, options);
                        assert_1.assert.isString('makerAssetData', makerAssetData);
                        assert_1.assert.isString('takerAssetData', takerAssetData);
                        if (!!!opts.gasPrice) return [3 /*break*/, 1];
                    ...
                    case 3:
                        ...
                        if (opts.rfqt &&
                            ...
                            opts.excludedSources.includes(types_2.ERC20BridgeSource.Native)) {
                            throw new Error('Native liquidity cannot be excluded if "rfqt.nativeExclusivelyRFQT" is set');
                        }
                        orderBatchPromises = [];
                        skipOpenOrderbook = opts.excludedSources.includes(types_2.ERC20BridgeSource.Native) ||
                        ...
                        rfqtOptions = this._rfqtOptions;
                        quoteRequestor = new quote_requestor_1.QuoteRequestor(rfqtOptions ? rfqtOptions.makerAssetOfferings || {} : {}, rfqtOptions ? rfqtOptions.warningLogger : undefined, rfqtOptions ? rfqtOptions.infoLogger : undefined, this.expiryBufferMs);
                        if (opts.rfqt && // This is an RFQT-enabled API request
                            ...
                            !opts.excludedSources.includes(types_2.ERC20BridgeSource.Native) // Native liquidity is not excluded
                        ) {
                            ...
                            orderBatchPromises.push(quoteRequestor
                                ...
                                .then(function (firmQuotes) { return firmQuotes.map(function (quote) { return quote.signedOrder; }); }));
                        }
                        return [4 /*yield*/, Promise.all(orderBatchPromises)];
                    case 4:
                        orderBatches = _a.sent();
                        unsortedOrders = orderBatches.reduce(function (_orders, batch) { return _orders.concat.apply(_orders, __spread(batch)); }, []);
                        orders = sorting_utils_1.sortingUtils.sortOrders(unsortedOrders);
                        ...
                        return [4 /*yield*/, this._swapQuoteCalculator.calculateMarketBuySwapQuoteAsync(orders, assetFillAmount, gasPrice, calcOpts)];
                    case 5:
                        swapQuote = _a.sent();
                        return [3 /*break*/, 8];
                    case 6: return [4 /*yield*/, this._swapQuoteCalculator.calculateMarketSellSwapQuoteAsync(orders, assetFillAmount, gasPrice, calcOpts)];
                    case 7:
                        swapQuote = _a.sent();
                        _a.label = 8;
    ...
    SwapQuoter.prototype._isApiKeyWhitelisted = function (apiKey) {
        var whitelistedApiKeys = this._rfqtOptions ? this._rfqtOptions.takerApiKeyWhitelist : [];
