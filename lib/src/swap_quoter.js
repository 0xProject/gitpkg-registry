...
class SwapQuoter {
    ...
    constructor(supportedProvider, orderbook, options = {}) {
        ...
        this._contractAddresses = options.contractAddresses || Object.assign({}, (0, contract_addresses_1.getContractAddressesForChainOrThrow)(chainId));
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const batchSwapQuotes = yield Promise.all(optimizerResults.map((result, i) => __awaiter(this, void 0, void 0, function* () {
                if (result) {
                    ...
                    return createSwapQuote(result, makerToken, takerToken, types_1.MarketOperation.Buy, makerTokenBuyAmounts[i], gasPrice, opts.gasSchedule, opts.bridgeSlippage);
                }
                else {
                    return undefined;
                }
     ...
     */
    getSwapQuoteAsync(makerToken, takerToken, assetFillAmount, marketOperation, options, rfqClient) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const calcOpts = Object.assign(Object.assign({}, cloneOpts), { gasPrice, feeSchedule: _.mapValues(opts.feeSchedule, gasCost => (fillData) => gasCost === undefined ? 0 : gasPrice.times(gasCost(fillData))), exchangeProxyOverhead: flags => gasPrice.times(opts.exchangeProxyOverhead(flags)) });
...
function createSwapQuote(optimizerResult, makerToken, takerToken, operation, assetFillAmount, gasPrice, gasSchedule, slippage) {
    const { optimizedOrders, quoteReport, extendedQuoteReportSources, sourceFlags, takerAmountPerEth, makerAmountPerEth, priceComparisonsReport, } = optimizerResult;
