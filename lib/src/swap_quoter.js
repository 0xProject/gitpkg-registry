...
class SwapQuoter {
    ...
    getPricesForAssetDataAsync(makerAssetDatas, takerAssetData, makerAssetBuyAmount, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            let gasPrice;
            if (!!options.gasPrice) {
            ...
            const dummyOrders = makerAssetDatas.map(m => orders_1.createDummyOrderForSampler(m, takerAssetData, this._contractAddresses.uniswapBridge));
            const calculateSwapQuoteOpts = _.merge({}, constants_1.constants.DEFAULT_SWAP_QUOTE_REQUEST_OPTS, options);
            const prices = this._swapQuoteCalculator.getPricesAsync(dummyOrders, makerAssetBuyAmount, gasPrice, calculateSwapQuoteOpts);
            return prices;
        });
    }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (opts.rfqt && // This is an RFQT-enabled API request
                ...
                orderBatchPromises.push(quoteRequestor
                    .requestRfqtFirmQuotesAsync(makerAssetData, takerAssetData, assetFillAmount, marketOperation, undefined, opts.rfqt)
