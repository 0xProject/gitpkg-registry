...
var SwapQuoter = /** @class */ (function () {
    ...
    SwapQuoter.prototype._getSwapQuoteAsync = function (makerAssetData, takerAssetData, assetFillAmount, marketOperation, options) {
        return __awaiter(this, void 0, void 0, function () {
            var opts, gasPrice, orderBatchPromises, rfqtOptions, quoteRequestor, orderBatches, unsortedOrders, orders, swapQuote, calcOpts;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 3:
                        ...
                        if (opts.rfqt &&
                            ...
                            !(marketOperation === types_1.MarketOperation.Buy && this._shouldSkipRfqtBuyRequests())) {
    ...
    SwapQuoter.prototype._shouldSkipRfqtBuyRequests = function () {
        var rfqtOptions = this._rfqtOptions;
        if (rfqtOptions && rfqtOptions.skipBuyRequests !== undefined) {
            return rfqtOptions.skipBuyRequests;
        }
        var defaultRfqtOptions = constants_1.constants.DEFAULT_SWAP_QUOTER_OPTS.rfqt;
