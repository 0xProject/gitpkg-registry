...
class SwapQuoter {
    ...
    constructor(supportedProvider, orderbook, options = {}) {
        const { chainId, expiryBufferMs, permittedOrderFeeTypes, samplerGasLimit, liquidityProviderRegistryAddress, rfqt, } = _.merge({}, constants_1.constants.DEFAULT_SWAP_QUOTER_OPTS, options);
        const provider = utils_1.providerUtils.standardizeOrThrow(supportedProvider);
