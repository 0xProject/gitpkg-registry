...
const INVALID_SIGNATURE = { signatureType: protocol_utils_1.SignatureType.Invalid, v: 1, r: utils_1.NULL_BYTES, s: utils_1.NULL_BYTES };
function formatOrderbookOrder(order) {
    return {
...
class SwapQuoter {
    ...
    getBatchMarketBuySwapQuoteAsync(makerTokens, targetTakerToken, makerAssetBuyAmounts, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const apiOrders = yield this.orderbook.getBatchOrdersAsync(makerTokens, targetTakerToken, this._limitOrderPruningFn);
