...
var SwapQuoter = /** @class */ (function () {
    ...
    SwapQuoter.prototype._getSwapQuoteAsync = function (makerAssetData, takerAssetData, assetFillAmount, marketOperation, options) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, calculateSwapQuoteOpts, gasPrice, orderPromises, orders, _b, _c, _d, swapQuote;
                ...
                switch (_e.label) {
                    ...
                    case 3:
                        ...
                        if (options.rfqt &&
                            ...
                            if (!options.rfqt.takerAddress || options.rfqt.takerAddress === constants_1.constants.NULL_ADDRESS) {
                                throw new Error('RFQ-T requests must specify a taker address');
                            }
                            orderPromises.push(this._quoteRequestor.requestRfqtFirmQuotesAsync(makerAssetData, takerAssetData, assetFillAmount, marketOperation, options.apiKey, options.rfqt.takerAddress));
                        }
                        _c = (_b = (_a = []).concat).apply;
                        _d = [_a];
                        return [4 /*yield*/, Promise.all(orderPromises)];
                    case 4:
                        orders = _c.apply(_b, _d.concat([__spread.apply(void 0, [(_e.sent())])]));
                    ...
                    case 5:
                        swapQuote = _e.sent();
                        return [3 /*break*/, 8];
                    case 6: return [4 /*yield*/, this._swapQuoteCalculator.calculateMarketSellSwapQuoteAsync(orders, assetFillAmount, gasPrice, calculateSwapQuoteOpts)];
                    case 7:
                        swapQuote = _e.sent();
                        _e.label = 8;
