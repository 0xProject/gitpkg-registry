...
exports.signatureUtils = {
     ...
     */
    ecSignExchangeProxyMetaTransactionAsync: function (supportedProvider, transaction, signerAddress) {
        return __awaiter(this, void 0, void 0, function () {
            var signedTransaction, err_5, transactionHash, signatureHex, signedTransaction;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        assert_1.assert.doesConformToSchema('transaction', transaction, json_schemas_1.schemas.zeroExTransactionSchema, [json_schemas_1.schemas.hexSchema]);
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 5]);
                        return [4 /*yield*/, exports.signatureUtils.ecSignTypedDataExchangeProxyMetaTransactionAsync(supportedProvider, transaction, signerAddress)];
                    case 2:
                        signedTransaction = _a.sent();
                        return [2 /*return*/, signedTransaction];
                    case 3:
                        ...
                        //       Coinbase Wallet. Unfortunately for signers with a different error message,
                        //       they will receive two signature requests.
                        if (err_5.message.includes('User denied message signature')) {
                            throw err_5;
                        }
                        transactionHash = hash_utils_1.getExchangeProxyMetaTransactionHash(transaction);
                        return [4 /*yield*/, exports.signatureUtils.ecSignHashAsync(supportedProvider, transactionHash, signerAddress)];
                    case 4:
                        signatureHex = _a.sent();
                        signedTransaction = __assign({}, transaction, { signature: signatureHex });
     ...
     */
    ecSignTypedDataExchangeProxyMetaTransactionAsync: function (supportedProvider, transaction, signerAddress) {
        return __awaiter(this, void 0, void 0, function () {
            var provider, web3Wrapper, normalizedSignerAddress, typedData, signature, ecSignatureRSV, signatureHex, err_6;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        provider = utils_1.providerUtils.standardizeOrThrow(supportedProvider);
                    ...
                    case 1:
                        _a.sent();
                        normalizedSignerAddress = signerAddress.toLowerCase();
                        typedData = eip712_utils_1.eip712Utils.createExchangeProxyMetaTransactionTypedData(transaction);
                        _a.label = 2;
                    case 2:
                        _a.trys.push([2, 4, , 5]);
                        return [4 /*yield*/, web3Wrapper.signTypedDataAsync(normalizedSignerAddress, typedData)];
                    case 3:
                        signature = _a.sent();
                        ecSignatureRSV = parseSignatureHexAsRSV(signature);
                        signatureHex = utils_1.hexUtils.concat(ecSignatureRSV.v, ecSignatureRSV.r, ecSignatureRSV.s, types_1.SignatureType.EIP712);
                        return [2 /*return*/, __assign({}, transaction, { signature: signatureHex })];
                    case 4:
                        err_6 = _a.sent();
                        // Detect if Metamask to transition users to the MetamaskSubprovider
    ...
    convertECSignatureToSignatureHex: function (ecSignature) {
        var signatureHex = utils_1.hexUtils.concat(ecSignature.v, ecSignature.r, ecSignature.s);
