...
var ForwarderContract = /** @class */ (function (_super) {
     ...
     * @returns wethSpentAmount Amount of WETH spent on the given set of orders.makerAssetAcquiredAmount Amount of maker asset acquired from the given set of orders.
     */
    ForwarderContract.prototype.marketSellAmountWithEth = function (orders, ethSellAmount, signatures, ethFeeAmounts, feeRecipients) {
        var self = this;
        assert_1.assert.isArray('orders', orders);
        ...
        assert_1.assert.isArray('ethFeeAmounts', ethFeeAmounts);
        assert_1.assert.isArray('feeRecipients', feeRecipients);
        var functionSignature = 'marketSellAmountWithEth((address,address,address,address,uint256,uint256,uint256,uint256,uint256,uint256,bytes,bytes,bytes,bytes)[],uint256,bytes[],uint256[],address[])';
        return {
            sendTransactionAsync: function (txData, opts) {
                if (opts === void 0) { opts = { shouldValidate: true }; }
                return __awaiter(this, void 0, void 0, function () {
