...
class IZeroExContract extends base_contract_1.BaseContract {
     ...
     */
    _multiplexBatchSell(params, minBuyAmount) {
        const self = this;
        assert_1.assert.isBigNumber('minBuyAmount', minBuyAmount);
        const functionSignature = '_multiplexBatchSell((address,address,uint256,(uint8,uint256,bytes)[],bool,address,address),uint256)';
        return {
            selector: self._lookupAbiEncoder(functionSignature).getSelector(),
            sendTransactionAsync(txData, opts = { shouldValidate: true }) {
                return __awaiter(this, void 0, void 0, function* () {
     ...
     */
    _multiplexMultiHopSell(params, minBuyAmount) {
        const self = this;
        assert_1.assert.isBigNumber('minBuyAmount', minBuyAmount);
        const functionSignature = '_multiplexMultiHopSell((address[],uint256,(uint8,bytes)[],bool,address,address),uint256)';
        return {
            selector: self._lookupAbiEncoder(functionSignature).getSelector(),
            sendTransactionAsync(txData, opts = { shouldValidate: true }) {
                return __awaiter(this, void 0, void 0, function* () {
     ...
     */
    _sellTokenForTokenToUniswapV3(encodedPath, sellAmount, minBuyAmount, recipient, payer) {
        const self = this;
        assert_1.assert.isString('encodedPath', encodedPath);
        assert_1.assert.isBigNumber('sellAmount', sellAmount);
        assert_1.assert.isBigNumber('minBuyAmount', minBuyAmount);
        assert_1.assert.isString('recipient', recipient);
        assert_1.assert.isString('payer', payer);
     ...
     * @param signatures The signature by each respective `mtx.signer`.
     */
    batchExecuteMetaTransactionsV2(mtxs, signatures) {
        const self = this;
        assert_1.assert.isArray('mtxs', mtxs);
        assert_1.assert.isArray('signatures', signatures);
        const functionSignature = 'batchExecuteMetaTransactionsV2((address,address,uint256,uint256,bytes,address,(address,uint256)[])[],(uint8,uint8,bytes32,bytes32)[])';
        return {
            selector: self._lookupAbiEncoder(functionSignature).getSelector(),
            sendTransactionAsync(txData, opts = { shouldValidate: true }) {
                return __awaiter(this, void 0, void 0, function* () {
     ...
     * @param signature The signature by `mtx.signer`.
     */
    executeMetaTransactionV2(mtx, signature) {
        const self = this;
        const functionSignature = 'executeMetaTransactionV2((address,address,uint256,uint256,bytes,address,(address,uint256)[]),(uint8,uint8,bytes32,bytes32))';
        return {
            selector: self._lookupAbiEncoder(functionSignature).getSelector(),
            sendTransactionAsync(txData, opts = { shouldValidate: true }) {
                return __awaiter(this, void 0, void 0, function* () {
    ...
    getMetaTransactionV2ExecutedBlock(mtx) {
        const self = this;
        const functionSignature = 'getMetaTransactionV2ExecutedBlock((address,address,uint256,uint256,bytes,address,(address,uint256)[]))';
        return {
            selector: self._lookupAbiEncoder(functionSignature).getSelector(),
            sendTransactionAsync(txData, opts = { shouldValidate: true }) {
                return __awaiter(this, void 0, void 0, function* () {
    ...
    getMetaTransactionV2Hash(mtx) {
        const self = this;
        const functionSignature = 'getMetaTransactionV2Hash((address,address,uint256,uint256,bytes,address,(address,uint256)[]))';
        return {
            selector: self._lookupAbiEncoder(functionSignature).getSelector(),
            sendTransactionAsync(txData, opts = { shouldValidate: true }) {
                return __awaiter(this, void 0, void 0, function* () {
     ...
     * @param mtxHash The meta-transaction hash.
     */
    getMetaTransactionV2HashExecutedBlock(mtxHash) {
        const self = this;
        assert_1.assert.isString('mtxHash', mtxHash);
