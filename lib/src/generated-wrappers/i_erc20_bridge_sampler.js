...
var IERC20BridgeSamplerContract = /** @class */ (function (_super) {
     ...
     */
    IERC20BridgeSamplerContract.prototype.getOrderFillableMakerAssetAmounts = function (orders, orderSignatures, devUtilsAddress) {
        var self = this;
     ...
     */
    IERC20BridgeSamplerContract.prototype.getOrderFillableTakerAssetAmounts = function (orders, orderSignatures, devUtilsAddress) {
        var self = this;
        assert_1.assert.isArray('orders', orders);
        assert_1.assert.isArray('orderSignatures', orderSignatures);
        assert_1.assert.isString('devUtilsAddress', devUtilsAddress);
     ...
     */
    IERC20BridgeSamplerContract.prototype.sampleBuysFromCurve = function (curveAddress, fromTokenIdx, toTokenIdx, makerTokenAmounts) {
        var self = this;
     ...
     * @returns takerTokenAmounts Taker amounts sold at each maker token         amount.
     */
    IERC20BridgeSamplerContract.prototype.sampleBuysFromKyberNetwork = function (takerToken, makerToken, makerTokenAmounts, opts) {
        var self = this;
        assert_1.assert.isString('takerToken', takerToken);
        assert_1.assert.isString('makerToken', makerToken);
        assert_1.assert.isArray('makerTokenAmounts', makerTokenAmounts);
     ...
     * @returns takerTokenAmounts Taker amounts sold at each maker token         amount.
     */
    IERC20BridgeSamplerContract.prototype.sampleBuysFromLiquidityProviderRegistry = function (registryAddress, takerToken, makerToken, makerTokenAmounts, opts) {
        var self = this;
        assert_1.assert.isString('registryAddress', registryAddress);
        assert_1.assert.isString('takerToken', takerToken);
        assert_1.assert.isString('makerToken', makerToken);
     ...
     * @returns takerTokenAmounts Taker amounts sold at each maker token         amount.
     */
    IERC20BridgeSamplerContract.prototype.sampleBuysFromUniswapV2 = function (path, makerTokenAmounts) {
        var self = this;
     ...
     * @returns makerTokenAmounts Maker amounts bought at each taker token         amount.
     */
    IERC20BridgeSamplerContract.prototype.sampleSellsFromMultiBridge = function (multibridge, takerToken, intermediateToken, makerToken, takerTokenAmounts) {
        var self = this;
     ...
     * @returns makerTokenAmounts Maker amounts bought at each taker token         amount.
     */
    IERC20BridgeSamplerContract.prototype.sampleSellsFromUniswapV2 = function (path, takerTokenAmounts) {
        var self = this;
        assert_1.assert.isArray('path', path);
        assert_1.assert.isArray('takerTokenAmounts', takerTokenAmounts);
