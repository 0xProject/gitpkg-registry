...
export declare class ERC20BridgeSamplerContract extends BaseContract {
    ...
    }, devUtilsAddress: string): Promise<ERC20BridgeSamplerContract>;
     ...
     * @returns takerTokenAmounts Taker amounts sold at each maker token         amount.
     */
    sampleBuysFromKyberNetwork(takerToken: string, makerToken: string, makerTokenAmounts: BigNumber[], opts: {
     ...
     * @returns takerTokenAmounts Taker amounts sold at each maker token         amount.
     */
    sampleBuysFromLiquidityProviderRegistry(registryAddress: string, takerToken: string, makerToken: string, makerTokenAmounts: BigNumber[], opts: {
        targetSlippageBps: BigNumber;
        maxIterations: BigNumber;
    }): ContractFunctionObj<BigNumber[]>;
    /**
