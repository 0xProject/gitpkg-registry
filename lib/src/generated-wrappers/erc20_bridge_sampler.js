...
var ERC20BridgeSamplerContract = /** @class */ (function (_super) {
     ...
     */
    ERC20BridgeSamplerContract.prototype.getOrderFillableMakerAssetAmounts = function (orders, orderSignatures, devUtilsAddress) {
        var self = this;
        assert_1.assert.isArray('orders', orders);
        assert_1.assert.isArray('orderSignatures', orderSignatures);
        assert_1.assert.isString('devUtilsAddress', devUtilsAddress);
     ...
     */
    ERC20BridgeSamplerContract.prototype.getOrderFillableTakerAssetAmounts = function (orders, orderSignatures, devUtilsAddress) {
        var self = this;
        assert_1.assert.isArray('orders', orders);
        assert_1.assert.isArray('orderSignatures', orderSignatures);
        assert_1.assert.isString('devUtilsAddress', devUtilsAddress);
