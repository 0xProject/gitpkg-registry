...
class BaseContract {
    ...
    constructor(contractName, abi, address, supportedProvider, callAndTxnDefaults, logDecodeDependencies, deployedBytecode, encodingOpts) {
        ...
        this._encodingOpts = encodingOpts || utils_1.AbiEncoderConstants.DEFAULT_ENCODING_RULES;
        this.abi = abi;
    ...
    _isEncoderOverrides(arg) {
        return arg && (arg.encodeInput || arg.decodeOutput);
    }
    // tslint:disable prefer-function-over-method
    _isEncoderRules(arg) {
        return arg && arg.shouldOptimize && arg;
    }
    _getEncoderRulesIfExists() {
