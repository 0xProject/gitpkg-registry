...
class MeshGraphQLClient {
    ...
    getOrderAsyncV4(hash) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return types_1.fromStringifiedOrderWithMetadataV4(resp.data.order);
        });
    }
    ...
    findOrdersV4Async(query = { sort: [], filters: [], limit: defaultOrderQueryLimit }) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return resp.data.orders.map(types_1.fromStringifiedOrderWithMetadataV4);
        });
    }
    onReconnected(cb) {
