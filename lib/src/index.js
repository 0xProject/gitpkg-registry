...
`;
const addOrdersMutation = core_1.gql `
    mutation AddOrders(
        $orders: [NewOrder!]!
        $pinned: Boolean = true
...
`;
const orderEventsSubscription = core_1.gql `
    subscription {
        orderEvents {
            timestamp
            endState
