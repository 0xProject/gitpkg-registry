...
function processAbiFile(abiFileName) {
    console.log('in parse', abiFileName);
    ...
    let parsedContent = JSON.parse(namedContent.content);
    console.log('out parse', abiFileName);
    let ABI;
    let devdoc;
...
(() => __awaiter(void 0, void 0, void 0, function* () {
    for (const abiFileName of abiFileNames) {
        processAbiFile(abiFileName);
    }
    console.log('I am soooo done');
}))().catch(err => {
