...
exports.eip712Utils = {
    ...
    createExchangeProxyMetaTransactionTypedData: function (mtx) {
        ...
        function (v) { return (utils_1.BigNumber.isBigNumber(v) ? v.toString(10) : v); }), __assign({}, constants_1.constants.MAINNET_EXCHANGE_PROXY_DOMAIN, mtx.domain));
    },
};
