...
exports.indicativeQuoteToReportEntry = exports.nativeOrderToReportEntry = exports.multiHopSampleToReportSource = exports.dexSampleToReportSource = exports.generateExtendedQuoteReport = void 0;
...
function indicativeQuoteToReportEntry(order, comparisonPrice) {
    ...
    // tslint:disable-next-line: no-object-literal-type-assertion
    return Object.assign(Object.assign(Object.assign({ liquiditySource: types_2.ERC20BridgeSource.Native }, nativeOrderBase), { isRfqt: true, makerUri: order.makerUri }), (comparisonPrice ? { comparisonPrice: comparisonPrice.toNumber() } : {}));
}
exports.indicativeQuoteToReportEntry = indicativeQuoteToReportEntry;
//# sourceMappingURL=extended_quote_report_generator.js.map