        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const batchSwapQuotes = yield Promise.all(optimizerResults.map((result, i) => __awaiter(this, void 0, void 0, function* () {
                if (result) {
                    ...
                    return createSwapQuote(makerAssetData, takerAssetData, result.optimizedOrders, operation, assetFillAmounts[i], gasPrice, opts.gasSchedule, result.marketSideLiquidity.makerTokenDecimals, result.marketSideLiquidity.takerTokenDecimals);
                }
                else {
                    return undefined;
                }
    ...
    _calculateSwapQuoteAsync(prunedOrders, assetFillAmount, gasPrice, operation, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const swapQuote = sourceFlags === constants_2.SOURCE_FLAGS[types_2.ERC20BridgeSource.MultiHop]
                ? createTwoHopSwapQuote(makerAssetData, takerAssetData, optimizedOrders, operation, assetFillAmount, gasPrice, opts.gasSchedule, makerTokenDecimals, takerTokenDecimals, quoteReport)
                : createSwapQuote(makerAssetData, takerAssetData, optimizedOrders, operation, assetFillAmount, gasPrice, opts.gasSchedule, makerTokenDecimals, takerTokenDecimals, quoteReport);
