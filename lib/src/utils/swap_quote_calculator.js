...
class SwapQuoteCalculator {
    ...
    calculateMarketSellSwapQuoteAsync(prunedOrders, takerAssetFillAmount, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            return (yield this._calculateSwapQuoteAsync(prunedOrders, takerAssetFillAmount, types_1.MarketOperation.Sell, opts));
        });
    }
    calculateMarketBuySwapQuoteAsync(prunedOrders, takerAssetFillAmount, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            return (yield this._calculateSwapQuoteAsync(prunedOrders, takerAssetFillAmount, types_1.MarketOperation.Buy, opts));
        });
    }
    calculateBatchMarketBuySwapQuoteAsync(batchPrunedOrders, takerAssetFillAmounts, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            return (yield this._calculateBatchBuySwapQuoteAsync(batchPrunedOrders, takerAssetFillAmounts, types_1.MarketOperation.Buy, opts));
        });
    }
    _calculateBatchBuySwapQuoteAsync(batchPrunedOrders, assetFillAmounts, operation, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const batchSwapQuotes = yield Promise.all(optimizerResults.map((result, i) => __awaiter(this, void 0, void 0, function* () {
                if (result) {
                    ...
                    return createSwapQuote(makerAssetData, takerAssetData, result.optimizedOrders, operation, assetFillAmounts[i], opts.gasPrice, opts.gasSchedule, result.marketSideLiquidity.makerTokenDecimals, result.marketSideLiquidity.takerTokenDecimals);
                }
                else {
                    return undefined;
                }
    ...
    _calculateSwapQuoteAsync(prunedOrders, assetFillAmount, operation, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const _opts = Object.assign({}, opts, { feeSchedule: _.mapValues(opts.feeSchedule, gasCost => (fillData) => gasCost === undefined ? 0 : opts.gasPrice.times(gasCost(fillData))), exchangeProxyOverhead: flags => opts.gasPrice.times(opts.exchangeProxyOverhead(flags)) });
            ...
            const swapQuote = sourceFlags === constants_2.SOURCE_FLAGS[types_2.ERC20BridgeSource.MultiHop]
                ? createTwoHopSwapQuote(makerAssetData, takerAssetData, optimizedOrders, operation, assetFillAmount, opts.gasPrice, opts.gasSchedule, makerTokenDecimals, takerTokenDecimals, quoteReport)
                : createSwapQuote(makerAssetData, takerAssetData, optimizedOrders, operation, assetFillAmount, opts.gasPrice, opts.gasSchedule, makerTokenDecimals, takerTokenDecimals, quoteReport);
...
function createSwapQuote(makerAssetData, takerAssetData, optimizedOrders, operation, assetFillAmount, gasPrice, gasSchedule, makerTokenDecimals, takerTokenDecimals, quoteReport) {
...
function createTwoHopSwapQuote(makerAssetData, takerAssetData, optimizedOrders, operation, assetFillAmount, gasPrice, gasSchedule, makerTokenDecimals, takerTokenDecimals, quoteReport) {
