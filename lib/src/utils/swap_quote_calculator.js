...
var SwapQuoteCalculator = /** @class */ (function () {
                        ...
                        return [4 /*yield*/, Promise.all(batchSignedOrders.map(function (orders, i) { return __awaiter(_this, void 0, void 0, function () {
                                ...
                                return __generator(this, function (_b) {
                                    if (orders) {
                                        ...
                                        return [2 /*return*/, this._createSwapQuoteAsync(makerAssetData, takerAssetData, orders, operation, assetFillAmounts[i], gasPrice, opts.gasSchedule)];
                                    }
                                    else {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        resultOrders = [];
                        _opts = __assign({}, opts, { feeSchedule: _.mapValues(opts.feeSchedule, function (v) { return v.times(gasPrice); }) });
                    ...
                    case 5:
                        ...
                        return [2 /*return*/, this._createSwapQuoteAsync(makerAssetData, takerAssetData, resultOrders, operation, assetFillAmount, gasPrice, opts.gasSchedule)];
                }
            });
        });
    };
    SwapQuoteCalculator.prototype._createSwapQuoteAsync = function (makerAssetData, takerAssetData, resultOrders, operation, assetFillAmount, gasPrice, gasSchedule) {
        return __awaiter(this, void 0, void 0, function () {
            var bestCaseQuoteInfo, worstCaseQuoteInfo, breakdown, quoteBase;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._calculateQuoteInfoAsync(resultOrders, assetFillAmount, gasPrice, gasSchedule, operation)];
                    case 1:
                        bestCaseQuoteInfo = _a.sent();
                        return [4 /*yield*/, this._calculateQuoteInfoAsync(resultOrders, assetFillAmount, gasPrice, gasSchedule, operation, true)];
                    case 2:
                        worstCaseQuoteInfo = _a.sent();
                        breakdown = getSwapQuoteOrdersBreakdown(resultOrders, operation);
                        quoteBase = {
    ...
    SwapQuoteCalculator.prototype._calculateQuoteInfoAsync = function (orders, assetFillAmount, gasPrice, gasSchedule, operation, worstCase) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _a = [{}];
                        if (!(operation === types_2.MarketOperation.Buy)) return [3 /*break*/, 2];
                        return [4 /*yield*/, this._calculateMarketBuyQuoteInfoAsync(orders, assetFillAmount, gasPrice, worstCase)];
                    case 1:
                        _b = _c.sent();
                        return [3 /*break*/, 4];
                    case 2: return [4 /*yield*/, this._calculateMarketSellQuoteInfoAsync(orders, assetFillAmount, gasPrice, worstCase)];
                    case 3:
                        _b = _c.sent();
                        _c.label = 4;
                    case 4: return [2 /*return*/, __assign.apply(void 0, _a.concat([(_b), { gas: getGasUsedByOrders(orders, gasSchedule) }]))];
                }
            });
        });
    };
...
function getSwapQuoteOrdersBreakdown(orders, operation) {
    var e_5, _a;
    var orderAmounts = operation === types_2.MarketOperation.Buy
        ? orders.map(function (o) { return o.fill.totalMakerAssetAmount; })
        : orders.map(function (o) { return o.fill.totalTakerAssetAmount; });
    var amountsBySource = {};
    orders.forEach(function (o, i) {
        var source = o.fill.source;
        amountsBySource[source] = orderAmounts[i].plus(amountsBySource[source] || 0);
    });
    var totalAmount = utils_1.BigNumber.sum.apply(utils_1.BigNumber, __spread([0], orderAmounts));
    var breakdown = {};
    try {
        for (var _b = __values(Object.entries(amountsBySource)), _c = _b.next(); !_c.done; _c = _b.next()) {
            var _d = __read(_c.value, 2), source = _d[0], amount = _d[1];
...
function getTakerAssetAmountBreakDown(order, takerAssetAmountWithFees) {
    if (utils_2.isOrderTakerFeePayableWithTakerAsset(order)) {
    ...
    else if (utils_2.isOrderTakerFeePayableWithMakerAsset(order)) {
...
function getGasUsedByOrders(orders, gasSchedule) {
    var e_6, _a;
    var totalUsage = 0;
    try {
