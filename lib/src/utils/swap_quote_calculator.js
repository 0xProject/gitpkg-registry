...
exports.SwapQuoteCalculator = void 0;
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        resultOrders = [];
                        _opts = __assign(__assign({}, opts), { feeSchedule: _.mapValues(opts.feeSchedule, function (gasCost) { return function (fillData) {
...
function createSwapQuote(makerAssetData, takerAssetData, resultOrders, operation, assetFillAmount, gasPrice, gasSchedule) {
    ...
    if (operation === types_2.MarketOperation.Buy) {
        return __assign(__assign({}, quoteBase), { type: types_2.MarketOperation.Buy, makerAssetFillAmount: assetFillAmount });
    }
    else {
        return __assign(__assign({}, quoteBase), { type: types_2.MarketOperation.Sell, takerAssetFillAmount: assetFillAmount });
    }
}
