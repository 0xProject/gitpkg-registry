...
class SwapQuoteCalculator {
    ...
    getPricesAsync(nativeOrders, takerAmount, gasPrice, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            const pricesBySourceByTokens = yield this._marketOperationUtils.getPricesAsync(nativeOrders, takerAmount, opts);
            return pricesBySourceByTokens.map(p => {
                ...
                const outputsAdjusted = p.outputs
                    .map(o => (Object.assign({}, o, { adjustedPrice: o.output.dividedBy(p.input.plus(p.ethToTakerRate.times(feeSchedule[o.source](o.fillData))).integerValue()), price: o.output.dividedBy(p.input), gasCost: opts.gasSchedule[o.source](o.fillData), costOutput: p.ethToTakerRate.times(feeSchedule[o.source](o.fillData)), ethToTakerRate: p.ethToTakerRate })))
                    .sort((a, b) => b.adjustedPrice.comparedTo(a.adjustedPrice));
                const output = outputsAdjusted[0];
                return {
                    input: p.input,
                    ...
                    buyToken: p.buyToken,
                    sellTokenDecimals: p.sellTokenDecimals,
