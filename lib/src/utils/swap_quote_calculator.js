...
var SwapQuoteCalculator = /** @class */ (function () {
    ...
    SwapQuoteCalculator.prototype._calculateSwapQuoteAsync = function (prunedOrders, assetFillAmount, gasPrice, operation, opts) {
        return __awaiter(this, void 0, void 0, function () {
            var optimizedOrders, quoteReport, _opts, firstOrderMakerAssetData, buyResult, sellResult, _a, makerAssetData, takerAssetData;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        optimizedOrders = prunedOrders.map(function (o) { return orders_1.convertNativeOrderToFullyFillableOptimizedOrders(o); });
                        return [3 /*break*/, 5];
                    case 1:
                    ...
                    case 5:
                        ...
                        return [2 /*return*/, createSwapQuote(makerAssetData, takerAssetData, optimizedOrders, operation, assetFillAmount, gasPrice, opts.gasSchedule, quoteReport)];
                }
            });
        });
    };
...
function createSwapQuote(makerAssetData, takerAssetData, optimizedOrders, operation, assetFillAmount, gasPrice, gasSchedule, quoteReport) {
    ...
    if (operation === types_2.MarketOperation.Buy) {
        return __assign({}, quoteBase, { type: types_2.MarketOperation.Buy, makerAssetFillAmount: assetFillAmount, quoteReport: quoteReport });
    }
    else {
        return __assign({}, quoteBase, { type: types_2.MarketOperation.Sell, takerAssetFillAmount: assetFillAmount, quoteReport: quoteReport });
    }
}
