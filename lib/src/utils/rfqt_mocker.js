...
exports.rfqtMocker = {
     ...
     */
    withMockedRfqtFirmQuotes: function (mockedResponses, performFn, axiosClient) {
        ...
        return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        mockedAxios = new axios_mock_adapter_1.default(axiosClient);
                        _b.label = 1;
                    case 1:
                        _b.trys.push([1, , 3, 4]);
                        try {
    ...
    withMockedRfqtIndicativeQuotes: function (mockedResponses, performFn, axiosClient) {
        if (axiosClient === void 0) { axiosClient = axios_1.default; }
        return __awaiter(_this, void 0, void 0, function () {
