...
exports.rfqtMocker = {
     ...
     */
    withMockedRfqtFirmQuotes: function (mockedResponses, performFn) { return __awaiter(void 0, void 0, void 0, function () {
        var mockedAxios, mockedResponses_1, mockedResponses_1_1, mockedResponse, endpoint, requestApiKey, requestParams, responseData, responseCode, requestHeaders;
        var e_1, _a;
    ...
    withMockedRfqtIndicativeQuotes: function (mockedResponses, performFn) { return __awaiter(void 0, void 0, void 0, function () {
        var mockedAxios, mockedResponses_2, mockedResponses_2_1, mockedResponse, endpoint, requestApiKey, requestParams, responseData, responseCode, requestHeaders;
        var e_2, _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
