...
function simulateBestCaseFill(quoteInfo) {
    ...
    var result = fillQuoteOrders(quoteInfo.side, createBestCaseFillOrderCalls(quoteInfo), quoteInfo.fillAmount, quoteInfo.gasPrice.times(opts.protocolFeeMultiplier), opts.gasSchedule);
...
function simulateWorstCaseFill(quoteInfo) {
    ...
    var result = __assign({}, fillQuoteOrders(quoteInfo.side, createWorstCaseFillOrderCalls(quoteInfo), quoteInfo.fillAmount, protocolFeePerFillOrder, opts.gasSchedule), { 
...
function fillQuoteOrders(side, fillOrders, inputAmount, protocolFeePerFillOrder, gasSchedule) {
