...
function getNativeAdjustedFillableAmountsFromTakerAmount(order, takerFillAmount) {
    ...
    return {
        ...
        fillableTakerFeeAmount: order.type === protocol_utils_1.FillQuoteTransformerOrderType.Limit
            ? getNativeAdjustedTakerFeeAmount(order.order, takerFillAmount)
...
function getNativeAdjustedFillableAmountsFromMakerAmount(order, makerFillAmount) {
    ...
    return {
        ...
        fillableTakerAmount,
        fillableTakerFeeAmount: order.type === protocol_utils_1.FillQuoteTransformerOrderType.Limit
            ? getNativeAdjustedTakerFeeAmount(order.order, fillableTakerAmount)
            : constants_2.ZERO_AMOUNT,
    };
}
