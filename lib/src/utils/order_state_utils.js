...
exports.OrderStateUtils = void 0;
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        ordersOnChainMetadata = ordersInfo.map(function (orderInfo, index) {
                            return __assign(__assign({}, orderInfo), { fillableTakerAssetAmount: fillableTakerAssetAmounts[index], isValidSignature: isValidSignatures[index] });
                        });
                        ...
                        return [2 /*return*/, signedOrders.map(function (order, index) {
                                ...
                                return __assign(__assign({}, order), { fillableTakerAssetAmount: fillableTakerAssetAmount, fillableMakerAssetAmount: order_utils_1.orderCalculationUtils.getMakerFillAmount(order, fillableTakerAssetAmount), fillableTakerFeeAmount: order_utils_1.orderCalculationUtils.getTakerFeeAmount(order, fillableTakerAssetAmount) });
                            })];
                }
            });
        });
