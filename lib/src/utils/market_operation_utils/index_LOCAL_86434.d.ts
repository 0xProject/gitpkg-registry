...
import { GenerateOptimizedOrdersOpts, GetMarketOrdersOpts, MarketSideLiquidity, OptimizedMarketOrder, OptimizerResult, OptimizerResultWithReport, OrderDomain, TokenAdjacencyGraph } from './types';
/**
...
export declare class MarketOperationUtils {
    ...
    _generateOptimizedOrdersAsync(marketSideLiquidity: Omit<MarketSideLiquidity, 'makerTokenDecimals' | 'takerTokenDecimals'>, opts: GenerateOptimizedOrdersOpts): Promise<OptimizerResult>;
    private _getMarketSideOrdersAsync;
}
//# sourceMappingURL=index_LOCAL_86434.d.ts.map