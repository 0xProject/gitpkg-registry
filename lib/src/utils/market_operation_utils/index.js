            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        rfqtPromise = getRfqtIndicativeQuotesAsync(makerToken, takerToken, types_1.MarketOperation.Sell, takerAmount, _opts);
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        rfqtPromise = getRfqtIndicativeQuotesAsync(makerToken, takerToken, types_1.MarketOperation.Buy, makerAmount, _opts);
                        return [4 /*yield*/, Promise.all([samplerPromise, rfqtPromise])];
                    case 1:
