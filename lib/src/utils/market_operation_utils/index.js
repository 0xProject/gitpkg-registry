        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (bestTwoHopQuote && bestTwoHopRate.isGreaterThan(optimalPathRate)) {
                ...
                const twoHopQuoteReport = opts.shouldGenerateQuoteReport
                    ? quote_report_generator_1.generateQuoteReport(side, _.flatten(dexQuotes), twoHopQuotes, nativeOrders, orderFillableAmounts, bestTwoHopQuote, opts.quoteRequestor)
                    : undefined;
            ...
            const quoteReport = opts.shouldGenerateQuoteReport
                ? quote_report_generator_1.generateQuoteReport(side, _.flatten(dexQuotes), twoHopQuotes, nativeOrders, orderFillableAmounts, _.flatten(optimizedOrders.map(order => order.fills)), opts.quoteRequestor)
                : undefined;
