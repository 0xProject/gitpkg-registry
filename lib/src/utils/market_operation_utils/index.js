...
const native_order_utils_1 = require("../../network/native_order_utils");
const network_utils_1 = require("../../network/network_utils");
const sassy_sampler_1 = require("../../network/sassy_sampler");
const source_filters_1 = require("../../network/source_filters");
const tokens_1 = require("../../network/tokens");
...
const sampler_utils_1 = require("./sampler_utils");
const types_3 = require("./types");
// tslint:disable:boolean-naming
class MarketOperationUtils {
    constructor(chain, contractAddresses, _sampler) {
        this.chain = chain;
        this.contractAddresses = contractAddresses;
        this._sampler = _sampler;
        this._buySources = constants_2.BUY_SOURCE_FILTER_BY_CHAIN_ID[chain.chainId];
        this._sellSources = constants_2.SELL_SOURCE_FILTER_BY_CHAIN_ID[chain.chainId];
        this._feeSources = new source_filters_1.SourceFilters(constants_2.FEE_QUOTE_SOURCES_BY_CHAIN_ID[chain.chainId]);
        this._nativeFeeToken = tokens_1.WRAPPED_NETWORK_TOKEN_BY_CHAIN_ID[chain.chainId];
        this._nativeFeeTokenAmount = constants_2.NATIVE_FEE_TOKEN_AMOUNT_BY_CHAIN_ID[chain.chainId];
        this._networkUtils = new network_utils_1.NetworkUtils(chain);
        this._nativeOrderUtils = new native_order_utils_1.NativeOrderUtils(chain);
    }
    static createAsync(opts) {
        return __awaiter(this, void 0, void 0, function* () {
            const { chain } = opts;
            const samplerSources = new source_filters_1.SourceFilters([
                ...constants_2.SELL_SOURCE_FILTER_BY_CHAIN_ID[chain.chainId].sources,
                ...constants_2.BUY_SOURCE_FILTER_BY_CHAIN_ID[chain.chainId].sources,
                ...constants_2.FEE_QUOTE_SOURCES_BY_CHAIN_ID[chain.chainId],
            ]).exclude([types_1.ERC20BridgeSource.Native, types_1.ERC20BridgeSource.MultiHop]).sources;
            const sampler = yield sassy_sampler_1.SassySampler.createAsync({
                chain: opts.chain,
    ...
    getMarketSellLiquidityAsync(nativeOrders, takerAmount, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const sampleAmounts = sampler_utils_1.getSampleAmounts(takerAmount, _opts.numSamples, _opts.sampleDistributionBase);
            ...
            const batchId = utils_1.hexUtils.random();
            const [isTxOriginContract, tokenDecimals, orderFillableTakerAmounts, outputAmountPerEth, inputAmountPerEth, dexQuotes, rawTwoHopQuotes,] = yield Promise.all([
                this._networkUtils.isAddressContractAsync(txOrigin, batchId),
                this._networkUtils.getTokenDecimalsAsync([makerToken, takerToken], batchId),
                // Get native order fillable amounts.
                this._nativeOrderUtils.getLimitOrderFillableTakerAmountsAsync(nativeOrders, batchId),
                // Get ETH -> maker token price.
                this._sampler.getMedianSellRateAsync(feeSourceFilters.sources, this._nativeFeeToken, makerToken, this._nativeFeeTokenAmount, batchId),
                // Get ETH -> taker token price.
                this._sampler.getMedianSellRateAsync(feeSourceFilters.sources, this._nativeFeeToken, takerToken, this._nativeFeeTokenAmount, batchId),
                // Get sell quotes for taker -> maker.
                this._sampler.getSellSamplesAsync(quoteSourceFilters.sources, takerToken, makerToken, sampleAmounts, batchId),
                this._sampler.getTwoHopSellSamplesAsync(quoteSourceFilters.isAllowed(types_1.ERC20BridgeSource.MultiHop) ? quoteSourceFilters.sources : [], takerToken, makerToken, takerAmount, batchId),
            ]);
            // Filter out any invalid two hop quotes where we couldn't find a route
            const twoHopQuotes = rawTwoHopQuotes.filter(q => q && q.fillData && q.fillData.firstHop.source && q.fillData.secondHop.source);
            ...
            return {
                side: types_2.MarketOperation.Sell,
    ...
    getMarketBuyLiquidityAsync(nativeOrders, makerAmount, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // tslint:disable-next-line: no-parameter-reassignment
            nativeOrders = nativeOrders.filter(o => !o.order.makerAmount.eq(0));
            const sampleAmounts = sampler_utils_1.getSampleAmounts(makerAmount, _opts.numSamples, _opts.sampleDistributionBase);
            const requestFilters = new source_filters_1.SourceFilters().exclude(_opts.excludedSources).include(_opts.includedSources);
            ...
            const txOrigin = (_opts.rfqt && _opts.rfqt.txOrigin) || utils_1.NULL_ADDRESS;
            const batchId = utils_1.hexUtils.random();
            const [isTxOriginContract, tokenDecimals, orderFillableMakerAmounts, ethToMakerAssetRate, ethToTakerAssetRate, dexQuotes, rawTwoHopQuotes,] = yield Promise.all([
                this._networkUtils.isAddressContractAsync(txOrigin, batchId),
                this._networkUtils.getTokenDecimalsAsync([makerToken, takerToken], batchId),
                // Get native order fillable amounts.
                this._nativeOrderUtils.getLimitOrderFillableMakerAmountsAsync(nativeOrders, batchId),
                // Get ETH -> maker token price.
                this._sampler.getMedianSellRateAsync(feeSourceFilters.sources, this._nativeFeeToken, makerToken, this._nativeFeeTokenAmount, batchId),
                // Get ETH -> taker token price.
                this._sampler.getMedianSellRateAsync(feeSourceFilters.sources, this._nativeFeeToken, takerToken, this._nativeFeeTokenAmount, batchId),
                // Get sell quotes for taker -> maker.
                this._sampler.getBuySamplesAsync(quoteSourceFilters.sources, takerToken, makerToken, sampleAmounts, batchId),
                this._sampler.getTwoHopBuySamplesAsync(quoteSourceFilters.isAllowed(types_1.ERC20BridgeSource.MultiHop) ? quoteSourceFilters.sources : [], takerToken, makerToken, makerAmount, batchId),
            ]);
            // Filter out any invalid two hop quotes where we couldn't find a route
            const twoHopQuotes = rawTwoHopQuotes.filter(q => q && q.fillData && q.fillData.firstHop.source && q.fillData.secondHop.source);
            const [makerTokenDecimals, takerTokenDecimals] = tokenDecimals;
            ...
            return {
                side: types_2.MarketOperation.Buy,
    ...
    getBatchMarketBuyOrdersAsync(batchNativeOrders, makerAmounts, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            if (batchNativeOrders.length === 0) {
                throw new Error(types_3.AggregationError.EmptyOrders);
            }
            const _opts = Object.assign(Object.assign({}, constants_2.DEFAULT_GET_MARKET_ORDERS_OPTS), opts);
            const requestFilters = new source_filters_1.SourceFilters().exclude(_opts.excludedSources).include(_opts.includedSources);
            const quoteSourceFilters = this._buySources.merge(requestFilters);
            const feeSourceFilters = this._feeSources.exclude(_opts.excludedFeeSources);
            const batchId = utils_1.hexUtils.random();
            const executeResults = yield Promise.all([
                ...batchNativeOrders.map((orders) => __awaiter(this, void 0, void 0, function* () { return this._nativeOrderUtils.getLimitOrderFillableMakerAmountsAsync(orders, batchId); })),
                ...batchNativeOrders.map((orders) => __awaiter(this, void 0, void 0, function* () {
                    return this._sampler.getMedianSellRateAsync(feeSourceFilters.sources, this._nativeFeeToken, orders[0].order.takerToken, this._nativeFeeTokenAmount, batchId);
                })),
                ...batchNativeOrders.map((orders, i) => __awaiter(this, void 0, void 0, function* () {
                    return this._sampler.getBuySamplesAsync(quoteSourceFilters.sources, orders[0].order.takerToken, orders[0].order.makerToken, [makerAmounts[i]], batchId);
                })),
                ...batchNativeOrders.map((orders) => __awaiter(this, void 0, void 0, function* () { return this._networkUtils.getTokenDecimalsAsync([orders[0].order.makerToken, orders[0].order.takerToken], batchId); })),
            ]);
    ...
    _generateOptimizedOrdersAsync(marketSideLiquidity, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const takerAmountPerEth = side === types_2.MarketOperation.Sell ? inputAmountPerEth : outputAmountPerEth;
            const makerAmountPerEth = side === types_2.MarketOperation.Sell ? outputAmountPerEth : inputAmountPerEth;
            ...
            // Find the optimal path
            const optimalPath = yield path_optimizer_1.findOptimalPathAsync(side, fills, inputAmount, {
            ...
            if (bestTwoHopQuote && bestTwoHopRate.isGreaterThan(optimalPathRate)) {
                ...
                return {
                    ...
                    sourceFlags: constants_2.SOURCE_FLAGS[types_1.ERC20BridgeSource.MultiHop],
                    numDistinctFills: 2,
                    marketSideLiquidity,
            ...
            if (optimalPath === undefined) {
                throw new Error(types_3.AggregationError.NoOptimalPath);
            }
            ...
            const fragileSources = [types_1.ERC20BridgeSource.Native, types_1.ERC20BridgeSource.LiquidityProvider];
            ...
            if (opts.allowFallback && fragileFills.length !== 0) {
                ...
                const sturdyOptimalPath = yield path_optimizer_1.findOptimalPathAsync(side, sturdyFills, inputAmount, {
                    runLimit: opts.runLimit,
                    pathPenaltyOpts: Object.assign(Object.assign({}, penaltyOpts), { exchangeProxyOverhead: (sourceFlags, numDistinctFills) => 
    ...
    getOptimizerResultAsync(nativeOrders, amount, side, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const marketLiquidityFnAsync = side === types_2.MarketOperation.Sell
            ...
            try {
                ...
                if (e.message !== types_3.AggregationError.NoOptimalPath) {
                    throw e;
                }
            }
