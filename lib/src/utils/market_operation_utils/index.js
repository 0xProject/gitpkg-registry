    ...
    getMarketSellLiquidityAsync(nativeOrders, takerAmount, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const offChainBancorPromise = quoteSourceFilters.isAllowed(types_2.ERC20BridgeSource.Bancor)
                ...
                : Promise.resolve([]);
            const [[tokenDecimals, orderFillableAmounts, ethToMakerAssetRate, ethToTakerAssetRate, dexQuotes, twoHopQuotes], offChainBalancerQuotes, offChainCreamQuotes, offChainBancorQuotes,] = yield Promise.all([
                samplerPromise,
    ...
    getMarketBuyLiquidityAsync(nativeOrders, makerAmount, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const offChainCreamPromise = sampleCreamOffChain
                ...
                : Promise.resolve([]);
            const [[tokenDecimals, orderFillableAmounts, ethToMakerAssetRate, ethToTakerAssetRate, dexQuotes, twoHopQuotes], offChainBalancerQuotes, offChainCreamQuotes,] = yield Promise.all([samplerPromise, offChainBalancerPromise, offChainCreamPromise]);
