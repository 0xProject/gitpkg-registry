    ...
    getMarketSellLiquidityAsync(nativeOrders, takerAmount, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const offChainBancorPromise = quoteSourceFilters.isAllowed(types_2.ERC20BridgeSource.Bancor)
                ...
                : Promise.resolve([]);
            const [[orderFillableAmounts, ethToMakerAssetRate, ethToTakerAssetRate, dexQuotes, twoHopQuotes], rfqtIndicativeQuotes, offChainBalancerQuotes, offChainCreamQuotes, offChainBancorQuotes,] = yield Promise.all([
                samplerPromise,
                rfqtPromise,
    ...
    getMarketBuyLiquidityAsync(nativeOrders, makerAmount, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const offChainCreamPromise = sampleCreamOffChain
                ...
                : Promise.resolve([]);
            const [[orderFillableAmounts, ethToMakerAssetRate, ethToTakerAssetRate, dexQuotes, twoHopQuotes], rfqtIndicativeQuotes, offChainBalancerQuotes, offChainCreamQuotes,] = yield Promise.all([samplerPromise, rfqtPromise, offChainBalancerPromise, offChainCreamPromise]);
