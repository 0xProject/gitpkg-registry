    ...
    _generateOptimizedOrdersAsync(marketSideLiquidity, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (opts.allowFallback && fragileFills.length !== 0) {
                ...
                const sturdyOptimalPath = yield path_optimizer_1.findOptimalPathAsync(side, sturdyFills, inputAmount, opts.runLimit, Object.assign(Object.assign({}, penaltyOpts), { exchangeProxyOverhead: (sourceFlags, numDistinctFills) => 
