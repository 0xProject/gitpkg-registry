...
function shouldIncludeIndicativeRfqt(opts) {
...
class MarketOperationUtils {
    ...
    getMarketSellLiquidityAsync(nativeOrders, takerAmount, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const takerAddress = (_opts.rfqt && _opts.rfqt.takerAddress) || utils_1.NULL_ADDRESS;
            ...
            const shouldFetchRfqtIndicativeQuotes = !isPriceAwareRfqEnabled &&
                quoteSourceFilters.isAllowed(types_2.ERC20BridgeSource.Native) &&
                shouldIncludeIndicativeRfqt(_opts);
            const rfqtPromise = shouldFetchRfqtIndicativeQuotes && _opts.rfqt && _opts.rfqt.quoteRequestor
                ? _opts.rfqt.quoteRequestor.requestRfqtIndicativeQuotesAsync(makerToken, takerToken, takerAmount, types_1.MarketOperation.Sell, undefined, _opts.rfqt) || Promise.resolve([])
                : Promise.resolve([]);
            ...
            ethToMakerAssetRate, ethToTakerAssetRate, dexQuotes, twoHopQuotes, isTakerContract,], rfqtIndicativeQuotes, offChainBalancerQuotes, offChainCreamQuotes,] = yield Promise.all([samplerPromise, rfqtPromise, offChainBalancerPromise, offChainCreamPromise]);
