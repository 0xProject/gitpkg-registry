...
var MarketOperationUtils = /** @class */ (function () {
    ...
    MarketOperationUtils.prototype.getMarketSellOrdersAsync = function (nativeOrders, takerAmount, opts) {
        return __awaiter(this, void 0, void 0, function () {
            var _opts, _a, makerToken, takerToken, samplerPromise, _b, _c, _d, rfqtPromise, _e, _f, orderFillableAmounts, liquidityProviderAddress, ethToMakerAssetRate, dexQuotes, rfqtIndicativeQuotes;
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, sampler_1.DexOrderSampler.ops.getSellQuotesAsync(utils_2.difference(constants_1.SELL_SOURCES.concat(this._optionalSources()), _opts.excludedSources), makerToken, takerToken, sampler_1.getSampleAmounts(takerAmount, _opts.numSamples, _opts.sampleDistributionBase), this._wethAddress, this._sampler.balancerPoolsCache, this._liquidityProviderRegistry, this._multiBridge)];
                    case 2:
                    ...
                    case 3:
                        _e = __read.apply(void 0, [_g.sent(), 2]), _f = __read(_e[0], 4), orderFillableAmounts = _f[0], liquidityProviderAddress = _f[1], ethToMakerAssetRate = _f[2], dexQuotes = _f[3], rfqtIndicativeQuotes = _e[1];
    ...
    MarketOperationUtils.prototype.getMarketBuyOrdersAsync = function (nativeOrders, makerAmount, opts) {
        return __awaiter(this, void 0, void 0, function () {
            var _opts, _a, makerToken, takerToken, samplerPromise, _b, _c, _d, rfqtPromise, _e, _f, orderFillableAmounts, liquidityProviderAddress, ethToTakerAssetRate, dexQuotes, rfqtIndicativeQuotes;
            return __generator(this, function (_g) {
                switch (_g.label) {
                    case 0:
                        if (nativeOrders.length === 0) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, Promise.all([samplerPromise, rfqtPromise])];
                    case 3:
                        _e = __read.apply(void 0, [_g.sent(), 2]), _f = __read(_e[0], 4), orderFillableAmounts = _f[0], liquidityProviderAddress = _f[1], ethToTakerAssetRate = _f[2], dexQuotes = _f[3], rfqtIndicativeQuotes = _e[1];
                        return [2 /*return*/, this._generateOptimizedOrders({
                                orderFillableAmounts: orderFillableAmounts,
                                nativeOrders: nativeOrders,
                                dexQuotes: dexQuotes,
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _a = [batchNativeOrders.map(function (orders) { return sampler_1.DexOrderSampler.ops.getOrderFillableMakerAmounts(orders); })];
