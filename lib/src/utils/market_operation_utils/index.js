...
function shouldIncludeIndicativeRfqt(filters, opts) {
    if (opts.rfqt &&
        opts.rfqt.isIndicative === true &&
        opts.rfqt.quoteRequestor &&
        filters.isAllowed(types_2.ERC20BridgeSource.Native)) {
        return true;
    }
    else {
        return false;
...
class MarketOperationUtils {
    ...
    static _computeQuoteReport(quoteRequestor, marketSideLiquidity, optimizerResult, comparisonPrice) {
        ...
        return quote_report_generator_1.generateQuoteReport(side, _.flatten(dexQuotes), twoHopQuotes, nativeOrders, liquidityDelivered, comparisonPrice, quoteRequestor);
    }
    /**
    ...
    getMarketSellLiquidityAsync(nativeOrders, takerAmount, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const rfqtPromise = shouldIncludeIndicativeRfqt(quoteSourceFilters, _opts) && _opts.rfqt && _opts.rfqt.quoteRequestor
                ? _opts.rfqt.quoteRequestor.requestRfqtIndicativeQuotesAsync(makerToken, takerToken, takerAmount, types_1.MarketOperation.Sell, undefined, _opts.rfqt)
                : Promise.resolve([]);
            ...
            const offChainCreamPromise = sampleCreamOffChain
                ...
                : Promise.resolve([]);
            const [[tokenDecimals, orderFillableAmounts, ethToMakerAssetRate, ethToTakerAssetRate, dexQuotes, twoHopQuotes, isTxOriginContract,], rfqtIndicativeQuotes, offChainBalancerQuotes, offChainCreamQuotes,] = yield Promise.all([samplerPromise, rfqtPromise, offChainBalancerPromise, offChainCreamPromise]);
            const [makerTokenDecimals, takerTokenDecimals] = tokenDecimals;
            const isRfqSupported = !!(_opts.rfqt && !isTxOriginContract);
            const limitOrdersWithFillableAmounts = nativeOrders.map((order, i) => (Object.assign({}, order, { fillableMakerAmount: orderFillableAmounts[i], 
                // TODO Jacob
                fillableTakerAmount: constants_1.ZERO_AMOUNT, fillableTakerFeeAmount: constants_1.ZERO_AMOUNT })));
            return {
    ...
    getMarketBuyLiquidityAsync(nativeOrders, makerAmount, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this._sampler.getBuyQuotes(quoteSourceFilters.exclude(offChainSources).sources, makerToken, takerToken, sampleAmounts), this._sampler.getTwoHopBuyQuotes(quoteSourceFilters.isAllowed(types_2.ERC20BridgeSource.MultiHop) ? quoteSourceFilters.sources : [], makerToken, takerToken, makerAmount), this._sampler.isAddressContract(txOrigin));
            const rfqtPromise = shouldIncludeIndicativeRfqt(quoteSourceFilters, _opts) && _opts.rfqt && _opts.rfqt.quoteRequestor
                ? _opts.rfqt.quoteRequestor.requestRfqtIndicativeQuotesAsync(makerToken, takerToken, makerAmount, types_1.MarketOperation.Buy, undefined, _opts.rfqt)
                : Promise.resolve([]);
            const offChainBalancerPromise = sampleBalancerOffChain
    ...
    getBatchMarketBuyOrdersAsync(batchNativeOrders, makerAmounts, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const feeSourceFilters = this._feeSources.exclude(_opts.excludedFeeSources);
            const ops = [
                ...batchNativeOrders.map(orders => this._sampler.getOrderFillableMakerAmounts(
                // TODO jacob
                orders, this.contractAddresses.exchangeProxy)),
                ...batchNativeOrders.map(orders => this._sampler.getMedianSellRate(feeSourceFilters.sources, orders[0].order.takerToken, this._wethAddress, constants_1.ONE_ETHER)),
            ...
            return Promise.all(batchNativeOrders.map((nativeOrders, i) => __awaiter(this, void 0, void 0, function* () {
                ...
                try {
                    const optimizerResult = yield this._generateOptimizedOrdersAsync({
                        ...
                        quotes: {
                            nativeOrders: nativeOrders.map((o, k) => (Object.assign({}, o, { fillableMakerAmount: orderFillableAmounts[k], 
                                // TODO Jacob
                                fillableTakerAmount: constants_1.ZERO_AMOUNT, fillableTakerFeeAmount: constants_1.ZERO_AMOUNT }))),
                            dexQuotes,
    ...
    _generateOptimizedOrdersAsync(marketSideLiquidity, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            const { inputToken, outputToken, side, inputAmount, quotes, ethToOutputRate, ethToInputRate, } = marketSideLiquidity;
            ...
            const augmentedRfqtIndicativeQuotes = rfqtIndicativeQuotes.map(q => ({
                order: Object.assign({}, q, { txOrigin: utils_1.NULL_ADDRESS, pool: order_utils_1.NULL_BYTES, maker: utils_1.NULL_ADDRESS, taker: utils_1.NULL_ADDRESS, salt: constants_1.ZERO_AMOUNT, chainId: 1, verifyingContract: utils_1.NULL_ADDRESS }),
                signature: { v: 1, r: order_utils_1.NULL_BYTES, s: order_utils_1.NULL_BYTES, signatureType: protocol_utils_1.SignatureType.Invalid },
            ...
            const takerTokenToEthRate = side === types_1.MarketOperation.Sell ? ethToInputRate : ethToOutputRate;
            const makerTokenToEthRate = side === types_1.MarketOperation.Sell ? ethToOutputRate : ethToInputRate;
            // Find the optimal path
            ...
            if (marketSideLiquidity.isRfqSupported &&
                ...
                if (rfqt.isIndicative && isIndicativePriceAwareEnabled) {
                    ...
                    if (firmQuotes.length > 0) {
                        ...
                        const quotesWithOrderFillableAmounts = firmQuotes.map((order, i) => (Object.assign({}, order, { fillableTakerAmount: rfqOrderFillableAmounts[i], 
                            // TODO jacob adjust
                            fillableMakerAmount: order.order.makerAmount, fillableTakerFeeAmount: constants_1.ZERO_AMOUNT })));
