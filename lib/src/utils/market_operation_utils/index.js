...
var MarketOperationUtils = /** @class */ (function () {
    ...
    MarketOperationUtils.prototype.getMarketSellOrdersAsync = function (nativeOrders, takerAmount, opts) {
        return __awaiter(this, void 0, void 0, function () {
            var _opts, _a, makerToken, takerToken, _b, fillableAmounts, liquidityPoolAddress, ethToMakerAssetRate, dexQuotes, nativeOrdersWithFillableAmounts, nativeFills, dexPaths, allPaths, allFills, optimizer, upperBoundPath, optimalPath;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this._sampler.executeAsync(sampler_1.DexOrderSampler.ops.getOrderFillableTakerAmounts(nativeOrders), sampler_1.DexOrderSampler.ops.getLiquidityProviderFromRegistry(this._liquidityProviderRegistry, takerToken, makerToken), makerToken.toLowerCase() === this._wethAddress.toLowerCase()
                                ? sampler_1.DexOrderSampler.ops.constant(new utils_1.BigNumber(1))
                                : sampler_1.DexOrderSampler.ops.getMedianSellRate(difference(FEE_QUOTE_SOURCES, _opts.excludedSources).concat(this._liquidityPoolSourceIfAvailable()), makerToken, this._wethAddress, ONE_ETHER, this._liquidityProviderRegistry), sampler_1.DexOrderSampler.ops.getSellQuotes(difference(SELL_SOURCES, _opts.excludedSources).concat(this._liquidityPoolSourceIfAvailable()), makerToken, takerToken, sampler_1.getSampleAmounts(takerAmount, _opts.numSamples, _opts.sampleDistributionBase), this._liquidityProviderRegistry))];
                    case 1:
                        _b = __read.apply(void 0, [_c.sent(), 4]), fillableAmounts = _b[0], liquidityPoolAddress = _b[1], ethToMakerAssetRate = _b[2], dexQuotes = _b[3];
                        ...
                        return [2 /*return*/, this._createOrderUtils.createSellOrdersFromPath(this._orderDomain, takerToken, makerToken, collapsePath(optimalPath, false), _opts.bridgeSlippage, liquidityPoolAddress)];
                }
            });
        });
    };
    ...
    MarketOperationUtils.prototype.getMarketBuyOrdersAsync = function (nativeOrders, makerAmount, opts) {
        return __awaiter(this, void 0, void 0, function () {
            var _opts, _a, makerToken, takerToken, _b, fillableAmounts, liquidityPoolAddress, ethToTakerAssetRate, dexQuotes, signedOrderWithFillableAmounts;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        if (nativeOrders.length === 0) {
                        ...
                        _opts = __assign({}, DEFAULT_GET_MARKET_ORDERS_OPTS, opts);
                        _a = __read(getOrderTokens(nativeOrders[0]), 2), makerToken = _a[0], takerToken = _a[1];
                        return [4 /*yield*/, this._sampler.executeAsync(sampler_1.DexOrderSampler.ops.getOrderFillableMakerAmounts(nativeOrders), sampler_1.DexOrderSampler.ops.getLiquidityProviderFromRegistry(this._liquidityProviderRegistry, takerToken, makerToken), takerToken.toLowerCase() === this._wethAddress.toLowerCase()
                                ? sampler_1.DexOrderSampler.ops.constant(new utils_1.BigNumber(1))
                                : sampler_1.DexOrderSampler.ops.getMedianSellRate(difference(FEE_QUOTE_SOURCES, _opts.excludedSources).concat(this._liquidityPoolSourceIfAvailable()), takerToken, this._wethAddress, ONE_ETHER, this._liquidityProviderRegistry), sampler_1.DexOrderSampler.ops.getBuyQuotes(difference(BUY_SOURCES, _opts.excludedSources).concat(this._liquidityPoolSourceIfAvailable()), makerToken, takerToken, sampler_1.getSampleAmounts(makerAmount, _opts.numSamples, _opts.sampleDistributionBase), this._liquidityProviderRegistry))];
                    case 1:
                        _b = __read.apply(void 0, [_c.sent(), 4]), fillableAmounts = _b[0], liquidityPoolAddress = _b[1], ethToTakerAssetRate = _b[2], dexQuotes = _b[3];
                        signedOrderWithFillableAmounts = this._createBuyOrdersPathFromSamplerResultIfExists(nativeOrders, makerAmount, fillableAmounts, dexQuotes, ethToTakerAssetRate, _opts, liquidityPoolAddress);
    ...
    MarketOperationUtils.prototype._liquidityPoolSourceIfAvailable = function () {
        return this._liquidityProviderRegistry !== utils_1.NULL_ADDRESS ? [types_2.ERC20BridgeSource.LiquidityProvider] : [];
    };
    MarketOperationUtils.prototype._createBuyOrdersPathFromSamplerResultIfExists = function (nativeOrders, makerAmount, nativeOrderFillableAmounts, dexQuotes, ethToTakerAssetRate, opts, liquidityPoolAddress) {
        ...
        return this._createOrderUtils.createBuyOrdersFromPath(this._orderDomain, inputToken, outputToken, collapsePath(optimalPath, true), opts.bridgeSlippage, liquidityPoolAddress);
    };
...
function sourceToFillFlags(source) {
    ...
    if (source === types_2.ERC20BridgeSource.LiquidityProvider) {
        return types_2.FillFlags.SourceLiquidityPool;
    }
