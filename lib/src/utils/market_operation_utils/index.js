...
class MarketOperationUtils {
    ...
    getMarketSellLiquidityAsync(nativeOrders, takerAmount, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this._sampler.getSellQuotes(quoteSourceFilters
                .exclude(sampleBalancerOnChain ? [] : types_2.ERC20BridgeSource.Balancer)
                .exclude(types_2.ERC20BridgeSource.MultiHop).sources, makerToken, takerToken, sampleAmounts, this._wethAddress, this._liquidityProviderRegistry, this._multiBridge), this._sampler.getTwoHopSellQuotes(quoteSourceFilters.isAllowed(types_2.ERC20BridgeSource.MultiHop)
                ? quoteSourceFilters.exclude([types_2.ERC20BridgeSource.MultiBridge, types_2.ERC20BridgeSource.MultiHop]).sources
                : [], makerToken, takerToken, takerAmount, this._tokenAdjacencyGraph, this._wethAddress, this._liquidityProviderRegistry));
    ...
    getMarketBuyLiquidityAsync(nativeOrders, makerAmount, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this._sampler.getBuyQuotes(quoteSourceFilters
                .exclude(sampleBalancerOnChain ? [] : types_2.ERC20BridgeSource.Balancer)
                .exclude(types_2.ERC20BridgeSource.MultiHop).sources, makerToken, takerToken, sampleAmounts, this._wethAddress, this._liquidityProviderRegistry), this._sampler.getTwoHopBuyQuotes(quoteSourceFilters.isAllowed(types_2.ERC20BridgeSource.MultiHop)
                ? quoteSourceFilters.exclude([types_2.ERC20BridgeSource.MultiBridge, types_2.ERC20BridgeSource.MultiHop]).sources
                : [], makerToken, takerToken, makerAmount, this._tokenAdjacencyGraph, this._wethAddress, this._liquidityProviderRegistry));
            const rfqtPromise = quoteSourceFilters.isAllowed(types_2.ERC20BridgeSource.Native)
