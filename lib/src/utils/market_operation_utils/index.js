...
class MarketOperationUtils {
    ...
    _fetchTokenOverridesAsync(takerToken, makerToken) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const hackedERC20Bytecode = _.get(__1.artifacts.HackedERC20, 'compilerOutput.evm.deployedBytecode.object');
            const overrides = {};
            ...
            const gasOverhead = _.get(__1.artifacts.GasOverhead, 'compilerOutput.evm.deployedBytecode.object');
