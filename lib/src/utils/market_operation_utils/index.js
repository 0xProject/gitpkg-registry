...
class MarketOperationUtils {
    ...
    static _computeExtendedQuoteReport(quoteRequestor, marketSideLiquidity, optimizerResult, comparisonPrice) {
        const { side, quotes } = marketSideLiquidity;
        const { liquidityDelivered } = optimizerResult;
        return quote_report_generator_1.generateExtendedQuoteReport(side, quotes, liquidityDelivered, comparisonPrice, quoteRequestor);
    }
    ...
    getOptimizerResultAsync(nativeOrders, amount, side, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            extendedQuoteReport = MarketOperationUtils._computeExtendedQuoteReport(_opts.rfqt ? _opts.rfqt.quoteRequestor : undefined, marketSideLiquidity, optimizerResult, wholeOrderPrice);
