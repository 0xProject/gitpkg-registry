...
var MarketOperationUtils = /** @class */ (function () {
    ...
    MarketOperationUtils.prototype.getMarketSellOrdersAsync = function (nativeOrders, takerAmount, opts) {
        return __awaiter(this, void 0, void 0, function () {
            var _opts, _a, makerToken, takerToken, _b, orderFillableAmounts, liquidityProviderAddress, ethToMakerAssetRate, dexQuotes;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this._sampler.executeAsync(
                    ...
                    case 1:
                        _b = __read.apply(void 0, [_c.sent(), 4]), orderFillableAmounts = _b[0], liquidityProviderAddress = _b[1], ethToMakerAssetRate = _b[2], dexQuotes = _b[3];
    ...
    MarketOperationUtils.prototype.getMarketBuyOrdersAsync = function (nativeOrders, makerAmount, opts) {
        return __awaiter(this, void 0, void 0, function () {
            var _opts, _a, makerToken, takerToken, _b, orderFillableAmounts, liquidityProviderAddress, ethToTakerAssetRate, dexQuotes;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        if (nativeOrders.length === 0) {
                    ...
                    case 1:
                        _b = __read.apply(void 0, [_c.sent(), 4]), orderFillableAmounts = _b[0], liquidityProviderAddress = _b[1], ethToTakerAssetRate = _b[2], dexQuotes = _b[3];
                        return [2 /*return*/, this._generateOptimizedOrders({
                                orderFillableAmounts: orderFillableAmounts,
                                nativeOrders: nativeOrders,
                                dexQuotes: dexQuotes,
    ...
    MarketOperationUtils.prototype._generateOptimizedOrders = function (opts) {
        ...
        var paths = fills_1.createFillPaths({
            ...
            orders: orders_1.createSignedOrdersWithFillableAmounts(side, opts.nativeOrders, opts.orderFillableAmounts),
