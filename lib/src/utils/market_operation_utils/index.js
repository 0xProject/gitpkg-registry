            ...
            return __generator(this, function (_k) {
                switch (_k.label) {
                    case 0:
                        ...
                        _opts = __assign(__assign({}, constants_1.DEFAULT_GET_MARKET_ORDERS_OPTS), opts);
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        ...
                        return [2 /*return*/, Promise.all(batchNativeOrders.map(function (nativeOrders, i) {
                                if (nativeOrders.length === 0) {
                                    throw new Error(types_2.AggregationError.EmptyOrders);
                                }
                                ...
                                try {
                                    return _this._generateOptimizedOrdersAsync({
                                        orderFillableAmounts: orderFillableAmounts,
                                        nativeOrders: nativeOrders,
                                        dexQuotes: dexQuotes,
