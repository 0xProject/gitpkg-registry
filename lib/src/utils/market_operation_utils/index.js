            ...
            let sampleAmounts;
            {
                ...
                const [multiHopLegs, multiHopAmounts] = quoteSourceFilters.isAllowed(types_2.ERC20BridgeSource.MultiHop)
                    ? yield this._getMultiHopSampleLegsAndAmountsAsync({
                        ...
                        optionalSources: samplerSourceFilters.exclude(samplerSourceFilters.sources).sources,
            ...
            let sampleAmounts;
            {
                ...
                const [multiHopLegs, multiHopAmounts] = quoteSourceFilters.isAllowed(types_2.ERC20BridgeSource.MultiHop)
                    ? yield this._getMultiHopSampleLegsAndAmountsAsync({
                        ...
                        requiredSources: samplerSourceFilters.sources,
                        optionalSources: samplerSourceFilters.exclude(samplerSourceFilters.sources).sources,
    ...
    _findOptimalPathFromSamples(opts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (SHOULD_USE_RUST_ROUTER) {
                return path_optimizer_1.findOptimalRustPathFromSamples(opts.side, opts.dexQuotes, opts.nativeOrders, opts.inputAmount, penaltyOpts, opts.gasPrice, this._sampler.chainId, opts.neonRouterNumSamples, opts.samplerMetrics);
            }
            ;
...
function getHopRouteOverallRate(multiHopPaths) {
    return multiHopPaths.reduce((a, h) => a = a.times(h.adjustedCompleteRate), new utils_1.BigNumber(1));
}
