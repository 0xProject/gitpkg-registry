...
class MarketOperationUtils {
    ...
    getMarketSellLiquidityAsync(nativeOrders, takerAmount, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this._sampler.getMedianSellRate(feeSourceFilters.sources, makerToken, this._wethAddress, constants_1.ONE_ETHER, this._liquidityProviderRegistry, this._multiBridge), 
            // Get ETH -> taker token price.
            this._sampler.getMedianSellRate(feeSourceFilters.sources, takerToken, this._wethAddress, constants_1.ONE_ETHER, this._liquidityProviderRegistry, this._multiBridge), 
            // Get sell quotes for taker -> maker.
            this._sampler.getSellQuotes(quoteSourceFilters.exclude(offChainSources).sources, makerToken, takerToken, sampleAmounts, this._wethAddress, _opts.tokenAdjacencyGraph, this._liquidityProviderRegistry, this._multiBridge), this._sampler.getTwoHopSellQuotes(quoteSourceFilters.isAllowed(types_2.ERC20BridgeSource.MultiHop) ? quoteSourceFilters.sources : [], makerToken, takerToken, takerAmount, this._wethAddress, _opts.tokenAdjacencyGraph, this._liquidityProviderRegistry));
    ...
    getMarketBuyLiquidityAsync(nativeOrders, makerAmount, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this._sampler.getBuyQuotes(quoteSourceFilters.exclude(offChainSources).sources, makerToken, takerToken, sampleAmounts, this._wethAddress, _opts.tokenAdjacencyGraph, this._liquidityProviderRegistry), this._sampler.getTwoHopBuyQuotes(quoteSourceFilters.isAllowed(types_2.ERC20BridgeSource.MultiHop) ? quoteSourceFilters.sources : [], makerToken, takerToken, makerAmount, this._wethAddress, _opts.tokenAdjacencyGraph, this._liquidityProviderRegistry));
            const isPriceAwareRfqEnabled = _opts.rfqt && _opts.rfqt.isPriceAwareRFQEnabled;
            const rfqtPromise = !isPriceAwareRfqEnabled && quoteSourceFilters.isAllowed(types_2.ERC20BridgeSource.Native)
    ...
    getBatchMarketBuyOrdersAsync(batchNativeOrders, makerAmounts, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const ops = [
                ...
                ...batchNativeOrders.map((orders, i) => this._sampler.getBuyQuotes(quoteSourceFilters.sources, orders_1.getNativeOrderTokens(orders[0])[0], orders_1.getNativeOrderTokens(orders[0])[1], [makerAmounts[i]], this._wethAddress, _opts.tokenAdjacencyGraph)),
            ];
    ...
    _getMarketSideOrdersAsync(nativeOrders, amount, side, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (rfqt &&
                ...
                if (optimizerResult) {
                    ...
                    if (totalMakerAmount.gt(0)) {
                        const totalMakerAmountUnitAmount = web3_wrapper_1.Web3Wrapper.toUnitAmount(totalMakerAmount, marketSideLiquidity.makerTokenDecimals);
                        const totalTakerAmountUnitAmount = web3_wrapper_1.Web3Wrapper.toUnitAmount(totalTakerAmount, marketSideLiquidity.takerTokenDecimals);
                        comparisonPrice = totalMakerAmountUnitAmount
                            .div(totalTakerAmountUnitAmount)
                            .decimalPlaces(constants_1.COMPARISON_PRICE_DECIMALS);
                    }
                }
            ...
            if (_opts.shouldGenerateQuoteReport) {
                quoteReport = MarketOperationUtils._computeQuoteReport(nativeOrders, _opts.rfqt ? _opts.rfqt.quoteRequestor : undefined, marketSideLiquidity, optimizerResult, comparisonPrice);
            }
