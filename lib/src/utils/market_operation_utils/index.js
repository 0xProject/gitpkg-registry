    ...
    _generateOptimizedOrdersAsync(marketSideLiquidity, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (SHOULD_USE_RUST_ROUTER) {
                optimalPath = path_optimizer_1.findOptimalRustPathFromSamples(side, dexQuotes, [...nativeOrders, ...augmentedRfqtIndicativeQuotes], inputAmount, penaltyOpts, opts.feeSchedule, this._sampler.chainId, opts.neonRouterNumSamples);
            }
            else {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (opts.allowFallback && fragileFills.length !== 0) {
                ...
                if (SHOULD_USE_RUST_ROUTER) {
                    ...
                    sturdyOptimalPath = path_optimizer_1.findOptimalRustPathFromSamples(side, sturdySamples, [], inputAmount, sturdyPenaltyOpts, opts.feeSchedule, this._sampler.chainId, opts.neonRouterNumSamples);
                }
                else {
