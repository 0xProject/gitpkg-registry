    ...
    _generateOptimizedOrdersAsync(marketSideLiquidity, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const quoteReport = opts.shouldGenerateQuoteReport
                ? quote_report_generator_1.generateQuoteReport(side, _.flatten(dexQuotes), twoHopQuotes, nativeOrders, orderFillableAmounts, collapsedPath.collapsedFills, opts.quoteRequestor)
                : undefined;
