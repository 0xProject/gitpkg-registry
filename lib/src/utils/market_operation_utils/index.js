            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        sampler_1.DexOrderSampler.ops.getMedianSellRate(utils_2.difference(constants_1.FEE_QUOTE_SOURCES, _opts.excludedSources).concat(this._liquidityProviderSourceIfAvailable(_opts.excludedSources)), makerToken, this._wethAddress, constants_1.ONE_ETHER, this._wethAddress, this._liquidityProviderRegistry), 
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        sampler_1.DexOrderSampler.ops.getMedianSellRate(utils_2.difference(constants_1.FEE_QUOTE_SOURCES, _opts.excludedSources).concat(this._liquidityProviderSourceIfAvailable(_opts.excludedSources)), takerToken, this._wethAddress, constants_1.ONE_ETHER, this._wethAddress, this._liquidityProviderRegistry), 
