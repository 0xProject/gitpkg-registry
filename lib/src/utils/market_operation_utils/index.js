...
var MarketOperationUtils = /** @class */ (function () {
    ...
    MarketOperationUtils.prototype.getBatchMarketBuyOrdersAsync = function (batchNativeOrders, makerAmounts, opts) {
        return __awaiter(this, void 0, void 0, function () {
            var _opts, sources, id, ops, _a, executeResults, batchOrderFillableAmounts, batchEthToTakerAssetRate, batchDexQuotes, ethToInputRate;
            var _this = this;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _opts = __assign({}, constants_1.DEFAULT_GET_MARKET_ORDERS_OPTS, opts);
                        sources = utils_2.difference(constants_1.BUY_SOURCES, _opts.excludedSources.concat(types_2.ERC20BridgeSource.Balancer));
                        id = batchNativeOrders.map(function (o) { return orders_1.getNativeOrderTokens(o[0])[0]; });
