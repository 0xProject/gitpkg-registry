            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        rfqtPromise = _opts !== undefined && _opts.rfqt !== undefined && _opts.rfqt.quoteRequestor !== undefined
                            ? _opts.rfqt.quoteRequestor.requestRfqtIndicativeQuotesAsync(nativeOrders[0].makerAssetData, nativeOrders[0].takerAssetData, takerAmount, types_1.MarketOperation.Sell, _opts.rfqt)
                            : Promise.resolve([]);
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        rfqtPromise = opts !== undefined && _opts.rfqt !== undefined && _opts.rfqt.quoteRequestor !== undefined
                            ? _opts.rfqt.quoteRequestor.requestRfqtIndicativeQuotesAsync(nativeOrders[0].makerAssetData, nativeOrders[0].takerAssetData, makerAmount, types_1.MarketOperation.Buy, _opts.rfqt)
                            : [];
                        return [4 /*yield*/, Promise.all([samplerPromise, rfqtPromise])];
                    case 1:
