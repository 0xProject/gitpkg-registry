    ...
    getOptimizerResultAsync(nativeOrders, amount, side, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (_opts.shouldIncludePriceComparisonsReport) {
                ...
                const nativeSources = quotes.nativeOrders.map(order => quote_report_generator_1.nativeOrderToReportEntry(order.type, order, order.fillableTakerAmount, wholeOrderPrice, _opts.rfqt ? _opts.rfqt.quoteRequestor : undefined));
