...
class MarketOperationUtils {
    ...
    static _computeExtendedQuoteReport(quoteRequestor, marketSideLiquidity, amount, optimizerResult, comparisonPrice) {
        const { side, quotes } = marketSideLiquidity;
        const { liquidityDelivered } = optimizerResult;
        return quote_report_generator_1.generateExtendedQuoteReport(side, quotes, liquidityDelivered, amount, comparisonPrice, quoteRequestor);
    }
    ...
    getMarketSellLiquidityAsync(nativeOrders, takerAmount, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this._sampler.getSellQuotes(quoteSourceFilters.sources, makerToken, takerToken, sampleAmounts), this._sampler.getTwoHopSellQuotes(quoteSourceFilters.isAllowed(types_2.ERC20BridgeSource.MultiHop) ? quoteSourceFilters.sources : [], makerToken, takerToken, takerAmount), this._sampler.isAddressContract(txOrigin));
    ...
    _generateOptimizedOrdersAsync(marketSideLiquidity, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (SHOULD_USE_RUST_ROUTER) {
                optimalPath = path_optimizer_1.findOptimalRustPathFromSamples(side, dexQuotes, [...nativeOrders, ...augmentedRfqtIndicativeQuotes], inputAmount, penaltyOpts, opts.feeSchedule, this._sampler.chainId);
            }
            else {
                optimalPath = yield path_optimizer_1.findOptimalPathJSAsync(side, fills, inputAmount, opts.runLimit, penaltyOpts);
            }
    ...
    getOptimizerResultAsync(nativeOrders, amount, side, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let extendedQuoteReport;
            extendedQuoteReport = MarketOperationUtils._computeExtendedQuoteReport(_opts.rfqt ? _opts.rfqt.quoteRequestor : undefined, marketSideLiquidity, amount, optimizerResult, wholeOrderPrice);
            ...
            return Object.assign(Object.assign({}, optimizerResult), { quoteReport, extendedQuoteReport, priceComparisonsReport });
        });
    }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (opts.allowFallback && fragileFills.length !== 0) {
                ...
                if (SHOULD_USE_RUST_ROUTER) {
                    ...
                    sturdyOptimalPath = path_optimizer_1.findOptimalRustPathFromSamples(side, sturdySamples, [], inputAmount, sturdyPenaltyOpts, opts.feeSchedule, this._sampler.chainId);
                }
                else {
                    const sturdyFills = fills.filter(p => p.length > 0 && !fragileSources.includes(p[0].source));
                    sturdyOptimalPath = yield path_optimizer_1.findOptimalPathJSAsync(side, sturdyFills, inputAmount, opts.runLimit, sturdyPenaltyOpts);
                }
