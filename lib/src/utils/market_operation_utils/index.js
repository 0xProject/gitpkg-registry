...
var MarketOperationUtils = /** @class */ (function () {
    ...
    MarketOperationUtils.prototype._generateOptimizedOrders = function (opts) {
        utils_1.logUtils.log(__filename + " nativeOrders: " + opts.nativeOrders);
        utils_1.logUtils.log(__filename + " orderFillableAmounts: " + opts.orderFillableAmounts);
        ...
        utils_1.logUtils.log(__filename + ": paths: " + JSON.stringify(paths, null, '\t'));
        // Find the optimal path.
        var optimalPath = path_optimizer_1.findOptimalPath(side, paths, inputAmount, opts.runLimit) || [];
        utils_1.logUtils.log(__filename + ": optimalPath: " + JSON.stringify(optimalPath, null, '\t'));
        ...
        if (opts.allowFallback && nativeSubPath.length !== 0) {
            ...
            utils_1.logUtils.log(__filename + ": fallbackPath: " + JSON.stringify(fallbackPath, null, '\t'));
        }
