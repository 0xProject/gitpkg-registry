    ...
    _generateOptimizedOrdersAsync(marketSideLiquidity, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (SHOULD_USE_RUST_ROUTER) {
                fills = [[]];
                optimalPath = path_optimizer_1.findOptimalRustPathFromSamples(side, inputToken, outputToken, dexQuotes, [...nativeOrders, ...augmentedRfqtIndicativeQuotes], inputAmount, penaltyOpts, opts.feeSchedule, this._sampler.chainId, opts.neonRouterNumSamples, opts.samplerMetrics);
            }
            else {
