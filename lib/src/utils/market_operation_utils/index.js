    ...
    getMarketSellLiquidityAsync(nativeOrders, takerAmount, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const offChainCreamPromise = sampleCreamOffChain
                ...
                : Promise.resolve([]);
            const [[tokenDecimals, orderFillableTakerAmounts, ethToMakerAssetRate, ethToTakerAssetRate, dexQuotes, twoHopQuotes, isTxOriginContract,], offChainBalancerQuotes, offChainCreamQuotes,] = yield Promise.all([samplerPromise, offChainBalancerPromise, offChainCreamPromise]);
    ...
    getMarketBuyLiquidityAsync(nativeOrders, makerAmount, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const offChainCreamPromise = sampleCreamOffChain
                ...
                : Promise.resolve([]);
            const [[tokenDecimals, orderFillableMakerAmounts, ethToMakerAssetRate, ethToTakerAssetRate, dexQuotes, twoHopQuotes, isTxOriginContract,], offChainBalancerQuotes, offChainCreamQuotes,] = yield Promise.all([samplerPromise, offChainBalancerPromise, offChainCreamPromise]);
            const [makerTokenDecimals, takerTokenDecimals] = tokenDecimals;
