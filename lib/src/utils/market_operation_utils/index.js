        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const penaltyOpts = {
                ...
                exchangeProxyOverhead: (sourceFlags) => {
                    ...
                    return opts.exchangeProxyOverhead(sourceFlags | (opts.isMultiHop ? constants_2.SOURCE_FLAGS.MultiHop : BigInt(0)));
                },
            };
...
function getHopRouteOverallRate(hops) {
    return hops.reduce((a, h) => a = a.times(h.adjustedCompleteRate), new utils_1.BigNumber(1));
}
