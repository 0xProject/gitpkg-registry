    ...
    getMarketSellLiquidityAsync(nativeOrders, takerAmount, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const [isTxOriginContract, tokenDecimals, orderFillableTakerAmounts, outputAmountPerEth, inputAmountPerEth, dexQuotes, rawTwoHopQuotes,] = yield Promise.all([
                ...
                this._sampler.getMedianSellRateAsync(feeSourceFilters.sources, this._nativeFeeToken, makerToken, this._nativeFeeTokenAmount),
                // Get ETH -> taker token price.
                this._sampler.getMedianSellRateAsync(feeSourceFilters.sources, this._nativeFeeToken, takerToken, this._nativeFeeTokenAmount),
                // Get sell quotes for taker -> maker.
                this._sampler.getSellSamplesAsync(quoteSourceFilters.sources, takerToken, makerToken, sampleAmounts),
                this._sampler.getTwoHopSellSamplesAsync(quoteSourceFilters.isAllowed(types_1.ERC20BridgeSource.MultiHop) ? quoteSourceFilters.sources : [], takerToken, makerToken, takerAmount),
            ]);
    ...
    getMarketBuyLiquidityAsync(nativeOrders, makerAmount, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const [isTxOriginContract, tokenDecimals, orderFillableMakerAmounts, ethToMakerAssetRate, ethToTakerAssetRate, dexQuotes, rawTwoHopQuotes,] = yield Promise.all([
                ...
                this._sampler.getTwoHopBuySamplesAsync(quoteSourceFilters.isAllowed(types_1.ERC20BridgeSource.MultiHop) ? quoteSourceFilters.sources : [], takerToken, makerToken, makerAmount),
            ]);
            // Filter out any invalid two hop quotes where we couldn't find a route
            const twoHopQuotes = rawTwoHopQuotes.filter(q => q && q.fillData && q.fillData.firstHop.source && q.fillData.secondHop.source);
            const [makerTokenDecimals, takerTokenDecimals] = tokenDecimals;
    ...
    getBatchMarketBuyOrdersAsync(batchNativeOrders, makerAmounts, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const executeResults = yield Promise.all([
                ...batchNativeOrders.map((orders) => __awaiter(this, void 0, void 0, function* () { return this._nativeOrderUtils.getLimitOrderFillableMakerAmountsAsync(orders); })),
                ...batchNativeOrders.map((orders) => __awaiter(this, void 0, void 0, function* () {
                    return this._sampler.getMedianSellRateAsync(feeSourceFilters.sources, this._nativeFeeToken, orders[0].order.takerToken, this._nativeFeeTokenAmount);
                })),
                ...batchNativeOrders.map((orders, i) => __awaiter(this, void 0, void 0, function* () {
                    return this._sampler.getBuySamplesAsync(quoteSourceFilters.sources, orders[0].order.takerToken, orders[0].order.makerToken, [makerAmounts[i]]);
                })),
                ...batchNativeOrders.map((orders) => __awaiter(this, void 0, void 0, function* () { return this._networkUtils.getTokenDecimalsAsync([orders[0].order.makerToken, orders[0].order.takerToken]); })),
            ]);
