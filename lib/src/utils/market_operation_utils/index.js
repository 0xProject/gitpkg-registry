...
class MarketOperationUtils {
    ...
    getMarketSellLiquidityAsync(nativeOrders, takerAmount, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this._sampler.getMedianSellRate(feeSourceFilters.sources, makerToken, constants_2.NATIVE_FEE_TOKEN, constants_2.NATIVE_FEE_TOKEN_AMOUNT), 
            // Get ETH -> taker token price.
            this._sampler.getMedianSellRate(feeSourceFilters.sources, takerToken, constants_2.NATIVE_FEE_TOKEN, constants_2.NATIVE_FEE_TOKEN_AMOUNT), 
            ...
            const offChainCreamPromise = sampleCreamOffChain
                ...
                : Promise.resolve([]);
            const [[tokenDecimals, orderFillableTakerAmounts, outputAmountPerEth, inputAmountPerEth, dexQuotes, rawTwoHopQuotes, isTxOriginContract,], offChainBalancerQuotes, offChainCreamQuotes,] = yield Promise.all([samplerPromise, offChainBalancerPromise, offChainCreamPromise]);
    ...
    getBatchMarketBuyOrdersAsync(batchNativeOrders, makerAmounts, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const ops = [
                ...
                ...batchNativeOrders.map(orders => this._sampler.getMedianSellRate(feeSourceFilters.sources, orders[0].order.takerToken, constants_2.NATIVE_FEE_TOKEN, constants_2.NATIVE_FEE_TOKEN_AMOUNT)),
