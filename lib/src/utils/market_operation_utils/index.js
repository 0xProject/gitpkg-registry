...
var MarketOperationUtils = /** @class */ (function () {
    ...
    MarketOperationUtils.prototype.getMarketSellLiquidityAsync = function (nativeOrders, takerAmount, opts) {
        return __awaiter(this, void 0, void 0, function () {
            var _opts, _a, makerToken, takerToken, sampleAmounts, samplerPromise, _b, _c, _d, rfqtPromise, balancerPromise, _e, _f, orderFillableAmounts, liquidityProviderAddress, ethToMakerAssetRate, ethToTakerAssetRate, dexQuotes, rfqtIndicativeQuotes, _g, balancerQuotes;
            var _this = this;
            return __generator(this, function (_h) {
                switch (_h.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, sampler_1.DexOrderSampler.ops.getMedianSellRateAsync(utils_2.difference(constants_1.FEE_QUOTE_SOURCES, _opts.excludedSources), makerToken, this._wethAddress, constants_1.ONE_ETHER, this._wethAddress, this._sampler.balancerPoolsCache, this._liquidityProviderRegistry, this._multiBridge, this._sampler.bancorService)];
                    case 1:
                        _d = _d.concat([
                            // Get ETH -> maker token price.
                            _h.sent()]);
                        // Get ETH -> taker token price.
                        return [4 /*yield*/, sampler_1.DexOrderSampler.ops.getMedianSellRateAsync(utils_2.difference(constants_1.FEE_QUOTE_SOURCES, _opts.excludedSources), takerToken, this._wethAddress, constants_1.ONE_ETHER, this._wethAddress, this._sampler.balancerPoolsCache, this._liquidityProviderRegistry, this._multiBridge)];
                    case 2:
                        _d = _d.concat([
                            // Get ETH -> taker token price.
                            _h.sent()]);
                    ...
                    case 4:
                        _e = __read.apply(void 0, [_h.sent(), 3]), _f = __read(_e[0], 5), orderFillableAmounts = _f[0], liquidityProviderAddress = _f[1], ethToMakerAssetRate = _f[2], ethToTakerAssetRate = _f[3], dexQuotes = _f[4], rfqtIndicativeQuotes = _e[1], _g = __read(_e[2], 1), balancerQuotes = _g[0];
    ...
    MarketOperationUtils.prototype.getMarketBuyLiquidityAsync = function (nativeOrders, makerAmount, opts) {
        return __awaiter(this, void 0, void 0, function () {
            var _opts, _a, makerToken, takerToken, sampleAmounts, samplerPromise, _b, _c, _d, balancerPromise, _e, _f, rfqtPromise, _g, _h, orderFillableAmounts, liquidityProviderAddress, ethToMakerAssetRate, ethToTakerAssetRate, dexQuotes, rfqtIndicativeQuotes, _j, balancerQuotes;
            var _this = this;
                ...
                switch (_k.label) {
                    case 0:
                        ...
                        _d = [
                            ...
                            sampler_1.DexOrderSampler.ops.getLiquidityProviderFromRegistry(this._liquidityProviderRegistry, makerToken, takerToken)];
                        // Get ETH -> maker token price.
                        return [4 /*yield*/, sampler_1.DexOrderSampler.ops.getMedianSellRateAsync(constants_1.FEE_QUOTE_SOURCES, makerToken, this._wethAddress, constants_1.ONE_ETHER, this._wethAddress, this._sampler.balancerPoolsCache, this._liquidityProviderRegistry, this._multiBridge)];
                    case 1:
                        _d = _d.concat([
                            // Get ETH -> maker token price.
                            _k.sent()]);
                        // Get ETH -> taker token price.
                        return [4 /*yield*/, sampler_1.DexOrderSampler.ops.getMedianSellRateAsync(constants_1.FEE_QUOTE_SOURCES, takerToken, this._wethAddress, constants_1.ONE_ETHER, this._wethAddress, this._sampler.balancerPoolsCache, this._liquidityProviderRegistry, this._multiBridge, this._sampler.bancorService)];
                    case 2:
                        _d = _d.concat([
                            // Get ETH -> taker token price.
                            _k.sent()]);
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, Promise.all([samplerPromise, rfqtPromise, balancerPromise])];
                    case 5:
                        _g = __read.apply(void 0, [_k.sent(), 3]), _h = __read(_g[0], 5), orderFillableAmounts = _h[0], liquidityProviderAddress = _h[1], ethToMakerAssetRate = _h[2], ethToTakerAssetRate = _h[3], dexQuotes = _h[4], rfqtIndicativeQuotes = _g[1], _j = __read(_g[2], 1), balancerQuotes = _j[0];
                        // Attach the LiquidityProvider address to the sample fillData
                        (dexQuotes.find(function (quotes) { return quotes[0] && quotes[0].source === types_2.ERC20BridgeSource.LiquidityProvider; }) || []).forEach(function (q) { return (q.fillData = { poolAddress: liquidityProviderAddress }); });
                        // Attach the MultiBridge address to the sample fillData
                        (dexQuotes.find(function (quotes) { return quotes[0] && quotes[0].source === types_2.ERC20BridgeSource.MultiBridge; }) || []).forEach(function (q) { return (q.fillData = { poolAddress: _this._multiBridge }); });
    ...
    MarketOperationUtils.prototype.getBatchMarketBuyOrdersAsync = function (batchNativeOrders, makerAmounts, opts) {
        return __awaiter(this, void 0, void 0, function () {
            var _opts, sources, ops, _a, executeResults, batchOrderFillableAmounts, batchEthToTakerAssetRate, batchDexQuotes, ethToInputRate;
            var _this = this;
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        _a = [batchNativeOrders.map(function (orders) {
                                return sampler_1.DexOrderSampler.ops.getOrderFillableMakerAmounts(orders, _this.contractAddresses.exchange);
                            })];
                    ...
                    case 3:
                        ...
                        ethToInputRate = order_utils_1.ZERO_AMOUNT;
