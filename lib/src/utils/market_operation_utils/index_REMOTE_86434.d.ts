...
import { GetMarketOrdersOpts, MarketSideLiquidity, OptimizedMarketOrder, OptimizerResult, OrderDomain, TokenAdjacencyGraph } from './types';
/**
...
export declare class MarketOperationUtils {
    ...
    constructor(_sampler: DexOrderSampler, contractAddresses: AssetSwapperContractAddresses, _orderDomain: OrderDomain, _liquidityProviderRegistry?: string, _tokenAdjacencyGraph?: TokenAdjacencyGraph);
    /**
     ...
     */
    getMarketSellOrdersAsync(nativeOrders: SignedOrder[], takerAmount: BigNumber, opts?: Partial<GetMarketOrdersOpts>): Promise<OptimizerResult>;
    /**
     ...
     * @return object with optimized orders and a QuoteReport
     */
    getMarketBuyOrdersAsync(nativeOrders: SignedOrder[], makerAmount: BigNumber, opts?: Partial<GetMarketOrdersOpts>): Promise<OptimizerResult>;
    /**
...
//# sourceMappingURL=index_REMOTE_86434.d.ts.map