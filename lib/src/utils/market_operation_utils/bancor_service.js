...
var BancorService = /** @class */ (function () {
    function BancorService(ethereumNodeEndpoint) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _a = this;
                        return [4 /*yield*/, sdk_1.SDK.create({ ethereumNodeEndpoint: this.ethereumNodeEndpoint })];
                    case 1:
                        _a._sdk = _b.sent();
                        _b.label = 2;
    ...
    BancorService.prototype.getQuoteAsync = function (fromToken, toToken, amount) {
        return __awaiter(this, void 0, void 0, function () {
            var sdk, _a, path, rate;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.getSDKAsync()];
                    case 1:
                        sdk = _b.sent();
                        return [4 /*yield*/, sdk.pricing.getPathAndRate(token(fromToken), token(toToken), amount.toString())];
                    case 2:
                        _a = _b.sent(), path = _a.path, rate = _a.rate;
                        return [2 /*return*/, {
                                fillData: { path: path.map(function (p) { return p.blockchainId; }) },
                                amount: new utils_1.BigNumber(rate).multipliedBy(this.minReturnAmountBufferPercentage),
                            }];
                }
            });
        });
