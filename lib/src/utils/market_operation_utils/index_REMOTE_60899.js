...
class MarketOperationUtils {
    ...
    getMarketSellLiquidityAsync(nativeOrders, takerAmount, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this._sampler.getSellQuotes(utils_2.difference(constants_1.SELL_SOURCES.concat(this._optionalSources()), _opts.excludedSources.concat(types_2.ERC20BridgeSource.Balancer)), makerToken, takerToken, sampleAmounts, this._wethAddress, this._liquidityProviderRegistry, this._multiBridge), this._sampler.getTwoHopSellQuotes(utils_2.difference(constants_1.SELL_SOURCES.concat(this._optionalSources()), _opts.excludedSources.concat([types_2.ERC20BridgeSource.MultiBridge])), makerToken, takerToken, takerAmount, this._wethAddress, this._liquidityProviderRegistry));
            ...
            const bancorPromise = _opts.excludedSources.includes(types_2.ERC20BridgeSource.Bancor)
                ? Promise.resolve([])
                : this._sampler.getBancorSellQuotesAsync(makerToken, takerToken, sampleAmounts);
            const [[orderFillableAmounts, ethToMakerAssetRate, ethToTakerAssetRate, dexQuotes, twoHopQuotes], rfqtIndicativeQuotes, balancerQuotes, bancorQuotes,] = yield Promise.all([samplerPromise, rfqtPromise, balancerPromise, bancorPromise]);
            return {
    ...
    getMarketBuyLiquidityAsync(nativeOrders, makerAmount, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const [[orderFillableAmounts, ethToMakerAssetRate, ethToTakerAssetRate, dexQuotes, twoHopQuotes], rfqtIndicativeQuotes, balancerQuotes,] = yield Promise.all([samplerPromise, rfqtPromise, balancerPromise]);
...
//# sourceMappingURL=index_REMOTE_60899.js.map