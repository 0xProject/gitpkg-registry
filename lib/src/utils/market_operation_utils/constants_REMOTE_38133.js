...
exports.MAINNET_SHELL_POOLS = exports.MOONISWAP_LIQUIDITY_PROVIDER_BY_CHAIN_ID = exports.CURVE_LIQUIDITY_PROVIDER_BY_CHAIN_ID = exports.MAINNET_MAKER_PSM_GEM_TOKEN = exports.MAINNET_MAKER_PSM_ILK_IDENTIFIER = exports.MAINNET_MAKER_PSM_VAT = exports.MAINNET_MAKER_PSM_AUTH_GEM = exports.MAINNET_MAKER_PSM_CONTRACT = exports.MAX_DODOV2_POOLS_QUERIED = exports.MAINNET_DODOV2_VENDING_MACHINE_FACTORY = exports.MAINNET_DODOV2_PRIVATE_POOL_FACTORY = exports.MAINNET_DODO_HELPER = exports.MAINNET_MOONISWAP_V2_1_REGISTRY = exports.MAINNET_MOONISWAP_V2_REGISTRY = exports.MAINNET_MOONISWAP_REGISTRY = exports.MAINNET_OASIS_ROUTER = exports.MAINNET_MSTABLE_ROUTER = exports.MAINNET_LINKSWAP_ROUTER = exports.MAINNET_CRYPTO_COM_ROUTER = exports.MAINNET_SUSHI_SWAP_ROUTER = exports.MAINNET_UNISWAP_V2_ROUTER = exports.MAINNET_UNISWAP_V1_ROUTER = exports.LIQUIDITY_PROVIDER_REGISTRY = exports.MAINNET_KYBER_NETWORK_PROXY = exports.MAX_KYBER_RESERVES_QUERIED = exports.KYBER_BRIDGED_LIQUIDITY_PREFIX = exports.MAINNET_SNOWSWAP_INFOS = exports.MAINNET_SWERVE_INFOS = exports.MAINNET_CURVE_INFOS = exports.DEFAULT_TOKEN_ADJACENCY_GRAPH = exports.DEFAULT_INTERMEDIATE_TOKENS = exports.POOLS = exports.TOKENS = exports.SOURCE_FLAGS = exports.FEE_QUOTE_SOURCES = exports.PROTOCOL_FEE_MULTIPLIER = exports.BUY_SOURCE_FILTER = exports.SELL_SOURCE_FILTER = exports.COMPARISON_PRICE_DECIMALS = exports.NULL_ADDRESS = exports.NULL_BYTES = exports.ONE_SECOND_MS = exports.ONE_HOUR_IN_SECONDS = exports.MAX_UINT256 = exports.ZERO_AMOUNT = exports.POSITIVE_INF = exports.NEGATIVE_INF = exports.ONE_ETHER = exports.WALLET_SIGNATURE = exports.ERC20_PROXY_ID = void 0;
exports.DEFAULT_GET_MARKET_ORDERS_OPTS = exports.POSITIVE_SLIPPAGE_FEE_TRANSFORMER_GAS = exports.DEFAULT_FEE_SCHEDULE = exports.DEFAULT_GAS_SCHEDULE = exports.BALANCER_MAX_POOLS_FETCHED = exports.BALANCER_TOP_POOLS_FETCHED = exports.BALANCER_SUBGRAPH_URL = void 0;
...
exports.DEFAULT_INTERMEDIATE_TOKENS = [exports.TOKENS.WETH, exports.TOKENS.USDT, exports.TOKENS.DAI, exports.TOKENS.USDC, exports.TOKENS.WBTC];
exports.DEFAULT_TOKEN_ADJACENCY_GRAPH = new token_adjacency_graph_builder_1.TokenAdjacencyGraphBuilder({
    default: exports.DEFAULT_INTERMEDIATE_TOKENS,
})
    // Mirror Protocol
    .tap(builder => {
    builder
...
exports.MAINNET_CURVE_INFOS = {
    ...
    //     metaToken: undefined,
    // },
    [exports.POOLS.curve_aave]: {
        exchangeFunctionSelector: types_1.CurveFunctionSelectors.exchange_underlying,
        sellQuoteFunctionSelector: types_1.CurveFunctionSelectors.get_dy_underlying,
        buyQuoteFunctionSelector: types_1.CurveFunctionSelectors.None,
        poolAddress: exports.POOLS.curve_aave,
        tokens: [exports.TOKENS.DAI, exports.TOKENS.USDC, exports.TOKENS.USDT],
        metaToken: undefined,
    },
    [exports.POOLS.curve_aave]: {
...
exports.MAINNET_KYBER_NETWORK_PROXY = '0x9aab3f75489902f3a48495025729a0af77d4b11e';
exports.LIQUIDITY_PROVIDER_REGISTRY = {};
exports.MAINNET_UNISWAP_V1_ROUTER = '0xc0a47dfe034b400b47bdad5fecda2621de6c4d95';
exports.MAINNET_UNISWAP_V2_ROUTER = '0xf164fc0ec4e93095b804a4795bbe1e041497b92a';
exports.MAINNET_SUSHI_SWAP_ROUTER = '0xd9e1ce17f2641f24ae83637ab66a2cca9c378b9f';
exports.MAINNET_CRYPTO_COM_ROUTER = '0xceb90e4c17d626be0facd78b79c9c87d7ca181b3';
exports.MAINNET_LINKSWAP_ROUTER = '0xa7ece0911fe8c60bff9e99f8fafcdbe56e07aff1';
exports.MAINNET_MSTABLE_ROUTER = '0xe2f2a5c287993345a840db3b0845fbc70f5935a5';
exports.MAINNET_OASIS_ROUTER = '0x794e6e91555438afc3ccf1c5076a74f42133d08d';
exports.MAINNET_MOONISWAP_REGISTRY = '0x71CD6666064C3A1354a3B4dca5fA1E2D3ee7D303';
exports.MAINNET_MOONISWAP_V2_REGISTRY = '0xc4a8b7e29e3c8ec560cd4945c1cf3461a85a148d';
exports.MAINNET_MOONISWAP_V2_1_REGISTRY = '0xbaf9a5d4b0052359326a6cdab54babaa3a3a9643';
exports.MAINNET_DODO_HELPER = '0x533da777aedce766ceae696bf90f8541a4ba80eb';
exports.MAINNET_DODOV2_PRIVATE_POOL_FACTORY = '0x6b4fa0bc61eddc928e0df9c7f01e407bfcd3e5ef';
exports.MAINNET_DODOV2_VENDING_MACHINE_FACTORY = '0x72d220ce168c4f361dd4dee5d826a01ad8598f6c';
exports.MAX_DODOV2_POOLS_QUERIED = 3;
exports.MAINNET_MAKER_PSM_CONTRACT = '0x89b78cfa322f6c5de0abceecab66aee45393cc5a';
exports.MAINNET_MAKER_PSM_AUTH_GEM = '0x0a59649758aa4d66e25f08dd01271e891fe52199';
exports.MAINNET_MAKER_PSM_VAT = '0x35d1b3f3d7966a1dfe207aa4514c12a259a0492b';
exports.MAINNET_MAKER_PSM_ILK_IDENTIFIER = strings_1.formatBytes32String('PSM-USDC-A');
// Currently only USDC is supported
exports.MAINNET_MAKER_PSM_GEM_TOKEN = '0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48';
exports.CURVE_LIQUIDITY_PROVIDER_BY_CHAIN_ID = {
    '1': '0x561b94454b65614ae3db0897b74303f4acf7cc75',
    '3': '0xae241c6fc7f28f6dc0cb58b4112ba7f63fcaf5e2',
    '1337': exports.NULL_ADDRESS,
};
// TODO(dorothy-zbornak): Point these to real addresses after deploying.
exports.MOONISWAP_LIQUIDITY_PROVIDER_BY_CHAIN_ID = {
...
exports.DEFAULT_GAS_SCHEDULE = {
    ...
    [types_1.ERC20BridgeSource.Curve]: fillData => {
        ...
        switch (poolAddress) {
            case exports.POOLS.curve_renBTC:
            case exports.POOLS.curve_sBTC:
            case exports.POOLS.curve_sUSD:
            case exports.POOLS.curve_HBTC:
            case exports.POOLS.curve_TRI:
                return 150e3;
            case exports.POOLS.curve_USDN:
            case exports.POOLS.curve_mUSD:
                return 300e3;
            case exports.POOLS.curve_GUSD:
            case exports.POOLS.curve_HUSD:
                return 310e3;
            case exports.POOLS.curve_tBTC:
                return 370e3;
            case exports.POOLS.curve_UST:
                return 500e3;
            case exports.POOLS.curve_dUSD:
            case exports.POOLS.curve_bBTC:
            case exports.POOLS.curve_oBTC:
            case exports.POOLS.curve_eurs:
                return 600e3;
            case exports.POOLS.curve_compound:
                return 750e3;
            case exports.POOLS.curve_aave:
                return 800e3;
            case exports.POOLS.curve_PAX:
                return 850e3;
    ...
    [types_1.ERC20BridgeSource.MakerPsm]: () => 300e3,
...
//# sourceMappingURL=constants_REMOTE_38133.js.map