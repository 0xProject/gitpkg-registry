...
function valueByChainId(rest, defaultValue) {
    ...
    return Object.assign({ [contract_addresses_1.ChainId.Mainnet]: defaultValue, [contract_addresses_1.ChainId.Ropsten]: defaultValue, [contract_addresses_1.ChainId.Rinkeby]: defaultValue, [contract_addresses_1.ChainId.Kovan]: defaultValue, [contract_addresses_1.ChainId.Ganache]: defaultValue }, (rest || {}));
}
exports.CHAIN_ID = contract_addresses_1.ChainId.Mainnet;
/**
...
exports.SELL_SOURCE_FILTER = exports.SELL_SOURCE_FILTER_BY_CHAIN_ID[exports.CHAIN_ID];
/**
...
exports.BUY_SOURCE_FILTER = exports.BUY_SOURCE_FILTER_BY_CHAIN_ID[exports.CHAIN_ID];
/**
 ...
 */
exports.FEE_QUOTE_SOURCES_BY_CHAIN_ID = valueByChainId({ [contract_addresses_1.ChainId.Mainnet]: [types_1.ERC20BridgeSource.Uniswap, types_1.ERC20BridgeSource.UniswapV2] }, []);
exports.FEE_QUOTE_SOURCES = exports.FEE_QUOTE_SOURCES_BY_CHAIN_ID[exports.CHAIN_ID];
...
exports.DEFAULT_INTERMEDIATE_TOKENS = exports.DEFAULT_INTERMEDIATE_TOKENS_BY_CHAIN_ID[exports.CHAIN_ID];
exports.DEFAULT_TOKEN_ADJACENCY_GRAPH_BY_CHAIN_ID = valueByChainId({
    [contract_addresses_1.ChainId.Mainnet]: new token_adjacency_graph_builder_1.TokenAdjacencyGraphBuilder({
        ...
        // Build
        .build(),
}, new token_adjacency_graph_builder_1.TokenAdjacencyGraphBuilder({ default: exports.DEFAULT_INTERMEDIATE_TOKENS }).build());
exports.DEFAULT_TOKEN_ADJACENCY_GRAPH = exports.DEFAULT_TOKEN_ADJACENCY_GRAPH_BY_CHAIN_ID[exports.CHAIN_ID];
exports.NATIVE_FEE_TOKEN_BY_CHAIN_ID = valueByChainId({ [contract_addresses_1.ChainId.Mainnet]: exports.TOKENS.WETH }, exports.NULL_ADDRESS);
exports.NATIVE_FEE_TOKEN = exports.NATIVE_FEE_TOKEN_BY_CHAIN_ID[exports.CHAIN_ID];
exports.NATIVE_FEE_TOKEN_AMOUNT_BY_CHAIN_ID = valueByChainId({}, exports.ONE_ETHER);
exports.NATIVE_FEE_TOKEN_AMOUNT = exports.NATIVE_FEE_TOKEN_AMOUNT_BY_CHAIN_ID[exports.CHAIN_ID];
/**
...
exports.MAINNET_CURVE_INFOS = {
    ...
    [exports.CURVE_POOLS.curve_y]: {
        exchangeFunctionSelector: types_1.CurveFunctionSelectors.exchange_underlying,
        sellQuoteFunctionSelector: types_1.CurveFunctionSelectors.get_dy_underlying,
        buyQuoteFunctionSelector: types_1.CurveFunctionSelectors.get_dx_underlying,
        poolAddress: exports.CURVE_POOLS.curve_y,
        tokens: [exports.TOKENS.DAI, exports.TOKENS.USDC, exports.TOKENS.USDT, exports.TOKENS.TUSD],
        metaToken: undefined,
    },
    [exports.CURVE_POOLS.curve_BUSD]: {
        exchangeFunctionSelector: types_1.CurveFunctionSelectors.exchange_underlying,
        sellQuoteFunctionSelector: types_1.CurveFunctionSelectors.get_dy_underlying,
        buyQuoteFunctionSelector: types_1.CurveFunctionSelectors.get_dx_underlying,
        poolAddress: exports.CURVE_POOLS.curve_BUSD,
...
exports.UNISWAPV1_ROUTER = exports.UNISWAPV1_ROUTER_BY_CHAIN_ID[exports.CHAIN_ID];
...
exports.UNISWAPV2_ROUTER = exports.UNISWAPV2_ROUTER_BY_CHAIN_ID[exports.CHAIN_ID];
...
exports.SUSHISWAP_ROUTER = exports.SUSHISWAP_ROUTER_BY_CHAIN_ID[exports.CHAIN_ID];
...
exports.CRYPTO_COM_ROUTER = exports.CRYPTO_COM_ROUTER_BY_CHAIN_ID[exports.CHAIN_ID];
...
exports.LINKSWAP_ROUTER = exports.LINKSWAP_ROUTER_BY_CHAIN_ID[exports.CHAIN_ID];
...
exports.MSTABLE_ROUTER = exports.MSTABLE_ROUTER_BY_CHAIN_ID[exports.CHAIN_ID];
exports.OASIS_ROUTER_BY_CHAIN_ID = valueByChainId({
    [contract_addresses_1.ChainId.Mainnet]: '0x794e6e91555438afc3ccf1c5076a74f42133d08d',
}, exports.NULL_ADDRESS);
exports.OASIS_ROUTER = exports.OASIS_ROUTER_BY_CHAIN_ID[exports.CHAIN_ID];
exports.MOONISWAP_REGISTRIES_BY_CHAIN_ID = valueByChainId({
    [contract_addresses_1.ChainId.Mainnet]: {
        v0: '0x71CD6666064C3A1354a3B4dca5fA1E2D3ee7D303',
        v2: '0xc4a8b7e29e3c8ec560cd4945c1cf3461a85a148d',
        v2_1: '0xbaf9a5d4b0052359326a6cdab54babaa3a3a9643',
    },
}, {
    v0: exports.NULL_ADDRESS,
    v2: exports.NULL_ADDRESS,
    v2_1: exports.NULL_ADDRESS,
});
exports.MOONISWAP_REGISTRIES = exports.MOONISWAP_REGISTRIES_BY_CHAIN_ID[exports.CHAIN_ID];
...
exports.DODOV2_FACTORIES_BY_CHAIN_ID = valueByChainId({
    [contract_addresses_1.ChainId.Mainnet]: {
        PrivatePool: '0x6b4fa0bc61eddc928e0df9c7f01e407bfcd3e5ef',
        VendingMachine: '0x72d220ce168c4f361dd4dee5d826a01ad8598f6c',
    },
}, {
    PrivatePool: exports.NULL_ADDRESS,
    VendingMachine: exports.NULL_ADDRESS,
});
exports.DODOV2_FACTORIES = exports.DODOV2_FACTORIES_BY_CHAIN_ID[exports.CHAIN_ID];
...
exports.CURVE_LIQUIDITY_PROVIDER = exports.CURVE_LIQUIDITY_PROVIDER_BY_CHAIN_ID[exports.CHAIN_ID];
...
exports.SHELL_POOLS = exports.SHELL_POOLS_BY_CHAIN_ID[exports.CHAIN_ID];
...
exports.DEFAULT_GAS_SCHEDULE = {
    ...
    [types_1.ERC20BridgeSource.Curve]: fillData => {
        ...
        switch (poolAddress) {
            ...
            case exports.CURVE_POOLS.curve_y:
            case exports.CURVE_POOLS.curve_BUSD:
                return 850e3;
...
//# sourceMappingURL=constants_REMOTE_42071.js.map