...
export declare function uniswapV2LikeRouterAddress(chainId: ChainId, source: ERC20BridgeSource.UniswapV2 | ERC20BridgeSource.SushiSwap | ERC20BridgeSource.CryptoCom | ERC20BridgeSource.PancakeSwap | ERC20BridgeSource.BakerySwap | ERC20BridgeSource.KyberDmm): string;
