...
export declare function nativeOrdersToFills(side: MarketOperation, orders: NativeOrderWithFillableAmounts[], targetInput: BigNumber | undefined, outputAmountPerEth: BigNumber, inputAmountPerEth: BigNumber, fees: FeeSchedule, filterNegativeAdjustedRateOrders?: boolean): Fill[];
