...
var FIVE_SECONDS_MS = 5 * 1000; // tslint:disable-line:custom-no-magic-numbers
var MAX_POOLS_FETCHED = 5; // tslint:disable-line:custom-no-magic-numbers
var Decimal20 = decimal_js_1.Decimal.clone({ precision: 20 });
var BalancerPoolsCache = /** @class */ (function () {
    function BalancerPoolsCache(_cache, cacheExpiryMs) {
        if (_cache === void 0) { _cache = {}; }
        if (cacheExpiryMs === void 0) { cacheExpiryMs = FIVE_SECONDS_MS; }
        this._cache = _cache;
        this.cacheExpiryMs = cacheExpiryMs;
    }
    BalancerPoolsCache.prototype.getPoolsForPairAsync = function (takerToken, makerToken) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, pools.length > MAX_POOLS_FETCHED ? pools.slice(0, MAX_POOLS_FETCHED) : pools];
                    case 2:
                        err_1 = _a.sent();
                        return [2 /*return*/, []];
...
function computeBalancerBuyQuote(pool, makerFillAmount) {
    ...
    var foo = Number.isSafeInteger(y.integerValue().toNumber())
        ? Math.pow(y.toNumber(), weightRatio.toNumber()) - 1
        : new Decimal20(y.toString()).pow(weightRatio.toString()).minus(1);
