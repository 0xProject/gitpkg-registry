...
function computeBalancerSellQuote(pool, takerFillAmount) {
    if (takerFillAmount.isGreaterThan(sor_1.bmath.bmul(pool.balanceIn, sor_1.bmath.MAX_IN_RATIO))) {
...
function computeBalancerBuyQuote(pool, makerFillAmount) {
    if (makerFillAmount.isGreaterThan(sor_1.bmath.bmul(pool.balanceOut, sor_1.bmath.MAX_OUT_RATIO))) {
        return constants_1.ZERO_AMOUNT;
    }
