...
var MAX_POOLS_FETCHED = 10; // tslint:disable-line:custom-no-magic-numbers
...
function computeBalancerSellQuote(pool, takerFillAmount) {
    ...
    var foo = new decimal_js_1.Decimal(y.toString()).pow(weightRatio.toString());
    var bar = new utils_1.BigNumber(1).minus(foo.toString());
