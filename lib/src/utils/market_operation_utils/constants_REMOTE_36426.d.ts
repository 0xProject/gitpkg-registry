...
import { CurveInfo, ERC20BridgeSource, GetMarketOrdersOpts, KyberSamplerOpts, LiquidityProviderRegistry, PsmInfo, TokenAdjacencyGraph } from './types';
...
export declare const SAMPLER_ADDRESS = "0x5555555555555555555555555555555555555556";
...
export declare const BALANCER_V2_SUBGRAPH_URL = "https://api.thegraph.com/subgraphs/name/balancer-labs/balancer-v2";
...
export declare const WAULT_ROUTER_BY_CHAIN_ID: {
    1: string;
    3: string;
    4: string;
    42: string;
...
export declare const NATIVE_RFQT_GAS_USED: BigNumber;
export declare const NATIVE_LIMIT_ORDER_GAS_USED: BigNumber;
...
//# sourceMappingURL=constants_REMOTE_36426.d.ts.map