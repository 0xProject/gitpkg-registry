...
exports.findOptimalPathAsync = void 0;
...
var setImmediateAsync = function (delay) {
    if (delay === void 0) { delay = 0; }
    return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
        return [2 /*return*/, new Promise(function (resolve) { return setImmediate(function () { return resolve(); }, delay); })];
    }); });
};
/**
...
function findOptimalPathAsync(side, paths, targetInput, runLimit) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var sortedPaths, optimalPath, _a, _b, _c, i, path, e_1_1;
        var e_1, _d;
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 1:
                    ...
                    _a = __values(sortedPaths.slice(1).entries()), _b = _a.next();
                    _e.label = 2;
                case 2:
                    if (!!_b.done) return [3 /*break*/, 5];
                    _c = __read(_b.value, 2), i = _c[0], path = _c[1];
                    optimalPath = mixPaths(side, optimalPath, path, targetInput, runLimit * Math.pow(RUN_LIMIT_DECAY_FACTOR, i));
                    return [4 /*yield*/, setImmediateAsync()];
                case 3:
                    _e.sent();
                    _e.label = 4;
                case 4:
