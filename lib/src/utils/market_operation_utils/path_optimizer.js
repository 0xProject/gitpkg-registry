...
function findOptimalPath(side, paths, targetInput, runLimit) {
    ...
    optimalPath.sort(function (a, b) {
        if (a.flags === types_2.FillFlags.ConflictsWithKyber && b.flags === types_2.FillFlags.Kyber) {
            return -1;
        }
        if (b.flags === types_2.FillFlags.ConflictsWithKyber && a.flags === types_2.FillFlags.Kyber) {
            return 1;
        }
        return 0;
    });
