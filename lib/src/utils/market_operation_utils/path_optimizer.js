 ...
 */
function findOptimalPathAsync(side, fills, targetInput, opts) {
    return __awaiter(this, void 0, void 0, function* () {
        const { runLimit, pathPenaltyOpts, timeLimitMs } = Object.assign({ runLimit: Math.pow(2, 8), timeLimitMs: 500, pathPenaltyOpts: path_1.DEFAULT_PATH_PENALTY_OPTS }, opts);
...
// Sort fill arrays by descending adjusted completed rate.
function fillsToSortedPaths(fills, side, targetInput, pathPenaltyOpts) {
    const paths = fills.map(singleSourceFills => path_1.Path.create(side, singleSourceFills, targetInput, pathPenaltyOpts));
