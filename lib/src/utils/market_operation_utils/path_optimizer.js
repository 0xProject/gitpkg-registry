...
function findOptimalPathAsync(side, fills, targetInput, runLimit = Math.pow(2, 8), opts = path_1.DEFAULT_PATH_PENALTY_OPTS) {
    return __awaiter(this, void 0, void 0, function* () {
        return utils_1.timeIt(() => __awaiter(this, void 0, void 0, function* () {
            // Sort fill arrays by descending adjusted completed rate.
            // Remove any paths which cannot impact the optimal path
            const sortedPaths = yield utils_1.timeIt(() => reducePaths(fillsToSortedPaths(fills, side, targetInput, opts)), 'reducePaths', 100);
