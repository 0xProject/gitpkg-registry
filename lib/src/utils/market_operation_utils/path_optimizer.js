...
function findRoutesAndCreateOptimalPath(side, samples, nativeOrders, input, opts, fees, neonRouterNumSamples) {
    ...
    for (const [routeInput, routeSamplesAndNativeOrders, outputAmount, sourcePathId] of routesAndSamplesAndOutputs) {
        ...
        adjustedFills.push(Object.assign(Object.assign({}, fill), { input: rustInputAdjusted, output: scaleOutput(fill.input, fill.output), adjustedOutput: scaleOutput(fill.input, fill.adjustedOutput), index: 0, parent: undefined, sourcePathId: sourcePathId !== null && sourcePathId !== void 0 ? sourcePathId : utils_1.hexUtils.random() }));
    }
