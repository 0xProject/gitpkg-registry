...
var CreateOrderUtils = /** @class */ (function () {
    ...
    CreateOrderUtils.prototype.createSellOrdersFromPath = function (orderDomain, inputToken, outputToken, path, bridgeSlippage, liquidityPoolAddress) {
        var e_1, _a;
        var orders = [];
        try {
            for (var path_1 = __values(path), path_1_1 = path_1.next(); !path_1_1.done; path_1_1 = path_1.next()) {
                ...
                if (fill.source === types_1.ERC20BridgeSource.Native) {
                    ...
                    orders.push(createBridgeOrder(orderDomain, fill, this._getBridgeAddressFromSource(fill.source, liquidityPoolAddress), outputToken, inputToken, bridgeSlippage));
                }
            }
        }
    ...
    CreateOrderUtils.prototype.createBuyOrdersFromPath = function (orderDomain, inputToken, outputToken, path, bridgeSlippage, liquidityPoolAddress) {
        var e_2, _a;
        var orders = [];
        try {
            for (var path_2 = __values(path), path_2_1 = path_2.next(); !path_2_1.done; path_2_1 = path_2.next()) {
                ...
                if (fill.source === types_1.ERC20BridgeSource.Native) {
                    ...
                    orders.push(createBridgeOrder(orderDomain, fill, this._getBridgeAddressFromSource(fill.source, liquidityPoolAddress), inputToken, outputToken, bridgeSlippage, true));
                }
            }
        }
    ...
    CreateOrderUtils.prototype._getBridgeAddressFromSource = function (source, liquidityPoolAddress) {
        switch (source) {
            ...
            case types_1.ERC20BridgeSource.LiquidityProvider:
                ...
                assert_1.assert.isETHAddressHex('liquidityPoolAddress', liquidityPoolAddress);
