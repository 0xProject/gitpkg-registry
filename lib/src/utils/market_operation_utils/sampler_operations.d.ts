...
import { BalancerFillData, BatchedOperation, CurveFillData, CurveInfo, DexSample, SourceQuoteOperation, UniswapV2FillData } from './types';
/**
...
export declare const samplerOperations: {
    ...
    getKyberBuyQuotes(makerToken: string, takerToken: string, makerFillAmounts: BigNumber[]): SourceQuoteOperation<import("@0x/asset-swapper/src/utils/market_operation_utils/types").FillData>;
    ...
    getLiquidityProviderBuyQuotes(registryAddress: string, makerToken: string, takerToken: string, makerFillAmounts: BigNumber[]): SourceQuoteOperation<import("@0x/asset-swapper/src/utils/market_operation_utils/types").FillData>;
    ...
    getMStableSellQuotes(makerToken: string, takerToken: string, takerFillAmounts: BigNumber[]): SourceQuoteOperation<import("@0x/asset-swapper/src/utils/market_operation_utils/types").FillData>;
    getMStableBuyQuotes(makerToken: string, takerToken: string, makerFillAmounts: BigNumber[]): SourceQuoteOperation<import("@0x/asset-swapper/src/utils/market_operation_utils/types").FillData>;
