...
import { BalancerFillData, BalancerV2FillData, BalancerV2PoolInfo, BancorFillData, BatchedOperation, CurveFillData, DexSample, DODOFillData, ERC20BridgeSource, GenericRouterFillData, KyberDmmFillData, KyberSamplerOpts, LiquidityProviderFillData, LiquidityProviderRegistry, MakerPsmFillData, MooniswapFillData, MultiHopFillData, PsmInfo, ShellFillData, SourceQuoteOperation, SourcesWithPoolsCache, TokenAdjacencyGraph, UniswapV2FillData, UniswapV3FillData } from './types';
/**
...
export declare class SamplerOperations {
    ...
    getCurveSellQuotes(pool: CurveDetailedInfo, makerToken: string, takerToken: string, takerFillAmounts: BigNumber[], source?: ERC20BridgeSource): SourceQuoteOperation<CurveFillData>;
    getCurveBuyQuotes(pool: CurveDetailedInfo, makerToken: string, takerToken: string, makerFillAmounts: BigNumber[], source?: ERC20BridgeSource): SourceQuoteOperation<CurveFillData>;
    ...
    getShellBuyQuotes(poolAddress: string, makerToken: string, takerToken: string, makerFillAmounts: BigNumber[], source?: ERC20BridgeSource): SourceQuoteOperation<ShellFillData>;
