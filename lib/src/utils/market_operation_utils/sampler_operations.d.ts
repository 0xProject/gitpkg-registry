...
export declare const samplerOperations: {
    ...
    getLiquidityProviderBuyQuotes(liquidityProviderRegistryAddress: string, makerToken: string, takerToken: string, makerFillAmounts: BigNumber[], fakeBuyOpts?: FakeBuyOpts): BatchedOperation<BigNumber[]>;
    ...
    getSellQuotes(sources: ERC20BridgeSource[], makerToken: string, takerToken: string, takerFillAmounts: BigNumber[], wethAddress: string, liquidityProviderRegistryAddress?: string | undefined): BatchedOperation<DexSample[][]>;
