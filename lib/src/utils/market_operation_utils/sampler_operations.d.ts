...
export declare class SamplerOperations {
    ...
    getOrderFillableTakerAmounts(orders: Array<SignedOrder<LimitOrderFields>>, exchangeAddress: string): BatchedOperation<BigNumber[]>;
    getOrderFillableMakerAmounts(orders: Array<SignedOrder<LimitOrderFields>>, exchangeAddress: string): BatchedOperation<BigNumber[]>;
