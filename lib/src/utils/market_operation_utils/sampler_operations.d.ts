...
import { BalancerFillData, BalancerV2FillData, BalancerV2PoolInfo, BancorFillData, BatchedOperation, CurveFillData, DexSample, DODOFillData, ERC20BridgeSource, GenericRouterFillData, KyberDmmFillData, KyberFillData, KyberSamplerOpts, LidoFillData, LidoInfo, LiquidityProviderFillData, LiquidityProviderRegistry, MakerPsmFillData, MeasuredSourceQuoteOperation, MooniswapFillData, MultiHopFillData, PsmInfo, ShellFillData, SourcesWithPoolsCache, TokenAdjacencyGraph, UniswapV2FillData, UniswapV3FillData } from './types';
/**
...
export declare class SamplerOperations {
    ...
    getCurveV2BuyQuotes(pool: CurveDetailedInfo, makerToken: string, takerToken: string, takerFillAmounts: BigNumber[], source?: ERC20BridgeSource): MeasuredSourceQuoteOperation<CurveFillData>;
    ...
    getLidoSellQuotes(lidoInfo: LidoInfo, makerToken: string, takerToken: string, takerFillAmounts: BigNumber[]): MeasuredSourceQuoteOperation<LidoFillData>;
    getLidoBuyQuotes(lidoInfo: LidoInfo, makerToken: string, takerToken: string, makerFillAmounts: BigNumber[]): MeasuredSourceQuoteOperation<LidoFillData>;
