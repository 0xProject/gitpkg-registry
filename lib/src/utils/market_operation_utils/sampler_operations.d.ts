...
import { BalancerFillData, BancorFillData, BatchedOperation, CurveFillData, CurveInfo, DexSample, DODOFillData, ERC20BridgeSource, LiquidityProviderFillData, LiquidityProviderRegistry, MooniswapFillData, MultiHopFillData, ShellFillData, SignedOrder, SnowSwapFillData, SnowSwapInfo, SourceQuoteOperation, SushiSwapFillData, SwerveFillData, SwerveInfo, TokenAdjacencyGraph, UniswapV2FillData } from './types';
/**
...
export declare class SamplerOperations {
    ...
    constructor(_samplerContract: ERC20BridgeSamplerContract, balancerPoolsCache?: BalancerPoolsCache, creamPoolsCache?: CreamPoolsCache, tokenAdjacencyGraph?: TokenAdjacencyGraph, liquidityProviderRegistry?: LiquidityProviderRegistry, bancorServiceFn?: () => Promise<BancorService | undefined>);
    getTokenDecimals(tokens: string[]): BatchedOperation<BigNumber[]>;
    isAddressContract(address: string): BatchedOperation<boolean>;
    getLimitOrderFillableTakerAmounts(orders: Array<SignedOrder<LimitOrderFields>>, exchangeAddress: string): BatchedOperation<BigNumber[]>;
    getLimitOrderFillableMakerAmounts(orders: Array<SignedOrder<LimitOrderFields>>, exchangeAddress: string): BatchedOperation<BigNumber[]>;
