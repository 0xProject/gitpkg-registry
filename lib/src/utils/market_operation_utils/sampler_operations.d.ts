...
export declare class SamplerOperations {
    ...
    getBalancerV2MultihopSellQuotes(vault: string, quoteSwaps: BalancerSwapInfo, // Should always be sell swap steps.
    ...
    getBalancerV2MultihopBuyQuotes(vault: string, quoteSwaps: BalancerSwapInfo, // Should always be buy swap steps.
    ...
    getBancorV3SellQuotes(networkAddress: string, networkInfoAddress: string, path: string[], takerFillAmounts: BigNumber[]): SourceQuoteOperation<BancorFillData>;
    getBancorV3BuyQuotes(networkAddress: string, networkInfoAddress: string, path: string[], makerFillAmounts: BigNumber[]): SourceQuoteOperation<BancorFillData>;
    ...
    getGMXSellQuotes(router: string, reader: string, vault: string, tokenAddressPath: string[], takerFillAmounts: BigNumber[]): SourceQuoteOperation<GMXFillData>;
    getGMXBuyQuotes(router: string, reader: string, vault: string, tokenAddressPath: string[], makerFillAmounts: BigNumber[]): SourceQuoteOperation<GMXFillData>;
    getPlatypusSellQuotes(router: string, pool: string[], tokenAddressPath: string[], takerFillAmounts: BigNumber[]): SourceQuoteOperation<PlatypusFillData>;
    getPlatypusBuyQuotes(router: string, pool: string[], tokenAddressPath: string[], makerFillAmounts: BigNumber[]): SourceQuoteOperation<PlatypusFillData>;
    getVelodromeSellQuotes(router: string, takerToken: string, makerToken: string, takerFillAmounts: BigNumber[]): SourceQuoteOperation<VelodromeFillData>;
    getVelodromeBuyQuotes(router: string, takerToken: string, makerToken: string, makerFillAmounts: BigNumber[]): SourceQuoteOperation<VelodromeFillData>;
    /**
     ...
     */
    getBestNativeTokenSellRate(sources: ERC20BridgeSource[], makerToken: string, nativeToken: string, nativeFillAmount: BigNumber, feeSchedule: FeeSchedule): BatchedOperation<BigNumber>;
