...
import { BalancerFillData, BalancerV2FillData, BalancerV2PoolInfo, BancorFillData, BatchedOperation, CurveFillData, CurveInfo, DexSample, DODOFillData, ERC20BridgeSource, GenericRouterFillData, KyberSamplerOpts, LiquidityProviderFillData, LiquidityProviderRegistry, MakerPsmFillData, MooniswapFillData, MultiHopFillData, PsmInfo, ShellFillData, SourceQuoteOperation, SourcesWithPoolsCache, TokenAdjacencyGraph, UniswapV2FillData, UniswapV3FillData } from './types';
/**
