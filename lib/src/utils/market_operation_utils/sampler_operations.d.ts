...
import { BalancerFillData, BancorFillData, BatchedOperation, CurveFillData, CurveInfo, DexSample, ERC20BridgeSource, LiquidityProviderFillData, MultiBridgeFillData, MultiHopFillData, SourceQuoteOperation, SwerveFillData, SwerveInfo, TokenAdjacencyGraph, UniswapV2FillData } from './types';
/**
