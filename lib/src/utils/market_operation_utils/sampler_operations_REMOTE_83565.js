...
exports.samplerOperations = {
    ...
    getKyberSellQuotes: function (reserveId, makerToken, takerToken, takerFillAmounts) {
        var _this = this;
        return {
            ...
            handleCallResultsAsync: function (contract, callResults) { return __awaiter(_this, void 0, void 0, function () {
                var _a, samplesEncoded, hintEncoded, samples, hint, data;
                return __generator(this, function (_b) {
                    _a = __read(contract.getABIDecodedReturnData('batchCall', callResults), 2), samplesEncoded = _a[0], hintEncoded = _a[1];
                    samples = contract.getABIDecodedReturnData('sampleSellsFromKyberNetwork', samplesEncoded);
                    hint = contract.getABIDecodedReturnData('encodeKyberHint', hintEncoded);
                    data = samples.map(function (amount) { return ({ amount: amount, fillData: { hint: hint } }); });
    ...
    getKyberBuyQuotes: function (reserveId, makerToken, takerToken, makerFillAmounts) {
        var _this = this;
        return {
            source: __1.ERC20BridgeSource.Kyber,
            encodeCall: function (contract) {
            ...
            handleCallResultsAsync: function (contract, callResults) { return __awaiter(_this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, contract
                            ...
                            .map(function (amount) { return ({ amount: amount, fillData: { hint: reserveId } }); })];
                });
            }); },
        };
    },
            ...
            handleCallResultsAsync: function (contract, callResults) { return __awaiter(_this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, contract
                            ...
                            .map(function (amount) { return ({ amount: amount }); })];
                });
            }); },
        };
    },
    ...
    getBancorSellQuotes: function (makerToken, takerToken, takerFillAmounts, bancorService) {
        var _this = this;
        return {
            ...
            handleCallResultsAsync: function (_contract, _callResults) { return __awaiter(_this, void 0, void 0, function () {
                var _this = this;
                return __generator(this, function (_a) {
                    return [2 /*return*/, Promise.all(takerFillAmounts.map(function (amt) { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                            return [2 /*return*/, bancorService.getQuoteAsync(takerToken, makerToken, amt)];
                        }); }); }))];
                });
            }); },
        };
    ...
    getBalancerSellQuotes: function (pool, takerFillAmounts) {
        return __assign({ source: __1.ERC20BridgeSource.Balancer }, exports.samplerOperations.constant(takerFillAmounts.map(function (amount) { return ({
    ...
    getBalancerBuyQuotes: function (pool, makerFillAmounts) {
        return __assign({ source: __1.ERC20BridgeSource.Balancer }, exports.samplerOperations.constant(makerFillAmounts.map(function (amount) { return ({
    ...
    getMooniswapSellQuotes: function (makerToken, takerToken, takerFillAmounts) {
        var _this = this;
        return {
    ...
    getMooniswapBuyQuotes: function (makerToken, takerToken, makerFillAmounts) {
        var _this = this;
        return {
            source: __1.ERC20BridgeSource.Mooniswap,
            encodeCall: function (contract) {
    ...
    getDODOSellQuotes: function (makerToken, takerToken, takerFillAmounts) {
        var _this = this;
        return {
            source: __1.ERC20BridgeSource.Dodo,
            encodeCall: function (contract) {
                return contract
            ...
            handleCallResultsAsync: function (contract, callResults) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    data = contract
                        .getABIDecodedReturnData('sampleSellsFromDODO', callResults)
                        .map(function (amount) { return ({ amount: amount }); });
                    return [2 /*return*/, data];
                });
            }); },
    ...
    getMedianSellRateAsync: function (sources, makerToken, takerToken, takerFillAmount, wethAddress, balancerPoolsCache, liquidityProviderRegistryAddress, multiBridgeAddress, bancorService) { return __awaiter(_this, void 0, void 0, function () {
        var getSellQuotes;
        var _this = this;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, exports.samplerOperations.getSellQuotesAsync(sources, makerToken, takerToken, [takerFillAmount], wethAddress, balancerPoolsCache, liquidityProviderRegistryAddress, multiBridgeAddress, bancorService)];
                case 1:
                    getSellQuotes = _a.sent();
                    return [2 /*return*/, {
                            encodeCall: function (contract) {
                                var encodedCall = getSellQuotes.encodeCall(contract);
                                    ...
                                    switch (_a.label) {
                                        case 0:
                                            if (callResults === constants_1.NULL_BYTES) {
                                                return [2 /*return*/, constants_1.ZERO_AMOUNT];
                                            }
    ...
    getSellQuotesAsync: function (sources, makerToken, takerToken, takerFillAmounts, wethAddress, balancerPoolsCache, liquidityProviderRegistryAddress, multiBridgeAddress, bancorService) { return __awaiter(_this, void 0, void 0, function () {
        var subOps, _a, _b, nonSamplerSources, samplerOps, nonSamplerOps;
        var _this = this;
                                ...
                                switch (_b.label) {
                                    case 0:
                                        ...
                                        switch (_a) {
                                            ...
                                            case __1.ERC20BridgeSource.Bancor: return [3 /*break*/, 10];
                                            case __1.ERC20BridgeSource.MStable: return [3 /*break*/, 11];
                                            case __1.ERC20BridgeSource.Mooniswap: return [3 /*break*/, 12];
                                            case __1.ERC20BridgeSource.Dodo: return [3 /*break*/, 13];
                                        }
                                        return [3 /*break*/, 14];
                                    ...
                                    case 3:
                                        ...
                                        return [2 /*return*/, ops];
                                    case 4: return [2 /*return*/, Object.values(constants_1.MAINNET_KYBER_INFOS).map(function (reserveId) {
                                            return exports.samplerOperations.getKyberSellQuotes(reserveId, makerToken, takerToken, takerFillAmounts);
                                        })];
                                    ...
                                    case 10:
                                        ...
                                        return [2 /*return*/, exports.samplerOperations.getBancorSellQuotes(makerToken, takerToken, takerFillAmounts, bancorService)];
                                    case 11: return [2 /*return*/, exports.samplerOperations.getMStableSellQuotes(makerToken, takerToken, takerFillAmounts)];
                                    case 12: return [2 /*return*/, exports.samplerOperations.getMooniswapSellQuotes(makerToken, takerToken, takerFillAmounts)];
                                    case 13: return [2 /*return*/, exports.samplerOperations.getDODOSellQuotes(makerToken, takerToken, takerFillAmounts)];
                                    case 14: throw new Error("Unsupported sell sample source: " + source);
                                }
                            });
                        }); }))];
                case 1:
                    subOps = _b.apply(_a, [_c.sent()]);
                    nonSamplerSources = [__1.ERC20BridgeSource.Balancer, __1.ERC20BridgeSource.Bancor];
                    samplerOps = [];
                    nonSamplerOps = [];
                    subOps.forEach(function (op) {
                    ...
                    return [2 /*return*/, {
                            ...
                            handleCallResultsAsync: function (contract, callResults) { return __awaiter(_this, void 0, void 0, function () {
                                var samples, rawSubCallResults_1, _a, _b;
                                var _this = this;
                                return __generator(this, function (_c) {
                                    switch (_c.label) {
                                        case 0:
                                            if (!(callResults === constants_1.NULL_BYTES && samplerOps.length === 0)) return [3 /*break*/, 2];
                                        ...
                                        case 1:
                                            ...
                                            return [3 /*break*/, 5];
                                        case 2:
                                            rawSubCallResults_1 = contract.getABIDecodedReturnData('batchCall', callResults);
                                            return [4 /*yield*/, Promise.all(samplerOps.map(function (op, i) { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                                                    return [2 /*return*/, op.handleCallResultsAsync(contract, rawSubCallResults_1[i])];
                                                }); }); }))];
                                        case 3:
                                            samples = _c.sent();
                                        ...
                                        case 4:
                                            ...
                                            _c.label = 5;
                                        case 5: return [2 /*return*/, __spread(samplerOps, nonSamplerOps).map(function (op, i) {
    ...
    getBuyQuotesAsync: function (sources, makerToken, takerToken, makerFillAmounts, wethAddress, balancerPoolsCache, liquidityProviderRegistryAddress, bancorService) { return __awaiter(_this, void 0, void 0, function () {
        var subOps, _a, _b, nonSamplerSources, samplerOps, nonSamplerOps;
        var _this = this;
        return __generator(this, function (_c) {
            switch (_c.label) {
                                ...
                                switch (_b.label) {
                                    case 0:
                                        ...
                                        switch (_a) {
                                            ...
                                            case __1.ERC20BridgeSource.Bancor: return [3 /*break*/, 9];
                                            case __1.ERC20BridgeSource.MStable: return [3 /*break*/, 10];
                                            case __1.ERC20BridgeSource.Mooniswap: return [3 /*break*/, 11];
                                        }
                                        return [3 /*break*/, 12];
                                    ...
                                    case 3:
                                        ...
                                        return [2 /*return*/, ops];
                                    case 4: return [2 /*return*/, Object.values(constants_1.MAINNET_KYBER_INFOS).map(function (reserveId) {
                                            return exports.samplerOperations.getKyberBuyQuotes(reserveId, makerToken, takerToken, makerFillAmounts);
                                        })];
                                    case 5: return [2 /*return*/, curve_utils_1.getCurveInfosForPair(takerToken, makerToken).map(function (curve) {
                                    ...
                                    case 9: return [2 /*return*/, []]; //  FIXME: Waiting for Bancor SDK to support buy quotes, but don't throw an error here
                                    case 10: return [2 /*return*/, exports.samplerOperations.getMStableBuyQuotes(makerToken, takerToken, makerFillAmounts)];
                                    case 11: return [2 /*return*/, exports.samplerOperations.getMooniswapBuyQuotes(makerToken, takerToken, makerFillAmounts)];
                                    case 12: throw new Error("Unsupported buy sample source: " + source);
                                }
                            });
                        }); }))];
                case 1:
                    ...
                    nonSamplerOps = [];
                    subOps.forEach(function (op) {
                        if (nonSamplerSources.find(function (s) { return s === op.source; }) !== undefined) {
                            nonSamplerOps.push(op);
                        }
                        else {
                            samplerOps.push(op);
                    ...
                    return [2 /*return*/, {
                            ...
                            handleCallResultsAsync: function (contract, callResults) { return __awaiter(_this, void 0, void 0, function () {
                                var samples, rawSubCallResults_2, _a, _b;
                                var _this = this;
                                return __generator(this, function (_c) {
                                    switch (_c.label) {
                                        case 0:
                                        ...
                                        case 1:
                                            ...
                                            return [3 /*break*/, 5];
                                        case 2:
                                            rawSubCallResults_2 = contract.getABIDecodedReturnData('batchCall', callResults);
                                            return [4 /*yield*/, Promise.all(samplerOps.map(function (op, i) { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                                                    return [2 /*return*/, op.handleCallResultsAsync(contract, rawSubCallResults_2[i])];
                                                }); }); }))];
                                        case 3:
                                            samples = _c.sent();
                                            _b = (_a = samples).concat;
...
//# sourceMappingURL=sampler_operations_REMOTE_83565.js.map