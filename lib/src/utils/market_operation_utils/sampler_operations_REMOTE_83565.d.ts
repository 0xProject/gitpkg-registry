...
import { BalancerFillData, BancorFillData, BatchedOperation, CurveFillData, CurveInfo, DexSample, FillData, KyberFillData, SourceQuoteOperation, UniswapV2FillData } from './types';
/**
...
export declare const samplerOperations: {
    ...
    getKyberSellQuotes(reserveId: string, makerToken: string, takerToken: string, takerFillAmounts: BigNumber[]): SourceQuoteOperation<KyberFillData>;
    getKyberBuyQuotes(reserveId: string, makerToken: string, takerToken: string, makerFillAmounts: BigNumber[]): SourceQuoteOperation<KyberFillData>;
    ...
    getDODOSellQuotes(makerToken: string, takerToken: string, takerFillAmounts: BigNumber[]): SourceQuoteOperation<FillData>;
...
//# sourceMappingURL=sampler_operations_REMOTE_83565.d.ts.map