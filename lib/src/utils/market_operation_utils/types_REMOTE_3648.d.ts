...
export interface MeasuredSourceQuoteOperation<TFillData extends FillData = FillData> extends BatchedOperation<MeasuredSamplerResult> {
...
//# sourceMappingURL=types_REMOTE_3648.d.ts.map