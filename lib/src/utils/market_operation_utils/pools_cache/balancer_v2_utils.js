...
class BalancerV2PoolsCache extends pools_cache_1.PoolsCache {
    constructor(subgraphUrl = constants_2.BALANCER_V2_SUBGRAPH_URL, maxPoolsFetched = constants_2.BALANCER_MAX_POOLS_FETCHED, _topPoolsFetched = constants_2.BALANCER_TOP_POOLS_FETCHED, _warningLogger = constants_1.DEFAULT_WARNING_LOGGER, cache = {}) {
        super(cache);
