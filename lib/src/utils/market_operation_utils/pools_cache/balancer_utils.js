...
class BalancerPoolsCache extends pools_cache_1.PoolsCache {
    ...
    _fetchTopPoolsAsync() {
        return __awaiter(this, void 0, void 0, function* () {
            const query = `
      query {
          pools (first: ${this._topPoolsFetched}, where: {publicSwap: true, liquidity_gt: 0}, orderBy: swapsCount, orderDirection: desc) {
            id
            publicSwap
            swapFee
            totalWeight
    ...
    `;
            try {
                const response = yield fetch(this._subgraphUrl, {
                    method: 'POST',
                    headers: {
