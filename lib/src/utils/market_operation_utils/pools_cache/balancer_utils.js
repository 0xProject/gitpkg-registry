...
class BalancerPoolsCache extends pools_cache_1.PoolsCache {
    ...
    _fetchPoolsForPairAsync(takerToken, makerToken) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const poolData = (yield (0, sor_1.getPoolsWithTokens)(takerToken, makerToken)).pools;
                // Sort by maker token balance (descending)
                const pools = (0, sor_1.parsePoolData)(poolData, takerToken, makerToken).sort((a, b) => b.balanceOut.minus(a.balanceOut).toNumber());
                ...
                for (const from of tokensList) {
                    for (const to of tokensList.filter(t => t.toLowerCase() !== from.toLowerCase())) {
                        ...
                        try {
                            ...
                            const poolData = (0, sor_1.parsePoolData)([pool], from, to);
