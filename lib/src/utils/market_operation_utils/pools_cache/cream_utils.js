...
class CreamPoolsCache extends pools_cache_1.PoolsCache {
    ...
    _fetchPoolsForPairAsync(takerToken, makerToken) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const poolData = (yield (0, cream_sor_1.getPoolsWithTokens)(takerToken, makerToken)).pools;
                // Sort by maker token balance (descending)
                const pools = (0, cream_sor_1.parsePoolData)(poolData, takerToken, makerToken).sort((a, b) => b.balanceOut.minus(a.balanceOut).toNumber());
