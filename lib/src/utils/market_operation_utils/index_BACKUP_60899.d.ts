...
export declare class MarketOperationUtils {
    ...
    constructor(_sampler: DexOrderSampler, contractAddresses: ContractAddresses, _orderDomain: OrderDomain, _liquidityProviderRegistry?: string, _tokenAdjacencyGraph?: TokenAdjacencyGraph);
    /**
...
//# sourceMappingURL=index_BACKUP_60899.d.ts.map