...
function nativeOrdersToFills(side, orders, targetInput = constants_1.POSITIVE_INF, outputAmountPerEth, inputAmountPerEth, fees, filterNegativeAdjustedRateOrders = true) {
