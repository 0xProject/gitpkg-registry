...
function createFills(opts) {
    ...
    // Create native fills.
    const nativeFills = nativeOrdersToFills(side, orders.filter(o => o.fillableTakerAmount.isGreaterThan(0)), opts.targetInput, ethToOutputRate, ethToInputRate, feeSchedule);
    // Create DEX fills.
