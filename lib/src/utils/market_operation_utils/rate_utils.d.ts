 ...
 */
export declare function getTwoHopAdjustedRate(side: MarketOperation, twoHopQuote: DexSample<MultiHopFillData>, targetInput: BigNumber, ethToOutputRate: BigNumber, fees?: FeeSchedule, exchangeProxyOverhead?: ExchangeProxyOverhead): BigNumber;
/**
