...
const extended_quote_report_generator_1 = require("./../extended_quote_report_generator");
...
class MarketOperationUtils {
    ...
    static _computeExtendedQuoteReport(quoteRequestor, marketSideLiquidity, optimizerResult, comparisonPrice) {
        const { side, quotes } = marketSideLiquidity;
        const { liquidityDelivered } = optimizerResult;
        return extended_quote_report_generator_1.generateExtendedQuoteReport(side, quotes, liquidityDelivered, comparisonPrice, quoteRequestor);
    }
    ...
    _generateOptimizedOrdersAsync(marketSideLiquidity, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this._addOptionalFallbackAsync(side, inputAmount, optimalPath, fills, opts, penaltyOpts);
    ...
    getOptimizerResultAsync(nativeOrders, amount, side, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            extendedQuoteReport = MarketOperationUtils._computeQuoteReport(_opts.rfqt ? _opts.rfqt.quoteRequestor : undefined, marketSideLiquidity, optimizerResult, wholeOrderPrice);
    ...
    _addOptionalFallbackAsync(side, inputAmount, optimalPath, fills, opts, penaltyOpts) {
        return __awaiter(this, void 0, void 0, function* () {
...
//# sourceMappingURL=index_kafka.js.map