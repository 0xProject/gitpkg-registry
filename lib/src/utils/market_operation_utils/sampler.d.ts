...
export declare class DexOrderSampler extends SamplerOperations {
    ...
    constructor(_samplerContract: ERC20BridgeSamplerContract, _samplerOverrides?: SamplerOverrides | undefined, provider?: SupportedProvider, balancerPoolsCache?: BalancerPoolsCache, getBancorServiceFn?: () => BancorService);
