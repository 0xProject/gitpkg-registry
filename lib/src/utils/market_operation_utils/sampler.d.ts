...
export declare class DexOrderSampler {
    ...
    static ops: {
        ...
        getKyberBuyQuotes(makerToken: string, takerToken: string, makerFillAmounts: BigNumber[], fakeBuyOpts?: import("@0x/asset-swapper/src/utils/market_operation_utils/types").FakeBuyOpts): BatchedOperation<BigNumber[]>;
        ...
        getLiquidityProviderBuyQuotes(liquidityProviderRegistryAddress: string, makerToken: string, takerToken: string, makerFillAmounts: BigNumber[], fakeBuyOpts?: import("@0x/asset-swapper/src/utils/market_operation_utils/types").FakeBuyOpts): BatchedOperation<BigNumber[]>;
        ...
        getMedianSellRate(sources: ERC20BridgeSource[], makerToken: string, takerToken: string, takerFillAmount: BigNumber, wethAddress: string, liquidityProviderRegistryAddress?: string | undefined): BatchedOperation<BigNumber>;
        ...
        getSellQuotes(sources: ERC20BridgeSource[], makerToken: string, takerToken: string, takerFillAmounts: BigNumber[], wethAddress: string, liquidityProviderRegistryAddress?: string | undefined): BatchedOperation<import("@0x/asset-swapper/src/utils/market_operation_utils/types").DexSample[][]>;
        getBuyQuotes(sources: ERC20BridgeSource[], makerToken: string, takerToken: string, makerFillAmounts: BigNumber[], wethAddress: string, liquidityProviderRegistryAddress?: string | undefined, fakeBuyOpts?: import("@0x/asset-swapper/src/utils/market_operation_utils/types").FakeBuyOpts): BatchedOperation<import("@0x/asset-swapper/src/utils/market_operation_utils/types").DexSample[][]>;
    };
