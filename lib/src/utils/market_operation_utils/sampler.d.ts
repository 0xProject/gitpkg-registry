...
export declare class DexOrderSampler {
    ...
    static ops: {
        ...
        getMooniswapSellQuotes(makerToken: string, takerToken: string, takerFillAmounts: BigNumber[]): import("@0x/asset-swapper/src/utils/market_operation_utils/types").SourceQuoteOperation<import("@0x/asset-swapper/src/utils/market_operation_utils/types").FillData>;
