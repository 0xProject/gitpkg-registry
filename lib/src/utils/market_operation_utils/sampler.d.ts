...
export declare class DexOrderSampler {
    ...
    static ops: {
        ...
        getKyberBuyQuotes(makerToken: string, takerToken: string, makerFillAmounts: BigNumber[], fakeBuyOpts?: import("./types").FakeBuyOpts): BatchedOperation<BigNumber[]>;
        ...
        getLiquidityProviderBuyQuotes(registryAddress: string, makerToken: string, takerToken: string, makerFillAmounts: BigNumber[], fakeBuyOpts?: import("./types").FakeBuyOpts): BatchedOperation<BigNumber[]>;
        ...
        getSellQuotes(sources: ERC20BridgeSource[], makerToken: string, takerToken: string, takerFillAmounts: BigNumber[], wethAddress: string, liquidityProviderRegistryAddress?: string | undefined, multiBridgeAddress?: string | undefined): BatchedOperation<import("./types").DexSample[][]>;
        getBuyQuotes(sources: ERC20BridgeSource[], makerToken: string, takerToken: string, makerFillAmounts: BigNumber[], wethAddress: string, liquidityProviderRegistryAddress?: string | undefined, fakeBuyOpts?: import("./types").FakeBuyOpts): BatchedOperation<import("./types").DexSample[][]>;
    };
