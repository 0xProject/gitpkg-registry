...
export declare class DexOrderSampler {
    ...
    static ops: {
        ...
        getLiquidityProviderBuyQuotes(liquidityProviderRegistryAddress: string, makerToken: string, takerToken: string, makerFillAmounts: BigNumber[], fakeBuyOpts?: import("./types").FakeBuyOpts): BatchedOperation<BigNumber[]>;
        ...
        getSellQuotes(sources: ERC20BridgeSource[], makerToken: string, takerToken: string, takerFillAmounts: BigNumber[], liquidityProviderRegistryAddress?: string | undefined): BatchedOperation<import("./types").DexSample[][]>;
        getBuyQuotes(sources: ERC20BridgeSource[], makerToken: string, takerToken: string, makerFillAmounts: BigNumber[], liquidityProviderRegistryAddress?: string | undefined, fakeBuyOpts?: import("./types").FakeBuyOpts): BatchedOperation<import("./types").DexSample[][]>;
    };
