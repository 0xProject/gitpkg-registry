...
export declare class DexOrderSampler {
    ...
    static ops: {
        ...
        getLiquidityProviderSellQuotes(liquidityProviderRegistryAddress: string, takerToken: string, makerToken: string, takerFillAmounts: BigNumber[]): BatchedOperation<BigNumber[]>;
        getLiquidityProviderBuyQuotes(liquidityProviderRegistryAddress: string, takerToken: string, makerToken: string, makerFillAmounts: BigNumber[]): BatchedOperation<BigNumber[]>;
