...
class SamplerOperations {
    constructor(_samplerContract, bancorService, balancerPoolsCache = new balancer_utils_1.BalancerPoolsCache()) {
        this._samplerContract = _samplerContract;
        this.bancorService = bancorService;
    ...
    static constant(result) {
        return {
            ...
            handleCallResultsAsync: (_callResults) => __awaiter(this, void 0, void 0, function* () {
                return result;
            }),
        };
    }
    getOrderFillableTakerAmounts(orders, exchangeAddress) {
        return new types_1.SamplerContractOperation({
    ...
    getLiquidityProviderSellQuotes(registryAddress, makerToken, takerToken, takerFillAmounts) {
        return new types_1.SamplerContractOperation({
            ...
            callback: (callResults, fillData) => __awaiter(this, void 0, void 0, function* () {
    ...
    getBancorSellQuotesAsync(makerToken, takerToken, takerFillAmounts) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.bancorService === undefined) {
                throw new Error('Cannot sample liquidity from Bancor; no Bancor service instantiated.');
            }
            return Promise.all(takerFillAmounts.map((amount) => __awaiter(this, void 0, void 0, function* () {
                try {
                    const { amount: output, fillData } = yield this.bancorService.getQuoteAsync(takerToken, makerToken, amount);
                    return {
    ...
    getTwoHopSellQuotes(sources, makerToken, takerToken, sellAmount, tokenAdjacencyGraph, wethAddress, liquidityProviderRegistryAddress) {
        ...
        const subOps = intermediateTokens.map(intermediateToken => {
            const firstHopOps = this._getSellQuoteOperations(sources, intermediateToken, takerToken, [new utils_1.BigNumber(0)], wethAddress, liquidityProviderRegistryAddress);
            const secondHopOps = this._getSellQuoteOperations(sources, makerToken, intermediateToken, [new utils_1.BigNumber(0)], wethAddress, liquidityProviderRegistryAddress);
            return new types_1.SamplerContractOperation({
                contract: this._samplerContract,
                ...
                callback: (callResults, fillData) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    yield fillData.firstHopSource.handleCallResultsAsync(firstHop.returnData);
                    yield fillData.secondHopSource.handleCallResultsAsync(secondHop.returnData);
                    return Promise.resolve([buyAmount]);
                }),
            });
        });
        return {
            ...
            handleCallResultsAsync: (callResults) => __awaiter(this, void 0, void 0, function* () {
                const rawSubCallResults = this._samplerContract.getABIDecodedReturnData('batchCall', callResults);
                return Promise.all(subOps.map((op, i) => __awaiter(this, void 0, void 0, function* () {
                    const [output] = yield op.handleCallResultsAsync(rawSubCallResults[i]);
                    return {
                        source: op.source,
                        output,
                        input: sellAmount,
    ...
    getMedianSellRate(sources, makerToken, takerToken, takerFillAmount, wethAddress, liquidityProviderRegistryAddress, multiBridgeAddress) {
        ...
        return {
            ...
            handleCallResultsAsync: (callResults) => __awaiter(this, void 0, void 0, function* () {
                ...
                const rawSubCallResults = this._samplerContract.getABIDecodedReturnData('batchCall', callResults);
                const samples = yield getSellQuotes.handleCallResultsAsync(rawSubCallResults[0]);
                if (samples.length === 0) {
                    return constants_1.ZERO_AMOUNT;
                }
    ...
    getSellQuotes(sources, makerToken, takerToken, takerFillAmounts, wethAddress, liquidityProviderRegistryAddress, multiBridgeAddress) {
        ...
        return {
            ...
            handleCallResultsAsync: (callResults) => __awaiter(this, void 0, void 0, function* () {
                const rawSubCallResults = this._samplerContract.getABIDecodedReturnData('batchCall', callResults);
                const samples = yield Promise.all(subOps.map((op, i) => __awaiter(this, void 0, void 0, function* () { return op.handleCallResultsAsync(rawSubCallResults[i]); })));
