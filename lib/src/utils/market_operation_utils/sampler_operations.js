...
var __1 = require("../..");
var source_utils_1 = require("../source_utils");
...
exports.samplerOperations = {
    ...
    getMedianSellRate: function (sources, makerToken, takerToken, takerFillAmount, wethAddress, liquidityProviderRegistryAddress, multiBridgeAddress) {
        var _this = this;
        if (makerToken.toLowerCase() === takerToken.toLowerCase()) {
            return exports.samplerOperations.constant(new __1.BigNumber(1));
        }
        var getSellQuotes = exports.samplerOperations.getSellQuotes(sources, makerToken, takerToken, [takerFillAmount], wethAddress, liquidityProviderRegistryAddress, multiBridgeAddress);
        return {
            encodeCall: function (contract) {
    ...
    getSellQuotes: function (sources, makerToken, takerToken, takerFillAmounts, wethAddress, liquidityProviderRegistryAddress, multiBridgeAddress) {
        var _this = this;
        var subOps = sources
            .map(function (source) {
            ...
            if (source === __1.ERC20BridgeSource.Eth2Dai) {
            ...
            else if (source === __1.ERC20BridgeSource.UniswapV2) {
                batchedOperation = exports.samplerOperations.getUniswapV2SellQuotes([takerToken, makerToken], takerFillAmounts);
            }
            else if (source === __1.ERC20BridgeSource.UniswapV2Eth) {
                batchedOperation = exports.samplerOperations.getUniswapV2SellQuotes([takerToken, wethAddress, makerToken], takerFillAmounts);
            }
            ...
            else if (source_utils_1.isCurveSource(source)) {
                var _a = source_utils_1.getCurveInfo(source, takerToken, makerToken), curveAddress = _a.curveAddress, fromTokenIdx = _a.fromTokenIdx, toTokenIdx = _a.toTokenIdx;
            ...
            else if (source === __1.ERC20BridgeSource.MultiBridge) {
                ...
                batchedOperation = exports.samplerOperations.getMultiBridgeSellQuotes(multiBridgeAddress, makerToken, intermediateToken, takerToken, takerFillAmounts);
            }
            else {
    ...
    getBuyQuotes: function (sources, makerToken, takerToken, makerFillAmounts, wethAddress, liquidityProviderRegistryAddress, fakeBuyOpts) {
        var _this = this;
        if (fakeBuyOpts === void 0) { fakeBuyOpts = constants_1.DEFAULT_FAKE_BUY_OPTS; }
        var subOps = sources
            .map(function (source) {
            var batchedOperation;
            if (source === __1.ERC20BridgeSource.Eth2Dai) {
                batchedOperation = exports.samplerOperations.getEth2DaiBuyQuotes(makerToken, takerToken, makerFillAmounts);
            }
            else if (source === __1.ERC20BridgeSource.Uniswap) {
                batchedOperation = exports.samplerOperations.getUniswapBuyQuotes(makerToken, takerToken, makerFillAmounts);
            }
            else if (source === __1.ERC20BridgeSource.UniswapV2) {
                batchedOperation = exports.samplerOperations.getUniswapV2BuyQuotes([takerToken, makerToken], makerFillAmounts);
            }
            else if (source === __1.ERC20BridgeSource.UniswapV2Eth) {
                batchedOperation = exports.samplerOperations.getUniswapV2BuyQuotes([takerToken, wethAddress, makerToken], makerFillAmounts);
            }
            else if (source === __1.ERC20BridgeSource.Kyber) {
                batchedOperation = exports.samplerOperations.getKyberBuyQuotes(makerToken, takerToken, makerFillAmounts, fakeBuyOpts);
            }
            else if (source_utils_1.isCurveSource(source)) {
                var _a = source_utils_1.getCurveInfo(source, takerToken, makerToken), curveAddress = _a.curveAddress, fromTokenIdx = _a.fromTokenIdx, toTokenIdx = _a.toTokenIdx;
                if (fromTokenIdx !== -1 && toTokenIdx !== -1) {
                    batchedOperation = exports.samplerOperations.getCurveBuyQuotes(curveAddress, fromTokenIdx, toTokenIdx, makerFillAmounts);
                }
            }
            else if (source === __1.ERC20BridgeSource.LiquidityProvider) {
                if (liquidityProviderRegistryAddress === undefined) {
                ...
                batchedOperation = exports.samplerOperations.getLiquidityProviderBuyQuotes(liquidityProviderRegistryAddress, makerToken, takerToken, makerFillAmounts, fakeBuyOpts);
            }
            else {
                throw new Error("Unsupported buy sample source: " + source);
            }
            return { source: source, batchedOperation: batchedOperation };
        })
            .filter(function (op) { return op.batchedOperation; });
        return {
            encodeCall: function (contract) {
