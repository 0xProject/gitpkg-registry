    ...
    getBancorSellQuotes: function (makerToken, takerToken, takerFillAmounts, bancorService) {
        ...
        return {
            ...
            handleCallResultsAsync: function (_contract, _callResults) { return __awaiter(_this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, Promise.all(takerFillAmounts.map(function (amt) { return bancorService.getQuoteAsync(makerToken, takerToken, amt); }))];
                });
            }); },
        };
    },
    getBancorBuyQuotes: function (makerToken, takerToken, makerFillAmounts, bancorService) {
        var _this = this;
        return {
            source: __1.ERC20BridgeSource.Bancor,
            encodeCall: function (_contract) {
            ...
            handleCallResultsAsync: function (_contract, _callResults) { return __awaiter(_this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, Promise.all(makerFillAmounts.map(function (amt) { return bancorService.getQuoteAsync(takerToken, makerToken, amt); }))];
                });
            }); },
        };
    },
                            ...
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    ...
                                    case 10:
                                        ...
                                        return [2 /*return*/, exports.samplerOperations.getBancorSellQuotes(takerToken, makerToken, takerFillAmounts, bancorService)];
                                        ...
                                        case 2:
                                            ...
                                            return [2 /*return*/, __spread(samplerOps, nonSamplerOps).map(function (op, i) {
                                                    return samples[i].map(function (output, j) { return ({
                                                        source: op.source,
                                                        output: op.source === __1.ERC20BridgeSource.Bancor
                                                            ? output.amount
                                                            : output,
                                                        input: takerFillAmounts[j],
                                                        fillData: op.source === __1.ERC20BridgeSource.Bancor ? output.fillData : op.fillData,
                                                    }); });
                                                })];
                                    }
                                });
                            ...
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    ...
                                    case 9:
                                        ...
                                        return [2 /*return*/, exports.samplerOperations.getBancorBuyQuotes(takerToken, makerToken, makerFillAmounts, bancorService)];
