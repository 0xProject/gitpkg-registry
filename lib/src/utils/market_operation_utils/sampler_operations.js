...
exports.samplerOperations = {
    ...
    getLiquidityProviderSellQuotes: function (liquidityProviderRegistryAddress, takerToken, makerToken, takerFillAmounts) {
        var _this = this;
        return {
            encodeCall: function (contract) {
                return contract
    ...
    getLiquidityProviderBuyQuotes: function (liquidityProviderRegistryAddress, takerToken, makerToken, makerFillAmounts) {
        var _this = this;
        return {
            encodeCall: function (contract) {
                return contract
    ...
    getSellQuotes: function (sources, makerToken, takerToken, takerFillAmounts, liquidityProviderRegistryAddress) {
        ...
        var subOps = sources
            ...
            if (source === __1.ERC20BridgeSource.Eth2Dai) {
            ...
            else if (source === __1.ERC20BridgeSource.CurveUsdcDai ||
                source === __1.ERC20BridgeSource.CurveUsdcDaiUsdt ||
                source === __1.ERC20BridgeSource.CurveUsdcDaiUsdtTusd) {
                ...
                batchedOperation = exports.samplerOperations.getLiquidityProviderSellQuotes(liquidityProviderRegistryAddress, takerToken, makerToken, takerFillAmounts);
            }
            else {
    ...
    getBuyQuotes: function (sources, makerToken, takerToken, makerFillAmounts, liquidityProviderRegistryAddress) {
        ...
        var subOps = sources.map(function (source) {
            if (source === __1.ERC20BridgeSource.Eth2Dai) {
                ...
                return exports.samplerOperations.getLiquidityProviderBuyQuotes(liquidityProviderRegistryAddress, takerToken, makerToken, makerFillAmounts);
            }
            else {
