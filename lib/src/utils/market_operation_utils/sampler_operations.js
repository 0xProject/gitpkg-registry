...
exports.samplerOperations = {
    ...
    getSellQuotes: function (sources, makerToken, takerToken, takerFillAmounts, liquidityProviderRegistryAddress) {
        ...
        var subOps = sources
            ...
            else if (Object.keys(constants_1.DEFAULT_CURVE_OPTS).includes(source)) {
                var _a = constants_1.DEFAULT_CURVE_OPTS[source], curveAddress = _a.curveAddress, tokens = _a.tokens;
