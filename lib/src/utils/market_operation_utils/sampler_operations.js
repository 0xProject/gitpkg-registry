...
class SamplerOperations {
    ...
    getKyberSellQuotes(reserveOffset, makerToken, takerToken, takerFillAmounts) {
        return new sampler_contract_operation_1.SamplerContractOperation({
            ...
            callback: (callResults, fillData) => {
                ...
                return kyber_utils_1.isAllowedKyberReserveId(reserveId) ? samples : [];
            },
        });
    }
    ...
    getUniswapV2SellQuotes(tokenAddressPath, takerFillAmounts) {
        return new sampler_contract_operation_1.SamplerContractOperation({
            ...
            fillData: { tokenAddressPath, router: constants_1.MAINNET_UNISWAP_V2_ROUTER },
            contract: this._samplerContract,
            function: this._samplerContract.sampleSellsFromUniswapV2,
            params: [constants_1.MAINNET_UNISWAP_V2_ROUTER, tokenAddressPath, takerFillAmounts],
        });
    }
    getUniswapV2BuyQuotes(tokenAddressPath, makerFillAmounts) {
        return new sampler_contract_operation_1.SamplerContractOperation({
            ...
            params: [constants_1.MAINNET_UNISWAP_V2_ROUTER, tokenAddressPath, makerFillAmounts],
        });
    }
        ...
        return _.flatten(_sources.map((source) => {
            switch (source) {
                ...
                case types_1.ERC20BridgeSource.Kyber:
                    return kyber_utils_1.getKyberOffsets().map(offset => this.getKyberSellQuotes(offset, makerToken, takerToken, takerFillAmounts));
        ...
        return _.flatten(_sources.map((source) => {
            switch (source) {
                ...
                case types_1.ERC20BridgeSource.CryptoCom:
                    ...
                    return cryptoComOps;
                case types_1.ERC20BridgeSource.Kyber:
                    return kyber_utils_1.getKyberOffsets().map(offset => this.getKyberBuyQuotes(offset, makerToken, takerToken, makerFillAmounts));
                case types_1.ERC20BridgeSource.Curve:
