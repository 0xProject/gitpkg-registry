...
class SamplerOperations {
    constructor(chainId, _samplerContract, poolsCaches, tokenAdjacencyGraph = { default: [] }, liquidityProviderRegistry = {}, bancorServiceFn = () => __awaiter(this, void 0, void 0, function* () { return undefined; })) {
        ...
        this.poolsCaches = poolsCaches
            ...
            : {
                ...
                [types_1.ERC20BridgeSource.BalancerV2]: new balancer_v2_utils_new_1.BalancerV2SwapInfoCache(chainId),
            };
    ...
    getKyberSellQuotes(kyberOpts, reserveOffset, makerToken, takerToken, takerFillAmounts) {
        return new sampler_contract_operation_1.SamplerContractOperation({
            ...
            callback: (callResults, fillData) => {
                ...
                return (0, bridge_source_utils_1.isAllowedKyberReserveId)(reserveId) ? samples : [];
            },
        });
    }
    ...
    getBalancerV2MulthopSellQuotes(vault, quoteSwaps, // Should always be sell swap steps.
    ...
    getBalancerV2MulthopBuyQuotes(vault, quoteSwaps, // Should always be buy swap steps.
        ...
        const allOps = _.flatten(_sources.map((source) => {
            ...
            switch (source) {
                ...
                case types_1.ERC20BridgeSource.Kyber:
                    return (0, bridge_source_utils_1.getKyberOffsets)().map(offset => this.getKyberSellQuotes(constants_1.KYBER_CONFIG_BY_CHAIN_ID[this.chainId], offset, makerToken, takerToken, takerFillAmounts));
                ...
                case types_1.ERC20BridgeSource.BalancerV2: {
                    ...
                    return swaps.swapInfoExactIn.map(swapInfo => this.getBalancerV2MulthopSellQuotes(vault, swapInfo, swapInfo, takerFillAmounts, source));
                }
                ...
                case types_1.ERC20BridgeSource.Linkswap:
                    if (!(0, bridge_source_utils_1.isValidAddress)(constants_1.LINKSWAP_ROUTER_BY_CHAIN_ID[this.chainId])) {
                        return [];
                    }
                    return [
                        [takerToken, makerToken],
                        ...(0, multihop_utils_1.getIntermediateTokens)(makerToken, takerToken, {
    ...
    _getBuyQuoteOperations(sources, makerToken, takerToken, makerFillAmounts) {
        ...
        return _.flatten(_sources.map((source) => {
            switch (source) {
                ...
                case types_1.ERC20BridgeSource.Kyber:
                    return (0, bridge_source_utils_1.getKyberOffsets)().map(offset => this.getKyberBuyQuotes(constants_1.KYBER_CONFIG_BY_CHAIN_ID[this.chainId], offset, makerToken, takerToken, makerFillAmounts));
                case types_1.ERC20BridgeSource.Curve:
                case types_1.ERC20BridgeSource.CurveV2:
                case types_1.ERC20BridgeSource.Swerve:
                case types_1.ERC20BridgeSource.SnowSwap:
                ...
                case types_1.ERC20BridgeSource.BalancerV2: {
                    ...
                    // Changed to retrieve queryBatchSwap for swap steps > 1 of length
                    return swaps.swapInfoExactOut.map((quoteSwapInfo, i) => this.getBalancerV2MulthopBuyQuotes(vault, quoteSwapInfo, swaps.swapInfoExactIn[i], makerFillAmounts, source));
                }
                case types_1.ERC20BridgeSource.Beethovenx: {
                    const poolIds = this.poolsCaches[source].getCachedPoolAddressesForPair(takerToken, makerToken) || [];
                    const vault = constants_1.BEETHOVEN_X_VAULT_ADDRESS_BY_CHAIN[this.chainId];
