...
exports.samplerOperations = void 0;
...
exports.samplerOperations = {
    getOrderFillableTakerAmounts: function (orders, devUtilsAddress) {
        var _this = this;
        return {
            encodeCall: function (contract) {
                return contract
                    .getOrderFillableTakerAssetAmounts(orders, orders.map(function (o) { return o.signature; }), devUtilsAddress)
    ...
    getOrderFillableMakerAmounts: function (orders, devUtilsAddress) {
        var _this = this;
        return {
            encodeCall: function (contract) {
                return contract
                    .getOrderFillableMakerAssetAmounts(orders, orders.map(function (o) { return o.signature; }), devUtilsAddress)
                    .getABIEncodedTransactionData();
            },
            handleCallResultsAsync: function (contract, callResults) { return __awaiter(_this, void 0, void 0, function () {
                return __generator(this, function (_a) {
    ...
    getKyberBuyQuotes: function (makerToken, takerToken, makerFillAmounts, fakeBuyOpts) {
        var _this = this;
        if (fakeBuyOpts === void 0) { fakeBuyOpts = constants_1.DEFAULT_FAKE_BUY_OPTS; }
        return {
            source: __1.ERC20BridgeSource.Kyber,
            encodeCall: function (contract) {
                return contract
    ...
    getLiquidityProviderBuyQuotes: function (registryAddress, makerToken, takerToken, makerFillAmounts, fakeBuyOpts) {
        var _this = this;
        if (fakeBuyOpts === void 0) { fakeBuyOpts = constants_1.DEFAULT_FAKE_BUY_OPTS; }
        return {
            source: __1.ERC20BridgeSource.LiquidityProvider,
            encodeCall: function (contract) {
                return contract
                    .sampleBuysFromLiquidityProviderRegistry(registryAddress, takerToken, makerToken, makerFillAmounts, fakeBuyOpts)
                    .getABIEncodedTransactionData();
            },
            handleCallResultsAsync: function (contract, callResults) { return __awaiter(_this, void 0, void 0, function () {
                return __generator(this, function (_a) {
    ...
    getCurveBuyQuotes: function (curveAddress, fromTokenIdx, toTokenIdx, makerFillAmounts) {
        var _this = this;
        return {
            source: __1.ERC20BridgeSource.Curve,
            fillData: {
            ...
            encodeCall: function (contract) {
                return contract
                    .sampleBuysFromCurve(curveAddress, new __1.BigNumber(fromTokenIdx), new __1.BigNumber(toTokenIdx), makerFillAmounts)
                    .getABIEncodedTransactionData();
            },
            handleCallResultsAsync: function (contract, callResults) { return __awaiter(_this, void 0, void 0, function () {
                return __generator(this, function (_a) {
    ...
    getMedianSellRateAsync: function (sources, makerToken, takerToken, takerFillAmount, wethAddress, balancerPoolsCache, liquidityProviderRegistryAddress, multiBridgeAddress) { return __awaiter(void 0, void 0, void 0, function () {
        var getSellQuotes;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 1:
                    ...
                    return [2 /*return*/, {
                            ...
                            handleCallResultsAsync: function (contract, callResults) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    getSellQuotesAsync: function (sources, makerToken, takerToken, takerFillAmounts, wethAddress, balancerPoolsCache, liquidityProviderRegistryAddress, multiBridgeAddress) { return __awaiter(void 0, void 0, void 0, function () {
        var subOps, _a, _b, samplerOps, nonSamplerOps;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    _b = (_a = _).flatten;
                    return [4 /*yield*/, Promise.all(sources.map(function (source) { return __awaiter(void 0, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    ...
                                    case 5: return [2 /*return*/, curve_utils_1.getCurveAddressesForPair(takerToken, makerToken).map(function (curveAddress) {
                                            return exports.samplerOperations.getCurveSellQuotes(curveAddress, constants_1.MAINNET_CURVE_CONTRACTS[curveAddress].indexOf(takerToken), constants_1.MAINNET_CURVE_CONTRACTS[curveAddress].indexOf(makerToken), takerFillAmounts);
                                        })];
                                    case 6:
                                    ...
                                    case 10: throw new Error("Unsupported sell sample source: " + source);
                                }
                            });
                        }); }))];
                case 1:
                            ...
                            handleCallResultsAsync: function (contract, callResults) { return __awaiter(void 0, void 0, void 0, function () {
                                ...
                                return __generator(this, function (_c) {
                                    switch (_c.label) {
                                        case 0:
                                            rawSubCallResults = contract.getABIDecodedReturnData('batchCall', callResults);
                                            return [4 /*yield*/, Promise.all(samplerOps.map(function (op, i) { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
                                                    return [2 /*return*/, op.handleCallResultsAsync(contract, rawSubCallResults[i])];
                                                }); }); }))];
                                        case 1:
                                            samples = _c.sent();
                                            _b = (_a = samples).concat;
                                            return [4 /*yield*/, Promise.all(nonSamplerOps.map(function (op) { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
    ...
    getBuyQuotesAsync: function (sources, makerToken, takerToken, makerFillAmounts, wethAddress, balancerPoolsCache, liquidityProviderRegistryAddress, fakeBuyOpts) {
        if (fakeBuyOpts === void 0) { fakeBuyOpts = constants_1.DEFAULT_FAKE_BUY_OPTS; }
                                ...
                                return __generator(this, function (_b) {
                                    switch (_b.label) {
                                        ...
                                        case 3:
                                            ...
                                            return [2 /*return*/, ops];
                                        case 4: return [2 /*return*/, exports.samplerOperations.getKyberBuyQuotes(makerToken, takerToken, makerFillAmounts, fakeBuyOpts)];
                                        case 5: return [2 /*return*/, curve_utils_1.getCurveAddressesForPair(takerToken, makerToken).map(function (curveAddress) {
                                                return exports.samplerOperations.getCurveBuyQuotes(curveAddress, constants_1.MAINNET_CURVE_CONTRACTS[curveAddress].indexOf(takerToken), constants_1.MAINNET_CURVE_CONTRACTS[curveAddress].indexOf(makerToken), makerFillAmounts);
                                            })];
                                        case 6:
                                            if (liquidityProviderRegistryAddress === undefined) {
                                                throw new Error('Cannot sample liquidity from a LiquidityProvider liquidity pool, if a registry is not provided.');
                                            }
                                            return [2 /*return*/, exports.samplerOperations.getLiquidityProviderBuyQuotes(liquidityProviderRegistryAddress, makerToken, takerToken, makerFillAmounts, fakeBuyOpts)];
                                        case 7:
                                            if (balancerPoolsCache === undefined) {
                                                throw new Error('Cannot sample liquidity from Balancer if a cache is not provided.');
                                            }
                                        ...
                                        case 9: throw new Error("Unsupported buy sample source: " + source);
                                    }
                                });
                            }); }))];
                    case 1:
