...
exports.samplerOperations = {
    ...
    getLiquidityProviderBuyQuotes: function (liquidityProviderRegistryAddress, makerToken, takerToken, makerFillAmounts, fakeBuyOpts) {
        var _this = this;
        if (fakeBuyOpts === void 0) { fakeBuyOpts = constants_1.DEFAULT_FAKE_BUY_OPTS; }
        return {
            encodeCall: function (contract) {
                return contract
                    .sampleBuysFromLiquidityProviderRegistry(liquidityProviderRegistryAddress, takerToken, makerToken, makerFillAmounts, fakeBuyOpts)
                    .getABIEncodedTransactionData();
            },
            handleCallResultsAsync: function (contract, callResults) { return __awaiter(_this, void 0, void 0, function () {
                return __generator(this, function (_a) {
    ...
    getMedianSellRate: function (sources, makerToken, takerToken, takerFillAmount, wethAddress, liquidityProviderRegistryAddress) {
        var _this = this;
        if (makerToken.toLowerCase() === takerToken.toLowerCase()) {
            return exports.samplerOperations.constant(new __1.BigNumber(1));
        }
        var getSellQuotes = exports.samplerOperations.getSellQuotes(sources, makerToken, takerToken, [takerFillAmount], wethAddress, liquidityProviderRegistryAddress);
        return {
            encodeCall: function (contract) {
    ...
    getSellQuotes: function (sources, makerToken, takerToken, takerFillAmounts, wethAddress, liquidityProviderRegistryAddress) {
        var _this = this;
        var subOps = sources
            .map(function (source) {
