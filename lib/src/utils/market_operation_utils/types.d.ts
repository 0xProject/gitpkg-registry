...
export declare type SourcesWithPoolsCache = ERC20BridgeSource.Balancer | ERC20BridgeSource.BalancerV2 | ERC20BridgeSource.Beethovenx | ERC20BridgeSource.Cream;
/**
...
export declare enum CurveFunctionSelectors {
    ...
    get_dy = "0x5e0d443f",
    get_dx = "0x67df02ca",
    get_dy_uint256 = "0x556d6e9f",
    exchange_underlying_uint256 = "0x65b2489b",
...
export declare type MakerPsmFillData = FillData & MakerPsmExtendedData & PsmInfo;
 ...
 */
export declare function isFinalUniswapV3FillData(data: UniswapV3FillData | FinalUniswapV3FillData): data is FinalUniswapV3FillData;
...
export interface OptimizedMarketOrderBase<TFillData extends FillData = FillData> {
    ...
    fill: Omit<Fill, 'flags' | 'fillData' | 'sourcePathId' | 'source' | 'type'>;
}
...
export declare type FeeEstimate = (fillData: FillData) => {
    gas: number;
    fee: BigNumber;
};
...
export declare type GasEstimate = (fillData: FillData) => number;
export declare type GasSchedule = Partial<{
    [key in ERC20BridgeSource]: GasEstimate;
}>;
export declare type ExchangeProxyOverhead = (sourceFlags: bigint) => BigNumber;
/**
