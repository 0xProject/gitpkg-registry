...
export interface SourceQuoteOperation<TFillData extends FillData = FillData> extends BatchedOperation<BigNumber[]>, SourceInfo<TFillData> {
...
export declare class SamplerContractOperation<TParams extends any[], TReturn, TFillData extends FillData = FillData> implements SourceQuoteOperation<TFillData> {
    readonly source: ERC20BridgeSource;
    fillData: TFillData;
    ...
    encodeCall(): string;
    handleCallResultsAsync(callResults: string): Promise<BigNumber[]>;
}
