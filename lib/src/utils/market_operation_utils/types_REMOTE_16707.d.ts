...
export interface SourceQuoteOperation<TFillData extends FillData = FillData> extends BatchedOperation<Array<Quote<TFillData>>> {
    source: ERC20BridgeSource;
}
...
//# sourceMappingURL=types_REMOTE_16707.d.ts.map