...
class MarketOperationUtils {
    ...
    getMarketSellLiquidityAsync(nativeOrders, takerAmount, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this._sampler.getMedianSellRate(utils_2.difference(constants_1.FEE_QUOTE_SOURCES, _opts.excludedSources), makerToken, this._wethAddress, constants_1.ONE_ETHER, this._wethAddress, this._liquidityProviderRegistry, this._multiBridge), 
            // Get ETH -> taker token price.
            this._sampler.getMedianSellRate(utils_2.difference(constants_1.FEE_QUOTE_SOURCES, _opts.excludedSources), takerToken, this._wethAddress, constants_1.ONE_ETHER, this._wethAddress, this._liquidityProviderRegistry, this._multiBridge), 
    ...
    getMarketBuyLiquidityAsync(nativeOrders, makerAmount, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const offChainBalancerPromise = sampleBalancerOffChain
                ...
                : Promise.resolve([]);
            const balancerPromise = _opts.excludedSources.includes(types_2.ERC20BridgeSource.Balancer)
                ? Promise.resolve([])
...
//# sourceMappingURL=index_BACKUP_60899.js.map