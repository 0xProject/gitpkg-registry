...
import { CurveInfo, ERC20BridgeSource, FeeSchedule, GasSchedule, GetMarketOrdersOpts, LidoInfo, LiquidityProviderRegistry, PlatypusInfo, PsmInfo, TokenAdjacencyGraph } from './types';
...
export declare const MDEX_ROUTER_BY_CHAIN_ID: {
    1: string;
    3: string;
    4: string;
    42: string;
...
export declare const KNIGHTSWAP_ROUTER_BY_CHAIN_ID: {
    1: string;
    3: string;
    4: string;
    42: string;
...
export declare const BANCORV3_NETWORK_BY_CHAIN_ID: {
    1: string;
    3: string;
    4: string;
    42: string;
...
export declare const BANCORV3_NETWORK_INFO_BY_CHAIN_ID: {
    1: string;
    3: string;
    4: string;
    42: string;
...
export declare const MESHSWAP_ROUTER_BY_CHAIN_ID: {
    1: string;
    3: string;
    4: string;
    42: string;
...
export declare const VELODROME_ROUTER_BY_CHAIN_ID: {
    1: string;
    3: string;
    4: string;
    42: string;
 ...
 */
export declare const DEFAULT_GAS_SCHEDULE: Required<GasSchedule>;
...
export declare const DEFAULT_FEE_ESTIMATE: {
    gas: number;
    fee: BigNumber;
};
