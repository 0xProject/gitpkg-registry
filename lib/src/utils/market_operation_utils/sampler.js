...
class DexOrderSampler extends sampler_operations_1.SamplerOperations {
    constructor(_samplerContract, _samplerOverrides, bancorService, balancerPoolsCache) {
    ...
    executeBatchAsync(ops) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (callDatas.every(cd => cd === utils_1.NULL_BYTES)) {
                return Promise.all(callDatas.map((_callData, i) => __awaiter(this, void 0, void 0, function* () { return ops[i].handleCallResultsAsync(utils_1.NULL_BYTES); })));
            }
            ...
            return Promise.all(callDatas.map((callData, i) => __awaiter(this, void 0, void 0, function* () {
