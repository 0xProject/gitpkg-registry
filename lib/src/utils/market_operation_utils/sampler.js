...
class DexOrderSampler extends sampler_operations_1.SamplerOperations {
    constructor(_samplerContract, _samplerOverrides, balancerPoolsCache, creamPoolsCache, tokenAdjacencyGraph, liquidityProviderRegistry, bancorServiceFn = () => __awaiter(this, void 0, void 0, function* () { return undefined; })) {
        super(_samplerContract, balancerPoolsCache, creamPoolsCache, tokenAdjacencyGraph, liquidityProviderRegistry, bancorServiceFn);
    ...
    executeBatchAsync(ops) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return callDatas.map((callData, i) => {
                const result = callData !== utils_1.NULL_BYTES ? rawCallResults[rawCallResultsIdx++] : utils_1.NULL_BYTES;
