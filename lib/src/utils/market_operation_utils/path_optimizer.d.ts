...
export declare function findOptimalRustPathFromSamples(side: MarketOperation, samples: DexSample[][], nativeOrders: NativeOrderWithFillableAmounts[], input: BigNumber, opts: PathPenaltyOpts, chainId: ChainId, neonRouterNumSamples: number, samplerMetrics?: SamplerMetrics): Path | undefined;
/**
