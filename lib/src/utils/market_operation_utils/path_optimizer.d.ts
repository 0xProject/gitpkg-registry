...
import { DexSample, FeeSchedule, Fill, SamplerMetrics } from './types';
export declare function findOptimalRustPathFromSamples(side: MarketOperation, inputToken: string, outputToken: string, samples: DexSample[][], nativeOrders: NativeOrderWithFillableAmounts[], input: BigNumber, opts: PathPenaltyOpts, fees: FeeSchedule, chainId: ChainId, neonRouterNumSamples: number, samplerMetrics?: SamplerMetrics): Path | undefined;
/**
