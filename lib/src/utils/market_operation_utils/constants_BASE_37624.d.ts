...
export declare const CHAIN_ID: ChainId;
/**
...
export declare const NATIVE_FEE_TOKEN: string;
...
export declare const NATIVE_FEE_TOKEN_AMOUNT: BigNumber;
/**
...
export declare const UNISWAPV1_ROUTER: string;
...
export declare const UNISWAPV2_ROUTER: string;
...
export declare const SUSHISWAP_ROUTER: string;
...
export declare const CRYPTO_COM_ROUTER: string;
...
export declare const LINKSWAP_ROUTER: string;
...
export declare const MSTABLE_ROUTER: string;
...
export declare const OASIS_ROUTER: string;
...
export declare const MOONISWAP_REGISTRIES: string[];
...
export declare const DODOV2_FACTORIES: string[];
...
export declare const CURVE_LIQUIDITY_PROVIDER: string;
...
export declare const MOONISWAP_LIQUIDITY_PROVIDER: string;
...
export declare const SHELL_POOLS: {
    StableCoins: {
        poolAddress: string;
        tokens: string[];
    };
...
export declare const PANCAKESWAP_ROUTER: string;
...
export declare const BAKERYSWAP_ROUTER: string;
/**
...
//# sourceMappingURL=constants_BASE_37624.d.ts.map