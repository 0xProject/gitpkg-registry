...
function createNativeOrder(fill) {
    ...
    return fill.type === protocol_utils_1.FillQuoteTransformerOrderType.Rfq
        ? Object.assign({}, base, { type: protocol_utils_1.FillQuoteTransformerOrderType.Rfq, fillData: fillData }) : Object.assign({}, base, { type: protocol_utils_1.FillQuoteTransformerOrderType.Limit, fillData: fillData });
