...
function getErc20BridgeSourceToBridgeSource(source) {
    switch (source) {
        ...
        case types_2.ERC20BridgeSource.Geist:
            return protocol_utils_1.encodeBridgeSourceId(protocol_utils_1.BridgeProtocol.AaveV2, 'Geist');
        case types_2.ERC20BridgeSource.MobiusMoney:
            return protocol_utils_1.encodeBridgeSourceId(protocol_utils_1.BridgeProtocol.Nerve, 'MobiusMoney');
        default:
