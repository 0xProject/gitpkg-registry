...
function convertNativeOrderToFullyFillableOptimizedOrders(order, fill) {
    return {
...
function convertNativeRFQOrderToFullyFillableOptimizedOrders(order) {
    return {
...
exports.convertNativeRFQOrderToFullyFillableOptimizedOrders = convertNativeRFQOrderToFullyFillableOptimizedOrders;
...
function createBridgeDataForBridgeOrder(order) {
    ...
    switch (order.source) {
        ...
        case types_2.ERC20BridgeSource.Swerve:
        case types_2.ERC20BridgeSource.SnowSwap:
            const curveFillData = order.fillData; // tslint:disable-line:no-non-null-assertion
...
exports.BRIDGE_ENCODERS = {
    ...
    // Generic pools
    [types_2.ERC20BridgeSource.Shell]: poolEncoder,
    [types_2.ERC20BridgeSource.Mooniswap]: poolEncoder,
    [types_2.ERC20BridgeSource.Eth2Dai]: poolEncoder,
    [types_2.ERC20BridgeSource.MStable]: poolEncoder,
    [types_2.ERC20BridgeSource.Balancer]: poolEncoder,
    [types_2.ERC20BridgeSource.Cream]: poolEncoder,
    [types_2.ERC20BridgeSource.Uniswap]: poolEncoder,
};
function getBridgeTokenAmounts(fill, side) {
    return [
        // Maker asset amount.
...
function createNativeOrder(fill) {
    return convertNativeOrderToFullyFillableOptimizedOrders(fill.fillData, fill); // TODO (xianny): handle RFQ, fix fill data
}
