...
function createOrdersFromTwoHopSample(sample, opts) {
    ...
    const firstHopFill = {
        ...
        gasUsed: constants_1.ZERO_AMOUNT,
    };
    const secondHopFill = {
        sourcePathId: '',
...
function createNativeOptimizedOrder(fill, side) {
    ...
    return fill.type === protocol_utils_1.FillQuoteTransformerOrderType.Rfq
        ? Object.assign(Object.assign({}, base), { type: protocol_utils_1.FillQuoteTransformerOrderType.Rfq, fillData: fillData, gasUsed: constants_1.NATIVE_RFQT_GAS_USED }) : Object.assign(Object.assign({}, base), { type: protocol_utils_1.FillQuoteTransformerOrderType.Limit, fillData: fillData, gasUsed: constants_1.NATIVE_LIMIT_ORDER_GAS_USED });
}
