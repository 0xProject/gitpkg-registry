...
exports.createSignedOrdersFromRfqtIndicativeQuotes = exports.createOrdersFromPath = exports.createSignedOrdersWithFillableAmounts = exports.convertNativeOrderToFullyFillableOptimizedOrders = exports.getNativeOrderTokens = exports.createDummyOrderForSampler = void 0;
...
function convertNativeOrderToFullyFillableOptimizedOrders(order) {
    return __assign(__assign({}, order), { fillableMakerAssetAmount: order.makerAssetAmount, fillableTakerAssetAmount: order.takerAssetAmount, fillableTakerFeeAmount: order.takerFee, fills: [] });
}
...
function createSignedOrdersWithFillableAmounts(side, orders, fillableAmounts) {
    return orders
        ...
        return __assign(__assign({}, order), { fillableMakerAssetAmount: fillableMakerAssetAmount,
