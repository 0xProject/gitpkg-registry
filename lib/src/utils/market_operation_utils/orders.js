...
function getErc20BridgeSourceToBridgeSource(source) {
    switch (source) {
        ...
        case types_2.ERC20BridgeSource.KyberDmm:
            return protocol_utils_1.encodeBridgeSourceId(protocol_utils_1.BridgeProtocol.UniswapV2, 'KyberDmm');
...
const balancerV2Encoder = utils_1.AbiEncoder.create([{ name: 'vault', type: 'address' }, { name: 'poolId', type: 'bytes32' }]);
...
exports.BRIDGE_ENCODERS = {
    ...
    [types_2.ERC20BridgeSource.KyberDmm]: routerAddressPathEncoder,
    // BSC
