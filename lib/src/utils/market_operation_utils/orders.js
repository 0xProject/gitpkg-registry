...
function createBridgeOrder(fill, opts) {
    ...
    switch (fill.source) {
        ...
        case types_2.ERC20BridgeSource.CurveUsdcDaiUsdtSusd:
            ...
            break;
        case types_2.ERC20BridgeSource.UniswapV2:
            makerAssetData = order_utils_1.assetDataUtils.encodeERC20BridgeAssetData(makerToken, bridgeAddress, createUniswapV2BridgeData([makerToken, takerToken]));
            break;
        case types_2.ERC20BridgeSource.UniswapV2Eth:
            ...
            makerAssetData = order_utils_1.assetDataUtils.encodeERC20BridgeAssetData(makerToken, bridgeAddress, createUniswapV2BridgeData([makerToken, opts.contractAddresses.etherToken, takerToken]));
            break;
        default:
