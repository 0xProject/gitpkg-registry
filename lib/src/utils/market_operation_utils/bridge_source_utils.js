...
exports.isBadTokenForSource = exports.uniswapV2LikeRouterAddress = exports.getCurveLikeInfosForPair = exports.getShellLikeInfosForPair = exports.getMobiusMoneyInfoForPair = exports.getAcryptosInfosForPair = exports.getXSigmaInfosForPair = exports.getIronSwapInfosForPair = exports.getSaddleInfosForPair = exports.getSmoothyInfosForPair = exports.getEllipsisInfosForPair = exports.getBeltInfosForPair = exports.getFirebirdOneSwapInfosForPair = exports.getSynapseInfosForPair = exports.getNerveInfosForPair = exports.getSnowSwapInfosForPair = exports.getSwerveInfosForPair = exports.getCurveV2InfosForPair = exports.getCurveInfosForPair = exports.getMStableForPair = exports.getComponentForPair = exports.getShellsForPair = exports.getDodoV2Offsets = exports.getKyberOffsets = exports.isValidAddress = exports.isAllowedKyberReserveId = void 0;
...
function getCurveInfosForPair(chainId, takerToken, makerToken) {
    switch (chainId) {
        ...
        case contract_addresses_1.ChainId.Fantom:
            return Object.values(constants_1.CURVE_FANTOM_INFOS).filter(c => [makerToken, takerToken].every(t => (c.tokens.includes(t) && c.metaTokens === undefined) ||
                (c.tokens.includes(t) &&
                    [makerToken, takerToken].filter(v => { var _a; return (_a = c.metaTokens) === null || _a === void 0 ? void 0 : _a.includes(v); }).length > 0)));
        case contract_addresses_1.ChainId.Avalanche:
            return Object.values(constants_1.CURVE_AVALANCHE_INFOS).filter(c => [makerToken, takerToken].every(t => (c.tokens.includes(t) && c.metaTokens === undefined) ||
                (c.tokens.includes(t) &&
                    [makerToken, takerToken].filter(v => { var _a; return (_a = c.metaTokens) === null || _a === void 0 ? void 0 : _a.includes(v); }).length > 0)));
        case contract_addresses_1.ChainId.Optimism:
            return Object.values(constants_1.CURVE_OPTIMISM_INFOS).filter(c => [makerToken, takerToken].every(t => (c.tokens.includes(t) && c.metaTokens === undefined) ||
                (c.tokens.includes(t) &&
                    [makerToken, takerToken].filter(v => { var _a; return (_a = c.metaTokens) === null || _a === void 0 ? void 0 : _a.includes(v); }).length > 0)));
        default:
            return [];
        ...
        case contract_addresses_1.ChainId.Polygon:
            return Object.values(constants_1.CURVE_V2_POLYGON_INFOS).filter(c => [makerToken, takerToken].every(t => (c.tokens.includes(t) && c.metaTokens === undefined) ||
                (c.tokens.includes(t) &&
                    [makerToken, takerToken].filter(v => { var _a; return (_a = c.metaTokens) === null || _a === void 0 ? void 0 : _a.includes(v); }).length > 0)));
        case contract_addresses_1.ChainId.Fantom:
            return Object.values(constants_1.CURVE_V2_FANTOM_INFOS).filter(c => [makerToken, takerToken].every(t => (c.tokens.includes(t) && c.metaTokens === undefined) ||
                (c.tokens.includes(t) &&
                    [makerToken, takerToken].filter(v => { var _a; return (_a = c.metaTokens) === null || _a === void 0 ? void 0 : _a.includes(v); }).length > 0)));
        case contract_addresses_1.ChainId.Avalanche:
            return Object.values(constants_1.CURVE_V2_AVALANCHE_INFOS).filter(c => [makerToken, takerToken].every(t => (c.tokens.includes(t) && c.metaTokens === undefined) ||
                (c.tokens.includes(t) &&
                    [makerToken, takerToken].filter(v => { var _a; return (_a = c.metaTokens) === null || _a === void 0 ? void 0 : _a.includes(v); }).length > 0)));
        default:
            return [];
...
exports.getSynapseInfosForPair = getSynapseInfosForPair;
...
exports.getMobiusMoneyInfoForPair = getMobiusMoneyInfoForPair;
