...
function uniswapV2LikeRouterAddress(chainId, source) {
    switch (source) {
        ...
        case types_1.ERC20BridgeSource.WaultSwap:
            return constants_1.WAULT_ROUTER_BY_CHAIN_ID[chainId];
