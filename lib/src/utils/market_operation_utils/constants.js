...
exports.DEFAULT_GAS_SCHEDULE = {
    ...
    [types_1.ERC20BridgeSource.ApeSwap]: (fillData) => {
        // TODO: Different base cost if to/from ETH.
        let gas = 90e3;
        const path = fillData.tokenAddressPath;
        if (path.length > 2) {
    ...
    [types_1.ERC20BridgeSource.CafeSwap]: (fillData) => {
        // TODO: Different base cost if to/from ETH.
        let gas = 90e3;
        const path = fillData.tokenAddressPath;
        if (path.length > 2) {
    ...
    [types_1.ERC20BridgeSource.CheeseSwap]: (fillData) => {
        // TODO: Different base cost if to/from ETH.
        let gas = 90e3;
        const path = fillData.tokenAddressPath;
        if (path.length > 2) {
    ...
    [types_1.ERC20BridgeSource.JulSwap]: (fillData) => {
        // TODO: Different base cost if to/from ETH.
        let gas = 90e3;
        const path = fillData.tokenAddressPath;
        if (path.length > 2) {
