...
exports.KYBER_CONFIG_BY_CHAIN_ID = valueByChainId({
    ...
    [contract_addresses_1.ChainId.Ropsten]: {
        ...
        weth: (0, contract_addresses_1.getContractAddressesForChainOrThrow)(contract_addresses_1.ChainId.Ropsten).etherToken,
    },
}, {
