 ...
 */
function getComparisonPrices(adjustedRate, amount, marketSideLiquidity, feeSchedule) {
    let wholeOrder;
    let feeInEth;
    ...
    if (feeSchedule[types_2.ERC20BridgeSource.Native] === undefined) {
        ...
        try {
            feeInEth = new utils_1.BigNumber(feeSchedule[types_2.ERC20BridgeSource.Native]({ type: protocol_utils_1.FillQuoteTransformerOrderType.Rfq }));
        }
        catch (_a) {
