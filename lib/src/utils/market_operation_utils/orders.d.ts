import { BridgeSource, LimitOrder, RfqOrder } from '@0x/protocol-utils';
...
export declare function createNativeOrder(fill: NativeCollapsedFill): OptimizedMarketOrderBase<NativeLimitOrderFillData> | OptimizedMarketOrderBase<NativeRfqOrderFillData>;
