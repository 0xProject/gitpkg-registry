    ...
    getKyberSellQuotes(reserveId, makerToken, takerToken, takerFillAmounts) {
        return new sampler_contract_operation_1.SamplerContractOperation({
            ...
            callback: (callResults, fillData) => {
                ...
                console.log({ hint, samples, reserveId });
                fillData.hint = hint;
        ...
        return _.flatten(sources.map((source) => {
            switch (source) {
                ...
                case types_1.ERC20BridgeSource.Kyber:
                    return Object.values(constants_1.MAINNET_KYBER_INFOS).map(reserveId => this.getKyberSellQuotes(reserveId, makerToken, takerToken, takerFillAmounts));
        ...
        return _.flatten(sources.map((source) => {
            switch (source) {
                ...
                case types_1.ERC20BridgeSource.UniswapV2:
                    ...
                    return ops;
                case types_1.ERC20BridgeSource.Kyber:
                    return Object.values(constants_1.MAINNET_KYBER_INFOS).map(reserveId => this.getKyberBuyQuotes(reserveId, makerToken, takerToken, makerFillAmounts));
                case types_1.ERC20BridgeSource.Curve:
...
//# sourceMappingURL=sampler_operations_BASE_62941.js.map