...
class Path {
    ...
    bestRate() {
        ...
        return rate_utils_1.getRate(this.side, this._bestFill.input, this._bestFill.output);
    }
    ...
    _addFillSize(fill) {
        ...
        if (this._bestFill === undefined ||
            rate_utils_1.getRate(this.side, this._bestFill.input, this._bestFill.output).isLessThan(rate_utils_1.getRate(this.side, fill.input, fill.output))) {
            this._bestFill = fill;
        }
    }
}
