...
var MarketOperationUtils = /** @class */ (function () {
                ...
                switch (_b.label) {
                    ...
                    case 3:
                        ...
                        return [2 /*return*/, Promise.all(batchNativeOrders.map(function (nativeOrders, i) { return __awaiter(_this, void 0, void 0, function () {
                                var _a, makerToken, takerToken, orderFillableAmounts, ethToTakerAssetRate, dexQuotes, makerAmount, e_1;
                                return __generator(this, function (_b) {
                                    switch (_b.label) {
                                        case 0:
                                            if (nativeOrders.length === 0) {
                                        ...
                                        case 2: return [2 /*return*/, (_b.sent()).optimizedOrders];
                                        case 3:
                                            e_1 = _b.sent();
    ...
    MarketOperationUtils.prototype.getMarketDepthAsync = function (sellOrders, buyOrders, sellAmount, opts) {
        return __awaiter(this, void 0, void 0, function () {
            var _opts, _a, makerToken, takerToken, sampleAmounts, sellSamplerPromise, _b, _c, _d, buySamplerPromise, _e, _f, _g, balancerSellPromise, balancerBuyPromise, _h, _j, sellOrderFillableAmounts, dexSellQuotes, _k, buyOrderFillableAmounts, dexBuyQuotes, _l, balancerSellQuotes, _m, balancerBuyQuotes, getMarketDepthSide;
            var _this = this;
            return __generator(this, function (_o) {
                switch (_o.label) {
                    case 0:
                        ...
                        sampleAmounts = sampler_1.getSampleAmounts(sellAmount, _opts.numSamples, _opts.sampleDistributionBase);
                        _c = (_b = this._sampler).executeAsync;
                        _d = [
                            // Get native order fillable amounts.
                        ...
                        return [4 /*yield*/, sampler_1.DexOrderSampler.ops.getSellQuotesAsync(utils_2.difference(constants_1.SELL_SOURCES.concat(this._optionalSources()), _opts.excludedSources.concat(types_2.ERC20BridgeSource.Balancer)), makerToken, takerToken, sampleAmounts, this._wethAddress, this._sampler.balancerPoolsCache, this._liquidityProviderRegistry, this._multiBridge)];
                    case 1:
                        sellSamplerPromise = _c.apply(_b, _d.concat([_o.sent()]));
                        _f = (_e = this._sampler).executeAsync;
                        _g = [
                            // Get native order fillable amounts.
                            sampler_1.DexOrderSampler.ops.getOrderFillableTakerAmounts(buyOrders, this.contractAddresses.devUtils)];
                        return [4 /*yield*/, sampler_1.DexOrderSampler.ops.getBuyQuotesAsync(utils_2.difference(constants_1.BUY_SOURCES.concat(this._optionalSources()), _opts.excludedSources.concat(types_2.ERC20BridgeSource.Balancer)), takerToken, makerToken, sampleAmounts, this._wethAddress, this._sampler.balancerPoolsCache, this._liquidityProviderRegistry)];
                    case 2:
                        buySamplerPromise = _f.apply(_e, _g.concat([_o.sent()]));
                        balancerSellPromise = sampler_1.DexOrderSampler.ops
                            .getSellQuotesAsync(utils_2.difference([types_2.ERC20BridgeSource.Balancer], _opts.excludedSources), makerToken, takerToken, sampleAmounts, this._wethAddress, this._sampler.balancerPoolsCache, this._liquidityProviderRegistry, this._multiBridge)
                            .then(function (result) { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                            return [2 /*return*/, this._sampler.executeAsync(result)];
                        }); }); });
                        balancerBuyPromise = sampler_1.DexOrderSampler.ops
                            .getBuyQuotesAsync(utils_2.difference([types_2.ERC20BridgeSource.Balancer], _opts.excludedSources), takerToken, makerToken, sampleAmounts, this._wethAddress, this._sampler.balancerPoolsCache, this._liquidityProviderRegistry)
                            .then(function (result) { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                            return [2 /*return*/, this._sampler.executeAsync(result)];
                        }); }); });
                        return [4 /*yield*/, Promise.all([sellSamplerPromise, buySamplerPromise, balancerSellPromise, balancerBuyPromise])];
                    case 3:
                        _h = __read.apply(void 0, [_o.sent(), 4]), _j = __read(_h[0], 2), sellOrderFillableAmounts = _j[0], dexSellQuotes = _j[1], _k = __read(_h[1], 2), buyOrderFillableAmounts = _k[0], dexBuyQuotes = _k[1], _l = __read(_h[2], 1), balancerSellQuotes = _l[0], _m = __read(_h[3], 1), balancerBuyQuotes = _m[0];
                        getMarketDepthSide = function (dexQuotes, nativeOrders, orderFillableAmounts, side) {
                        ...
                        return [2 /*return*/, {
                                bids: getMarketDepthSide(__spread(dexBuyQuotes, balancerBuyQuotes), buyOrders, buyOrderFillableAmounts, types_1.MarketOperation.Buy),
                                asks: getMarketDepthSide(__spread(dexSellQuotes, balancerSellQuotes), sellOrders, sellOrderFillableAmounts, types_1.MarketOperation.Sell),
                            }];
                }
            });
        });
    ...
    MarketOperationUtils.prototype._generateOptimizedOrdersAsync = function (opts) {
        return __awaiter(this, void 0, void 0, function () {
            var inputToken, outputToken, side, inputAmount, maxFallbackSlippage, paths, optimalPath, nativeSubPath, nonNativePaths, nonNativeOptimalPath, fallbackSlippage, _a, last, penultimateIfExists, lastNativeFillIfExists_1, optimizedOrders, quoteReport;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                    ...
                    case 3:
                        ...
                        quoteReport = new quote_report_generator_1.QuoteReportGenerator(opts.side, _.flatten(opts.dexQuotes), opts.nativeOrders, opts.orderFillableAmounts, _.flatten(optimizedOrders.map(function (o) { return o.fills; })), opts.quoteRequestor).generateReport();
...
//# sourceMappingURL=index_LOCAL_67959.js.map