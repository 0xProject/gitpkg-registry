...
export declare class MarketOperationUtils {
    ...
    private readonly _contractCodeByAddress;
     ...
     * @return orders.
     */
    getBatchMarketBuyOrdersAsync(batchNativeOrders: SignedNativeOrder[][], makerAmounts: BigNumber[], gasPrice: BigNumber, opts: GetMarketOrdersOpts): Promise<Array<OptimizerResult | undefined>>;
     ...
     */
    getOptimizerResultAsync(nativeOrders: SignedNativeOrder[], amount: BigNumber, side: MarketOperation, opts: GetMarketOrdersOpts): Promise<OptimizerResultWithReport>;
    private _refreshPoolCacheIfRequiredAsync;
    private _fetchTokenOverridesAsync;
}
