...
import { GenerateOptimizedOrdersOpts, GetMarketOrdersOpts, MarketSideLiquidity, OptimizedMarketOrder, OptimizerResult, OptimizerResultWithReport, OrderDomain } from './types';
/**
...
export declare class MarketOperationUtils {
    ...
    constructor(_sampler: DexOrderSampler, contractAddresses: AssetSwapperContractAddresses, _orderDomain: OrderDomain, _liquidityProviderRegistry?: string);
    /**
