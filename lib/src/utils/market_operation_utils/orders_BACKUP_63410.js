...
function createBridgeOrder(fill, makerToken, takerToken, opts) {
    ...
    switch (fill.source) {
        ...
        case types_2.ERC20BridgeSource.SushiSwap:
            ...
            break;
        case types_2.ERC20BridgeSource.CryptoCom:
            const cryptoComFillData = fill.fillData; // tslint:disable-line:no-non-null-assertion
            makerAssetData = order_utils_1.assetDataUtils.encodeERC20BridgeAssetData(makerToken, bridgeAddress, createSushiSwapBridgeData(cryptoComFillData.tokenAddressPath, cryptoComFillData.router));
            break;
        case types_2.ERC20BridgeSource.Kyber:
        ...
        case types_2.ERC20BridgeSource.Dodo:
            ...
            break;
        case types_2.ERC20BridgeSource.Shell:
            const shellFillData = fill.fillData; // tslint:disable-line:no-non-null-assertion
            makerAssetData = order_utils_1.assetDataUtils.encodeERC20BridgeAssetData(makerToken, bridgeAddress, createShellBridgeData(takerToken, shellFillData.poolAddress));
            break;
        case types_2.ERC20BridgeSource.CoFiX:
            const cofixFillData = fill.fillData; // tslint:disable-line:no-non-null-assertion
            makerAssetData = order_utils_1.assetDataUtils.encodeERC20BridgeAssetData(makerToken, bridgeAddress, createCoFiXBridgeData(takerToken, cofixFillData.feeInWei, cofixFillData.poolAddress));
            break;
        default:
...
function createShellBridgeData(takerToken, poolAddress) {
    const encoder = utils_1.AbiEncoder.create([
        { name: 'takerToken', type: 'address' },
        { name: 'poolAddress', type: 'address' },
    ]);
...
function createCoFiXBridgeData(takerToken, fee, pool) {
    const encoder = utils_1.AbiEncoder.create([
        { name: 'takerToken', type: 'address' },
...
//# sourceMappingURL=orders_BACKUP_63410.js.map