...
import { LogFunction, MarketOperation, RfqtFirmQuoteValidator, RfqtMakerAssetOfferings, RfqtRequestOpts } from '../types';
...
export declare class QuoteRequestor {
    ...
    constructor(_rfqtAssetOfferings: RfqtMakerAssetOfferings, _warningLogger?: LogFunction, _infoLogger?: LogFunction, _expiryBufferMs?: number, _firmQuoteValidator?: RfqtFirmQuoteValidator | undefined);
