...
import { LogFunction, MarketOperation, RfqtFirmQuoteValidator, RfqtIndicativeQuoteObserver, RfqtMakerAssetOfferings, RfqtRequestOpts } from '../types';
...
export declare class QuoteRequestor {
    ...
    private readonly _indicativeQuoteHook?;
    ...
    constructor(_rfqtAssetOfferings: RfqtMakerAssetOfferings, _warningLogger?: LogFunction, _infoLogger?: LogFunction, _expiryBufferMs?: number, _firmQuoteValidator?: RfqtFirmQuoteValidator | undefined, _indicativeQuoteHook?: RfqtIndicativeQuoteObserver | undefined);
