...
import { Integrator, LogFunction, MarketOperation, RfqMakerAssetOfferings, RfqmRequestOptions, RfqRequestOpts, SignedRfqOrder, TypedMakerUrl } from '../types';
...
export declare class QuoteRequestor {
    ...
    assetFillAmount: BigNumber, marketOperation: MarketOperation, comparisonPrice: BigNumber | undefined, options: RfqmRequestOptions): Promise<SignedRfqOrder[]>;
    requestRfqtFirmQuotesAsync(makerToken: string, // maker token
    takerToken: string, // taker token
    assetFillAmount: BigNumber, marketOperation: MarketOperation, comparisonPrice: BigNumber | undefined, options: RfqRequestOpts): Promise<SignedRfqOrder[]>;
