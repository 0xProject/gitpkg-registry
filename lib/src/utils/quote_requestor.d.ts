...
import { LogFunction, MarketOperation, RfqtFirmQuoteValidator, RfqtIndicativeQuoteHook, RfqtMakerAssetOfferings, RfqtRequestOpts } from '../types';
...
export declare class QuoteRequestor {
    ...
    constructor(_rfqtAssetOfferings: RfqtMakerAssetOfferings, _warningLogger?: LogFunction, _infoLogger?: LogFunction, _expiryBufferMs?: number, _firmQuoteValidator?: RfqtFirmQuoteValidator | undefined, _indicativeQuoteHook?: RfqtIndicativeQuoteHook | undefined);
