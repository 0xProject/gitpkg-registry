            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        utils_1.logUtils.log(__filename + ": returning " + JSON.stringify(orders, null, '\t'));
                    ...
                    case 1:
                        ...
                        validResponsesWithStringInts = responsesWithStringInts.filter(function (response) {
                            ...
                            if (!hasExpectedAssetData(makerAssetData, takerAssetData, response.makerAssetData, response.takerAssetData)) {
                                utils_1.logUtils.warn("Unexpected asset data in RFQ-T indicative quote, filtering out: " + JSON.stringify(response));
                                return false;
                            }
                            return true;
                        });
