...
class QuoteRequestor {
    ...
    assetFillAmount, marketOperation, comparisonPrice, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // TODO jacob
            const validationFunction = (o) => true;
            ...
            const rfqQuotes = validQuotes.map(result => {
                const order = {
                    order: Object.assign({}, result.response, { makerAmount: new utils_1.BigNumber(result.response.makerAmount), takerAmount: new utils_1.BigNumber(result.response.takerAmount), expiry: new utils_1.BigNumber(result.response.expiry) }),
