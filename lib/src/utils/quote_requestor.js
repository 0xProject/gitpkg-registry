...
class QuoteRequestor {
    constructor(_rfqtAssetOfferings, _rfqmAssetOfferings, _quoteRequestorHttpClient, _altRfqCreds, _warningLogger = constants_1.constants.DEFAULT_WARNING_LOGGER, _infoLogger = constants_1.constants.DEFAULT_INFO_LOGGER, _expiryBufferMs = 120e3, _metrics) {
