...
var QuoteRequestor = /** @class */ (function () {
    function QuoteRequestor(_rfqtAssetOfferings, _warningLogger, _infoLogger, _expiryBufferMs) {
        if (_warningLogger === void 0) { _warningLogger = function (a) { return utils_1.logUtils.warn(a); }; }
        if (_infoLogger === void 0) { _infoLogger = function () { return undefined; }; }
    ...
    QuoteRequestor.prototype.requestRfqtFirmQuotesAsync = function (makerAssetData, takerAssetData, assetFillAmount, marketOperation, options) {
        return __awaiter(this, void 0, void 0, function () {
            var _opts, responsesIfDefined, responses, ordersWithStringInts, validatedOrdersWithStringInts, validatedOrders, orders;
            var _this = this;
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, Promise.all(Object.keys(this._rfqtAssetOfferings).map(function (url) { return __awaiter(_this, void 0, void 0, function () {
                                var timeBeforeAwait, response, err_1;
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                    ...
                    case 1:
                        ...
                        validatedOrdersWithStringInts = ordersWithStringInts.filter(function (order) {
                            ...
                            if (order.takerAddress.toLowerCase() !== _opts.takerAddress.toLowerCase()) {
                                _this._warningLogger("Unexpected takerAddress in RFQ-T order, filtering out: " + JSON.stringify(order));
                                return false;
                            }
                            return true;
                        });
                        ...
                        orders = validatedOrders.filter(function (order) {
                            if (order_utils_1.orderCalculationUtils.willOrderExpire(order, _this._expiryBufferMs / constants_1.constants.ONE_SECOND_MS)) {
                                _this._warningLogger("Expiry too soon in RFQ-T order, filtering out: " + JSON.stringify(order));
                                return false;
                            }
                            return true;
                        });
    ...
    QuoteRequestor.prototype.requestRfqtIndicativeQuotesAsync = function (makerAssetData, takerAssetData, assetFillAmount, marketOperation, options) {
        return __awaiter(this, void 0, void 0, function () {
            var _opts, axiosResponsesIfDefined, axiosResponses, responsesWithStringInts, validResponsesWithStringInts, validResponses, responses;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        assertTakerAddressOrThrow(_opts.takerAddress);
                        return [4 /*yield*/, Promise.all(Object.keys(this._rfqtAssetOfferings).map(function (url) { return __awaiter(_this, void 0, void 0, function () {
                                var timeBeforeAwait, response, err_2;
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                            if (!this._makerSupportsPair(url, makerAssetData, takerAssetData)) return [3 /*break*/, 4];
                    ...
                    case 1:
                        ...
                        responses = validResponses.filter(function (response) {
                            if (_this._isExpirationTooSoon(response.expirationTimeSeconds)) {
                                _this._warningLogger("Expiry too soon in RFQ-T indicative quote, filtering out: " + JSON.stringify(response));
                                return false;
                            }
                            return true;
                        });
