                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        validatedOrdersWithStringInts = ordersWithStringInts.filter(function (order) {
                            ...
                            if (new utils_1.BigNumber(order.expirationTimeSeconds).isGreaterThan((Date.now() + _this._expiryBufferMs) * constants_1.constants.ONE_SECOND_MS)) {
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        validResponsesWithStringInts = responsesWithStringInts.filter(function (response) {
                            ...
                            if (new utils_1.BigNumber(response.expirationTimeSeconds).isGreaterThan((Date.now() + _this._expiryBufferMs) * constants_1.constants.ONE_SECOND_MS)) {
