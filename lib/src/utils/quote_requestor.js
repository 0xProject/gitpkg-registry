...
class QuoteRequestor {
    constructor(_rfqtAssetOfferings, _warningLogger = constants_1.constants.DEFAULT_WARNING_LOGGER, _infoLogger = constants_1.constants.DEFAULT_INFO_LOGGER, _expiryBufferMs = constants_1.constants.DEFAULT_SWAP_QUOTER_OPTS.expiryBufferMs, _firmQuoteValidator, _quoteObserver) {
        ...
        this._quoteObserver = _quoteObserver;
