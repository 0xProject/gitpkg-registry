                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        validatedOrdersWithStringInts = ordersWithStringInts.filter(function (order) {
                            try {
                                console.log("checking order " + JSON.stringify(order));
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Promise.all(Object.keys(this._rfqtAssetOfferings).map(function (url) { return __awaiter(_this, void 0, void 0, function () {
                            var requestParams, partialLogEntry, timeBeforeAwait, quotePath, axiosArg, response, err_1;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        if (!this._makerSupportsPair(url, makerAssetData, takerAssetData)) return [3 /*break*/, 4];
                                        requestParams = __assign({ takerAddress: options.takerAddress }, inferQueryParams(marketOperation, makerAssetData, takerAssetData, assetFillAmount));
                                    ...
                                    case 1:
                                        ...
                                        console.log("requestor: " + url + "/" + quotePath + " -- " + JSON.stringify(axiosArg, undefined, '\t'));
                                        console.log("buyAmountBaseUnits type: " + typeof axiosArg.params.buyAmountBaseUnits);
                                        console.log("sellAmountBaseUnits type: " + typeof axiosArg.params.sellAmountBaseUnits);
                                        return [4 /*yield*/, axios_1.default.get(url + "/" + quotePath, axiosArg)];
                                    case 2:
                                        response = _a.sent();
                                        this._infoLogger({
