...
var QuoteRequestor = /** @class */ (function () {
    ...
    QuoteRequestor.prototype.requestRfqtFirmQuotesAsync = function (makerAssetData, takerAssetData, assetFillAmount, marketOperation, options) {
        return __awaiter(this, void 0, void 0, function () {
            var _opts, timeBeforeAwait, responsesIfDefined, responses, ordersWithStringInts, validatedOrdersWithStringInts, validatedOrders, orders;
            var _this = this;
    ...
    QuoteRequestor.prototype.requestRfqtIndicativeQuotesAsync = function (makerAssetData, takerAssetData, assetFillAmount, marketOperation, options) {
        return __awaiter(this, void 0, void 0, function () {
            var _opts, timeBeforeAwait, axiosResponsesIfDefined, axiosResponses, responsesWithStringInts, validResponsesWithStringInts, validResponses, responses;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
