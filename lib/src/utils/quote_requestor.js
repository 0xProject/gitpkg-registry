...
var QuoteRequestor = /** @class */ (function () {
    ...
    QuoteRequestor.prototype.requestRfqtFirmQuotesAsync = function (makerAssetData, takerAssetData, assetFillAmount, marketOperation, options) {
        return __awaiter(this, void 0, void 0, function () {
            var _opts, ordersWithStringInts, validatedOrdersWithStringInts, validatedOrders, orders;
            var _this = this;
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        validatedOrdersWithStringInts = ordersWithStringInts.filter(function (order) {
                            ...
                            if (!hasValidSchema) {
                                _this._warningLogger(order, 'Invalid RFQ-t order received, filtering out');
                                return false;
                            }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Promise.all(Object.keys(this._rfqtAssetOfferings).map(function (url) { return __awaiter(_this, void 0, void 0, function () {
                            var logEntry, timeBeforeAwait, quotePath, response, err_1;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        if (!this._makerSupportsPair(url, makerAssetData, takerAssetData)) return [3 /*break*/, 5];
                                        logEntry = void 0;
                                    ...
                                    case 4:
                                        this._infoLogger({ rfqtMakerResponse: __assign({}, logEntry, { makerEndpoint: url, quoteType: quoteType }) });
                                        _a.label = 5;
