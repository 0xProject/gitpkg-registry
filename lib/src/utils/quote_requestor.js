...
var QuoteRequestor = /** @class */ (function () {
    ...
    QuoteRequestor.prototype.requestRfqtFirmQuotesAsync = function (makerAssetData, takerAssetData, assetFillAmount, marketOperation, takerApiKey, takerAddress, options) {
        return __awaiter(this, void 0, void 0, function () {
            var makerEndpointMaxResponseTimeMs, buyToken, sellToken, responsesIfDefined, responses, ordersWithStringInts, validatedOrdersWithStringInts, orders;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        makerEndpointMaxResponseTimeMs = _.merge({}, constants_1.constants.DEFAULT_RFQT_FIRM_QUOTE_REQUEST_OPTS, options).makerEndpointMaxResponseTimeMs;
                        ...
                        return [4 /*yield*/, Promise.all(this._rfqtMakerEndpoints.map(function (rfqtMakerEndpoint) { return __awaiter(_this, void 0, void 0, function () {
                                ...
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        ...
                                        case 2:
                                            err_1 = _a.sent();
                                            utils_1.logUtils.warn("Failed to get RFQ-T quote from market maker endpoint " + rfqtMakerEndpoint + " for API key " + takerApiKey + " for taker address " + takerAddress);
