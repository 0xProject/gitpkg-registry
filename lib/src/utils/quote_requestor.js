...
class QuoteRequestor {
    constructor(_rfqtAssetOfferings, _warningLogger = constants_1.constants.DEFAULT_WARNING_LOGGER, _infoLogger = constants_1.constants.DEFAULT_INFO_LOGGER, _expiryBufferMs = constants_1.constants.DEFAULT_SWAP_QUOTER_OPTS.expiryBufferMs, _firmQuoteValidator) {
    ...
    requestRfqtFirmQuotesAsync(makerAssetData, takerAssetData, assetFillAmount, marketOperation, comparisonPrice, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            firmQuoteResponses.forEach((firmQuoteResponse) => __awaiter(this, void 0, void 0, function* () {
                ...
                if (this._firmQuoteValidator !== undefined) {
                    if (!(yield this._firmQuoteValidator.validateQuoteAsync(orderWithBigNumberInts))) {
                        this._warningLogger(orderWithBigNumberInts, 'Quote deemed invalid by custom validator');
                        return;
                    }
                }
