...
var QuoteRequestor = /** @class */ (function () {
                ...
                switch (_a.label) {
                        ...
                        return [4 /*yield*/, Promise.all(this._rfqtMakerEndpoints.map(function (rfqtMakerEndpoint) { return __awaiter(_this, void 0, void 0, function () {
                                ...
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        ...
                                        case 2:
                                            err_1 = _a.sent();
                                            utils_1.logUtils.warn("Failed to get RFQ-T firm quote from market maker endpoint " + rfqtMakerEndpoint + " for API key " + _opts.apiKey + " for taker address " + _opts.takerAddress);
                                            utils_1.logUtils.warn(err_1);
                    ...
                    case 1:
                        ...
                        validatedOrdersWithStringInts = ordersWithStringInts.filter(function (order) {
                            ...
                            if (!hasValidSchema) {
                                utils_1.logUtils.warn("Invalid RFQ-t order received, filtering out: " + JSON.stringify(order));
                                return false;
                            }
                            var hasExpectedMakerAssetData = order.makerAssetData.toLowerCase() === makerAssetData.toLowerCase();
                            var hasExpectedTakerAssetData = order.takerAssetData.toLowerCase() === takerAssetData.toLowerCase();
                            if (!hasExpectedMakerAssetData || !hasExpectedTakerAssetData) {
                                utils_1.logUtils.warn("Unexpected asset data in RFQ-T order, filtering out: " + JSON.stringify(order));
                                return false;
                            }
                            return true;
                        });
                ...
                switch (_a.label) {
                        ...
                        return [4 /*yield*/, Promise.all(this._rfqtMakerEndpoints.map(function (rfqtMakerEndpoint) { return __awaiter(_this, void 0, void 0, function () {
                                ...
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        ...
                                        case 2:
                                            err_2 = _a.sent();
                                            utils_1.logUtils.warn("Failed to get RFQ-T indicative quote from market maker endpoint " + rfqtMakerEndpoint + " for API key " + options.apiKey + " for taker address " + options.takerAddress);
                                            utils_1.logUtils.warn(err_2);
                                            return [2 /*return*/, undefined];
                                        case 3: return [2 /*return*/];
                                    }
                                });
                    ...
                    case 1:
                        ...
                        validResponsesWithStringInts = responsesWithStringInts.filter(function (response) {
                            ...
                            utils_1.logUtils.warn("Invalid RFQ-T indicative quote received, filtering out: " + JSON.stringify(response));
                            return false;
                        });
    ...
    QuoteRequestor.prototype._isValidRfqtIndicativeQuoteResponse = function (response) {
        var hasValidMakerAssetAmount = this._schemaValidator.isValid(response.makerAssetAmount, json_schemas_1.schemas.wholeNumberSchema);
        var hasValidTakerAssetAmount = this._schemaValidator.isValid(response.takerAssetAmount, json_schemas_1.schemas.wholeNumberSchema);
        var hasValidMakerAssetData = this._schemaValidator.isValid(response.makerAssetData, json_schemas_1.schemas.hexSchema);
        var hasValidTakerAssetData = this._schemaValidator.isValid(response.takerAssetData, json_schemas_1.schemas.hexSchema);
