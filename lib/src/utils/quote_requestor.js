...
class QuoteRequestor {
    ...
    assetFillAmount, comparisonPrice, isLastLook = false) {
    ...
    assetFillAmount, marketOperation, comparisonPrice, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _opts = Object.assign(Object.assign(Object.assign({}, constants_1.constants.DEFAULT_RFQT_REQUEST_OPTS), options), { isLastLook: true });
    ...
    _getQuotesAsync(makerToken, takerToken, assetFillAmount, marketOperation, comparisonPrice, options, quoteType, assetOfferings) {
        return __awaiter(this, void 0, void 0, function* () {
            const requestParams = QuoteRequestor.makeQueryParameters(options.txOrigin, options.takerAddress, marketOperation, makerToken, takerToken, assetFillAmount, comparisonPrice, options.isLastLook);
            const quotePath = (() => {
                switch (quoteType) {
                    case 'firm':
                        return 'quote';
