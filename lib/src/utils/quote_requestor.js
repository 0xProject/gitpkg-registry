    ...
    QuoteRequestor.prototype.requestRfqtFirmQuotesAsync = function (makerAssetData, takerAssetData, assetFillAmount, marketOperation, options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _opts = __assign(__assign({}, constants_1.constants.DEFAULT_RFQT_REQUEST_OPTS), options);
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, orders.map(function (order) { return ({ signedOrder: order }); })];
                }
            });
        });
    };
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        validResponses = validResponsesWithStringInts.map(function (response) {
                            return __assign(__assign({}, response), { makerAssetAmount: new utils_1.BigNumber(response.makerAssetAmount), takerAssetAmount: new utils_1.BigNumber(response.takerAssetAmount), expirationTimeSeconds: new utils_1.BigNumber(response.expirationTimeSeconds) });
                        });
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        ...
                                        requestParams = __assign(__assign({}, requestParamsWithBigNumbers), { sellAmountBaseUnits: requestParamsWithBigNumbers.sellAmountBaseUnits
                                    ...
                                    case 2:
                                        response = _a.sent();
                                        this._infoLogger({
                                            rfqtMakerInteraction: __assign(__assign({}, partialLogEntry), { response: {
