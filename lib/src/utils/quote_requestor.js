...
class QuoteRequestor {
    constructor(_rfqtAssetOfferings, _altRfqCreds, _warningLogger = constants_1.constants.DEFAULT_WARNING_LOGGER, _infoLogger = constants_1.constants.DEFAULT_INFO_LOGGER, _expiryBufferMs = constants_1.constants.DEFAULT_SWAP_QUOTER_OPTS.expiryBufferMs) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const quotePromises = typedMakerUrls.map((typedMakerUrl) => __awaiter(this, void 0, void 0, function* () {
                ...
                if (isBlacklisted) {
                    ...
                    try {
                        if (typedMakerUrl.pairType === types_1.RfqPairType.Standard) {
                            const response = yield exports.quoteRequestorHttpClient.get(`${typedMakerUrl.url}/${quotePath}`, {
