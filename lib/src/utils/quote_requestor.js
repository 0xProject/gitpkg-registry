 ...
 */
function hasExpectedTokenAddresses(comparisons) {
...
class QuoteRequestor {
    ...
    static makeQueryParameters(takerAddress, marketOperation, buyTokenAddress, // maker token
    ...
    assetFillAmount, marketOperation, comparisonPrice, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // validate
            const validationFunction = (o) => this._schemaValidator.isValid(o, json_schemas_1.schemas.orderSchema); //  TODO (xianny): might not be the right schema, placeholde
    ...
    requestRfqtIndicativeQuotesAsync(makerToken, takerToken, assetFillAmount, marketOperation, comparisonPrice, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const quotes = yield this._getQuotesAsync(makerToken, takerToken, assetFillAmount, marketOperation, comparisonPrice, _opts, 'indicative');
            // validate
            const validationFunction = (o) => this._isValidRfqtIndicativeQuoteResponse(o); //  TODO (xianny): might not be the right schema, placeholde
            const validQuotes = quotes.filter(result => {
                const order = result.response;
                if (!validationFunction(order)) {
    ...
    _getQuotesAsync(makerToken, takerToken, assetFillAmount, marketOperation, comparisonPrice, options, quoteType) {
        return __awaiter(this, void 0, void 0, function* () {
            const requestParams = QuoteRequestor.makeQueryParameters(options.takerAddress, marketOperation, makerToken, takerToken, assetFillAmount, comparisonPrice);
            const quotePath = (() => {
                switch (quoteType) {
                    case 'firm':
                        return 'quote';
