...
class QuoteRequestor {
    constructor(_rfqtAssetOfferings, _warningLogger = (obj, msg) => utils_1.logUtils.warn(`${msg ? `${msg}: ` : ''}${JSON.stringify(obj)}`), _infoLogger = (obj, msg) => utils_1.logUtils.log(`${msg ? `${msg}: ` : ''}${JSON.stringify(obj)}`), _expiryBufferMs = constants_1.constants.DEFAULT_SWAP_QUOTER_OPTS.expiryBufferMs) {
    ...
    requestRfqtFirmQuotesAsync(makerAssetData, takerAssetData, assetFillAmount, marketOperation, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            firmQuoteResponses.forEach(firmQuoteResponse => {
                ...
                this._orderHashToMakerUri[order_utils_1.orderHashUtils.getOrderHash(orderWithBigNumberInts)] = firmQuoteResponse.makerUri;
    ...
    requestRfqtIndicativeQuotesAsync(makerAssetData, takerAssetData, assetFillAmount, marketOperation, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _opts = Object.assign({}, constants_1.constants.DEFAULT_RFQT_REQUEST_OPTS, options);
            ...
            const validResponses = validResponsesWithStringInts.map(result => {
                const response = result.response;
                return Object.assign({}, response, { makerAssetAmount: new utils_1.BigNumber(response.makerAssetAmount), takerAssetAmount: new utils_1.BigNumber(response.takerAssetAmount), expirationTimeSeconds: new utils_1.BigNumber(response.expirationTimeSeconds) });
            });
     ...
     */
    getMakerUriForOrderHash(orderHash) {
    ...
    _getQuotesAsync(makerAssetData, takerAssetData, assetFillAmount, marketOperation, options, quoteType) {
        return __awaiter(this, void 0, void 0, function* () {
            const result = [];
            yield Promise.all(Object.keys(this._rfqtAssetOfferings).map((url) => __awaiter(this, void 0, void 0, function* () {
                if (this._makerSupportsPair(url, makerAssetData, takerAssetData)) {
                    const requestParamsWithBigNumbers = Object.assign({ takerAddress: options.takerAddress }, inferQueryParams(marketOperation, makerAssetData, takerAssetData, assetFillAmount));
                    // convert BigNumbers to strings
                    // so they are digestible by axios
                    const requestParams = Object.assign({}, requestParamsWithBigNumbers, { sellAmountBaseUnits: requestParamsWithBigNumbers.sellAmountBaseUnits
