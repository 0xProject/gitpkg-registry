...
var ProtocolFeeUtils = /** @class */ (function () {
    function ProtocolFeeUtils(gasPricePollingIntervalInMs, ethGasStationUrl, initialGasPrice) {
        if (ethGasStationUrl === void 0) { ethGasStationUrl = constants_1.constants.ETH_GAS_STATION_API_URL; }
    ...
    ProtocolFeeUtils.getInstance = function (gasPricePollingIntervalInMs, ethGasStationUrl, initialGasPrice) {
        if (ethGasStationUrl === void 0) { ethGasStationUrl = constants_1.constants.ETH_GAS_STATION_API_URL; }
        if (initialGasPrice === void 0) { initialGasPrice = constants_1.constants.ZERO_AMOUNT; }
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                if (shouldHardRefresh) {
                    ...
                    return [2 /*return*/, this._gasPriceEstimation];
                }
                return [2 /*return*/];
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        return [4 /*yield*/, fetch(this._ethGasStationUrl)];
                    case 1:
                        res = _a.sent();
        ...
        this._gasPriceHeart.createEvent(1, function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _a._gasPriceEstimation = _b.sent();
                        return [2 /*return*/];
                }
            });
        }); });
