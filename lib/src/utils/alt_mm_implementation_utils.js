...
exports.returnQuoteFromAltMMAsync = exports.getAltMarketInfo = void 0;
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const response = yield axiosInstance
            ...
            if (err.response) {
                ...
                warningLogger({ data: err.response.data, status: err.response.status, headers: err.response.headers }, `Alt RFQ MM request failed`);
            }
            else if (err.request) {
