...
import { GasSchedule, OptimizedMarketOrder } from './market_operation_utils/types';
...
export declare function fillQuoteOrders(fillOrders: QuoteFillOrderCall[], inputAmount: BigNumber, protocolFeePerFillOrder: BigNumber, gasSchedule: GasSchedule): IntermediateQuoteFillResult;
export {};
