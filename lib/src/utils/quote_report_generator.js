 ...
 */
function generateQuoteReport(marketOperation, _dexQuotes, _multiHopQuotes, nativeOrders, liquidityDelivered, comparisonPrice, quoteRequestor) {
    ...
    // Due to the sheer amount of volume coming into Quote Report, we will only be reporting considered sources if they come
    // from RFQ liquidity.
