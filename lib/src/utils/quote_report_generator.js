 ...
 */
function generateExtendedQuoteReport(marketOperation, quotes, liquidityDelivered, amount, comparisonPrice, quoteRequestor) {
 ...
 */
function isDexSampleForTotalAmount(ds, marketOperation, amount) {
    // input and output map to different values
    // based on the market operation
    if (marketOperation === types_1.MarketOperation.Buy) {
