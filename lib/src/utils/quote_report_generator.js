...
function _nativeOrderToReportEntry(type, fillData, fillableAmount, comparisonPrice, quoteRequestor) {
    ...
    if (isRfqt) {
        ...
        return Object.assign({ liquiditySource: types_2.ERC20BridgeSource.Native }, nativeOrderBase, { isRfqt: true, makerUri: rfqtMakerUri || '' }, (comparisonPrice ? { comparisonPrice: comparisonPrice.toNumber() } : {}), { nativeOrder,
            fillData });
    }
    else {
        // tslint:disable-next-line: no-object-literal-type-assertion
        return Object.assign({ liquiditySource: types_2.ERC20BridgeSource.Native }, nativeOrderBase, { isRfqt: false, fillData });
    }
}
