...
function _nativeOrderToReportEntry(type, fillData, fillableAmount, comparisonPrice, quoteRequestor) {
    ...
    if (isRfqt) {
        ...
        return Object.assign({}, nativeOrderBase, { nativeOrder: fillData.order, isRfqt: true, makerUri: rfqtMakerUri || '' }, (comparisonPrice ? { comparisonPrice: comparisonPrice.toNumber() } : {}), { fillData });
    }
    else {
        // tslint:disable-next-line: no-object-literal-type-assertion
        return Object.assign({}, nativeOrderBase, { isRfqt: false, nativeOrder: fillData.order, fillData });
    }
}
