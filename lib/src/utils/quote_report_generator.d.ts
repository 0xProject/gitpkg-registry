...
import { DexSample, ERC20BridgeSource, Fill, FillData, MultiHopFillData, NativeFillData, NativeLimitOrderFillData, NativeRfqOrderFillData, RawQuotes } from './market_operation_utils/types';
 ...
 */
export declare function generateQuoteReport(marketOperation: MarketOperation, nativeOrders: NativeOrderWithFillableAmounts[], liquidityDelivered: ReadonlyArray<Fill> | DexSample<MultiHopFillData>, comparisonPrice?: BigNumber | undefined, quoteRequestor?: QuoteRequestor): QuoteReport;
/**
 * Generates a report of sources considered while computing the optimized
 ...
 */
export declare function generateExtendedQuoteReportSources(marketOperation: MarketOperation, quotes: RawQuotes, liquidityDelivered: ReadonlyArray<Fill> | DexSample<MultiHopFillData>, amount: BigNumber, comparisonPrice?: BigNumber | undefined, quoteRequestor?: QuoteRequestor): ExtendedQuoteReportSources;
/**
