 ...
 */
export declare function generateExtendedQuoteReport(marketOperation: MarketOperation, quotes: RawQuotes, liquidityDelivered: ReadonlyArray<CollapsedFill> | DexSample<MultiHopFillData>, comparisonPrice?: BigNumber | undefined, quoteRequestor?: QuoteRequestor): ExtendedQuoteReport;
/**
