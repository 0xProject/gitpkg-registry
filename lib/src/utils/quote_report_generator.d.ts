 ...
 */
export declare function generateExtendedQuoteReport(marketOperation: MarketOperation, quotes: RawQuotes, liquidityDelivered: ReadonlyArray<CollapsedFill> | DexSample<MultiHopFillData>, amount: BigNumber, comparisonPrice?: BigNumber | undefined, quoteRequestor?: QuoteRequestor): ExtendedQuoteReport;
/**
