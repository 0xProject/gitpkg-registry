...
export declare const rfqtMocker: {
     ...
     */
    withMockedRfqtFirmQuotes: (mockedResponses: MockedRfqtFirmQuoteResponse[], performFn: () => Promise<void>, axiosClient?: AxiosInstance) => Promise<void>;
    withMockedRfqtIndicativeQuotes: (mockedResponses: MockedRfqtFirmQuoteResponse[], performFn: () => Promise<void>, axiosClient?: AxiosInstance) => Promise<void>;
};
