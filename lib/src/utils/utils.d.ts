...
export declare function getNativeAdjustedFillableAmountsFromTakerAmount(order: SignedNativeOrder, takerFillAmount: BigNumber): NativeOrderFillableAmountFields;
export declare function getNativeAdjustedFillableAmountsFromMakerAmount(order: SignedNativeOrder, makerFillAmount: BigNumber): NativeOrderFillableAmountFields;
