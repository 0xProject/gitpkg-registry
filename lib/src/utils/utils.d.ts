...
export declare function timeItAsync<TReturn>(cb: () => TReturn | Promise<TReturn>, handler?: (dt: number) => string, threshold?: number): Promise<TReturn>;
export declare function timeIt<TReturn>(cb: () => TReturn, handler?: (dt: number) => string, threshold?: number): TReturn;
