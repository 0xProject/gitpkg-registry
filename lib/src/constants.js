...
const DEFAULT_SWAP_QUOTER_OPTS = Object.assign({ chainId: contract_addresses_1.ChainId.Mainnet, orderRefreshIntervalMs: 10000 }, DEFAULT_ORDER_PRUNER_OPTS, { samplerGasLimit: 500e6, ethGasStationUrl: ETH_GAS_STATION_API_URL, rfqt: {
        takerApiKeyWhitelist: [],
        makerAssetOfferings: {},
        txOriginBlacklist: new Set(),
    }, tokenAdjacencyGraph: constants_1.DEFAULT_TOKEN_ADJACENCY_GRAPH });
...
exports.constants = {
    ...
    DEFAULT_INTERMEDIATE_TOKENS: constants_1.DEFAULT_INTERMEDIATE_TOKENS,
