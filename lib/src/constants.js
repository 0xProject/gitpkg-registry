...
var ETH_GAS_STATION_API_URL = 'https://ethgasstation.info/api/ethgasAPI.json';
var NULL_BYTES = '0x';
...
var ZERO_AMOUNT = new utils_1.BigNumber(0);
...
var PROTOCOL_FEE_MULTIPLIER = new utils_1.BigNumber(70000);
...
}, DEFAULT_ORDER_PRUNER_OPTS, { samplerGasLimit: 250e6, ethGasStationUrl: ETH_GAS_STATION_API_URL, rfqt: {
...
var DEFAULT_EXCHANGE_PROXY_EXTENSION_CONTRACT_OPTS = {
    isFromETH: false,
    isToETH: false,
    affiliateFee: {
...
var DEFAULT_EXCHANGE_PROXY_SWAP_QUOTE_GET_OPTS = {
...
exports.constants = {
    ...
    DEFAULT_EXCHANGE_PROXY_SWAP_QUOTE_GET_OPTS: DEFAULT_EXCHANGE_PROXY_SWAP_QUOTE_GET_OPTS,
    DEFAULT_EXCHANGE_PROXY_EXTENSION_CONTRACT_OPTS: DEFAULT_EXCHANGE_PROXY_EXTENSION_CONTRACT_OPTS,
