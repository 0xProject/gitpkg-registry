...
import { FillQuoteTransformerOrderType, LimitOrderFields, RfqOrder, RfqOrderFields, Signature } from '@0x/protocol-utils';
import { TakerRequestQueryParamsUnnested, V4SignedRfqOrder } from '@0x/quote-server';
import { Fee } from '@0x/quote-server/lib/src/types';
import { BigNumber } from '@0x/utils';
import { AxiosRequestConfig } from 'axios';
import { ERC20BridgeSource, GetMarketOrdersOpts, LiquidityProviderFillData, BridgeFillData, CurveFillData, UniswapV2FillData, UniswapV3FillData, NativeOrderFillData, MooniswapFillData } from './utils/market_operation_utils/types';
...
export declare type SignedRfqOrder = SignedOrder<RfqOrderFields>;
export declare type SignedLimitOrder = SignedOrder<LimitOrderFields>;
export declare type SignedNativeOrder = SignedLimitOrder | SignedRfqOrder;
/**
 ...
 */
export declare enum ExchangeProxyRefundReceiver {
...
export declare type SwapQuoteNativeOrder = SwapQuoteLimitOrder | SwapQuoteRfqOrder;
/**
 ...
 */
export declare type SwapQuoteOrdersBreakdown = Partial<{
...
export declare enum RfqPairType {
    Standard = "standard",
    Alt = "alt"
}
...
export declare type AssetSwapperContractAddresses = ContractAddresses;
/**
...
export declare enum AltQuoteModel {
    Firm = "firm",
    Indicative = "indicative"
}
export declare enum AltQuoteSide {
    Buy = "buy",
    Sell = "sell"
}
