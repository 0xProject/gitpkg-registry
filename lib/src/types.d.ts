...
import { CommonOrderFields, FillQuoteTransformerOrderType, LimitOrderFields, RfqOrder, RfqOrderFields, Signature } from '@0x/protocol-utils';
import { TakerRequestQueryParams } from '@0x/quote-server';
import { BigNumber } from '@0x/utils';
import { ERC20BridgeSource, GetMarketOrdersOpts, LiquidityProviderRegistry, OptimizedMarketOrder, TokenAdjacencyGraph } from './utils/market_operation_utils/types';
...
export declare type SignedNativeOrder = SignedOrder<LimitOrderFields> | SignedOrder<RfqOrderFields>;
export declare type NativeOrderWithFillableAmounts = SignedNativeOrder & NativeOrderFillableAmountFields;
export declare type OrderWithFillableAmounts = CommonOrderFields & NativeOrderFillableAmountFields;
/**
...
export declare type AssetSwapperContractAddresses = ContractAddresses & BridgeContractAddresses;
/**
