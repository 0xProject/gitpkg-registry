                ...
                case 0:
                    ...
                    provider = new swap_quoter_1.SwapQuoter(client.getProvider(), orderbook, {
                        ...
                        rfqt: {
                            ...
                            makerAssetOfferings: {
                                'https://eth-dai.pscope.xyz': [
                                    ['0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48', '0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2'],
                                ],
                            },
                        },
                    });
                    return [4 /*yield*/, provider.getMarketSellSwapQuoteAsync('0x6b175474e89094c44da98b954eedeac495271d0f', '0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2', dev_utils_1.Web3Wrapper.toBaseUnitAmount(30, 18), {
                            rfqt: {
                                apiKey: 'a7cbec71-2062-4321-9091-b40ccbbb3532',
                                isIndicative: false,
                                takerAddress: '0x9016cc2122b52ff5d9937c0c1422b78d7e81ceea',
