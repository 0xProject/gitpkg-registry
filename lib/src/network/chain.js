...
class LiveChain {
    ...
    static createAsync(opts) {
        return __awaiter(this, void 0, void 0, function* () {
            const fullOpts = Object.assign({ tickFrequency: 75, maxCacheAgeMs: 30e3 }, opts);
    ...
    _dispatchBatchAsync(calls) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                rawResultData = yield utils_2.timeIt(() => __awaiter(this, void 0, void 0, function* () { return this._w3.callAsync(merged); }), 'eth_call', 500, () => {
                    const numOverrides = Object.keys(merged.overrides).length;
                    const payloadSize = JSON.stringify(merged).length / 1e3;
                    const overridesSize = JSON.stringify(merged.overrides).length / 1e3;
                    const dataSize = JSON.stringify(merged.data).length / 1e3;
                    console.info(`\tnum calls: ${calls.length}, num overrides: ${numOverrides}, sizes: ${payloadSize}/${overridesSize}/${dataSize} kb`);
                });
            }
            catch (err) {
