...
class Memcache {
    constructor(db) {
        this._client = new redis_1.RedisClient({ db });
...
class LiveChain {
    constructor(opts) {
        ...
        this._cache = new Memcache(LiveChain.DB_VERSION);
    }
    get provider() {
    ...
    _findCachedCallResultAsync(callId, maxCacheAgeMs) {
        return __awaiter(this, void 0, void 0, function* () {
            const cached = yield this._cache.tryGetObjectAsync(callId);
    ...
    _cacheCallResultAsync(callId, successResult, error) {
        return __awaiter(this, void 0, void 0, function* () {
            return this._cache.setObjectAsync(callId, {
...
LiveChain.DB_VERSION = 'livechain@1.0.0';
class EthCallBatch {
