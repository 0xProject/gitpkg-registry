...
class LiveChain {
    ...
    static createAsync(opts) {
        return __awaiter(this, void 0, void 0, function* () {
            const fullOpts = Object.assign({ maxCacheAgeMs: 10e3, pruneFrequencyMs: 5e3, 
                ...
                // RPC calls.
                flushFrequencyMs: 100, maxBatchGas: 1e9, maxBatchBytes: 8.192e6, flushThreshold: 1.5, minDispatchFullness: 0.75, maxPendingCallAgeMs: 100 }, opts);
    ...
    _flush(frequency) {
        this._flushQueue();
        setTimeout(() => __awaiter(this, void 0, void 0, function* () { return this._flush(frequency); }), frequency);
    }
    _prune(frequency) {
    ...
    _flushQueue() {
        const batches = this._generateCallBatches();
    ...
    _generateCallBatches() {
        const batch = [];
        // Sort queue by descending creation time.
        let nextQueue = this._queue.sort((a, b) => b.createdTime - a.createdTime);
...
function mergeBatchCalls(calls) {
    return utils_2.timeIt(() => {
        ...
        for (const c of calls) {
            ...
            merged.value = utils_1.BigNumber.sum(c.opts.value || constants_1.ZERO_AMOUNT, merged.value);
            if (c.opts.overrides) {
        ...
        return Object.assign(Object.assign({}, merged), { data: utils_2.timeIt(() => DISPATCHER_CONTRACT.dispatch(callInfos).getABIEncodedTransactionData(), dt => `dispatch ABI encode took ${dt}ms`), gasPrice: merged.gasPrice || constants_1.ZERO_AMOUNT });
