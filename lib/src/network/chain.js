...
class LiveChain {
    ...
    static createAsync(opts) {
        return __awaiter(this, void 0, void 0, function* () {
            const fullOpts = Object.assign({ maxCacheAgeMs: 30e3, pruneFrequencyMs: 5e3, callTimeoutMs: 5e3, 
                // These numbers will all affect how calls are batched across
                // RPC calls.
                flushFrequencyMs: 100, maxBatchGas: 800e6, maxBatchBytes: 0.750e6, burstFullness: 16, maxOutstandingCalls: 4, maxBurstOutstandingCalls: 8 }, opts);
