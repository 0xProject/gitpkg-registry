...
class LiveChain {
    ...
    _startAsync(tickFrequency) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this._tickAsync(tickFrequency);
        });
    }
    ethCallAsync(opts) {
        return __awaiter(this, void 0, void 0, function* () {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this._pruneCache();
            {
                const queue = this._queue.sort((a, b) => {
                    if (a.opts.to !== b.opts.to) {
                        return (a.opts.gas || 0) - (b.opts.gas || 0);
                    }
                    return a.opts.to < b.opts.to ? -1 : (a.opts.to > b.opts.to ? 1 : 0);
                });
                this._queue = [];
                void this._executeAsync(queue);
            }
            this._lastTickTime = Date.now();
            setTimeout(() => __awaiter(this, void 0, void 0, function* () { return this._tickAsync(tickFrequency); }), tickFrequency + 1);
        });
    }
    _pruneCache() {
        const now = Date.now();
...
function canBatchCallWith(ethCall, batch) {
    ...
    if ((ethCall.opts.gas || DEFAULT_CALL_GAS_LIMIT) + batchGas >= 1e9) {
