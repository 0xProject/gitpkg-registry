...
class LiveChain {
    ...
    static createAsync(opts) {
        return __awaiter(this, void 0, void 0, function* () {
            const fullOpts = Object.assign({ maxCacheAgeMs: 10e3, pruneFrequency: 1000, 
                // These numbers will all affect how calls are batched across
                // RPC calls.
                tickFrequency: 100, maxBatchGas: 512e6, maxBatchBytes: 1.024e6, queueCapacity: 1.5 }, opts);
    ...
    _tick(frequency) {
        this._flushQueue();
        setTimeout(() => __awaiter(this, void 0, void 0, function* () { return this._tick(frequency); }), frequency);
    }
    _prune(frequency) {
        this._pruneCache();
        setTimeout(() => __awaiter(this, void 0, void 0, function* () { return this._tick(frequency); }), frequency);
