...
class LiveChain {
    ...
    static createAsync(opts) {
        return __awaiter(this, void 0, void 0, function* () {
            const fullOpts = Object.assign({ maxCacheAgeMs: 30e3, 
                // These numbers will all affect how calls are batched across
                // RPC calls.
                tickFrequency: 100, maxBatchGas: 768e6, maxBatchBytes: 1.024e6, queueCapacity: 1.5 }, opts);
    ...
    ethCallAsync(opts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (opts.timeoutMs) {
                (() => __awaiter(this, void 0, void 0, function* () { return setTimeout(() => c.reject(new Error('ethCall timed out')), opts.timeoutMs); }))();
            }
            if (opts.immediate) {
    ...
    _flushQueue() {
        // Shuffle the queue to encourage request interleaving.
