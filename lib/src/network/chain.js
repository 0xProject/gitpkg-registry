...
class LiveChain {
    ...
    _tickAsync(tickFrequency, bootstrap = false) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this._pruneCache();
            {
                ...
                this._queue = [];
                yield this._executeAsync(queue);
            }
    ...
    _executeAsync(queue) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield Promise.all([...generateCallBatches(queue)].map((b) => __awaiter(this, void 0, void 0, function* () { return this._dispatchBatchAsync(b); })));
        });
    }
...
function canBatchCallWith(ethCall, batch) {
    const { overrides } = Object.assign({ overrides: {} }, ethCall.opts);
