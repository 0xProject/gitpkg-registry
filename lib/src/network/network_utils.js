...
class NetworkUtils {
    ...
    getTokenDecimalsAsync(tokens) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (tokensToFetch.length > 0) {
                fetchedDecimals = (yield this._networkUtilsContractHelper.ethCallAsync(this._networkUtilsContract.getTokenDecimals, [tokensToFetch], { gas: tokensToFetch.length * 64e3, maxCacheAgeMs: 300e3 })).map(d => d.toNumber());
            }
    ...
    isAddressContractAsync(address) {
        return __awaiter(this, void 0, void 0, function* () {
            return this._networkUtilsContractHelper.ethCallAsync(this._networkUtilsContract.isContract, [address], { gas: 32e3, maxCacheAgeMs: 300e3 });
        });
    }
}
