    ...
    getTokenDecimalsAsync(tokens) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (tokensToFetch.length > 0) {
                fetchedDecimals = (yield this._networkUtilsContractHelper.ethCallAsync(this._networkUtilsContract.getTokenDecimals, [tokensToFetch], { gas: tokensToFetch.length * 20e3 })).map(d => d.toNumber());
            }
    ...
    isAddressContractAsync(address) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this._isAddressContractCache[address] === undefined) {
                this._isAddressContractCache[address] = yield this._networkUtilsContractHelper.ethCallAsync(this._networkUtilsContract.isContract, [address], { gas: 20e3 });
            }
