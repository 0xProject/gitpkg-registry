...
class SassySampler {
    ...
    getMedianSellRateAsync(sources, takerToken, makerToken, takerAmount) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let samples;
            try {
                samples = (yield Promise.all(sources.map((s) => __awaiter(this, void 0, void 0, function* () { return this._sampleSellsFromSourceAsync(s, [takerToken, makerToken], [takerAmount]); })))).flat(1);
            }
            catch (_a) { }
