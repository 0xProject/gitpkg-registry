...
class SassySampler {
    ...
    getMedianSellRateAsync(sources, takerToken, makerToken, takerAmount) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const samples = (yield Promise.all(sources.map((s) => __awaiter(this, void 0, void 0, function* () { return this._sampleSellsFromSourceAsync(s, [takerToken, makerToken], [takerAmount]); })))).flat(1);
            if (samples.length === 0) {
                return ZERO_AMOUNT;
            }
    ...
    getSellSamplesAsync(sources, takerToken, makerToken, takerAmounts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (yield Promise.all(sources.map((s) => __awaiter(this, void 0, void 0, function* () { return Promise.all(tokenPaths.map((p) => __awaiter(this, void 0, void 0, function* () { return this._sampleSellsFromSourceAsync(s, p, takerAmounts); }))); })))).flat(2);
        });
    }
    getBuySamplesAsync(sources, takerToken, makerToken, makerAmounts) {
        return __awaiter(this, void 0, void 0, function* () {
            const tokenPaths = this._getExpandedTokenPaths(takerToken, makerToken);
            return (yield Promise.all(sources.map((s) => __awaiter(this, void 0, void 0, function* () { return Promise.all(tokenPaths.map((p) => __awaiter(this, void 0, void 0, function* () { return this._sampleBuysFromSourceAsync(s, p, makerAmounts); }))); })))).flat(2);
        });
    }
    getTwoHopSellSamplesAsync(sources, takerToken, makerToken, takerAmount) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const hopResults = yield Promise.all(tokenPaths.map((tokenPath) => __awaiter(this, void 0, void 0, function* () { return this._twoHopSampler.getTwoHopSellSampleAsync(sources, tokenPath, takerAmount); })));
    ...
    getTwoHopBuySamplesAsync(sources, takerToken, makerToken, makerAmount) {
        return __awaiter(this, void 0, void 0, function* () {
            const tokenPaths = this._getTwoHopTokenPaths(takerToken, makerToken);
            const hopResults = yield Promise.all(tokenPaths.map((tokenPath) => __awaiter(this, void 0, void 0, function* () { return this._twoHopSampler.getTwoHopBuySampleAsync(sources, tokenPath, makerAmount); })));
            return hopResults.filter(h => !!h);
        });
    }
    _findSampler(source) {
    ...
    _sampleSellsFromSourceAsync(source, tokenPath, takerAmounts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (yield sampler.getSellSamplesAsync(tokenPath, takerAmounts)).filter(s => !!s.length);
        });
    }
    _sampleBuysFromSourceAsync(source, tokenPath, takerAmounts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (yield sampler.getBuySamplesAsync(tokenPath, takerAmounts)).filter(s => !!s.length);
        });
    }
