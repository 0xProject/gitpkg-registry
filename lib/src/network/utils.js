...
function createContractWrapperAndHelper(chain, contractType, artifactName, address) {
    ...
    const wrapper = new contractType(address || getDeterministicContractAddressFromArtifact(artifact), constants_1.DUMMY_PROVIDER, {}, {}, !address ? artifact.compilerOutput.evm.deployedBytecode.object : undefined, fast_abi_1.createFastAbiEncoderOverrides(contractType));
