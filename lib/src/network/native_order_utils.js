...
class NativeOrderUtils {
    ...
    getLimitOrderFillableTakerAmountsAsync(orders) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return this._nativeOrderUtilsContractHelper.ethCallAsync(this._nativeOrderUtilsContract.getLimitOrderFillableTakerAssetAmounts, [orders.map(o => o.order), orders.map(o => o.signature), this.exchangeProxyAddress], { gas: orders.length * 300e3 });
            }
            catch (err) {
    ...
    getLimitOrderFillableMakerAmountsAsync(orders) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return this._nativeOrderUtilsContractHelper.ethCallAsync(this._nativeOrderUtilsContract.getLimitOrderFillableMakerAssetAmounts, [orders.map(o => o.order), orders.map(o => o.signature), this.exchangeProxyAddress], { gas: orders.length * 300e3 });
            }
            catch (err) {
                // tslint:disable-next-line: no-console
                console.error(`Failed to call getLimitOrderFillableMakerAssetAmounts(): ${err}`);
