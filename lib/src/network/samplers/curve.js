...
exports.isCurveCompatible = exports.CurveSampler = exports.IRONSWAP_POLYGON_INFOS = exports.ACRYPTOS_BSC_INFOS = exports.CURVE_V2_MAINNET_INFOS = exports.ACRYPTOS_POOLS = exports.IRONSWAP_POOLS = exports.CurveFunctionSelectors = void 0;
...
const ACRYPTOS_ACS4USD_POOL_BSC_TOKENS = [tokens_1.BSC_TOKENS.BUSD, tokens_1.BSC_TOKENS.USDT, tokens_1.BSC_TOKENS.DAI, tokens_1.BSC_TOKENS.USDC];
...
const CURVELIKE_INFOS_BY_CHAIN_ID = utils_2.valueByChainId({
    ...
    [contract_addresses_1.ChainId.BSC]: {
        ...
        [types_1.ERC20BridgeSource.ACryptos]: exports.ACRYPTOS_BSC_INFOS,
    },
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return curves.map(c => {
                ...
                return {
                    ...
                    gas: GAS_PER_TOKEN_IN_POOL * c.tokens.length,
                };
            });
        });
    }
