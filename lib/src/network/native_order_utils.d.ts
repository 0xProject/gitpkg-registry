...
export declare class NativeOrderUtils {
    ...
    getLimitOrderFillableTakerAmountsAsync(orders: SignedNativeOrder[]): Promise<BigNumber[]>;
    getLimitOrderFillableMakerAmountsAsync(orders: SignedNativeOrder[]): Promise<BigNumber[]>;
}
