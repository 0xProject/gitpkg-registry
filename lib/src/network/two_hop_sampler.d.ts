...
export declare class TwoHopSampler {
    ...
    getTwoHopSellSampleAsync(sources: ERC20BridgeSource[], tokenAddressPath: Address[], takerFillAmount: BigNumber, batchId?: number): Promise<DexSample<TwoHopFillData> | null>;
    getTwoHopBuySampleAsync(sources: ERC20BridgeSource[], tokenAddressPath: Address[], makerFillAmount: BigNumber, batchId?: number): Promise<DexSample<TwoHopFillData> | null>;
