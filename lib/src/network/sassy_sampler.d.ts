...
export declare class SassySampler {
    ...
    getMedianSellRateAsync(sources: ERC20BridgeSource[], takerToken: Address, makerToken: Address, takerAmount: BigNumber, batchId?: number): Promise<BigNumber>;
    getSellSamplesAsync(sources: ERC20BridgeSource[], takerToken: Address, makerToken: Address, takerAmounts: BigNumber[], batchId?: number): Promise<DexSample[][]>;
    getBuySamplesAsync(sources: ERC20BridgeSource[], takerToken: Address, makerToken: Address, makerAmounts: BigNumber[], batchId?: number): Promise<DexSample[][]>;
    getTwoHopSellSamplesAsync(sources: ERC20BridgeSource[], takerToken: Address, makerToken: Address, takerAmount: BigNumber, batchId?: number): Promise<Array<DexSample<TwoHopFillData>>>;
    getTwoHopBuySamplesAsync(sources: ERC20BridgeSource[], takerToken: Address, makerToken: Address, makerAmount: BigNumber, batchId?: number): Promise<Array<DexSample<TwoHopFillData>>>;
