...
export declare class SassySampler {
    ...
    private readonly _maxPriceCacheAgeMs;
    readonly availableSources: ERC20BridgeSource[];
    private readonly _liquidityScores;
    private readonly _priceCache;
    static createAsync(opts: SassySamplerCreateOpts): Promise<SassySampler>;
    protected constructor(chain: Chain, _samplers: SourceSamplerMap, _tokenAdjacencyGraph: TokenAdjacencyGraph, _twoHopSampler: TwoHopSampler, _maxPriceCacheAgeMs: number);
    ...
    private _filterSourcesByLiquidityChance;
    private _filterTwoHopSourcesByLiquidityChance;
