...
const MAX_LIQUIDITY_SCORE_AGE_MS = 600;
...
class OnChainSourceSampler extends SourceSamplerBase {
    constructor(opts) {
        ...
        this._healLiquidityScoresAsync(0.01);
        this._refreshLiquidityScoresAsync();
    }
    canConvertTokens(_tokenAddressPath) {
        return true;
    }
    getSellSamplesAsync(tokenAddressPath, takerFillAmounts, batchId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!this.canConvertTokens(tokenAddressPath) || !(yield this._isLuckyForPathAsync(tokenPathId))) {
                return [];
            }
    ...
    pumpAsync(tokenPathOrId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            ls.chance = 1;
            this._memcache.setObjectAsync(tokenPathId, ls, MAX_LIQUIDITY_SCORE_AGE_MS);
        });
    }
    ...
    _isLuckyForPathAsync(tokenPathOrId) {
        return __awaiter(this, void 0, void 0, function* () {
            const tokenPathId = typeof tokenPathOrId === 'string' ? tokenPathOrId : getTokenPathId(tokenPathOrId);
            const ls = yield this._getLiquidityScoreByPathIdAsync(tokenPathId);
    ...
    _healLiquidityScoresAsync(healAmount) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const pathId in this._liquidityScores) {
                ...
                if (Date.now() - ls.lastTouchedTime >= MAX_LIQUIDITY_SCORE_AGE_MS) {
                    delete this._liquidityScores[pathId];
                }
                else if (ls.chance < 1) {
                    ls.chance = Math.min((ls === null || ls === void 0 ? void 0 : ls.chance) || 1 + healAmount, 1);
                    ls.lastTouchedTime = Date.now();
                    updatedScores[pathId] = ls;
                }
            }
            yield this._memcache.setMultipleObjectsAsync(updatedScores, MAX_LIQUIDITY_SCORE_AGE_MS);
            setTimeout(() => this._healLiquidityScoresAsync(healAmount), 10e3);
        });
    }
    _refreshLiquidityScoresAsync() {
        return __awaiter(this, void 0, void 0, function* () {
            const tokenPathIds = yield this._memcache.getAllKeysAsync();
            const scores = yield this._memcache.tryGetMultipleObjectsAsync(tokenPathIds);
            this._liquidityScores = Object.assign({}, ...tokenPathIds.map((id, i) => scores[i] ? { [id]: scores[i] } : {}));
            setTimeout(() => this._refreshLiquidityScoresAsync(), this._liquidityScoreRefreshRateMs);
        });
    }
    _getLiquidityScoreByPathIdAsync(pathId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return this._liquidityScores[pathId] = {
