...
class OnChainSourceSampler extends SourceSamplerBase {
    constructor(opts) {
        ...
        [this._sellContract, this._sellContractHelper] = utils_1.createContractWrapperAndHelper(opts.chain, opts.sellSamplerContractType, opts.sellSamplerContractType.name || opts.sellSamplerContractArtifactName);
        [this._buyContract, this._buyContractHelper] = utils_1.createContractWrapperAndHelper(opts.chain, opts.buySamplerContractType, opts.buySamplerContractType.name || opts.buySamplerContractArtifactName);
