...
class OnChainSourceSampler extends SourceSamplerBase {
    ...
    getSellSamplesAsync(tokenAddressPath, takerFillAmounts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return Promise.all(calls.map((c) => __awaiter(this, void 0, void 0, function* () {
                return c
                    .getDexSamplesFromResult(yield this._sellContractHelper.ethCallAsync(this._sellContractFunction, c.args, { gas: c.gas }))
                    .filter(s => s.output);
            })));
        });
    }
    getBuySamplesAsync(tokenAddressPath, makerFillAmounts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return Promise.all(calls.map((c) => __awaiter(this, void 0, void 0, function* () {
                return c
                    .getDexSamplesFromResult(yield this._buyContractHelper.ethCallAsync(this._buyContractFunction, c.args, { gas: c.gas }))
                    .filter(s => s.output);
            })));
        });
    }
