...
class TwoHopSampler {
    ...
    getTwoHopSellSampleAsync(sources, tokenAddressPath, takerFillAmount) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const totalGas = firstHopCalls.map(c => c.gas)
                .reduce((a, v) => (a || DEFAULT_SAMPLE_GAS) + (v || DEFAULT_SAMPLE_GAS), 0) || 0
                + 100e3;
            let result;
            try {
    ...
    getTwoHopBuySampleAsync(sources, tokenAddressPath, makerFillAmount) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const totalGas = firstHopCalls.map(c => c.gas)
                .reduce((a, v) => (a || DEFAULT_SAMPLE_GAS) + (v || DEFAULT_SAMPLE_GAS), 0) || 0 + 100e3;
            let result;
            try {
