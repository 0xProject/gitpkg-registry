...
const OTC_ORDER_INFO_ABI_COMPONENTS = [
    {
        name: 'order',
        type: 'tuple',
        components: orders_1.OtcOrder.STRUCT_ABI,
    },
    {
        name: 'signature',
        type: 'tuple',
...
(function (FillQuoteTransformerOrderType) {
    ...
    FillQuoteTransformerOrderType[FillQuoteTransformerOrderType["Otc"] = 3] = "Otc";
...
(function (BridgeProtocol) {
    ...
    BridgeProtocol[BridgeProtocol["Kyber_DEPRECATED"] = 5] = "Kyber_DEPRECATED";
    BridgeProtocol[BridgeProtocol["Mooniswap"] = 6] = "Mooniswap";
    BridgeProtocol[BridgeProtocol["MStable"] = 7] = "MStable";
    BridgeProtocol[BridgeProtocol["Oasis_DEPRECATED"] = 8] = "Oasis_DEPRECATED";
    ...
    BridgeProtocol[BridgeProtocol["CoFiX_DEPRECATED"] = 14] = "CoFiX_DEPRECATED";
    ...
    BridgeProtocol[BridgeProtocol["AaveV2"] = 23] = "AaveV2";
    BridgeProtocol[BridgeProtocol["Compound"] = 24] = "Compound";
    BridgeProtocol[BridgeProtocol["BalancerV2Batch"] = 25] = "BalancerV2Batch";
    BridgeProtocol[BridgeProtocol["GMX"] = 26] = "GMX";
    BridgeProtocol[BridgeProtocol["Platypus"] = 27] = "Platypus";
    BridgeProtocol[BridgeProtocol["BancorV3"] = 28] = "BancorV3";
    BridgeProtocol[BridgeProtocol["Solidly"] = 29] = "Solidly";
    BridgeProtocol[BridgeProtocol["Synthetix"] = 30] = "Synthetix";
    BridgeProtocol[BridgeProtocol["WOOFi"] = 31] = "WOOFi";
    BridgeProtocol[BridgeProtocol["AaveV3"] = 32] = "AaveV3";
    BridgeProtocol[BridgeProtocol["KyberElastic"] = 33] = "KyberElastic";
