...
export declare class SwapQuoter implements ISwapQuoter {
    ...
    readonly rfqtTakerApiKeyWhitelist: string[];
    readonly rfqtMakerEndpoints: string[];
     ...
     * @return  An instance of SwapQuoter
     */
    constructor(supportedProvider: SupportedProvider, orderbook: Orderbook, options?: Partial<SwapQuoterOpts>, quoteRequestor?: QuoteRequestor);
    /**
