...
export declare class SwapQuoter {
    ...
    getPricesForAssetDataAsync(makerAssetDatas: string[], takerAssetData: string, makerAssetBuyAmount: BigNumber[], options?: Partial<SwapQuoteRequestOpts>): Promise<Array<{
        input: BigNumber;
        output: BigNumber;
        sellToken: string;
        buyToken: string;
