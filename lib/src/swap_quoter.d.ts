...
export declare type OrderbookOrder = LimitOrderFields & {
    signature: string;
};
export declare abstract class Orderbook {
    abstract getOrdersAsync(makerToken: string, takerToken: string, pruneFn?: (o: OrderbookOrder) => boolean): Promise<OrderbookOrder[]>;
    abstract getBatchOrdersAsync(makerTokens: string[], takerToken: string, pruneFn?: (o: OrderbookOrder) => boolean): Promise<OrderbookOrder[][]>;
