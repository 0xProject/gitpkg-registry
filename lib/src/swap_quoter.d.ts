...
import { MarketBuySwapQuote, MarketOperation, MarketSellSwapQuote, OrderPrunerPermittedFeeTypes, SignedLimitOrder, SwapQuote, SwapQuoteRequestOpts, SwapQuoterOpts } from './types';
import { MarketDepth } from './utils/market_operation_utils/types';
export declare abstract class Orderbook {
    abstract getOrdersAsync(makerToken: string, takerToken: string, pruneFn?: (o: SignedLimitOrder) => boolean): Promise<SignedLimitOrder[]>;
    abstract getBatchOrdersAsync(makerTokens: string[], takerToken: string, pruneFn?: (o: SignedLimitOrder) => boolean): Promise<SignedLimitOrder[][]>;
...
export declare class SwapQuoter {
    ...
    getBatchMarketBuySwapQuoteAsync(makerTokens: string[], targetTakerToken: string, makerAssetBuyAmounts: BigNumber[], options?: Partial<SwapQuoteRequestOpts>): Promise<MarketBuySwapQuote[]>;
    /**
