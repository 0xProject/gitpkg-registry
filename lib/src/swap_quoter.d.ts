...
export declare class SwapQuoter {
    ...
    getPricesForAssetDataAsync(makerAssetDatas: string[], takerAssetData: string, takerAssetAmount: BigNumber, options?: Partial<SwapQuoteRequestOpts>): Promise<Array<{
        input: BigNumber;
        output: BigNumber;
        sellToken: string;
        buyToken: string;
        sellTokenDecimals: BigNumber;
        buyTokenDecimals: BigNumber;
    } | undefined>>;
     ...
     */
    getBidAskLiquidityForMakerTakerAssetPairAsync(makerTokenAddress: string, takerTokenAddress: string, takerAssetAmount: BigNumber, options?: Partial<SwapQuoteRequestOpts>): Promise<MarketDepth>;
    /**
