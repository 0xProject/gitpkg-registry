...
describe('MarketOperationUtils tests', () => {
    ...
    function getSourceFromAssetData(assetData) {
        ...
        switch (bridgeAddress) {
            ...
            case contractAddresses.cofixBridge.toLowerCase():
                return types_2.ERC20BridgeSource.CoFiX;
            default:
                break;
        }
    ...
    const ZERO_RATES = {
        ...
        [types_2.ERC20BridgeSource.CryptoCom]: _.times(NUM_SAMPLES, () => 0),
    };
    ...
    const DEFAULT_FILL_DATA = {
        ...
        [types_2.ERC20BridgeSource.Dodo]: {},
        [types_2.ERC20BridgeSource.CryptoCom]: { tokenAddressPath: [] },
    };
    const DEFAULT_OPS = {
...
//# sourceMappingURL=market_operation_utils_test_BACKUP_63410.js.map