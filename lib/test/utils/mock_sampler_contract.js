...
var MockSamplerContract = /** @class */ (function (_super) {
    ...
    MockSamplerContract.prototype.batchCall = function (callDatas) {
        var _this = this;
        return __assign(__assign({}, _super.prototype.batchCall.call(this, callDatas)), { callAsync: function () {
                var callArgs = [];
                for (var _i = 0; _i < arguments.length; _i++) {
    ...
    MockSamplerContract.prototype.getOrderFillableMakerAssetAmounts = function (orders, signatures) {
        return this._wrapCall(_super.prototype.getOrderFillableMakerAssetAmounts, this._handlers.getOrderFillableMakerAssetAmounts, orders, signatures, contracts_test_utils_1.constants.NULL_ADDRESS);
    };
    MockSamplerContract.prototype.getOrderFillableTakerAssetAmounts = function (orders, signatures) {
        return this._wrapCall(_super.prototype.getOrderFillableTakerAssetAmounts, this._handlers.getOrderFillableTakerAssetAmounts, orders, signatures, contracts_test_utils_1.constants.NULL_ADDRESS);
    };
    ...
    MockSamplerContract.prototype.sampleSellsFromUniswapV2 = function (path, takerAssetAmounts) {
        return this._wrapCall(_super.prototype.sampleSellsFromUniswapV2, this._handlers.sampleSellsFromUniswapV2, path, takerAssetAmounts);
    };
    MockSamplerContract.prototype.sampleSellsFromLiquidityProviderRegistry = function (registryAddress, takerToken, makerToken, takerAssetAmounts) {
        return this._wrapCall(_super.prototype.sampleSellsFromLiquidityProviderRegistry, this._handlers.sampleSellsFromLiquidityProviderRegistry, registryAddress, takerToken, makerToken, takerAssetAmounts);
    };
    MockSamplerContract.prototype.sampleSellsFromMultiBridge = function (multiBridgeAddress, takerToken, intermediateToken, makerToken, takerAssetAmounts) {
        return this._wrapCall(_super.prototype.sampleSellsFromMultiBridge, this._handlers.sampleSellsFromMultiBridge, multiBridgeAddress, takerToken, intermediateToken, makerToken, takerAssetAmounts);
    };
    ...
    MockSamplerContract.prototype.sampleBuysFromUniswapV2 = function (path, makerAssetAmounts) {
        return this._wrapCall(_super.prototype.sampleBuysFromUniswapV2, this._handlers.sampleBuysFromUniswapV2, path, makerAssetAmounts);
    };
    ...
    MockSamplerContract.prototype._wrapCall = function (superFn, handler) {
        ...
        return __assign(__assign({}, superFn.call.apply(superFn, __spread([this], args))), { callAsync: function () {
                var callArgs = [];
                for (var _i = 0; _i < arguments.length; _i++) {
                    callArgs[_i] = arguments[_i];
                }
...
}(contract_wrappers_1.ERC20BridgeSamplerContract));
