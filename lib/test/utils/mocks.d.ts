...
export declare const mockedSwapQuoterWithFillableAmounts: (provider: Web3ProviderEngine, orderbook: any, makerAssetData: string, takerAssetData: string, signedOrders: SignedOrderWithFillableAmounts[]) => TypeMoq.IMock<SwapQuoter>;
export {};
