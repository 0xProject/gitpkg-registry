...
var BASE_TEST_SIGNED_ORDER = __assign(__assign({}, BASE_TEST_ORDER), { signature: constants_1.constants.NULL_BYTES });
var BASE_TEST_PRUNED_SIGNED_ORDER = __assign(__assign({}, BASE_TEST_SIGNED_ORDER), { fillableMakerAssetAmount: constants_1.constants.ZERO_AMOUNT, fillableTakerAssetAmount: constants_1.constants.ZERO_AMOUNT, fillableTakerFeeAmount: constants_1.constants.ZERO_AMOUNT });
