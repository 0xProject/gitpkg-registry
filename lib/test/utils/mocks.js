...
exports.mockedSwapQuoterWithFillableAmounts = exports.protocolFeeUtilsMock = exports.mockAvailableAssetDatas = exports.orderbookMock = void 0;
...
exports.mockAvailableAssetDatas = function (mockOrderbook, availableAssetDatas) {
    mockOrderbook
        .setup(function (op) { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
        return [2 /*return*/, op.getAvailableAssetDatasAsync()];
    }); }); })
        .returns(function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
...
var ProtocolFeeUtilsClass = /** @class */ (function () {
    function ProtocolFeeUtilsClass() {
    }
    ProtocolFeeUtilsClass.getInstance = function () {
        var _this = this;
        var _args = [];
        ...
        return {
            getGasPriceEstimationOrThrowAsync: function () { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                return [2 /*return*/, Promise.resolve(new utils_1.BigNumber(contracts_test_utils_1.constants.DEFAULT_GAS_PRICE))];
            }); }); },
        };
    };
    // tslint:disable-next-line:prefer-function-over-method
...
var mockGetSignedOrdersWithFillableAmountsAsyncAsync = function (mockedSwapQuoter, makerAssetData, takerAssetData, signedOrders) {
    mockedSwapQuoter
        .setup(function (a) { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
