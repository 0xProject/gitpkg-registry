...
function getFullyFillableSwapQuoteWithNoFeesAsync(makerAssetData, takerAssetData, orders, operation, gasPrice) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (operation === types_1.MarketOperation.Buy) {
            return Object.assign({}, quoteBase, { type: types_1.MarketOperation.Buy, makerAssetFillAmount });
        }
        else {
            return Object.assign({}, quoteBase, { type: types_1.MarketOperation.Sell, takerAssetFillAmount: totalTakerAssetAmount });
        }
    });
}
