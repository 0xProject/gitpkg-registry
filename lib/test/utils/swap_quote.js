...
function getFullyFillableSwapQuoteWithNoFeesAsync(makerAssetData, takerAssetData, orders, operation, gasPrice) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, makerAssetFillAmount, totalTakerAssetAmount, protocolFeePerOrder, quoteInfo, breakdown, quoteBase;
        return __generator(this, function (_b) {
            ...
            quoteBase = {
                ...
                orders: orders.map(function (order) { return (__assign({}, order, { fills: [] })); }),
                gasPrice: gasPrice,
