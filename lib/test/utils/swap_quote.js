...
function getFullyFillableSwapQuoteWithNoFeesAsync(makerAssetData, takerAssetData, orders, operation, gasPrice) {
    return __awaiter(this, void 0, void 0, function () {
        var makerAssetFillAmount, totalTakerAssetAmount, protocolFeePerOrder, quoteInfo, breakdown, quoteBase;
        var _a;
        return __generator(this, function (_b) {
            ...
            protocolFeePerOrder = constants_1.constants.PROTOCOL_FEE_MULTIPLIER.times(gasPrice);
            quoteInfo = {
            ...
            quoteBase = {
                ...
                orders: orders.map(function (order) { return (__assign(__assign({}, order), { fills: [] })); }),
                gasPrice: gasPrice,
            ...
            if (operation === types_1.MarketOperation.Buy) {
                return [2 /*return*/, __assign(__assign({}, quoteBase), { type: types_1.MarketOperation.Buy, makerAssetFillAmount: makerAssetFillAmount })];
            }
            else {
                return [2 /*return*/, __assign(__assign({}, quoteBase), { type: types_1.MarketOperation.Sell, takerAssetFillAmount: totalTakerAssetAmount })];
            }
            return [2 /*return*/];
        });
    });
