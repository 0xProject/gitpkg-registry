...
function getFullyFillableSwapQuoteWithNoFeesAsync(makerToken, takerToken, orders, operation, gasPrice) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const quoteBase = {
            ...
            isTwoHop: false,
            takerTokenToEthRate: constants_1.constants.ZERO_AMOUNT,
            makerTokenToEthRate: constants_1.constants.ZERO_AMOUNT,
            makerTokenDecimals: 18,
            takerTokenDecimals: 18,
        };
        if (operation === types_1.MarketOperation.Buy) {
            return Object.assign({}, quoteBase, { type: types_1.MarketOperation.Buy, makerTokenFillAmount: makerAmount });
        }
        else {
            return Object.assign({}, quoteBase, { type: types_1.MarketOperation.Sell, takerTokenFillAmount: takerAmount });
        }
    });
}
