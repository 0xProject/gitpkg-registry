...
export declare const testHelpers: {
     ...
     */
    withMockedRfqtQuotes: (standardMockedResponses: MockedRfqtQuoteResponse[], altMockedResponses: AltMockedRfqtQuoteResponse[], quoteType: RfqtQuoteEndpoint, afterResponseCallback: () => Promise<void>, axiosClient?: AxiosInstance) => Promise<void>;
};
