...
describe('ExchangeProxySwapQuoteConsumer', () => {
    ...
    describe('getCalldataOrThrow()', () => {
        ...
        it('adds CoFix ETH fees', () => __awaiter(this, void 0, void 0, function* () {
            const quote = getRandomSellQuote();
            const originalCallInfo = yield consumer.getCalldataOrThrowAsync(quote);
            const fee = new utils_1.BigNumber(0.01e18);
            // Load the first order up as a CoFiX fill
            quote.orders[0].fills = [
                {
                    source: types_2.ERC20BridgeSource.CoFiX,
            ...
            const cofixCallInfo = yield consumer.getCalldataOrThrowAsync(quote);
            expect(cofixCallInfo.ethAmount).to.be.bignumber.eq(originalCallInfo.ethAmount.plus(fee));
        }));
    });
});
//# sourceMappingURL=exchange_proxy_swap_quote_consumer_test_REMOTE_66607.js.map