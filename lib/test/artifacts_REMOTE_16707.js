...
const DummyLiquidityProvider = require("../test/generated-artifacts/DummyLiquidityProvider.json");
const DummyLiquidityProviderRegistry = require("../test/generated-artifacts/DummyLiquidityProviderRegistry.json");
const ERC20BridgeSampler = require("../test/generated-artifacts/ERC20BridgeSampler.json");
const Eth2DaiSampler = require("../test/generated-artifacts/Eth2DaiSampler.json");
const ICurve = require("../test/generated-artifacts/ICurve.json");
const IDODO = require("../test/generated-artifacts/IDODO.json");
const IEth2Dai = require("../test/generated-artifacts/IEth2Dai.json");
const IKyberHintHandler = require("../test/generated-artifacts/IKyberHintHandler.json");
const IKyberNetwork = require("../test/generated-artifacts/IKyberNetwork.json");
const IKyberNetworkProxy = require("../test/generated-artifacts/IKyberNetworkProxy.json");
const IKyberStorage = require("../test/generated-artifacts/IKyberStorage.json");
const ILiquidityProvider = require("../test/generated-artifacts/ILiquidityProvider.json");
const ILiquidityProviderRegistry = require("../test/generated-artifacts/ILiquidityProviderRegistry.json");
...
const MultiBridgeSampler = require("../test/generated-artifacts/MultiBridgeSampler.json");
...
const TestERC20BridgeSampler = require("../test/generated-artifacts/TestERC20BridgeSampler.json");
...
//# sourceMappingURL=artifacts_REMOTE_16707.js.map