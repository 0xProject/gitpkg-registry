...
describe('ABI Encoder: Return Value Encoding/Decoding', () => {
    ...
    describe('Standard encoding/decoding', () => {
        it('No Return Value', () => __awaiter(this, void 0, void 0, function* () {
            // Decode return value
        ...
        it('Single static return value', () => __awaiter(this, void 0, void 0, function* () {
        ...
        it('Multiple static return values', () => __awaiter(this, void 0, void 0, function* () {
            // Generate Return Value
        ...
        it('Single dynamic return value', () => __awaiter(this, void 0, void 0, function* () {
            // Generate Return Value
        ...
        it('Multiple dynamic return values', () => __awaiter(this, void 0, void 0, function* () {
            // Generate Return Value
        ...
        it('Mixed static/dynamic return values', () => __awaiter(this, void 0, void 0, function* () {
            // Generate Return Value
        ...
        it('Should decode NULL as default value (single; static)', () => __awaiter(this, void 0, void 0, function* () {
            // Generate Return Value
            const method = new src_1.AbiEncoder.Method(ReturnValueAbis.singleStaticReturnValue);
        ...
        it('Should decode NULL as default value (multiple; static)', () => __awaiter(this, void 0, void 0, function* () {
            // Generate Return Value
            const method = new src_1.AbiEncoder.Method(ReturnValueAbis.multipleStaticReturnValues);
        ...
        it('Should decode NULL as default value (single; dynamic)', () => __awaiter(this, void 0, void 0, function* () {
            // Generate Return Value
            const method = new src_1.AbiEncoder.Method(ReturnValueAbis.singleDynamicReturnValue);
            const returnValue = ['0x'];
            const decodedReturnValue = method.decodeReturnValues(nullEncodedReturnValue, {
    ...
    describe('Strict encoding/decoding', () => {
        ...
        it('Struct should include fields', () => __awaiter(this, void 0, void 0, function* () {
            // Generate Return Value
        ...
        it('Should fail to decode NULL (single; static)', () => __awaiter(this, void 0, void 0, function* () {
            // Generate Return Value
            const method = new src_1.AbiEncoder.Method(ReturnValueAbis.singleStaticReturnValue);
        ...
        it('Should fail to decode NULL (multiple; static)', () => __awaiter(this, void 0, void 0, function* () {
            // Generate Return Value
            const method = new src_1.AbiEncoder.Method(ReturnValueAbis.multipleStaticReturnValues);
            const encodedReturnValue = '0x';
            const decodeReturnValue = () => method.strictDecodeReturnValue(encodedReturnValue);
        ...
        it('Should fail to decode NULL (single; dynamic)', () => __awaiter(this, void 0, void 0, function* () {
            // Generate Return Value
            const method = new src_1.AbiEncoder.Method(ReturnValueAbis.singleDynamicReturnValue);
            const encodedReturnValue = '0x';
            const decodeReturnValue = () => method.strictDecodeReturnValue(encodedReturnValue);
