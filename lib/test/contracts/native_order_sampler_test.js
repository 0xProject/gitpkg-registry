...
// TODO jacob
contracts_test_utils_1.blockchainTests.resets.skip('NativeOrderSampler contract', env => {
    let testContract;
    let makerToken;
    let takerToken;
    ...
    describe('getTokenDecimals()', () => {
        it('correctly returns the token decimals', () => __awaiter(this, void 0, void 0, function* () {
    ...
    describe('getLimitOrderFillableTakerAmount()', () => {
        ...
        it('returns zero for an order with zero maker asset amount', () => __awaiter(this, void 0, void 0, function* () {
            const order = Object.assign({}, createOrder(), { makerAmount: ZERO_AMOUNT });
            yield fundMakerAsync(order);
            const fillableTakerAmount = yield testContract
                .getLimitOrderFillableTakerAmount(order, VALID_SIGNATURE, testContract.address)
                .callAsync();
        ...
        it('returns zero for an order with zero taker asset amount', () => __awaiter(this, void 0, void 0, function* () {
            const order = Object.assign({}, createOrder(), { takerAmount: ZERO_AMOUNT });
            yield fundMakerAsync(order);
            const fillableTakerAmount = yield testContract
                .getLimitOrderFillableTakerAmount(order, VALID_SIGNATURE, testContract.address)
                .callAsync();
        ...
        it('returns zero for an order with an empty signature', () => __awaiter(this, void 0, void 0, function* () {
            ...
            yield fundMakerAsync(order);
            const fillableTakerAmount = yield testContract
                .getLimitOrderFillableTakerAmount(order, Object.assign({}, VALID_SIGNATURE, { r: NULL_BYTES, s: NULL_BYTES }), testContract.address)
                .callAsync();
            contracts_test_utils_1.expect(fillableTakerAmount).to.bignumber.eq(ZERO_AMOUNT);
        }));
    });
