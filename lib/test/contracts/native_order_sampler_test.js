...
contracts_test_utils_1.blockchainTests.resets('NativeOrderSampler contract', env => {
    ...
    function createOrder(fields = {}, filledTakerAssetAmount = ZERO_AMOUNT) {
        return Object.assign({ chainId: 1337, verifyingContract: (0, contracts_test_utils_1.randomAddress)(), maker: makerAddress, taker: constants_1.NULL_ADDRESS, pool: NULL_BYTES, sender: constants_1.NULL_ADDRESS, feeRecipient: (0, contracts_test_utils_1.randomAddress)(), makerAmount: (0, contracts_test_utils_1.getRandomInteger)(1, 1e18), takerAmount: (0, contracts_test_utils_1.getRandomInteger)(1, 1e18), takerTokenFeeAmount: (0, contracts_test_utils_1.getRandomInteger)(1, 1e18), makerToken,
