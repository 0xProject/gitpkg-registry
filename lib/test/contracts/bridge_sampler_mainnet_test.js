...
contracts_test_utils_1.blockchainTests.skip('Mainnet Sampler Tests', env => {
    ...
    (0, contracts_test_utils_1.describe)('Kyber', () => {
        ...
        (0, contracts_test_utils_1.describe)('sampleSellsFromKyberNetwork()', () => {
            it('samples sells from Kyber DAI->WETH', () => __awaiter(void 0, void 0, void 0, function* () {
                const [, samples] = yield testContract
                    .sampleSellsFromKyberNetwork(KYBER_OPTS, DAI, WETH, [(0, contracts_test_utils_1.toBaseUnitAmount)(1)])
                    .callAsync({ overrides });
                (0, contracts_test_utils_1.expect)(samples.length).to.be.bignumber.greaterThan(0);
                (0, contracts_test_utils_1.expect)(samples[0]).to.be.bignumber.greaterThan(0);
            }));
            it('samples sells from Kyber WETH->DAI', () => __awaiter(void 0, void 0, void 0, function* () {
                const [, samples] = yield testContract
                    .sampleSellsFromKyberNetwork(KYBER_OPTS, WETH, DAI, [(0, contracts_test_utils_1.toBaseUnitAmount)(1)])
                    .callAsync({ overrides });
                (0, contracts_test_utils_1.expect)(samples.length).to.be.bignumber.greaterThan(0);
                (0, contracts_test_utils_1.expect)(samples[0]).to.be.bignumber.greaterThan(0);
            }));
            it('samples sells from Kyber DAI->USDC', () => __awaiter(void 0, void 0, void 0, function* () {
                const [, samples] = yield testContract
                    .sampleSellsFromKyberNetwork(KYBER_OPTS, DAI, USDC, [(0, contracts_test_utils_1.toBaseUnitAmount)(1)])
                    .callAsync({ overrides });
                (0, contracts_test_utils_1.expect)(samples.length).to.be.bignumber.greaterThan(0);
                (0, contracts_test_utils_1.expect)(samples[0]).to.be.bignumber.greaterThan(0);
            }));
        });
        (0, contracts_test_utils_1.describe)('sampleBuysFromKyber()', () => {
            it('samples buys from Kyber WETH->DAI', () => __awaiter(void 0, void 0, void 0, function* () {
                // From ETH to DAI
                // I want to buy 1 DAI
                const [, samples] = yield testContract
                    .sampleBuysFromKyberNetwork(KYBER_OPTS, WETH, DAI, [(0, contracts_test_utils_1.toBaseUnitAmount)(1)])
                    .callAsync({ overrides });
                (0, contracts_test_utils_1.expect)(samples.length).to.be.bignumber.greaterThan(0);
                (0, contracts_test_utils_1.expect)(samples[0]).to.be.bignumber.greaterThan(0);
            }));
            it('samples buys from Kyber DAI->WETH', () => __awaiter(void 0, void 0, void 0, function* () {
                ...
                const [, samples] = yield testContract
                    .sampleBuysFromKyberNetwork(KYBER_OPTS, DAI, WETH, [(0, contracts_test_utils_1.toBaseUnitAmount)(1)])
                    .callAsync({ overrides });
                (0, contracts_test_utils_1.expect)(samples.length).to.be.bignumber.greaterThan(0);
                (0, contracts_test_utils_1.expect)(samples[0]).to.be.bignumber.greaterThan(0);
            }));
