...
contracts_test_utils_1.blockchainTests('erc20-bridge-sampler', env => {
    ...
    contracts_test_utils_1.blockchainTests.resets('sampleSellsFromKyberNetwork()', () => {
        ...
        before(() => __awaiter(this, void 0, void 0, function* () {
            ...
            kyberOpts = Object.assign({}, kyberOpts, { hintHandler: testContract.address, networkProxy: testContract.address });
        }));
    ...
    contracts_test_utils_1.blockchainTests.resets('sampleSellsFromEth2Dai()', () => {
        ...
        it('throws if tokens are the same', () => __awaiter(this, void 0, void 0, function* () {
            const tx = testContract
                .sampleSellsFromEth2Dai(testContract.address, MAKER_TOKEN, MAKER_TOKEN, [])
                .callAsync();
            return contracts_test_utils_1.expect(tx).to.revertWith(INVALID_TOKEN_PAIR_ERROR);
        }));
        it('can return no quotes', () => __awaiter(this, void 0, void 0, function* () {
            const quotes = yield testContract
                .sampleSellsFromEth2Dai(testContract.address, TAKER_TOKEN, MAKER_TOKEN, [])
                .callAsync();
            contracts_test_utils_1.expect(quotes).to.deep.eq([]);
        }));
        it('can quote token -> token', () => __awaiter(this, void 0, void 0, function* () {
            ...
            const quotes = yield testContract
                .sampleSellsFromEth2Dai(testContract.address, TAKER_TOKEN, MAKER_TOKEN, sampleAmounts)
                .callAsync();
            contracts_test_utils_1.expect(quotes).to.deep.eq(expectedQuotes);
        }));
        it('returns zero if token -> token fails', () => __awaiter(this, void 0, void 0, function* () {
        ...
        it('can quote token -> ETH', () => __awaiter(this, void 0, void 0, function* () {
            ...
            const quotes = yield testContract
                .sampleSellsFromEth2Dai(testContract.address, TAKER_TOKEN, WETH_ADDRESS, sampleAmounts)
                .callAsync();
            contracts_test_utils_1.expect(quotes).to.deep.eq(expectedQuotes);
        }));
        it('returns zero if token -> ETH fails', () => __awaiter(this, void 0, void 0, function* () {
        ...
        it('can quote ETH -> token', () => __awaiter(this, void 0, void 0, function* () {
            ...
            const quotes = yield testContract
                .sampleSellsFromEth2Dai(testContract.address, WETH_ADDRESS, TAKER_TOKEN, sampleAmounts)
                .callAsync();
            contracts_test_utils_1.expect(quotes).to.deep.eq(expectedQuotes);
        }));
        it('returns zero if ETH -> token fails', () => __awaiter(this, void 0, void 0, function* () {
    ...
    contracts_test_utils_1.blockchainTests.resets('sampleBuysFromEth2Dai()', () => {
        ...
        it('throws if tokens are the same', () => __awaiter(this, void 0, void 0, function* () {
            const tx = testContract
                .sampleBuysFromEth2Dai(testContract.address, MAKER_TOKEN, MAKER_TOKEN, [])
                .callAsync();
            return contracts_test_utils_1.expect(tx).to.revertWith(INVALID_TOKEN_PAIR_ERROR);
        }));
        it('can return no quotes', () => __awaiter(this, void 0, void 0, function* () {
            const quotes = yield testContract
                .sampleBuysFromEth2Dai(contracts_test_utils_1.randomAddress(), TAKER_TOKEN, MAKER_TOKEN, [])
                .callAsync();
            contracts_test_utils_1.expect(quotes).to.deep.eq([]);
        }));
        it('can quote token -> token', () => __awaiter(this, void 0, void 0, function* () {
            ...
            const quotes = yield testContract
                .sampleBuysFromEth2Dai(testContract.address, TAKER_TOKEN, MAKER_TOKEN, sampleAmounts)
                .callAsync();
            contracts_test_utils_1.expect(quotes).to.deep.eq(expectedQuotes);
        }));
        it('returns zero if token -> token fails', () => __awaiter(this, void 0, void 0, function* () {
        ...
        it('can quote token -> ETH', () => __awaiter(this, void 0, void 0, function* () {
            ...
            const quotes = yield testContract
                .sampleBuysFromEth2Dai(testContract.address, TAKER_TOKEN, WETH_ADDRESS, sampleAmounts)
                .callAsync();
            contracts_test_utils_1.expect(quotes).to.deep.eq(expectedQuotes);
        }));
        it('returns zero if token -> ETH fails', () => __awaiter(this, void 0, void 0, function* () {
        ...
        it('can quote ETH -> token', () => __awaiter(this, void 0, void 0, function* () {
            ...
            const quotes = yield testContract
                .sampleBuysFromEth2Dai(testContract.address, WETH_ADDRESS, TAKER_TOKEN, sampleAmounts)
                .callAsync();
            contracts_test_utils_1.expect(quotes).to.deep.eq(expectedQuotes);
        }));
        it('returns zero if ETH -> token fails', () => __awaiter(this, void 0, void 0, function* () {
    ...
    contracts_test_utils_1.blockchainTests.resets('TwoHopSampler', () => {
        ...
        it('sampleTwoHopSell', () => __awaiter(this, void 0, void 0, function* () {
            ...
            const eth2DaiFirstHop = testContract
                .sampleSellsFromEth2Dai(testContract.address, TAKER_TOKEN, INTERMEDIATE_TOKEN, [contracts_test_utils_1.constants.ZERO_AMOUNT])
                .getABIEncodedTransactionData();
            const eth2DaiSecondHop = testContract
                .sampleSellsFromEth2Dai(testContract.address, INTERMEDIATE_TOKEN, MAKER_TOKEN, [contracts_test_utils_1.constants.ZERO_AMOUNT])
                .getABIEncodedTransactionData();
        ...
        it('sampleTwoHopBuy', () => __awaiter(this, void 0, void 0, function* () {
            ...
            const uniswapV2SecondHop = testContract
                ...
                .getABIEncodedTransactionData();
            const eth2DaiFirstHop = testContract
                .sampleBuysFromEth2Dai(contracts_test_utils_1.randomAddress(), TAKER_TOKEN, INTERMEDIATE_TOKEN, [contracts_test_utils_1.constants.ZERO_AMOUNT])
                .getABIEncodedTransactionData();
            const eth2DaiSecondHop = testContract
                .sampleBuysFromEth2Dai(contracts_test_utils_1.randomAddress(), INTERMEDIATE_TOKEN, MAKER_TOKEN, [contracts_test_utils_1.constants.ZERO_AMOUNT])
                .getABIEncodedTransactionData();
            const secondHopQuotes = [
...
//# sourceMappingURL=erc20_bridge_sampler_test_REMOTE_38151.js.map