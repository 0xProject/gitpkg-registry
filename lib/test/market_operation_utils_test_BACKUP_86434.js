...
const BUY_SOURCES = constants_2.BUY_SOURCE_FILTER.sources;
const SELL_SOURCES = constants_2.SELL_SOURCE_FILTER.sources;
// tslint:disable: custom-no-magic-numbers promise-function-async
describe('MarketOperationUtils tests', () => {
    const CHAIN_ID = ChainId.Mainnet;
    const contractAddresses = Object.assign({}, contract_addresses_1.getContractAddressesForChainOrThrow(CHAIN_ID), { multiBridge: utils_1.NULL_ADDRESS }, BRIDGE_ADDRESSES_BY_CHAIN[CHAIN_ID]);
        ...
        describe('getMarketSellOrdersAsync()', () => {
            ...
            it('polls the liquidity provider when the registry is provided in the arguments', () => __awaiter(this, void 0, void 0, function* () {
                ...
                replaceSamplerOps({
                    ...
                    getCreamSellQuotesOffChainAsync: (makerToken, takerToken, takerFillAmounts) => {
                        args.sources = args.sources.concat(types_2.ERC20BridgeSource.Cream);
                        return DEFAULT_OPS.getCreamSellQuotesOffChainAsync(makerToken, takerToken, takerFillAmounts);
                    },
                });
            ...
            it('getMarketSellOrdersAsync() optimizer will be called once only if RFQ if not defined', constants_1.IS_PRICE_AWARE_RFQ_ENABLED
                ...
                : undefined);
            it('optimizer will send in a comparison price to RFQ providers', constants_1.IS_PRICE_AWARE_RFQ_ENABLED
                ? () => __awaiter(this, void 0, void 0, function* () {
                        ...
                        return [
                            {
                                signedOrder: createOrder({
                                    ...
                                    makerAssetAmount: dev_utils_1.Web3Wrapper.toBaseUnitAmount(321, 6),
                                    takerAssetAmount: dev_utils_1.Web3Wrapper.toBaseUnitAmount(1, 18),
                                }),
                            },
                        ];
                    }));
                    ...
                    mockedMarketOpUtils
                        ...
                        return {
                            dexQuotes: [],
                            ethToInputRate: dev_utils_1.Web3Wrapper.toBaseUnitAmount(1, 18),
                            ethToOutputRate: dev_utils_1.Web3Wrapper.toBaseUnitAmount(1, 6),
                            inputAmount: dev_utils_1.Web3Wrapper.toBaseUnitAmount(1, 18),
                            ...
                            nativeOrders: [
                                createOrder({
                                    makerAssetData: MAKER_ASSET_DATA,
                                    takerAssetData: TAKER_ASSET_DATA,
                                    makerAssetAmount: dev_utils_1.Web3Wrapper.toBaseUnitAmount(320, 6),
                                    takerAssetAmount: dev_utils_1.Web3Wrapper.toBaseUnitAmount(1, 18),
                                }),
                            ],
                            orderFillableAmounts: [dev_utils_1.Web3Wrapper.toBaseUnitAmount(1, 18)],
                    ...
                    const result = yield mockedMarketOpUtils.object.getMarketSellOrdersAsync(ORDERS, dev_utils_1.Web3Wrapper.toBaseUnitAmount(1, 18), Object.assign({}, DEFAULT_OPTS, { rfqt: {
                            isIndicative: false,
                            apiKey: 'foo',
                ...
                : undefined);
            it('getMarketSellOrdersAsync() will not rerun the optimizer if no orders are returned', constants_1.IS_PRICE_AWARE_RFQ_ENABLED
                ? () => __awaiter(this, void 0, void 0, function* () {
                    // Ensure that `_generateOptimizedOrdersAsync` is only called once
                    const mockedMarketOpUtils = TypeMoq.Mock.ofType(market_operation_utils_1.MarketOperationUtils, TypeMoq.MockBehavior.Loose, false, MOCK_SAMPLER, contractAddresses, ORDER_DOMAIN);
                    mockedMarketOpUtils.callBase = true;
                ...
                : undefined);
            it('getMarketSellOrdersAsync() will rerun the optimizer if one or more indicative are returned', constants_1.IS_PRICE_AWARE_RFQ_ENABLED
                ? () => __awaiter(this, void 0, void 0, function* () {
                ...
                : undefined);
            it('getMarketSellOrdersAsync() will rerun the optimizer if one or more RFQ orders are returned', constants_1.IS_PRICE_AWARE_RFQ_ENABLED
                ? () => __awaiter(this, void 0, void 0, function* () {
                ...
                : undefined);
            it('getMarketSellOrdersAsync() will not raise a NoOptimalPath error if no initial path was found during on-chain DEX optimization, but a path was found after RFQ optimization', constants_1.IS_PRICE_AWARE_RFQ_ENABLED
                ? () => __awaiter(this, void 0, void 0, function* () {
            ...
            it('factors in exchange proxy gas overhead', () => __awaiter(this, void 0, void 0, function* () {
                ...
                const optimizer = new market_operation_utils_1.MarketOperationUtils(MOCK_SAMPLER, contractAddresses, ORDER_DOMAIN, contracts_test_utils_1.randomAddress());
                const gasPrice = 100e9; // 100 gwei
                const exchangeProxyOverhead = (sourceFlags) => sourceFlags === constants_2.SOURCE_FLAGS.LiquidityProvider
                    ? new utils_1.BigNumber(3e4).times(gasPrice)
                    : new utils_1.BigNumber(1.3e5).times(gasPrice);
                const improvedOrdersResponse = yield optimizer.getMarketSellOrdersAsync(createOrdersFromSellRates(FILL_AMOUNT, rates[types_2.ERC20BridgeSource.Native]), FILL_AMOUNT, Object.assign({}, DEFAULT_OPTS, { numSamples: 4, excludedSources: [
        ...
        describe('getMarketBuyOrdersAsync()', () => {
            ...
            it('factors in exchange proxy gas overhead', () => __awaiter(this, void 0, void 0, function* () {
                ...
                const exchangeProxyOverhead = (sourceFlags) => sourceFlags === constants_2.SOURCE_FLAGS.LiquidityProvider
                    ? new utils_1.BigNumber(3e4).times(gasPrice)
                    : new utils_1.BigNumber(1.3e5).times(gasPrice);
                const improvedOrdersResponse = yield optimizer.getMarketBuyOrdersAsync(createOrdersFromSellRates(FILL_AMOUNT, rates[types_2.ERC20BridgeSource.Native]), FILL_AMOUNT, Object.assign({}, DEFAULT_OPTS, { numSamples: 4, excludedSources: [
                        ...DEFAULT_OPTS.excludedSources,
                        types_2.ERC20BridgeSource.Eth2Dai,
                        types_2.ERC20BridgeSource.Kyber,
                    ], exchangeProxyOverhead }));
    ...
    describe('createFills', () => {
        ...
        const smallOrder = {
            ...
            makerFee: constants_2.ZERO_AMOUNT,
            takerFee: constants_2.ZERO_AMOUNT,
        ...
        it('penalizes native fill based on available amount when target is larger', () => {
            const path = fills_1.createFills({
                ...
                orders,
                dexQuotes: [],
                targetInput: constants_2.POSITIVE_INF,
                ethToOutputRate,
                feeSchedule,
            });
...
//# sourceMappingURL=market_operation_utils_test_BACKUP_86434.js.map