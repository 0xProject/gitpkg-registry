...
describe('generateQuoteReport', () => __awaiter(void 0, void 0, void 0, function* () {
    it('should generate report properly for sell', () => {
        ...
        const balancerSample2 = {
            source: types_2.ERC20BridgeSource.BalancerV2,
        ...
        // generate path
        const uniswap2Fill = Object.assign(Object.assign({}, uniswapSample2), { sourcePathId: utils_1.hexUtils.random(), type: protocol_utils_1.FillQuoteTransformerOrderType.Bridge, adjustedOutput: uniswapSample2.output, flags: BigInt(0), gas: 1 });
        const balancer2Fill = Object.assign(Object.assign({}, balancerSample2), { sourcePathId: utils_1.hexUtils.random(), type: protocol_utils_1.FillQuoteTransformerOrderType.Bridge, adjustedOutput: balancerSample2.output, flags: BigInt(0), gas: 1 });
        ...
        const balancer2Source = {
            liquiditySource: types_2.ERC20BridgeSource.BalancerV2,
    ...
    it('should handle properly for buy without quoteRequestor', () => {
        ...
        const uniswap1Fill = Object.assign(Object.assign({}, uniswapSample1), { sourcePathId: utils_1.hexUtils.random(), type: protocol_utils_1.FillQuoteTransformerOrderType.Bridge, adjustedOutput: uniswapSample1.output, flags: BigInt(0), gas: 1 });
        const balancer1Fill = Object.assign(Object.assign({}, balancerSample1), { sourcePathId: utils_1.hexUtils.random(), type: protocol_utils_1.FillQuoteTransformerOrderType.Bridge, adjustedOutput: balancerSample1.output, flags: BigInt(0), gas: 1 });
