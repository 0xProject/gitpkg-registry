...
describe('generateQuoteReport', () => __awaiter(void 0, void 0, void 0, function* () {
    it('should generate report properly for sell', () => {
        const marketOperation = types_2.MarketOperation.Sell;
        const kyberSample2 = {
        ...
        const kyber2Source = {
            liquiditySource: types_1.ERC20BridgeSource.Kyber,
    ...
    it('should handle properly for buy without quoteRequestor', () => {
        const marketOperation = types_2.MarketOperation.Buy;
        const kyberSample1 = {
            source: types_1.ERC20BridgeSource.Kyber,
    ...
    it('should correctly generate report for a two-hop quote', () => {
        ...
        const twoHopFillData = {
            ...
            firstHop: {
                ...
                fillData: {},
                input: new utils_1.BigNumber(1337),
                output: new utils_1.BigNumber(1337),
            },
            secondHop: {
