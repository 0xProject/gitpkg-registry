...
describe('generateQuoteReport', () => __awaiter(this, void 0, void 0, function* () {
    it('should generate report properly for sell', () => {
        ...
        quoteRequestor
            ...
            .verifiable(TypeMoq.Times.atLeastOnce());
        const orderReport = quote_report_generator_1.generateQuoteReport(marketOperation, dexQuotes, [], nativeOrders, orderFillableAmounts, pathGenerated, undefined, quoteRequestor.object);
