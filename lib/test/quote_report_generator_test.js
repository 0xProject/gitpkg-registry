        ...
        describe('generateReport', function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                it('should generate report properly for sell', function () {
                    ...
                    // generate path
                    var uniswap2Fill = __assign({}, uniswapSample2, { subFills: [] });
                    var kyber2Fill = __assign({}, kyberSample2, { subFills: [] });
                ...
                it('should handle properly for buy without quoteRequestor', function () {
                    ...
                    var uniswap1Fill = __assign({}, uniswapSample1, { subFills: [] });
                    var kyber1Fill = __assign({}, kyberSample1, { subFills: [] });
