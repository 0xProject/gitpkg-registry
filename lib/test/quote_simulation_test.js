...
describe('quote_simulation tests', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    function createQuoteFillOrders(opts = {}) {
        const { fillableInput, fillableOutput, inputFeeRate, outputFeeRate, count, side, type } = Object.assign({ fillableInput: getRandomOrderSize(), fillableOutput: getRandomOrderSize(), inputFeeRate: 0, outputFeeRate: 0, count: 3, side: types_1.MarketOperation.Sell }, opts);
