...
describe('quote_simulation tests', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    describe('fillQuoteOrders()', () => {
        describe('single order', () => {
            it('can exactly fill one order', () => {
                ...
                (0, contracts_test_utils_1.expect)(result.gas).to.eq(fillsCount);
            });
            it('can partially fill one simple order', () => {
                ...
                (0, contracts_test_utils_1.expect)(result.protocolFee).to.bignumber.eq(1);
                (0, contracts_test_utils_1.expect)(result.gas).to.eq(1);
            });
            it('can partially fill one batched order', () => {
                ...
                (0, contracts_test_utils_1.expect)(result.protocolFee).to.bignumber.eq(1);
                (0, contracts_test_utils_1.expect)(result.gas).to.gte(1);
                (0, contracts_test_utils_1.expect)(result.gas).to.lte(fillsCount);
            });
        ...
        describe('multiple orders', () => {
            it('can exactly fill orders', () => {
                ...
                (0, contracts_test_utils_1.expect)(result.gas).to.eq(countCollapsedFills(fillOrders));
            });
            ...
            it('can partial fill orders with input fees', () => {
                ...
                (0, contracts_test_utils_1.expect)(result.gas).to.lte(countCollapsedFills(fillOrders));
            });
    ...
    describe('simulateBestCaseFill()', () => {
        ...
        it('can fully fill orders', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            (0, contracts_test_utils_1.expect)(result.gas).to.eq(countCollapsedFills(orders));
