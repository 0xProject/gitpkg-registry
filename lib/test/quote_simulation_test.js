...
describe('quote_simulation tests', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const GAS_SCHEDULE = { [types_2.ERC20BridgeSource.Uniswap]: _.constant(1), [types_2.ERC20BridgeSource.Native]: _.constant(1) };
    ...
    function createQuoteFillOrders(opts = {}) {
        const { fillableInput, fillableOutput, inputFeeRate, outputFeeRate, count, fillsCount, side, type } = Object.assign({ fillableInput: getRandomOrderSize(), fillableOutput: getRandomOrderSize(), inputFeeRate: 0, outputFeeRate: 0, count: 3, fillsCount: 3, side: types_1.MarketOperation.Sell }, opts);
    ...
    describe('simulateBestCaseFill()', () => {
        ...
        it('can fully fill orders', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            contracts_test_utils_1.expect(result.protocolFeeAmount).to.bignumber.eq(orders.length);
