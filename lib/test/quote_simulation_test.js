...
describe('quote_simulation tests', () => __awaiter(this, void 0, void 0, function* () {
    ...
    function slipOrder(order, orderSlippage, side) {
        ...
        const slippedFillData = {
            order: Object.assign({}, nativeFillData.order, { takerAmount: nativeFillData.order.takerAmount.times(takerScaling), makerAmount: nativeFillData.order.makerAmount.times(makerScaling) }),
            signature: nativeFillData.signature,
            maxTakerTokenFillAmount: nativeFillData.maxTakerTokenFillAmount.times(takerScaling),
        };
        return Object.assign({}, order, { makerAmount: order.makerAmount.times(makerScaling), takerAmount: order.takerAmount.times(takerScaling), fillData: slippedFillData });
    }
    describe('simulateBestCaseFill()', () => {
        ...
        it('can fully fill sell orders with "input" fees', () => __awaiter(this, void 0, void 0, function* () {
        ...
        it('can partially fill sell orders with "input" fees', () => __awaiter(this, void 0, void 0, function* () {
            const side = types_1.MarketOperation.Sell;
            const fillableInput = getRandomOrderSize();
            const fillableOutput = getRandomOrderSize();
            const inputFeeRate = getRandomFeeRate();
        ...
        it('can fully fill buy orders with "output" fees', () => __awaiter(this, void 0, void 0, function* () {
        ...
        it('can partially fill buy orders with "output" fees', () => __awaiter(this, void 0, void 0, function* () {
            const side = types_1.MarketOperation.Buy;
            const fillableInput = getRandomOrderSize();
            const fillableOutput = getRandomOrderSize();
            const outputFeeRate = getRandomFeeRate();
