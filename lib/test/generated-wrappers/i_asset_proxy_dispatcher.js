...
var IAssetProxyDispatcherEvents;
(function (IAssetProxyDispatcherEvents) {
    IAssetProxyDispatcherEvents["AssetProxyRegistered"] = "AssetProxyRegistered";
})(IAssetProxyDispatcherEvents = exports.IAssetProxyDispatcherEvents || (exports.IAssetProxyDispatcherEvents = {}));
...
var IAssetProxyDispatcherContract = /** @class */ (function (_super) {
    ...
    function IAssetProxyDispatcherContract(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) {
        if (deployedBytecode === void 0) { deployedBytecode = IAssetProxyDispatcherContract.deployedBytecode; }
        var _this = _super.call(this, 'IAssetProxyDispatcher', IAssetProxyDispatcherContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) || this;
        _this._methodABIIndex = {};
        utils_1.classUtils.bindAll(_this, ['_abiEncoderByFunctionSignature', 'address', '_web3Wrapper']);
        _this._subscriptionManager = new base_contract_1.SubscriptionManager(IAssetProxyDispatcherContract.ABI(), _this._web3Wrapper);
        IAssetProxyDispatcherContract.ABI().forEach(function (item, index) {
    ...
    IAssetProxyDispatcherContract.deployFrom0xArtifactAsync = function (artifact, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                ...
                return [2 /*return*/, IAssetProxyDispatcherContract.deployAsync(bytecode, abi, provider, txDefaults, logDecodeDependenciesAbiOnly)];
            });
        });
    };
    IAssetProxyDispatcherContract.deployWithLibrariesFrom0xArtifactAsync = function (artifact, libraryArtifacts, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, IAssetProxyDispatcherContract._deployLibrariesAsync(artifact, libraryArtifacts, new web3_wrapper_1.Web3Wrapper(provider), txDefaults)];
                    case 1:
    ...
    IAssetProxyDispatcherContract.deployAsync = function (bytecode, abi, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        contractInstance = new IAssetProxyDispatcherContract(txReceipt.contractAddress, provider, txDefaults, logDecodeDependencies);
    ...
    IAssetProxyDispatcherContract._deployLibrariesAsync = function (artifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses) {
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, IAssetProxyDispatcherContract._deployLibrariesAsync(libraryArtifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses)];
                    case 5:
                        // Deploy any dependent libraries used by this library.
                        _g.sent();
    ...
    IAssetProxyDispatcherContract.prototype.getFunctionSignature = function (methodName) {
        var index = this._methodABIIndex[methodName];
        var methodAbi = IAssetProxyDispatcherContract.ABI()[index]; // tslint:disable-line:no-unnecessary-type-assertion
        var functionSignature = base_contract_1.methodAbiToFunctionSignature(methodAbi);
        return functionSignature;
    };
    IAssetProxyDispatcherContract.prototype.getABIDecodedTransactionData = function (methodName, callData) {
    ...
    IAssetProxyDispatcherContract.prototype.getABIDecodedReturnData = function (methodName, callData) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
    ...
    IAssetProxyDispatcherContract.prototype.getSelector = function (methodName) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
    ...
    * @returns The asset proxy registered to assetProxyId. Returns 0x0 if no proxy is registered.
     */
    IAssetProxyDispatcherContract.prototype.getAssetProxy = function (assetProxyId) {
        var self = this;
 ...
 * Once an asset proxy is registered, it cannot be unregistered.
     ...
     */
    IAssetProxyDispatcherContract.prototype.registerAssetProxy = function (assetProxy) {
        var self = this;
     ...
     */
    IAssetProxyDispatcherContract.prototype.subscribe = function (eventName, indexFilterValues, callback, isVerbose, blockPollingIntervalMs) {
        if (isVerbose === void 0) { isVerbose = false; }
        assert_1.assert.doesBelongToStringEnum('eventName', eventName, IAssetProxyDispatcherEvents);
        ...
        var subscriptionToken = this._subscriptionManager.subscribe(this.address, eventName, indexFilterValues, IAssetProxyDispatcherContract.ABI(), callback, isVerbose, blockPollingIntervalMs);
     ...
     */
    IAssetProxyDispatcherContract.prototype.unsubscribe = function (subscriptionToken) {
        this._subscriptionManager.unsubscribe(subscriptionToken);
    };
    /**
     * Cancels all existing subscriptions
     */
    IAssetProxyDispatcherContract.prototype.unsubscribeAll = function () {
     ...
     */
    IAssetProxyDispatcherContract.prototype.getLogsAsync = function (eventName, blockRange, indexFilterValues) {
        return __awaiter(this, void 0, void 0, function () {
            var logs;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        assert_1.assert.doesConformToSchema('indexFilterValues', indexFilterValues, json_schemas_1.schemas.indexFilterValuesSchema);
                        return [4 /*yield*/, this._subscriptionManager.getLogsAsync(this.address, eventName, blockRange, indexFilterValues, IAssetProxyDispatcherContract.ABI())];
                    case 1:
                        logs = _a.sent();
    ...
    IAssetProxyDispatcherContract.contractName = 'IAssetProxyDispatcher';
