...
export declare class ILiquidityProviderContract extends BaseContract {
     ...
     */
    getBuyQuote(takerToken: string, makerToken: string, buyAmount: BigNumber): ContractTxFunctionObj<BigNumber>;
    /**
     ...
     */
    getSellQuote(takerToken: string, makerToken: string, sellAmount: BigNumber): ContractTxFunctionObj<BigNumber>;
