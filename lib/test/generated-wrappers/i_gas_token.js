...
var IGasTokenEvents;
(function (IGasTokenEvents) {
    IGasTokenEvents["Approval"] = "Approval";
    IGasTokenEvents["Transfer"] = "Transfer";
})(IGasTokenEvents = exports.IGasTokenEvents || (exports.IGasTokenEvents = {}));
/* istanbul ignore next */
// tslint:disable:array-type
// tslint:disable:no-parameter-reassignment
// tslint:disable-next-line:class-name
var IGasTokenContract = /** @class */ (function (_super) {
    __extends(IGasTokenContract, _super);
    function IGasTokenContract(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) {
        if (deployedBytecode === void 0) { deployedBytecode = IGasTokenContract.deployedBytecode; }
        var _this = _super.call(this, 'IGasToken', IGasTokenContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) || this;
        _this._methodABIIndex = {};
        utils_1.classUtils.bindAll(_this, ['_abiEncoderByFunctionSignature', 'address', '_web3Wrapper']);
        _this._subscriptionManager = new base_contract_1.SubscriptionManager(IGasTokenContract.ABI(), _this._web3Wrapper);
        IGasTokenContract.ABI().forEach(function (item, index) {
    ...
    IGasTokenContract.deployFrom0xArtifactAsync = function (artifact, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                ...
                return [2 /*return*/, IGasTokenContract.deployAsync(bytecode, abi, provider, txDefaults, logDecodeDependenciesAbiOnly)];
            });
        });
    };
    IGasTokenContract.deployWithLibrariesFrom0xArtifactAsync = function (artifact, libraryArtifacts, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, IGasTokenContract._deployLibrariesAsync(artifact, libraryArtifacts, new web3_wrapper_1.Web3Wrapper(provider), txDefaults)];
                    case 1:
    ...
    IGasTokenContract.deployAsync = function (bytecode, abi, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        contractInstance = new IGasTokenContract(txReceipt.contractAddress, provider, txDefaults, logDecodeDependencies);
     ...
     */
    IGasTokenContract.ABI = function () {
        var abi = [
            {
                anonymous: false,
                inputs: [
    ...
    IGasTokenContract._deployLibrariesAsync = function (artifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses) {
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, IGasTokenContract._deployLibrariesAsync(libraryArtifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses)];
                    case 5:
                        // Deploy any dependent libraries used by this library.
                        _g.sent();
    ...
    IGasTokenContract.prototype.getFunctionSignature = function (methodName) {
        var index = this._methodABIIndex[methodName];
        var methodAbi = IGasTokenContract.ABI()[index]; // tslint:disable-line:no-unnecessary-type-assertion
        var functionSignature = base_contract_1.methodAbiToFunctionSignature(methodAbi);
        return functionSignature;
    };
    IGasTokenContract.prototype.getABIDecodedTransactionData = function (methodName, callData) {
    ...
    IGasTokenContract.prototype.getABIDecodedReturnData = function (methodName, callData) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
    ...
    IGasTokenContract.prototype.getSelector = function (methodName) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
        return abiEncoder.getSelector();
    };
    IGasTokenContract.prototype.allowance = function (_owner, _spender) {
        var self = this;
    ...
    * @returns Always true if the call has enough gas to complete execution
     */
    IGasTokenContract.prototype.approve = function (_spender, _value) {
        var self = this;
        assert_1.assert.isString('_spender', _spender);
    ...
    ;
    IGasTokenContract.prototype.balanceOf = function (_owner) {
        var self = this;
        assert_1.assert.isString('_owner', _owner);
    ...
    * @returns How many tokens were freed
     */
    IGasTokenContract.prototype.freeFromUpTo = function (from, value) {
        var self = this;
        assert_1.assert.isString('from', from);
        assert_1.assert.isBigNumber('value', value);
        var functionSignature = 'freeFromUpTo(address,uint256)';
        return {
            sendTransactionAsync: function (txData, opts) {
                if (opts === void 0) { opts = { shouldValidate: true }; }
                return __awaiter(this, void 0, void 0, function () {
    ...
    * @returns How many tokens were freed
     */
    IGasTokenContract.prototype.freeUpTo = function (value) {
        var self = this;
        assert_1.assert.isBigNumber('value', value);
        var functionSignature = 'freeUpTo(uint256)';
        return {
            sendTransactionAsync: function (txData, opts) {
                if (opts === void 0) { opts = { shouldValidate: true }; }
                return __awaiter(this, void 0, void 0, function () {
     ...
     */
    IGasTokenContract.prototype.mint = function (value) {
        var self = this;
        assert_1.assert.isBigNumber('value', value);
        var functionSignature = 'mint(uint256)';
        return {
            sendTransactionAsync: function (txData, opts) {
                if (opts === void 0) { opts = { shouldValidate: true }; }
                return __awaiter(this, void 0, void 0, function () {
    ...
    * @returns Total supply of token
     */
    IGasTokenContract.prototype.totalSupply = function () {
        var self = this;
    ...
    * @returns True if transfer was successful
     */
    IGasTokenContract.prototype.transfer = function (_to, _value) {
        var self = this;
    ...
    * @returns True if transfer was successful
     */
    IGasTokenContract.prototype.transferFrom = function (_from, _to, _value) {
        var self = this;
     ...
     */
    IGasTokenContract.prototype.subscribe = function (eventName, indexFilterValues, callback, isVerbose, blockPollingIntervalMs) {
        if (isVerbose === void 0) { isVerbose = false; }
        assert_1.assert.doesBelongToStringEnum('eventName', eventName, IGasTokenEvents);
        ...
        var subscriptionToken = this._subscriptionManager.subscribe(this.address, eventName, indexFilterValues, IGasTokenContract.ABI(), callback, isVerbose, blockPollingIntervalMs);
     ...
     */
    IGasTokenContract.prototype.unsubscribe = function (subscriptionToken) {
        this._subscriptionManager.unsubscribe(subscriptionToken);
    };
    /**
     * Cancels all existing subscriptions
     */
    IGasTokenContract.prototype.unsubscribeAll = function () {
     ...
     */
    IGasTokenContract.prototype.getLogsAsync = function (eventName, blockRange, indexFilterValues) {
        return __awaiter(this, void 0, void 0, function () {
            var logs;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        assert_1.assert.doesConformToSchema('indexFilterValues', indexFilterValues, json_schemas_1.schemas.indexFilterValuesSchema);
                        return [4 /*yield*/, this._subscriptionManager.getLogsAsync(this.address, eventName, blockRange, indexFilterValues, IGasTokenContract.ABI())];
                    case 1:
                        logs = _a.sent();
