...
var IDydxContract = /** @class */ (function (_super) {
    __extends(IDydxContract, _super);
    function IDydxContract(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) {
        if (deployedBytecode === void 0) { deployedBytecode = IDydxContract.deployedBytecode; }
        var _this = _super.call(this, 'IDydx', IDydxContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) || this;
        _this._methodABIIndex = {};
        utils_1.classUtils.bindAll(_this, ['_abiEncoderByFunctionSignature', 'address', '_web3Wrapper']);
        IDydxContract.ABI().forEach(function (item, index) {
    ...
    IDydxContract.deployFrom0xArtifactAsync = function (artifact, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                ...
                return [2 /*return*/, IDydxContract.deployAsync(bytecode, abi, provider, txDefaults, logDecodeDependenciesAbiOnly)];
            });
        });
    };
    IDydxContract.deployWithLibrariesFrom0xArtifactAsync = function (artifact, libraryArtifacts, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, IDydxContract._deployLibrariesAsync(artifact, libraryArtifacts, new web3_wrapper_1.Web3Wrapper(provider), txDefaults)];
                    case 1:
    ...
    IDydxContract.deployAsync = function (bytecode, abi, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        txReceipt = _a.sent();
                        utils_1.logUtils.log("IDydx successfully deployed at " + txReceipt.contractAddress);
                        contractInstance = new IDydxContract(txReceipt.contractAddress, provider, txDefaults, logDecodeDependencies);
    ...
    IDydxContract._deployLibrariesAsync = function (artifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses) {
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, IDydxContract._deployLibrariesAsync(libraryArtifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses)];
                    case 5:
                        // Deploy any dependent libraries used by this library.
                        _g.sent();
    ...
    IDydxContract.prototype.getFunctionSignature = function (methodName) {
        var index = this._methodABIIndex[methodName];
        var methodAbi = IDydxContract.ABI()[index]; // tslint:disable-line:no-unnecessary-type-assertion
        var functionSignature = base_contract_1.methodAbiToFunctionSignature(methodAbi);
        return functionSignature;
    };
    IDydxContract.prototype.getABIDecodedTransactionData = function (methodName, callData) {
    ...
    IDydxContract.prototype.getABIDecodedReturnData = function (methodName, callData) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
    ...
    IDydxContract.prototype.getSelector = function (methodName) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
 ...
 * margin-ratio when determining if the account can be liquidated.
    ...
    * @returns supplyValue The supplied value of the account (adjusted for marginPremium)borrowValue The borrowed value of the account (adjusted for marginPremium)
     */
    IDydxContract.prototype.getAdjustedAccountValues = function (account) {
        var self = this;
 ...
 * Approved operators can act on the accounts of the owner as if it were the operator's own.
    ...
    * @returns isLocalOperator True if operator is approved for owner&#x27;s accounts
     */
    IDydxContract.prototype.getIsLocalOperator = function (owner, operator) {
        var self = this;
 ...
 * include the market require a higher collateralization to avoid being liquidated.
    ...
    * @returns premium The market&#x27;s margin premium
     */
    IDydxContract.prototype.getMarketMarginPremium = function (marketId) {
        var self = this;
    ...
    * @returns price The price of each atomic unit of the token
     */
    IDydxContract.prototype.getMarketPrice = function (marketId) {
        var self = this;
        assert_1.assert.isBigNumber('marketId', marketId);
    ...
    * @returns tokenAddress The token address
     */
    IDydxContract.prototype.getMarketTokenAddress = function (marketId) {
        var self = this;
        assert_1.assert.isBigNumber('marketId', marketId);
    ...
    * @returns riskParams All global risk parameters
     */
    IDydxContract.prototype.getRiskParams = function () {
        var self = this;
 ...
 * ensured only after the completion of the entire operation.
     ...
     */
    IDydxContract.prototype.operate = function (accounts, actions) {
        var self = this;
    ...
    ;
    IDydxContract.prototype.setOperators = function (args) {
        var self = this;
    ...
    ;
    IDydxContract.contractName = 'IDydx';
    return IDydxContract;
}(base_contract_1.BaseContract));
exports.IDydxContract = IDydxContract;
// tslint:disable:max-file-line-count
// tslint:enable:no-unbound-method no-parameter-reassignment no-consecutive-blank-lines ordered-imports align
// tslint:enable:trailing-comma whitespace no-trailing-whitespace
//# sourceMappingURL=i_dydx.js.map