...
class IKyberNetworkContract extends base_contract_1.BaseContract {
    constructor(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode = IKyberNetworkContract.deployedBytecode) {
    ...
    getContracts() {
        const self = this;
        const functionSignature = 'getContracts()';
        return {
