...
var IChaiEvents;
(function (IChaiEvents) {
    IChaiEvents["Approval"] = "Approval";
    IChaiEvents["Transfer"] = "Transfer";
})(IChaiEvents = exports.IChaiEvents || (exports.IChaiEvents = {}));
/* istanbul ignore next */
// tslint:disable:array-type
// tslint:disable:no-parameter-reassignment
// tslint:disable-next-line:class-name
var IChaiContract = /** @class */ (function (_super) {
    __extends(IChaiContract, _super);
    function IChaiContract(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) {
        if (deployedBytecode === void 0) { deployedBytecode = IChaiContract.deployedBytecode; }
        var _this = _super.call(this, 'IChai', IChaiContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) || this;
        _this._methodABIIndex = {};
        utils_1.classUtils.bindAll(_this, ['_abiEncoderByFunctionSignature', 'address', '_web3Wrapper']);
        _this._subscriptionManager = new base_contract_1.SubscriptionManager(IChaiContract.ABI(), _this._web3Wrapper);
        IChaiContract.ABI().forEach(function (item, index) {
    ...
    IChaiContract.deployFrom0xArtifactAsync = function (artifact, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                ...
                return [2 /*return*/, IChaiContract.deployAsync(bytecode, abi, provider, txDefaults, logDecodeDependenciesAbiOnly)];
            });
        });
    };
    IChaiContract.deployWithLibrariesFrom0xArtifactAsync = function (artifact, libraryArtifacts, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, IChaiContract._deployLibrariesAsync(artifact, libraryArtifacts, new web3_wrapper_1.Web3Wrapper(provider), txDefaults)];
                    case 1:
    ...
    IChaiContract.deployAsync = function (bytecode, abi, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        txReceipt = _a.sent();
                        utils_1.logUtils.log("IChai successfully deployed at " + txReceipt.contractAddress);
                        contractInstance = new IChaiContract(txReceipt.contractAddress, provider, txDefaults, logDecodeDependencies);
    ...
    IChaiContract._deployLibrariesAsync = function (artifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses) {
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, IChaiContract._deployLibrariesAsync(libraryArtifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses)];
                    case 5:
                        // Deploy any dependent libraries used by this library.
                        _g.sent();
    ...
    IChaiContract.prototype.getFunctionSignature = function (methodName) {
        var index = this._methodABIIndex[methodName];
        var methodAbi = IChaiContract.ABI()[index]; // tslint:disable-line:no-unnecessary-type-assertion
        var functionSignature = base_contract_1.methodAbiToFunctionSignature(methodAbi);
        return functionSignature;
    };
    IChaiContract.prototype.getABIDecodedTransactionData = function (methodName, callData) {
    ...
    IChaiContract.prototype.getABIDecodedReturnData = function (methodName, callData) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
    ...
    IChaiContract.prototype.getSelector = function (methodName) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
        return abiEncoder.getSelector();
    };
    IChaiContract.prototype.allowance = function (_owner, _spender) {
        var self = this;
    ...
    * @returns Always true if the call has enough gas to complete execution
     */
    IChaiContract.prototype.approve = function (_spender, _value) {
        var self = this;
        assert_1.assert.isString('_spender', _spender);
    ...
    ;
    IChaiContract.prototype.balanceOf = function (_owner) {
        var self = this;
        assert_1.assert.isString('_owner', _owner);
    ...
    * @returns Dai balance.
     */
    IChaiContract.prototype.dai = function (usr) {
        var self = this;
        assert_1.assert.isString('usr', usr);
        var functionSignature = 'dai(address)';
        return {
            sendTransactionAsync: function (txData, opts) {
                if (opts === void 0) { opts = { shouldValidate: true }; }
                return __awaiter(this, void 0, void 0, function () {
     ...
     */
    IChaiContract.prototype.draw = function (src, wad) {
        var self = this;
        assert_1.assert.isString('src', src);
        assert_1.assert.isBigNumber('wad', wad);
        var functionSignature = 'draw(address,uint256)';
        return {
            sendTransactionAsync: function (txData, opts) {
                if (opts === void 0) { opts = { shouldValidate: true }; }
                return __awaiter(this, void 0, void 0, function () {
     ...
     */
    IChaiContract.prototype.join = function (dst, wad) {
        var self = this;
        assert_1.assert.isString('dst', dst);
        assert_1.assert.isBigNumber('wad', wad);
        var functionSignature = 'join(address,uint256)';
        return {
            sendTransactionAsync: function (txData, opts) {
                if (opts === void 0) { opts = { shouldValidate: true }; }
                return __awaiter(this, void 0, void 0, function () {
            ...
            getABIEncodedTransactionData: function () {
                return self._strictEncodeArguments(functionSignature, [dst.toLowerCase(),
                    wad
                ]);
            },
        };
     ...
     */
    IChaiContract.prototype.pot = function () {
        var self = this;
        var functionSignature = 'pot()';
        return {
            sendTransactionAsync: function (txData, opts) {
                if (opts === void 0) { opts = { shouldValidate: true }; }
                return __awaiter(this, void 0, void 0, function () {
    ...
    * @returns Total supply of token
     */
    IChaiContract.prototype.totalSupply = function () {
        var self = this;
    ...
    * @returns True if transfer was successful
     */
    IChaiContract.prototype.transfer = function (_to, _value) {
        var self = this;
    ...
    * @returns True if transfer was successful
     */
    IChaiContract.prototype.transferFrom = function (_from, _to, _value) {
        var self = this;
     ...
     */
    IChaiContract.prototype.subscribe = function (eventName, indexFilterValues, callback, isVerbose, blockPollingIntervalMs) {
        if (isVerbose === void 0) { isVerbose = false; }
        assert_1.assert.doesBelongToStringEnum('eventName', eventName, IChaiEvents);
        ...
        var subscriptionToken = this._subscriptionManager.subscribe(this.address, eventName, indexFilterValues, IChaiContract.ABI(), callback, isVerbose, blockPollingIntervalMs);
     ...
     */
    IChaiContract.prototype.unsubscribe = function (subscriptionToken) {
        this._subscriptionManager.unsubscribe(subscriptionToken);
    };
    /**
     * Cancels all existing subscriptions
     */
    IChaiContract.prototype.unsubscribeAll = function () {
     ...
     */
    IChaiContract.prototype.getLogsAsync = function (eventName, blockRange, indexFilterValues) {
        return __awaiter(this, void 0, void 0, function () {
            var logs;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        assert_1.assert.doesConformToSchema('indexFilterValues', indexFilterValues, json_schemas_1.schemas.indexFilterValuesSchema);
                        return [4 /*yield*/, this._subscriptionManager.getLogsAsync(this.address, eventName, blockRange, indexFilterValues, IChaiContract.ABI())];
                    case 1:
                        logs = _a.sent();
    ...
    IChaiContract.contractName = 'IChai';
    return IChaiContract;
}(base_contract_1.BaseContract));
exports.IChaiContract = IChaiContract;
// tslint:disable:max-file-line-count
// tslint:enable:no-unbound-method no-parameter-reassignment no-consecutive-blank-lines ordered-imports align
// tslint:enable:trailing-comma whitespace no-trailing-whitespace
//# sourceMappingURL=i_chai.js.map