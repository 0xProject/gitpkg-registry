...
export declare class TestERC20BridgeSamplerContract extends BaseContract {
    ...
    getOrderFillableTakerAmount(order: {
        ...
        makerFeeAssetData: string;
        takerFeeAssetData: string;
    }, index_1: string, index_2: string): ContractTxFunctionObj<BigNumber>;
    /**
     * Queries the fillable taker asset amounts of native orders.
     * Effectively ignores orders that have empty signatures or
     ...
     * @param makerTokenAmounts Maker token buy amount for each sample.
     */
    sampleBuysFromLiquidityProviderRegistry(registryAddress: string, takerToken: string, makerToken: string, makerTokenAmounts: BigNumber[]): ContractTxFunctionObj<[BigNumber[], string]>;
    /**
     ...
     * @param makerTokenAmounts Maker token buy amount for each sample.
     */
    sampleBuysFromShell(takerToken: string, makerToken: string, makerTokenAmounts: BigNumber[]): ContractTxFunctionObj<BigNumber[]>;
    /**
     ...
     * @param takerTokenAmounts Taker token sell amount for each sample.
     */
    sampleSellsFromLiquidityProviderRegistry(registryAddress: string, takerToken: string, makerToken: string, takerTokenAmounts: BigNumber[]): ContractTxFunctionObj<[BigNumber[], string]>;
    /**
     ...
     * @param takerTokenAmounts Taker token sell amount for each sample.
     */
    sampleSellsFromShell(takerToken: string, makerToken: string, takerTokenAmounts: BigNumber[]): ContractTxFunctionObj<BigNumber[]>;
    /**
