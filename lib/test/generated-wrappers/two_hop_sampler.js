...
class TwoHopSamplerContract extends base_contract_1.BaseContract {
    constructor(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode = TwoHopSamplerContract.deployedBytecode, encodingRules) {
        super('TwoHopSampler', TwoHopSamplerContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode, encodingRules);
