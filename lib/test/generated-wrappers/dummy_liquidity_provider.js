...
class DummyLiquidityProviderContract extends base_contract_1.BaseContract {
    constructor(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode = DummyLiquidityProviderContract.deployedBytecode, encodingOpts) {
        super('DummyLiquidityProvider', DummyLiquidityProviderContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode, encodingOpts);
