...
class DODOSamplerContract extends base_contract_1.BaseContract {
    constructor(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode = DODOSamplerContract.deployedBytecode) {
        super('DODOSampler', DODOSamplerContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode);
    ...
    * @returns The amount bought of Quote token when selling Base token.
     */
    querySellBaseToken(dodo, sellAmount) {
        const self = this;
        assert_1.assert.isString('dodo', dodo);
        assert_1.assert.isBigNumber('sellAmount', sellAmount);
        const functionSignature = 'querySellBaseToken(address,uint256)';
        return {
            ...
            getABIEncodedTransactionData() {
                return self._strictEncodeArguments(functionSignature, [dodo.toLowerCase(),
                    sellAmount
                ]);
            },
        };
    ...
    * @returns The amount bought of Base token when selling Quote token.
     */
    querySellQuoteToken(dodo, sellAmount) {
        const self = this;
        assert_1.assert.isString('dodo', dodo);
        assert_1.assert.isBigNumber('sellAmount', sellAmount);
        const functionSignature = 'querySellQuoteToken(address,uint256)';
        return {
            callAsync(callData = {}, defaultBlock) {
                return __awaiter(this, void 0, void 0, function* () {
                    base_contract_1.BaseContract._assertCallParams(callData, defaultBlock);
    ...
    * @returns takerTokenAmounts Taker amounts sold at each maker token         amount.
     */
    sampleBuysFromDODO(takerToken, makerToken, makerTokenAmounts) {
        const self = this;
        ...
        const functionSignature = 'sampleBuysFromDODO(address,address,uint256[])';
        return {
            callAsync(callData = {}, defaultBlock) {
                return __awaiter(this, void 0, void 0, function* () {
                    base_contract_1.BaseContract._assertCallParams(callData, defaultBlock);
    ...
    * @returns makerTokenAmounts Maker amounts bought at each taker token         amount.
     */
    sampleSellsFromDODO(takerToken, makerToken, takerTokenAmounts) {
        const self = this;
        assert_1.assert.isString('takerToken', takerToken);
        assert_1.assert.isString('makerToken', makerToken);
        assert_1.assert.isArray('takerTokenAmounts', takerTokenAmounts);
        const functionSignature = 'sampleSellsFromDODO(address,address,uint256[])';
        return {
            callAsync(callData = {}, defaultBlock) {
                return __awaiter(this, void 0, void 0, function* () {
                    base_contract_1.BaseContract._assertCallParams(callData, defaultBlock);
