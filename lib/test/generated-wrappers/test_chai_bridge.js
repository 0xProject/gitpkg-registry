...
var TestChaiBridgeEvents;
(function (TestChaiBridgeEvents) {
    TestChaiBridgeEvents["ERC20BridgeTransfer"] = "ERC20BridgeTransfer";
})(TestChaiBridgeEvents = exports.TestChaiBridgeEvents || (exports.TestChaiBridgeEvents = {}));
/* istanbul ignore next */
// tslint:disable:array-type
// tslint:disable:no-parameter-reassignment
// tslint:disable-next-line:class-name
var TestChaiBridgeContract = /** @class */ (function (_super) {
    __extends(TestChaiBridgeContract, _super);
    function TestChaiBridgeContract(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) {
        if (deployedBytecode === void 0) { deployedBytecode = TestChaiBridgeContract.deployedBytecode; }
        var _this = _super.call(this, 'TestChaiBridge', TestChaiBridgeContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) || this;
        _this._methodABIIndex = {};
        utils_1.classUtils.bindAll(_this, ['_abiEncoderByFunctionSignature', 'address', '_web3Wrapper']);
        _this._subscriptionManager = new base_contract_1.SubscriptionManager(TestChaiBridgeContract.ABI(), _this._web3Wrapper);
        TestChaiBridgeContract.ABI().forEach(function (item, index) {
    ...
    TestChaiBridgeContract.deployFrom0xArtifactAsync = function (artifact, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                ...
                return [2 /*return*/, TestChaiBridgeContract.deployAsync(bytecode, abi, provider, txDefaults, logDecodeDependenciesAbiOnly)];
            });
        });
    };
    TestChaiBridgeContract.deployWithLibrariesFrom0xArtifactAsync = function (artifact, libraryArtifacts, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, TestChaiBridgeContract._deployLibrariesAsync(artifact, libraryArtifacts, new web3_wrapper_1.Web3Wrapper(provider), txDefaults)];
                    case 1:
    ...
    TestChaiBridgeContract.deployAsync = function (bytecode, abi, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        txReceipt = _a.sent();
                        utils_1.logUtils.log("TestChaiBridge successfully deployed at " + txReceipt.contractAddress);
                        contractInstance = new TestChaiBridgeContract(txReceipt.contractAddress, provider, txDefaults, logDecodeDependencies);
     ...
     */
    TestChaiBridgeContract.ABI = function () {
        var abi = [
            {
                inputs: [],
                outputs: [],
    ...
    TestChaiBridgeContract._deployLibrariesAsync = function (artifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses) {
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, TestChaiBridgeContract._deployLibrariesAsync(libraryArtifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses)];
                    case 5:
                        // Deploy any dependent libraries used by this library.
                        _g.sent();
    ...
    TestChaiBridgeContract.prototype.getFunctionSignature = function (methodName) {
        var index = this._methodABIIndex[methodName];
        var methodAbi = TestChaiBridgeContract.ABI()[index]; // tslint:disable-line:no-unnecessary-type-assertion
        var functionSignature = base_contract_1.methodAbiToFunctionSignature(methodAbi);
        return functionSignature;
    };
    TestChaiBridgeContract.prototype.getABIDecodedTransactionData = function (methodName, callData) {
    ...
    TestChaiBridgeContract.prototype.getABIDecodedReturnData = function (methodName, callData) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
    ...
    TestChaiBridgeContract.prototype.getSelector = function (methodName) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
 ...
 * Transfers `amount` of Dai to `to` address.
    ...
    * @returns success The magic bytes &#x60;0xdc1600f3&#x60; if successful.
     */
    TestChaiBridgeContract.prototype.bridgeTransferFrom = function (index_0, from, to, amount, index_4) {
        var self = this;
    ...
    ;
    TestChaiBridgeContract.prototype.testChaiDai = function () {
        var self = this;
        var functionSignature = 'testChaiDai()';
        return {
            callAsync: function (callData, defaultBlock) {
                if (callData === void 0) { callData = {}; }
                return __awaiter(this, void 0, void 0, function () {
    ...
    ;
    /**
     * Subscribe to an event type emitted by the TestChaiBridge contract.
     * @param eventName The TestChaiBridge contract event you would like to subscribe to.
     ...
     */
    TestChaiBridgeContract.prototype.subscribe = function (eventName, indexFilterValues, callback, isVerbose, blockPollingIntervalMs) {
        if (isVerbose === void 0) { isVerbose = false; }
        assert_1.assert.doesBelongToStringEnum('eventName', eventName, TestChaiBridgeEvents);
        ...
        var subscriptionToken = this._subscriptionManager.subscribe(this.address, eventName, indexFilterValues, TestChaiBridgeContract.ABI(), callback, isVerbose, blockPollingIntervalMs);
     ...
     */
    TestChaiBridgeContract.prototype.unsubscribe = function (subscriptionToken) {
        this._subscriptionManager.unsubscribe(subscriptionToken);
    };
    /**
     * Cancels all existing subscriptions
     */
    TestChaiBridgeContract.prototype.unsubscribeAll = function () {
     ...
     */
    TestChaiBridgeContract.prototype.getLogsAsync = function (eventName, blockRange, indexFilterValues) {
        return __awaiter(this, void 0, void 0, function () {
            var logs;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        assert_1.assert.doesConformToSchema('indexFilterValues', indexFilterValues, json_schemas_1.schemas.indexFilterValuesSchema);
                        return [4 /*yield*/, this._subscriptionManager.getLogsAsync(this.address, eventName, blockRange, indexFilterValues, TestChaiBridgeContract.ABI())];
                    case 1:
                        logs = _a.sent();
    ...
    TestChaiBridgeContract.contractName = 'TestChaiBridge';
    return TestChaiBridgeContract;
}(base_contract_1.BaseContract));
exports.TestChaiBridgeContract = TestChaiBridgeContract;
// tslint:disable:max-file-line-count
// tslint:enable:no-unbound-method no-parameter-reassignment no-consecutive-blank-lines ordered-imports align
// tslint:enable:trailing-comma whitespace no-trailing-whitespace
//# sourceMappingURL=test_chai_bridge.js.map