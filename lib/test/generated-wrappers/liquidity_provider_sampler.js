...
var LiquidityProviderSamplerContract = /** @class */ (function (_super) {
    __extends(LiquidityProviderSamplerContract, _super);
    function LiquidityProviderSamplerContract(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) {
        if (deployedBytecode === void 0) { deployedBytecode = LiquidityProviderSamplerContract.deployedBytecode; }
        var _this = _super.call(this, 'LiquidityProviderSampler', LiquidityProviderSamplerContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) || this;
        _this._methodABIIndex = {};
        utils_1.classUtils.bindAll(_this, ['_abiEncoderByFunctionSignature', 'address', '_web3Wrapper']);
        LiquidityProviderSamplerContract.ABI().forEach(function (item, index) {
    ...
    LiquidityProviderSamplerContract.deployFrom0xArtifactAsync = function (artifact, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                ...
                return [2 /*return*/, LiquidityProviderSamplerContract.deployAsync(bytecode, abi, provider, txDefaults, logDecodeDependenciesAbiOnly)];
            });
        });
    };
    LiquidityProviderSamplerContract.deployWithLibrariesFrom0xArtifactAsync = function (artifact, libraryArtifacts, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, LiquidityProviderSamplerContract._deployLibrariesAsync(artifact, libraryArtifacts, new web3_wrapper_1.Web3Wrapper(provider), txDefaults)];
                    case 1:
    ...
    LiquidityProviderSamplerContract.deployAsync = function (bytecode, abi, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        txReceipt = _a.sent();
                        utils_1.logUtils.log("LiquidityProviderSampler successfully deployed at " + txReceipt.contractAddress);
                        contractInstance = new LiquidityProviderSamplerContract(txReceipt.contractAddress, provider, txDefaults, logDecodeDependencies);
     ...
     */
    LiquidityProviderSamplerContract.ABI = function () {
        var abi = [
            {
                constant: true,
                inputs: [
    ...
    LiquidityProviderSamplerContract._deployLibrariesAsync = function (artifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses) {
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, LiquidityProviderSamplerContract._deployLibrariesAsync(libraryArtifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses)];
                    case 5:
                        // Deploy any dependent libraries used by this library.
                        _g.sent();
    ...
    LiquidityProviderSamplerContract.prototype.getFunctionSignature = function (methodName) {
        var index = this._methodABIIndex[methodName];
        var methodAbi = LiquidityProviderSamplerContract.ABI()[index]; // tslint:disable-line:no-unnecessary-type-assertion
        var functionSignature = base_contract_1.methodAbiToFunctionSignature(methodAbi);
        return functionSignature;
    };
    LiquidityProviderSamplerContract.prototype.getABIDecodedTransactionData = function (methodName, callData) {
    ...
    LiquidityProviderSamplerContract.prototype.getABIDecodedReturnData = function (methodName, callData) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
    ...
    LiquidityProviderSamplerContract.prototype.getSelector = function (methodName) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
 ...
 * Returns address(0) if no such provider exists in the registry.
    ...
    * @returns providerAddress Address of the liquidity provider.
     */
    LiquidityProviderSamplerContract.prototype.getLiquidityProviderFromRegistry = function (registryAddress, takerToken, makerToken) {
        var self = this;
    ...
    * @returns takerTokenAmounts Taker amounts sold at each maker token         amount.
     */
    LiquidityProviderSamplerContract.prototype.sampleBuysFromLiquidityProviderRegistry = function (registryAddress, takerToken, makerToken, makerTokenAmounts) {
        var self = this;
        assert_1.assert.isString('registryAddress', registryAddress);
        assert_1.assert.isString('takerToken', takerToken);
        assert_1.assert.isString('makerToken', makerToken);
    ...
    * @returns makerTokenAmounts Maker amounts bought at each taker token         amount.
     */
    LiquidityProviderSamplerContract.prototype.sampleSellsFromLiquidityProviderRegistry = function (registryAddress, takerToken, makerToken, takerTokenAmounts) {
        var self = this;
        assert_1.assert.isString('registryAddress', registryAddress);
        assert_1.assert.isString('takerToken', takerToken);
        assert_1.assert.isString('makerToken', makerToken);
    ...
    ;
    LiquidityProviderSamplerContract.contractName = 'LiquidityProviderSampler';
    return LiquidityProviderSamplerContract;
}(base_contract_1.BaseContract));
exports.LiquidityProviderSamplerContract = LiquidityProviderSamplerContract;
// tslint:disable:max-file-line-count
// tslint:enable:no-unbound-method no-parameter-reassignment no-consecutive-blank-lines ordered-imports align
// tslint:enable:trailing-comma whitespace no-trailing-whitespace
//# sourceMappingURL=liquidity_provider_sampler.js.map