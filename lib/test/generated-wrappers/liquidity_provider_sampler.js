...
class LiquidityProviderSamplerContract extends base_contract_1.BaseContract {
    constructor(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode = LiquidityProviderSamplerContract.deployedBytecode, encodingRules) {
        super('LiquidityProviderSampler', LiquidityProviderSamplerContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode, encodingRules);
