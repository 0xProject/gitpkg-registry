...
class TestERC20BridgeSamplerContract extends base_contract_1.BaseContract {
    ...
    BANCOR_ETH_ADDRESS() {
        const self = this;
        const functionSignature = 'BANCOR_ETH_ADDRESS()';
        return {
    ...
    ;
    _callRevert(selector, sellToken, buyToken, bridgeData, amountIn) {
        const self = this;
        ...
        const functionSignature = '_callRevert(bytes4,address,address,bytes,uint256)';
        return {
            sendTransactionAsync(txData, opts = { shouldValidate: true }) {
                return __awaiter(this, void 0, void 0, function* () {
                    const txDataWithDefaults = yield self._applyDefaultsToTxDataAsync(Object.assign({ data: this.getABIEncodedTransactionData() }, txData), this.estimateGasAsync.bind(this));
     ...
     */
    _mintCallRevert(selector, sellToken, buyToken, bridgeData, amountsIn) {
        const self = this;
        assert_1.assert.isString('selector', selector);
        assert_1.assert.isString('sellToken', sellToken);
        assert_1.assert.isString('buyToken', buyToken);
        assert_1.assert.isString('bridgeData', bridgeData);
        assert_1.assert.isArray('amountsIn', amountsIn);
        const functionSignature = '_mintCallRevert(bytes4,address,address,bytes,uint256[])';
        return {
            sendTransactionAsync(txData, opts = { shouldValidate: true }) {
                return __awaiter(this, void 0, void 0, function* () {
                    const txDataWithDefaults = yield self._applyDefaultsToTxDataAsync(Object.assign({ data: this.getABIEncodedTransactionData() }, txData), this.estimateGasAsync.bind(this));
    ...
    getCode(addr) {
        ...
        const functionSignature = 'getCode(address)';
        return {
            sendTransactionAsync(txData, opts = { shouldValidate: true }) {
                return __awaiter(this, void 0, void 0, function* () {
                    const txDataWithDefaults = yield self._applyDefaultsToTxDataAsync(Object.assign({ data: this.getABIEncodedTransactionData() }, txData), this.estimateGasAsync.bind(this));
 ...
 * maker/taker asset amounts (returning 0).
    ...
    sampleBuysFromBalancerV2(poolInfo, takerToken, makerToken, makerTokenAmounts) {
        ...
        assert_1.assert.isString('makerToken', makerToken);
        assert_1.assert.isArray('makerTokenAmounts', makerTokenAmounts);
        const functionSignature = 'sampleBuysFromBalancerV2((address,bytes32),address,address,uint256[])';
        return {
            sendTransactionAsync(txData, opts = { shouldValidate: true }) {
                return __awaiter(this, void 0, void 0, function* () {
                    const txDataWithDefaults = yield self._applyDefaultsToTxDataAsync(Object.assign({ data: this.getABIEncodedTransactionData() }, txData), this.estimateGasAsync.bind(this));
     ...
     * Sample buy quotes from Curve.
      ...
      * @param makerTokenAmounts Maker token buy amount for each sample.
     */
    sampleBuysFromCurve(curveInfo, takerToken, makerToken, makerTokenAmounts) {
        const self = this;
        assert_1.assert.isString('takerToken', takerToken);
        assert_1.assert.isString('makerToken', makerToken);
        assert_1.assert.isArray('makerTokenAmounts', makerTokenAmounts);
        const functionSignature = 'sampleBuysFromCurve((address,bytes4,int128,int128),address,address,uint256[])';
        return {
            sendTransactionAsync(txData, opts = { shouldValidate: true }) {
                return __awaiter(this, void 0, void 0, function* () {
                    const txDataWithDefaults = yield self._applyDefaultsToTxDataAsync(Object.assign({ data: this.getABIEncodedTransactionData() }, txData), this.estimateGasAsync.bind(this));
     ...
     * Sample buy quotes from Curve.
      ...
      * @param makerTokenAmounts Maker token buy amount for each sample.
     */
    sampleBuysFromCurveV2(curveInfo, takerToken, makerToken, makerTokenAmounts) {
        const self = this;
        assert_1.assert.isString('takerToken', takerToken);
        assert_1.assert.isString('makerToken', makerToken);
        assert_1.assert.isArray('makerTokenAmounts', makerTokenAmounts);
        const functionSignature = 'sampleBuysFromCurveV2((address,bytes4,int128,int128),address,address,uint256[])';
        return {
            sendTransactionAsync(txData, opts = { shouldValidate: true }) {
                return __awaiter(this, void 0, void 0, function* () {
                    const txDataWithDefaults = yield self._applyDefaultsToTxDataAsync(Object.assign({ data: this.getABIEncodedTransactionData() }, txData), this.estimateGasAsync.bind(this));
     ...
     * Sample buy quotes from Lido.
      ...
      * @param makerTokenAmounts Maker token buy amount for each sample.
     */
    sampleBuysFromLido(lido, takerToken, makerToken, makerTokenAmounts) {
        const self = this;
        assert_1.assert.isString('lido', lido);
        assert_1.assert.isString('takerToken', takerToken);
        assert_1.assert.isString('makerToken', makerToken);
        assert_1.assert.isArray('makerTokenAmounts', makerTokenAmounts);
        const functionSignature = 'sampleBuysFromLido(address,address,address,uint256[])';
        return {
            sendTransactionAsync(txData, opts = { shouldValidate: true }) {
                return __awaiter(this, void 0, void 0, function* () {
                    const txDataWithDefaults = yield self._applyDefaultsToTxDataAsync(Object.assign({ data: this.getABIEncodedTransactionData() }, txData), this.estimateGasAsync.bind(this));
            ...
            getABIEncodedTransactionData() {
                return self._strictEncodeArguments(functionSignature, [lido.toLowerCase(),
                    takerToken.toLowerCase(),
                    makerToken.toLowerCase(),
                    makerTokenAmounts
                ]);
     ...
     * Sample buy quotes from UniswapV3.
      ...
      * @param makerTokenAmounts Maker token buy amount for each sample.
     */
    sampleBuysFromUniswapV3(quoter, router, path, makerTokenAmounts) {
        const self = this;
        assert_1.assert.isString('quoter', quoter);
        assert_1.assert.isString('router', router);
        assert_1.assert.isArray('path', path);
        assert_1.assert.isArray('makerTokenAmounts', makerTokenAmounts);
        const functionSignature = 'sampleBuysFromUniswapV3(address,address,address[],uint256[])';
        return {
            sendTransactionAsync(txData, opts = { shouldValidate: true }) {
                return __awaiter(this, void 0, void 0, function* () {
                    const txDataWithDefaults = yield self._applyDefaultsToTxDataAsync(Object.assign({ data: this.getABIEncodedTransactionData() }, txData), this.estimateGasAsync.bind(this));
    ...
    sampleSellsFromBalancerV2(poolInfo, takerToken, makerToken, takerTokenAmounts) {
        ...
        assert_1.assert.isString('makerToken', makerToken);
        assert_1.assert.isArray('takerTokenAmounts', takerTokenAmounts);
        const functionSignature = 'sampleSellsFromBalancerV2((address,bytes32),address,address,uint256[])';
        return {
            sendTransactionAsync(txData, opts = { shouldValidate: true }) {
                return __awaiter(this, void 0, void 0, function* () {
                    const txDataWithDefaults = yield self._applyDefaultsToTxDataAsync(Object.assign({ data: this.getABIEncodedTransactionData() }, txData), this.estimateGasAsync.bind(this));
     ...
     * Sample sell quotes from Curve.
      ...
      * @param takerTokenAmounts Taker token sell amount for each sample.
     */
    sampleSellsFromCurve(curveInfo, takerToken, makerToken, takerTokenAmounts) {
        const self = this;
        assert_1.assert.isString('takerToken', takerToken);
        assert_1.assert.isString('makerToken', makerToken);
        assert_1.assert.isArray('takerTokenAmounts', takerTokenAmounts);
        const functionSignature = 'sampleSellsFromCurve((address,bytes4,int128,int128),address,address,uint256[])';
        return {
            sendTransactionAsync(txData, opts = { shouldValidate: true }) {
                return __awaiter(this, void 0, void 0, function* () {
                    const txDataWithDefaults = yield self._applyDefaultsToTxDataAsync(Object.assign({ data: this.getABIEncodedTransactionData() }, txData), this.estimateGasAsync.bind(this));
     ...
     * Sample sell quotes from Curve.
      ...
      * @param takerTokenAmounts Taker token sell amount for each sample.
     */
    sampleSellsFromCurveV2(curveInfo, takerToken, makerToken, takerTokenAmounts) {
        const self = this;
        assert_1.assert.isString('takerToken', takerToken);
        assert_1.assert.isString('makerToken', makerToken);
        assert_1.assert.isArray('takerTokenAmounts', takerTokenAmounts);
        const functionSignature = 'sampleSellsFromCurveV2((address,bytes4,int128,int128),address,address,uint256[])';
        return {
            sendTransactionAsync(txData, opts = { shouldValidate: true }) {
                return __awaiter(this, void 0, void 0, function* () {
                    const txDataWithDefaults = yield self._applyDefaultsToTxDataAsync(Object.assign({ data: this.getABIEncodedTransactionData() }, txData), this.estimateGasAsync.bind(this));
     ...
     * Sample sell quotes from Lido
      ...
      * @param takerTokenAmounts Taker token sell amount for each sample.
     */
    sampleSellsFromLido(lido, takerToken, makerToken, takerTokenAmounts) {
        const self = this;
        assert_1.assert.isString('lido', lido);
        assert_1.assert.isString('takerToken', takerToken);
        assert_1.assert.isString('makerToken', makerToken);
        assert_1.assert.isArray('takerTokenAmounts', takerTokenAmounts);
        const functionSignature = 'sampleSellsFromLido(address,address,address,uint256[])';
        return {
            sendTransactionAsync(txData, opts = { shouldValidate: true }) {
                return __awaiter(this, void 0, void 0, function* () {
                    const txDataWithDefaults = yield self._applyDefaultsToTxDataAsync(Object.assign({ data: this.getABIEncodedTransactionData() }, txData), this.estimateGasAsync.bind(this));
     ...
     * Sample sell quotes from UniswapV3.
      ...
      * @param takerTokenAmounts Taker token sell amount for each sample.
     */
    sampleSellsFromUniswapV3(quoter, router, path, takerTokenAmounts) {
        const self = this;
        assert_1.assert.isString('quoter', quoter);
        assert_1.assert.isString('router', router);
        assert_1.assert.isArray('path', path);
        assert_1.assert.isArray('takerTokenAmounts', takerTokenAmounts);
        const functionSignature = 'sampleSellsFromUniswapV3(address,address,address[],uint256[])';
        return {
            sendTransactionAsync(txData, opts = { shouldValidate: true }) {
                return __awaiter(this, void 0, void 0, function* () {
                    const txDataWithDefaults = yield self._applyDefaultsToTxDataAsync(Object.assign({ data: this.getABIEncodedTransactionData() }, txData), this.estimateGasAsync.bind(this));
    ...
    ;
    sampleSwapFromBalancer(sellToken, buyToken, bridgeData, takerTokenAmount) {
        const self = this;
        assert_1.assert.isString('sellToken', sellToken);
        assert_1.assert.isString('buyToken', buyToken);
        assert_1.assert.isString('bridgeData', bridgeData);
        assert_1.assert.isBigNumber('takerTokenAmount', takerTokenAmount);
        const functionSignature = 'sampleSwapFromBalancer(address,address,bytes,uint256)';
        return {
            sendTransactionAsync(txData, opts = { shouldValidate: true }) {
                return __awaiter(this, void 0, void 0, function* () {
                    const txDataWithDefaults = yield self._applyDefaultsToTxDataAsync(Object.assign({ data: this.getABIEncodedTransactionData() }, txData), this.estimateGasAsync.bind(this));
    ...
    ;
    sampleSwapFromBalancerV2(sellToken, buyToken, bridgeData, takerTokenAmount) {
        const self = this;
        assert_1.assert.isString('sellToken', sellToken);
        assert_1.assert.isString('buyToken', buyToken);
        assert_1.assert.isString('bridgeData', bridgeData);
        assert_1.assert.isBigNumber('takerTokenAmount', takerTokenAmount);
        const functionSignature = 'sampleSwapFromBalancerV2(address,address,bytes,uint256)';
        return {
            sendTransactionAsync(txData, opts = { shouldValidate: true }) {
                return __awaiter(this, void 0, void 0, function* () {
                    const txDataWithDefaults = yield self._applyDefaultsToTxDataAsync(Object.assign({ data: this.getABIEncodedTransactionData() }, txData), this.estimateGasAsync.bind(this));
    ...
    ;
    sampleSwapFromBancor(sellToken, buyToken, bridgeData, takerTokenAmount) {
        const self = this;
        assert_1.assert.isString('sellToken', sellToken);
        assert_1.assert.isString('buyToken', buyToken);
        assert_1.assert.isString('bridgeData', bridgeData);
        assert_1.assert.isBigNumber('takerTokenAmount', takerTokenAmount);
        const functionSignature = 'sampleSwapFromBancor(address,address,bytes,uint256)';
        return {
            sendTransactionAsync(txData, opts = { shouldValidate: true }) {
                return __awaiter(this, void 0, void 0, function* () {
                    const txDataWithDefaults = yield self._applyDefaultsToTxDataAsync(Object.assign({ data: this.getABIEncodedTransactionData() }, txData), this.estimateGasAsync.bind(this));
    ...
    ;
    sampleSwapFromCurve(sellToken, buyToken, bridgeData, takerTokenAmount) {
        const self = this;
        assert_1.assert.isString('sellToken', sellToken);
        assert_1.assert.isString('buyToken', buyToken);
        assert_1.assert.isString('bridgeData', bridgeData);
        assert_1.assert.isBigNumber('takerTokenAmount', takerTokenAmount);
        const functionSignature = 'sampleSwapFromCurve(address,address,bytes,uint256)';
        return {
            sendTransactionAsync(txData, opts = { shouldValidate: true }) {
                return __awaiter(this, void 0, void 0, function* () {
                    const txDataWithDefaults = yield self._applyDefaultsToTxDataAsync(Object.assign({ data: this.getABIEncodedTransactionData() }, txData), this.estimateGasAsync.bind(this));
    ...
    ;
    sampleSwapFromCurveV2(sellToken, buyToken, bridgeData, takerTokenAmount) {
        const self = this;
        assert_1.assert.isString('sellToken', sellToken);
        assert_1.assert.isString('buyToken', buyToken);
        assert_1.assert.isString('bridgeData', bridgeData);
        assert_1.assert.isBigNumber('takerTokenAmount', takerTokenAmount);
        const functionSignature = 'sampleSwapFromCurveV2(address,address,bytes,uint256)';
        return {
            sendTransactionAsync(txData, opts = { shouldValidate: true }) {
                return __awaiter(this, void 0, void 0, function* () {
                    const txDataWithDefaults = yield self._applyDefaultsToTxDataAsync(Object.assign({ data: this.getABIEncodedTransactionData() }, txData), this.estimateGasAsync.bind(this));
    ...
    ;
    sampleSwapFromDodo(sellToken, buyToken, bridgeData, takerTokenAmount) {
        const self = this;
        assert_1.assert.isString('sellToken', sellToken);
        assert_1.assert.isString('buyToken', buyToken);
        assert_1.assert.isString('bridgeData', bridgeData);
        assert_1.assert.isBigNumber('takerTokenAmount', takerTokenAmount);
        const functionSignature = 'sampleSwapFromDodo(address,address,bytes,uint256)';
        return {
            sendTransactionAsync(txData, opts = { shouldValidate: true }) {
                return __awaiter(this, void 0, void 0, function* () {
                    const txDataWithDefaults = yield self._applyDefaultsToTxDataAsync(Object.assign({ data: this.getABIEncodedTransactionData() }, txData), this.estimateGasAsync.bind(this));
    ...
    ;
    sampleSwapFromDodoV2(sellToken, buyToken, bridgeData, takerTokenAmount) {
        const self = this;
        assert_1.assert.isString('sellToken', sellToken);
        assert_1.assert.isString('buyToken', buyToken);
        assert_1.assert.isString('bridgeData', bridgeData);
        assert_1.assert.isBigNumber('takerTokenAmount', takerTokenAmount);
        const functionSignature = 'sampleSwapFromDodoV2(address,address,bytes,uint256)';
        return {
            sendTransactionAsync(txData, opts = { shouldValidate: true }) {
                return __awaiter(this, void 0, void 0, function* () {
                    const txDataWithDefaults = yield self._applyDefaultsToTxDataAsync(Object.assign({ data: this.getABIEncodedTransactionData() }, txData), this.estimateGasAsync.bind(this));
    ...
    ;
    sampleSwapFromKyber(sellToken, buyToken, bridgeData, takerTokenAmount) {
        const self = this;
        assert_1.assert.isString('sellToken', sellToken);
        assert_1.assert.isString('buyToken', buyToken);
        assert_1.assert.isString('bridgeData', bridgeData);
        assert_1.assert.isBigNumber('takerTokenAmount', takerTokenAmount);
        const functionSignature = 'sampleSwapFromKyber(address,address,bytes,uint256)';
        return {
            sendTransactionAsync(txData, opts = { shouldValidate: true }) {
                return __awaiter(this, void 0, void 0, function* () {
                    const txDataWithDefaults = yield self._applyDefaultsToTxDataAsync(Object.assign({ data: this.getABIEncodedTransactionData() }, txData), this.estimateGasAsync.bind(this));
    ...
    ;
    sampleSwapFromKyberDmm(sellToken, buyToken, bridgeData, takerTokenAmount) {
        const self = this;
        assert_1.assert.isString('sellToken', sellToken);
        assert_1.assert.isString('buyToken', buyToken);
        assert_1.assert.isString('bridgeData', bridgeData);
        assert_1.assert.isBigNumber('takerTokenAmount', takerTokenAmount);
        const functionSignature = 'sampleSwapFromKyberDmm(address,address,bytes,uint256)';
        return {
            sendTransactionAsync(txData, opts = { shouldValidate: true }) {
                return __awaiter(this, void 0, void 0, function* () {
                    const txDataWithDefaults = yield self._applyDefaultsToTxDataAsync(Object.assign({ data: this.getABIEncodedTransactionData() }, txData), this.estimateGasAsync.bind(this));
    ...
    ;
    sampleSwapFromLido(sellToken, buyToken, bridgeData, takerTokenAmount) {
        const self = this;
        assert_1.assert.isString('sellToken', sellToken);
        assert_1.assert.isString('buyToken', buyToken);
        assert_1.assert.isString('bridgeData', bridgeData);
        assert_1.assert.isBigNumber('takerTokenAmount', takerTokenAmount);
        const functionSignature = 'sampleSwapFromLido(address,address,bytes,uint256)';
        return {
            sendTransactionAsync(txData, opts = { shouldValidate: true }) {
                return __awaiter(this, void 0, void 0, function* () {
                    const txDataWithDefaults = yield self._applyDefaultsToTxDataAsync(Object.assign({ data: this.getABIEncodedTransactionData() }, txData), this.estimateGasAsync.bind(this));
    ...
    ;
    sampleSwapFromLiquidityProvider(sellToken, buyToken, bridgeData, takerTokenAmount) {
        const self = this;
        assert_1.assert.isString('sellToken', sellToken);
        assert_1.assert.isString('buyToken', buyToken);
        assert_1.assert.isString('bridgeData', bridgeData);
        assert_1.assert.isBigNumber('takerTokenAmount', takerTokenAmount);
        const functionSignature = 'sampleSwapFromLiquidityProvider(address,address,bytes,uint256)';
        return {
            sendTransactionAsync(txData, opts = { shouldValidate: true }) {
                return __awaiter(this, void 0, void 0, function* () {
                    const txDataWithDefaults = yield self._applyDefaultsToTxDataAsync(Object.assign({ data: this.getABIEncodedTransactionData() }, txData), this.estimateGasAsync.bind(this));
    ...
    ;
    sampleSwapFromMStable(sellToken, buyToken, bridgeData, takerTokenAmount) {
        const self = this;
        assert_1.assert.isString('sellToken', sellToken);
        assert_1.assert.isString('buyToken', buyToken);
        assert_1.assert.isString('bridgeData', bridgeData);
        assert_1.assert.isBigNumber('takerTokenAmount', takerTokenAmount);
        const functionSignature = 'sampleSwapFromMStable(address,address,bytes,uint256)';
        return {
            sendTransactionAsync(txData, opts = { shouldValidate: true }) {
                return __awaiter(this, void 0, void 0, function* () {
                    const txDataWithDefaults = yield self._applyDefaultsToTxDataAsync(Object.assign({ data: this.getABIEncodedTransactionData() }, txData), this.estimateGasAsync.bind(this));
    ...
    ;
    sampleSwapFromMakerPsm(sellToken, buyToken, bridgeData, takerTokenAmount) {
        const self = this;
        assert_1.assert.isString('sellToken', sellToken);
        assert_1.assert.isString('buyToken', buyToken);
        assert_1.assert.isString('bridgeData', bridgeData);
        assert_1.assert.isBigNumber('takerTokenAmount', takerTokenAmount);
        const functionSignature = 'sampleSwapFromMakerPsm(address,address,bytes,uint256)';
        return {
            sendTransactionAsync(txData, opts = { shouldValidate: true }) {
                return __awaiter(this, void 0, void 0, function* () {
                    const txDataWithDefaults = yield self._applyDefaultsToTxDataAsync(Object.assign({ data: this.getABIEncodedTransactionData() }, txData), this.estimateGasAsync.bind(this));
    ...
    ;
    sampleSwapFromMooniswap(sellToken, buyToken, bridgeData, takerTokenAmount) {
        const self = this;
        assert_1.assert.isString('sellToken', sellToken);
        assert_1.assert.isString('buyToken', buyToken);
        assert_1.assert.isString('bridgeData', bridgeData);
        assert_1.assert.isBigNumber('takerTokenAmount', takerTokenAmount);
        const functionSignature = 'sampleSwapFromMooniswap(address,address,bytes,uint256)';
        return {
            sendTransactionAsync(txData, opts = { shouldValidate: true }) {
                return __awaiter(this, void 0, void 0, function* () {
                    const txDataWithDefaults = yield self._applyDefaultsToTxDataAsync(Object.assign({ data: this.getABIEncodedTransactionData() }, txData), this.estimateGasAsync.bind(this));
    ...
    ;
    sampleSwapFromOasis(sellToken, buyToken, bridgeData, takerTokenAmount) {
        const self = this;
        assert_1.assert.isString('sellToken', sellToken);
        assert_1.assert.isString('buyToken', buyToken);
        assert_1.assert.isString('bridgeData', bridgeData);
        assert_1.assert.isBigNumber('takerTokenAmount', takerTokenAmount);
        const functionSignature = 'sampleSwapFromOasis(address,address,bytes,uint256)';
        return {
            sendTransactionAsync(txData, opts = { shouldValidate: true }) {
                return __awaiter(this, void 0, void 0, function* () {
                    const txDataWithDefaults = yield self._applyDefaultsToTxDataAsync(Object.assign({ data: this.getABIEncodedTransactionData() }, txData), this.estimateGasAsync.bind(this));
    ...
    ;
    sampleSwapFromShell(sellToken, buyToken, bridgeData, takerTokenAmount) {
        const self = this;
        assert_1.assert.isString('sellToken', sellToken);
        assert_1.assert.isString('buyToken', buyToken);
        assert_1.assert.isString('bridgeData', bridgeData);
        assert_1.assert.isBigNumber('takerTokenAmount', takerTokenAmount);
        const functionSignature = 'sampleSwapFromShell(address,address,bytes,uint256)';
        return {
            sendTransactionAsync(txData, opts = { shouldValidate: true }) {
                return __awaiter(this, void 0, void 0, function* () {
                    const txDataWithDefaults = yield self._applyDefaultsToTxDataAsync(Object.assign({ data: this.getABIEncodedTransactionData() }, txData), this.estimateGasAsync.bind(this));
    ...
    ;
    sampleSwapFromUniswap(sellToken, buyToken, bridgeData, takerTokenAmount) {
        const self = this;
        assert_1.assert.isString('sellToken', sellToken);
        assert_1.assert.isString('buyToken', buyToken);
        assert_1.assert.isString('bridgeData', bridgeData);
        assert_1.assert.isBigNumber('takerTokenAmount', takerTokenAmount);
        const functionSignature = 'sampleSwapFromUniswap(address,address,bytes,uint256)';
        return {
            sendTransactionAsync(txData, opts = { shouldValidate: true }) {
                return __awaiter(this, void 0, void 0, function* () {
                    const txDataWithDefaults = yield self._applyDefaultsToTxDataAsync(Object.assign({ data: this.getABIEncodedTransactionData() }, txData), this.estimateGasAsync.bind(this));
    ...
    ;
    sampleSwapFromUniswapV2(sellToken, buyToken, bridgeData, takerTokenAmount) {
        const self = this;
        assert_1.assert.isString('sellToken', sellToken);
        assert_1.assert.isString('buyToken', buyToken);
        assert_1.assert.isString('bridgeData', bridgeData);
        assert_1.assert.isBigNumber('takerTokenAmount', takerTokenAmount);
        const functionSignature = 'sampleSwapFromUniswapV2(address,address,bytes,uint256)';
        return {
            sendTransactionAsync(txData, opts = { shouldValidate: true }) {
                return __awaiter(this, void 0, void 0, function* () {
                    const txDataWithDefaults = yield self._applyDefaultsToTxDataAsync(Object.assign({ data: this.getABIEncodedTransactionData() }, txData), this.estimateGasAsync.bind(this));
    ...
    ;
    sampleSwapFromUniswapV3(sellToken, buyToken, bridgeData, takerTokenAmount) {
        const self = this;
        assert_1.assert.isString('sellToken', sellToken);
        assert_1.assert.isString('buyToken', buyToken);
        assert_1.assert.isString('bridgeData', bridgeData);
        assert_1.assert.isBigNumber('takerTokenAmount', takerTokenAmount);
        const functionSignature = 'sampleSwapFromUniswapV3(address,address,bytes,uint256)';
        return {
            sendTransactionAsync(txData, opts = { shouldValidate: true }) {
                return __awaiter(this, void 0, void 0, function* () {
                    const txDataWithDefaults = yield self._applyDefaultsToTxDataAsync(Object.assign({ data: this.getABIEncodedTransactionData() }, txData), this.estimateGasAsync.bind(this));
