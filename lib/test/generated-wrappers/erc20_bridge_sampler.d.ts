...
export declare class ERC20BridgeSamplerContract extends BaseContract {
    ...
    getBlockNumber(): ContractTxFunctionObj<BigNumber>;
    getGasLeft(): ContractTxFunctionObj<BigNumber>;
    /**
 ...
 * maker/taker asset amounts (returning 0).
     ...
     */
    sampleBuysFromBalancerGlobal(poolAddress: string, takerToken: string, makerToken: string): ContractTxFunctionObj<BigNumber[]>;
    /**
     * Sample buy quotes from Balancer V2.
      ...
      * @param makerToken Address of the maker token (what to buy).
     */
    sampleBuysFromBalancerV2Global(poolInfo: {
        poolId: string;
        vault: string;
    }, takerToken: string, makerToken: string): ContractTxFunctionObj<BigNumber[]>;
    /**
     * Sample buy quotes from Bancor. Unimplemented
      ...
      * @param makerToken Address of the maker token (what to buy).
     */
    sampleBuysFromBancorGlobal(opts: {
        registry: string;
        paths: string[][];
    }, takerToken: string, makerToken: string): ContractTxFunctionObj<[string, string[], BigNumber[]]>;
    sampleBuysFromCompoundGlobal(cToken: string, takerToken: string, makerToken: string): ContractTxFunctionObj<BigNumber[]>;
    /**
     ...
     */
    sampleBuysFromCurveGlobal(curveInfo: {
        poolAddress: string;
        sellQuoteFunctionSelector: string;
        buyQuoteFunctionSelector: string;
    }, fromTokenIdx: BigNumber, toTokenIdx: BigNumber): ContractTxFunctionObj<BigNumber[]>;
    /**
     * Sample buy quotes from DODO.
      ...
      * @param makerToken Address of the maker token (what to buy).
     */
    sampleBuysFromDODOGlobal(opts: {
        registry: string;
        helper: string;
    }, takerToken: string, makerToken: string): ContractTxFunctionObj<[boolean, string, BigNumber[]]>;
    /**
     * Sample buy quotes from DODO.
      ...
      * @param makerToken Address of the maker token (what to buy).
     */
    sampleBuysFromDODOV2Global(registry: string, offset: BigNumber, takerToken: string, makerToken: string): ContractTxFunctionObj<[boolean, string, BigNumber[]]>;
    /**
     * Sample buy quotes from KyberDmm.
      * @param router Router to look up tokens and amounts
      * @param path Token route. Should be takerToken -> makerToken.
     */
    sampleBuysFromKyberDmmGlobal(router: string, path: string[]): ContractTxFunctionObj<[string[], BigNumber[]]>;
    /**
     * Sample buy quotes from Kyber.
      ...
      * @param makerToken Address of the maker token (what to buy).
     */
    sampleBuysFromKyberNetworkGlobal(opts: {
        reserveOffset: BigNumber;
        hintHandler: string;
        networkProxy: string;
        weth: string;
     ...
     * Sample buy quotes from Lido.
      ...
      * @param makerToken Address of the maker token (what to buy).
     */
    sampleBuysFromLidoGlobal(lidoInfo: {
        stEthToken: string;
        wethToken: string;
    }, takerToken: string, makerToken: string): ContractTxFunctionObj<BigNumber[]>;
    /**
     ...
     * Sample buy quotes from MStable contract
      ...
      * @param makerToken Address of the maker token (what to buy).
     */
    sampleBuysFromMStableGlobal(router: string, takerToken: string, makerToken: string): ContractTxFunctionObj<BigNumber[]>;
    sampleBuysFromMakerPsmGlobal(psmInfo: {
        psmAddress: string;
     ...
     * Sample buy quotes from Mooniswap.
      ...
      * @param makerToken Address of the maker token (what to buy).
     */
    sampleBuysFromMooniswapGlobal(registry: string, takerToken: string, makerToken: string): ContractTxFunctionObj<[string, BigNumber[]]>;
    /**
     * Sample buy quotes from Shell pool contract
      ...
      * @param makerToken Address of the maker token (what to buy).
     */
    sampleBuysFromShellGlobal(pool: string, takerToken: string, makerToken: string): ContractTxFunctionObj<BigNumber[]>;
    /**
     * Sample buy quotes from Smoothy.
      ...
      * @param toTokenIdx Index of the maker token (what to buy).
     */
    sampleBuysFromSmoothyGlobal(smoothyInfo: {
        poolAddress: string;
        sellQuoteFunctionSelector: string;
        buyQuoteFunctionSelector: string;
    }, fromTokenIdx: BigNumber, toTokenIdx: BigNumber): ContractTxFunctionObj<BigNumber[]>;
     ...
     * Sample buy quotes from Uniswap.
      ...
      * @param makerToken Address of the maker token (what to buy).
     */
    sampleBuysFromUniswapGlobal(router: string, takerToken: string, makerToken: string): ContractTxFunctionObj<BigNumber[]>;
    /**
     * Sample buy quotes from UniswapV2.
      * @param router Router to look up tokens and amounts
      * @param path Token route. Should be takerToken -> makerToken.
     */
    sampleBuysFromUniswapV2Global(router: string, path: string[]): ContractTxFunctionObj<BigNumber[]>;
    /**
     * Sample buy quotes from UniswapV3.
      * @param quoter UniswapV3 Quoter contract.
      * @param path Token route. Should be takerToken -> makerToken.
     */
    sampleBuysFromUniswapV3Global(quoter: string, path: string[]): ContractTxFunctionObj<[string[], BigNumber[]]>;
     ...
     * Sample sell quotes from Balancer.
      ...
      * @param makerToken Address of the maker token (what to buy).
     */
    sampleSellsFromBalancerGlobal(poolAddress: string, takerToken: string, makerToken: string): ContractTxFunctionObj<BigNumber[]>;
    /**
     * Sample sell quotes from Balancer V2.
      ...
      * @param makerToken Address of the maker token (what to buy).
     */
    sampleSellsFromBalancerV2Global(poolInfo: {
        poolId: string;
        vault: string;
    }, takerToken: string, makerToken: string): ContractTxFunctionObj<BigNumber[]>;
    /**
     * Sample sell quotes from Bancor.
      ...
      * @param makerToken Address of the maker token (what to buy).
     */
    sampleSellsFromBancorGlobal(opts: {
        registry: string;
        paths: string[][];
    }, takerToken: string, makerToken: string): ContractTxFunctionObj<[string, string[], BigNumber[]]>;
    sampleSellsFromCompoundGlobal(cToken: string, takerToken: string, makerToken: string): ContractTxFunctionObj<BigNumber[]>;
    /**
     ...
     * Sample sell quotes from Curve.
      ...
      * @param toTokenIdx Index of the maker token (what to buy).
     */
    sampleSellsFromCurveGlobal(curveInfo: {
        poolAddress: string;
        sellQuoteFunctionSelector: string;
        buyQuoteFunctionSelector: string;
    }, fromTokenIdx: BigNumber, toTokenIdx: BigNumber): ContractTxFunctionObj<BigNumber[]>;
     ...
     * Sample sell quotes from DODO.
      ...
      * @param makerToken Address of the maker token (what to buy).
     */
    sampleSellsFromDODOGlobal(opts: {
        registry: string;
        helper: string;
    }, takerToken: string, makerToken: string): ContractTxFunctionObj<[boolean, string, BigNumber[]]>;
    /**
     ...
     * Sample sell quotes from DODO V2.
      ...
      * @param makerToken Address of the maker token (what to buy).
     */
    sampleSellsFromDODOV2Global(registry: string, offset: BigNumber, takerToken: string, makerToken: string): ContractTxFunctionObj<[boolean, string, BigNumber[]]>;
    /**
     * Sample sell quotes from KyberDmm.
      * @param router Router to look up tokens and amounts
      * @param path Token route. Should be takerToken -> makerToken
     */
    sampleSellsFromKyberDmmGlobal(router: string, path: string[]): ContractTxFunctionObj<[string[], BigNumber[]]>;
    /**
     ...
     * Sample sell quotes from Kyber.
      ...
      * @param makerToken Address of the maker token (what to buy).
     */
    sampleSellsFromKyberNetworkGlobal(opts: {
        reserveOffset: BigNumber;
        hintHandler: string;
        networkProxy: string;
        weth: string;
     ...
     * Sample sell quotes from Lido
      ...
      * @param makerToken Address of the maker token (what to buy).
     */
    sampleSellsFromLidoGlobal(lidoInfo: {
        stEthToken: string;
        wethToken: string;
    }, takerToken: string, makerToken: string): ContractTxFunctionObj<BigNumber[]>;
    /**
     ...
     * Sample sell quotes from the mStable contract
      ...
      * @param makerToken Address of the maker token (what to buy).
     */
    sampleSellsFromMStableGlobal(router: string, takerToken: string, makerToken: string): ContractTxFunctionObj<BigNumber[]>;
    /**
     * Sample sell quotes from Maker PSM
     */
    sampleSellsFromMakerPsmGlobal(psmInfo: {
        psmAddress: string;
        ilkIdentifier: string;
        gemTokenAddress: string;
    }, takerToken: string, makerToken: string): ContractTxFunctionObj<BigNumber[]>;
     ...
     * Sample sell quotes from Mooniswap.
      ...
      * @param makerToken Address of the maker token (what to buy).
     */
    sampleSellsFromMooniswapGlobal(registry: string, takerToken: string, makerToken: string): ContractTxFunctionObj<[string, BigNumber[]]>;
    /**
     ...
     * Sample sell quotes from the Shell pool contract
      ...
      * @param makerToken Address of the maker token (what to buy).
     */
    sampleSellsFromShellGlobal(pool: string, takerToken: string, makerToken: string): ContractTxFunctionObj<BigNumber[]>;
    /**
     ...
     * Sample sell quotes from Smoothy.
      ...
      * @param toTokenIdx Index of the maker token (what to buy).
     */
    sampleSellsFromSmoothyGlobal(smoothyInfo: {
        poolAddress: string;
        sellQuoteFunctionSelector: string;
        buyQuoteFunctionSelector: string;
    }, fromTokenIdx: BigNumber, toTokenIdx: BigNumber): ContractTxFunctionObj<BigNumber[]>;
     ...
     * Sample sell quotes from Uniswap.
      ...
      * @param makerToken Address of the maker token (what to buy).
     */
    sampleSellsFromUniswapGlobal(router: string, takerToken: string, makerToken: string): ContractTxFunctionObj<BigNumber[]>;
    /**
     * Sample sell quotes from UniswapV2.
      * @param router Router to look up tokens and amounts
      * @param path Token route. Should be takerToken -> makerToken
     */
    sampleSellsFromUniswapV2Global(router: string, path: string[]): ContractTxFunctionObj<BigNumber[]>;
    /**
     * Sample sell quotes from UniswapV3.
      * @param quoter UniswapV3 Quoter contract.
      * @param path Token route. Should be takerToken -> makerToken
     */
    sampleSellsFromUniswapV3Global(quoter: string, path: string[]): ContractTxFunctionObj<[string[], BigNumber[]]>;
