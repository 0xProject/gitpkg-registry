...
class BalancerSamplerContract extends base_contract_1.BaseContract {
    constructor(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode = BalancerSamplerContract.deployedBytecode, encodingOpts) {
        super('BalancerSampler', BalancerSamplerContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode, encodingOpts);
