...
export declare class IntermediateSamplerContract extends BaseContract {
    /**
     * @ignore
     */
    ...
    }): Promise<IntermediateSamplerContract>;
 ...
 * of price for the second hop calls (Y->Z).
     ...
     */
    sampleIntermediateSell(firstHopCalls: string[], secondHopCalls: string[], takerTokenAmounts: BigNumber[]): ContractTxFunctionObj<[Array<{
        returnData: string;
...
//# sourceMappingURL=intermediate_sampler.d.ts.map