...
class DODOV2SamplerContract extends base_contract_1.BaseContract {
    constructor(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode = DODOV2SamplerContract.deployedBytecode, encodingRules) {
        super('DODOV2Sampler', DODOV2SamplerContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode, encodingRules);
