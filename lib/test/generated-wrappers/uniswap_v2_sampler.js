...
var UniswapV2SamplerContract = /** @class */ (function (_super) {
    __extends(UniswapV2SamplerContract, _super);
    function UniswapV2SamplerContract(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) {
        if (deployedBytecode === void 0) { deployedBytecode = UniswapV2SamplerContract.deployedBytecode; }
        var _this = _super.call(this, 'UniswapV2Sampler', UniswapV2SamplerContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) || this;
        _this._methodABIIndex = {};
        utils_1.classUtils.bindAll(_this, ['_abiEncoderByFunctionSignature', 'address', '_web3Wrapper']);
        UniswapV2SamplerContract.ABI().forEach(function (item, index) {
    ...
    UniswapV2SamplerContract.deployFrom0xArtifactAsync = function (artifact, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                ...
                return [2 /*return*/, UniswapV2SamplerContract.deployAsync(bytecode, abi, provider, txDefaults, logDecodeDependenciesAbiOnly)];
            });
        });
    };
    UniswapV2SamplerContract.deployWithLibrariesFrom0xArtifactAsync = function (artifact, libraryArtifacts, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, UniswapV2SamplerContract._deployLibrariesAsync(artifact, libraryArtifacts, new web3_wrapper_1.Web3Wrapper(provider), txDefaults)];
                    case 1:
    ...
    UniswapV2SamplerContract.deployAsync = function (bytecode, abi, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        txReceipt = _a.sent();
                        utils_1.logUtils.log("UniswapV2Sampler successfully deployed at " + txReceipt.contractAddress);
                        contractInstance = new UniswapV2SamplerContract(txReceipt.contractAddress, provider, txDefaults, logDecodeDependencies);
     ...
     */
    UniswapV2SamplerContract.ABI = function () {
        var abi = [
            {
                constant: true,
                inputs: [
    ...
    UniswapV2SamplerContract._deployLibrariesAsync = function (artifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses) {
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, UniswapV2SamplerContract._deployLibrariesAsync(libraryArtifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses)];
                    case 5:
                        // Deploy any dependent libraries used by this library.
                        _g.sent();
    ...
    UniswapV2SamplerContract.prototype.getFunctionSignature = function (methodName) {
        var index = this._methodABIIndex[methodName];
        var methodAbi = UniswapV2SamplerContract.ABI()[index]; // tslint:disable-line:no-unnecessary-type-assertion
        var functionSignature = base_contract_1.methodAbiToFunctionSignature(methodAbi);
        return functionSignature;
    };
    UniswapV2SamplerContract.prototype.getABIDecodedTransactionData = function (methodName, callData) {
    ...
    UniswapV2SamplerContract.prototype.getABIDecodedReturnData = function (methodName, callData) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
    ...
    UniswapV2SamplerContract.prototype.getSelector = function (methodName) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
    ...
    * @returns takerTokenAmounts Taker amounts sold at each maker token         amount.
     */
    UniswapV2SamplerContract.prototype.sampleBuysFromUniswapV2 = function (path, makerTokenAmounts) {
        var self = this;
    ...
    * @returns makerTokenAmounts Maker amounts bought at each taker token         amount.
     */
    UniswapV2SamplerContract.prototype.sampleSellsFromUniswapV2 = function (path, takerTokenAmounts) {
        var self = this;
        assert_1.assert.isArray('path', path);
    ...
    ;
    UniswapV2SamplerContract.contractName = 'UniswapV2Sampler';
    return UniswapV2SamplerContract;
}(base_contract_1.BaseContract));
exports.UniswapV2SamplerContract = UniswapV2SamplerContract;
// tslint:disable:max-file-line-count
// tslint:enable:no-unbound-method no-parameter-reassignment no-consecutive-blank-lines ordered-imports align
// tslint:enable:trailing-comma whitespace no-trailing-whitespace
//# sourceMappingURL=uniswap_v2_sampler.js.map