...
var AssetBalanceContract = /** @class */ (function (_super) {
    __extends(AssetBalanceContract, _super);
    function AssetBalanceContract(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) {
        if (deployedBytecode === void 0) { deployedBytecode = AssetBalanceContract.deployedBytecode; }
        var _this = _super.call(this, 'AssetBalance', AssetBalanceContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) || this;
        _this._methodABIIndex = {};
        utils_1.classUtils.bindAll(_this, ['_abiEncoderByFunctionSignature', 'address', '_web3Wrapper']);
        AssetBalanceContract.ABI().forEach(function (item, index) {
    ...
    AssetBalanceContract.deployFrom0xArtifactAsync = function (artifact, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                ...
                return [2 /*return*/, AssetBalanceContract.deployAsync(bytecode, abi, provider, txDefaults, logDecodeDependenciesAbiOnly)];
            });
        });
    };
    AssetBalanceContract.deployWithLibrariesFrom0xArtifactAsync = function (artifact, libraryArtifacts, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, AssetBalanceContract._deployLibrariesAsync(artifact, libraryArtifacts, new web3_wrapper_1.Web3Wrapper(provider), txDefaults)];
                    case 1:
    ...
    AssetBalanceContract.deployAsync = function (bytecode, abi, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        txReceipt = _a.sent();
                        utils_1.logUtils.log("AssetBalance successfully deployed at " + txReceipt.contractAddress);
                        contractInstance = new AssetBalanceContract(txReceipt.contractAddress, provider, txDefaults, logDecodeDependencies);
     ...
     */
    AssetBalanceContract.ABI = function () {
        var abi = [
            {
                constant: true,
                inputs: [],
    ...
    AssetBalanceContract._deployLibrariesAsync = function (artifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses) {
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, AssetBalanceContract._deployLibrariesAsync(libraryArtifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses)];
                    case 5:
                        // Deploy any dependent libraries used by this library.
                        _g.sent();
    ...
    AssetBalanceContract.prototype.getFunctionSignature = function (methodName) {
        var index = this._methodABIIndex[methodName];
        var methodAbi = AssetBalanceContract.ABI()[index]; // tslint:disable-line:no-unnecessary-type-assertion
        var functionSignature = base_contract_1.methodAbiToFunctionSignature(methodAbi);
        return functionSignature;
    };
    AssetBalanceContract.prototype.getABIDecodedTransactionData = function (methodName, callData) {
    ...
    AssetBalanceContract.prototype.getABIDecodedReturnData = function (methodName, callData) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
    ...
    AssetBalanceContract.prototype.getSelector = function (methodName) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
        return abiEncoder.getSelector();
    };
    AssetBalanceContract.prototype.chaiBridgeAddress = function () {
        var self = this;
    ...
    ;
    AssetBalanceContract.prototype.dydxBridgeAddress = function () {
        var self = this;
    ...
    ;
    AssetBalanceContract.prototype.erc1155ProxyAddress = function () {
        var self = this;
    ...
    ;
    AssetBalanceContract.prototype.erc20ProxyAddress = function () {
        var self = this;
    ...
    ;
    AssetBalanceContract.prototype.erc721ProxyAddress = function () {
        var self = this;
    ...
    ;
    AssetBalanceContract.prototype.exchangeAddress = function () {
        var self = this;
    ...
    * @returns Number of assets (or asset baskets) that the corresponding AssetProxy is authorized to spend.
     */
    AssetBalanceContract.prototype.getAssetProxyAllowance = function (ownerAddress, assetData) {
        var self = this;
    ...
    * @returns Number of assets (or asset baskets) held by owner.
     */
    AssetBalanceContract.prototype.getBalance = function (ownerAddress, assetData) {
        var self = this;
        assert_1.assert.isString('ownerAddress', ownerAddress);
        assert_1.assert.isString('assetData', assetData);
    ...
    * @returns Number of assets (or asset baskets) held by owner, and number of assets (or asset baskets) that the corresponding AssetProxy is authorized to spend.
     */
    AssetBalanceContract.prototype.getBalanceAndAssetProxyAllowance = function (ownerAddress, assetData) {
        var self = this;
        assert_1.assert.isString('ownerAddress', ownerAddress);
        assert_1.assert.isString('assetData', assetData);
    ...
    * @returns An array of asset allowances from getAllowance(), with each element corresponding to the same-indexed element in the assetData input.
     */
    AssetBalanceContract.prototype.getBatchAssetProxyAllowances = function (ownerAddress, assetData) {
        var self = this;
        assert_1.assert.isString('ownerAddress', ownerAddress);
    ...
    * @returns Array of asset balances from getBalance(), with each element corresponding to the same-indexed element in the assetData input.
     */
    AssetBalanceContract.prototype.getBatchBalances = function (ownerAddress, assetData) {
        var self = this;
        assert_1.assert.isString('ownerAddress', ownerAddress);
        assert_1.assert.isArray('assetData', assetData);
    ...
    * @returns An array of asset balances from getBalance(), and an array of asset allowances from getAllowance(), with each element corresponding to the same-indexed element in the assetData input.
     */
    AssetBalanceContract.prototype.getBatchBalancesAndAssetProxyAllowances = function (ownerAddress, assetData) {
        var self = this;
        assert_1.assert.isString('ownerAddress', ownerAddress);
        assert_1.assert.isArray('assetData', assetData);
    ...
    ;
    AssetBalanceContract.prototype.staticCallProxyAddress = function () {
        var self = this;
    ...
    ;
    AssetBalanceContract.contractName = 'AssetBalance';
    return AssetBalanceContract;
}(base_contract_1.BaseContract));
exports.AssetBalanceContract = AssetBalanceContract;
// tslint:disable:max-file-line-count
// tslint:enable:no-unbound-method no-parameter-reassignment no-consecutive-blank-lines ordered-imports align
// tslint:enable:trailing-comma whitespace no-trailing-whitespace
//# sourceMappingURL=asset_balance.js.map