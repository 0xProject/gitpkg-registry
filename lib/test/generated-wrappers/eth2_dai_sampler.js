...
class Eth2DaiSamplerContract extends base_contract_1.BaseContract {
    constructor(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode = Eth2DaiSamplerContract.deployedBytecode, encodingOpts) {
        super('Eth2DaiSampler', Eth2DaiSamplerContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode, encodingOpts);
