...
class Eth2DaiSamplerContract extends base_contract_1.BaseContract {
    constructor(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode = Eth2DaiSamplerContract.deployedBytecode, encodingRules) {
        super('Eth2DaiSampler', Eth2DaiSamplerContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode, encodingRules);
