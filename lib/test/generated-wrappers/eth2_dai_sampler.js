...
var Eth2DaiSamplerContract = /** @class */ (function (_super) {
    __extends(Eth2DaiSamplerContract, _super);
    function Eth2DaiSamplerContract(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) {
        if (deployedBytecode === void 0) { deployedBytecode = Eth2DaiSamplerContract.deployedBytecode; }
        var _this = _super.call(this, 'Eth2DaiSampler', Eth2DaiSamplerContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) || this;
        _this._methodABIIndex = {};
        utils_1.classUtils.bindAll(_this, ['_abiEncoderByFunctionSignature', 'address', '_web3Wrapper']);
        Eth2DaiSamplerContract.ABI().forEach(function (item, index) {
    ...
    Eth2DaiSamplerContract.deployFrom0xArtifactAsync = function (artifact, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                ...
                return [2 /*return*/, Eth2DaiSamplerContract.deployAsync(bytecode, abi, provider, txDefaults, logDecodeDependenciesAbiOnly)];
            });
        });
    };
    Eth2DaiSamplerContract.deployWithLibrariesFrom0xArtifactAsync = function (artifact, libraryArtifacts, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, Eth2DaiSamplerContract._deployLibrariesAsync(artifact, libraryArtifacts, new web3_wrapper_1.Web3Wrapper(provider), txDefaults)];
                    case 1:
    ...
    Eth2DaiSamplerContract.deployAsync = function (bytecode, abi, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        txReceipt = _a.sent();
                        utils_1.logUtils.log("Eth2DaiSampler successfully deployed at " + txReceipt.contractAddress);
                        contractInstance = new Eth2DaiSamplerContract(txReceipt.contractAddress, provider, txDefaults, logDecodeDependencies);
     ...
     */
    Eth2DaiSamplerContract.ABI = function () {
        var abi = [
            {
                constant: true,
                inputs: [
    ...
    Eth2DaiSamplerContract._deployLibrariesAsync = function (artifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses) {
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, Eth2DaiSamplerContract._deployLibrariesAsync(libraryArtifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses)];
                    case 5:
                        // Deploy any dependent libraries used by this library.
                        _g.sent();
    ...
    Eth2DaiSamplerContract.prototype.getFunctionSignature = function (methodName) {
        var index = this._methodABIIndex[methodName];
        var methodAbi = Eth2DaiSamplerContract.ABI()[index]; // tslint:disable-line:no-unnecessary-type-assertion
        var functionSignature = base_contract_1.methodAbiToFunctionSignature(methodAbi);
        return functionSignature;
    };
    Eth2DaiSamplerContract.prototype.getABIDecodedTransactionData = function (methodName, callData) {
    ...
    Eth2DaiSamplerContract.prototype.getABIDecodedReturnData = function (methodName, callData) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
    ...
    Eth2DaiSamplerContract.prototype.getSelector = function (methodName) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
     ...
     */
    Eth2DaiSamplerContract.prototype.sampleBuysFromEth2Dai = function (takerToken, makerToken, makerTokenAmounts) {
        var self = this;
     ...
     */
    Eth2DaiSamplerContract.prototype.sampleSellsFromEth2Dai = function (takerToken, makerToken, takerTokenAmounts) {
        var self = this;
        assert_1.assert.isString('takerToken', takerToken);
        assert_1.assert.isString('makerToken', makerToken);
     ...
     * @returns makerTokenAmounts Maker amounts bought at each taker token         amount.
     */
    Eth2DaiSamplerContract.prototype.sampleSellsFromEth2DaiHop = function (takerToken, makerToken, intermediateToken, takerTokenAmounts) {
        var self = this;
        assert_1.assert.isString('takerToken', takerToken);
        assert_1.assert.isString('makerToken', makerToken);
        assert_1.assert.isString('intermediateToken', intermediateToken);
        assert_1.assert.isArray('takerTokenAmounts', takerTokenAmounts);
        var functionSignature = 'sampleSellsFromEth2DaiHop(address,address,address,uint256[])';
        return {
            callAsync: function (callData, defaultBlock) {
                if (callData === void 0) { callData = {}; }
                return __awaiter(this, void 0, void 0, function () {
    ...
    Eth2DaiSamplerContract.contractName = 'Eth2DaiSampler';
    return Eth2DaiSamplerContract;
}(base_contract_1.BaseContract));
exports.Eth2DaiSamplerContract = Eth2DaiSamplerContract;
// tslint:disable:max-file-line-count
// tslint:enable:no-unbound-method no-parameter-reassignment no-consecutive-blank-lines ordered-imports align
// tslint:enable:trailing-comma whitespace no-trailing-whitespace
//# sourceMappingURL=eth2_dai_sampler.js.map