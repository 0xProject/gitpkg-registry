...
var MixinAssetProxyDispatcherEvents;
(function (MixinAssetProxyDispatcherEvents) {
    MixinAssetProxyDispatcherEvents["AssetProxyRegistered"] = "AssetProxyRegistered";
    MixinAssetProxyDispatcherEvents["OwnershipTransferred"] = "OwnershipTransferred";
})(MixinAssetProxyDispatcherEvents = exports.MixinAssetProxyDispatcherEvents || (exports.MixinAssetProxyDispatcherEvents = {}));
/* istanbul ignore next */
// tslint:disable:array-type
// tslint:disable:no-parameter-reassignment
// tslint:disable-next-line:class-name
var MixinAssetProxyDispatcherContract = /** @class */ (function (_super) {
    __extends(MixinAssetProxyDispatcherContract, _super);
    function MixinAssetProxyDispatcherContract(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) {
        if (deployedBytecode === void 0) { deployedBytecode = MixinAssetProxyDispatcherContract.deployedBytecode; }
        var _this = _super.call(this, 'MixinAssetProxyDispatcher', MixinAssetProxyDispatcherContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) || this;
        _this._methodABIIndex = {};
        utils_1.classUtils.bindAll(_this, ['_abiEncoderByFunctionSignature', 'address', '_web3Wrapper']);
        _this._subscriptionManager = new base_contract_1.SubscriptionManager(MixinAssetProxyDispatcherContract.ABI(), _this._web3Wrapper);
        MixinAssetProxyDispatcherContract.ABI().forEach(function (item, index) {
    ...
    MixinAssetProxyDispatcherContract.deployFrom0xArtifactAsync = function (artifact, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                ...
                return [2 /*return*/, MixinAssetProxyDispatcherContract.deployAsync(bytecode, abi, provider, txDefaults, logDecodeDependenciesAbiOnly)];
            });
        });
    };
    MixinAssetProxyDispatcherContract.deployWithLibrariesFrom0xArtifactAsync = function (artifact, libraryArtifacts, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, MixinAssetProxyDispatcherContract._deployLibrariesAsync(artifact, libraryArtifacts, new web3_wrapper_1.Web3Wrapper(provider), txDefaults)];
                    case 1:
    ...
    MixinAssetProxyDispatcherContract.deployAsync = function (bytecode, abi, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        txReceipt = _a.sent();
                        utils_1.logUtils.log("MixinAssetProxyDispatcher successfully deployed at " + txReceipt.contractAddress);
                        contractInstance = new MixinAssetProxyDispatcherContract(txReceipt.contractAddress, provider, txDefaults, logDecodeDependencies);
     ...
     */
    MixinAssetProxyDispatcherContract.ABI = function () {
        var abi = [
            {
                anonymous: false,
                inputs: [
    ...
    MixinAssetProxyDispatcherContract._deployLibrariesAsync = function (artifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses) {
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, MixinAssetProxyDispatcherContract._deployLibrariesAsync(libraryArtifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses)];
                    case 5:
                        // Deploy any dependent libraries used by this library.
                        _g.sent();
    ...
    MixinAssetProxyDispatcherContract.prototype.getFunctionSignature = function (methodName) {
        var index = this._methodABIIndex[methodName];
        var methodAbi = MixinAssetProxyDispatcherContract.ABI()[index]; // tslint:disable-line:no-unnecessary-type-assertion
        var functionSignature = base_contract_1.methodAbiToFunctionSignature(methodAbi);
        return functionSignature;
    };
    MixinAssetProxyDispatcherContract.prototype.getABIDecodedTransactionData = function (methodName, callData) {
    ...
    MixinAssetProxyDispatcherContract.prototype.getABIDecodedReturnData = function (methodName, callData) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
    ...
    MixinAssetProxyDispatcherContract.prototype.getSelector = function (methodName) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
        return abiEncoder.getSelector();
    };
    MixinAssetProxyDispatcherContract.prototype.assetProxies = function (index_0) {
        var self = this;
        assert_1.assert.isString('index_0', index_0);
        var functionSignature = 'assetProxies(bytes4)';
        return {
    ...
    * @returns The asset proxy registered to assetProxyId. Returns 0x0 if no proxy is registered.
     */
    MixinAssetProxyDispatcherContract.prototype.getAssetProxy = function (assetProxyId) {
        var self = this;
    ...
    ;
    MixinAssetProxyDispatcherContract.prototype.owner = function () {
        var self = this;
 ...
 * Once an asset proxy is registered, it cannot be unregistered.
     ...
     */
    MixinAssetProxyDispatcherContract.prototype.registerAssetProxy = function (assetProxy) {
        var self = this;
    ...
    ;
    MixinAssetProxyDispatcherContract.prototype.transferOwnership = function (newOwner) {
        var self = this;
     ...
     */
    MixinAssetProxyDispatcherContract.prototype.subscribe = function (eventName, indexFilterValues, callback, isVerbose, blockPollingIntervalMs) {
        if (isVerbose === void 0) { isVerbose = false; }
        assert_1.assert.doesBelongToStringEnum('eventName', eventName, MixinAssetProxyDispatcherEvents);
        ...
        var subscriptionToken = this._subscriptionManager.subscribe(this.address, eventName, indexFilterValues, MixinAssetProxyDispatcherContract.ABI(), callback, isVerbose, blockPollingIntervalMs);
     ...
     */
    MixinAssetProxyDispatcherContract.prototype.unsubscribe = function (subscriptionToken) {
        this._subscriptionManager.unsubscribe(subscriptionToken);
    };
    /**
     * Cancels all existing subscriptions
     */
    MixinAssetProxyDispatcherContract.prototype.unsubscribeAll = function () {
     ...
     */
    MixinAssetProxyDispatcherContract.prototype.getLogsAsync = function (eventName, blockRange, indexFilterValues) {
        return __awaiter(this, void 0, void 0, function () {
            var logs;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        assert_1.assert.doesConformToSchema('indexFilterValues', indexFilterValues, json_schemas_1.schemas.indexFilterValuesSchema);
                        return [4 /*yield*/, this._subscriptionManager.getLogsAsync(this.address, eventName, blockRange, indexFilterValues, MixinAssetProxyDispatcherContract.ABI())];
                    case 1:
                        logs = _a.sent();
    ...
    MixinAssetProxyDispatcherContract.contractName = 'MixinAssetProxyDispatcher';
    return MixinAssetProxyDispatcherContract;
}(base_contract_1.BaseContract));
exports.MixinAssetProxyDispatcherContract = MixinAssetProxyDispatcherContract;
// tslint:disable:max-file-line-count
// tslint:enable:no-unbound-method no-parameter-reassignment no-consecutive-blank-lines ordered-imports align
// tslint:enable:trailing-comma whitespace no-trailing-whitespace
//# sourceMappingURL=mixin_asset_proxy_dispatcher.js.map