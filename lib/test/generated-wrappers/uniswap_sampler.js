...
class UniswapSamplerContract extends base_contract_1.BaseContract {
    constructor(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode = UniswapSamplerContract.deployedBytecode, encodingOpts) {
        super('UniswapSampler', UniswapSamplerContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode, encodingOpts);
