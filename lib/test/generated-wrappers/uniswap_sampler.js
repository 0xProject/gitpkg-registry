...
class UniswapSamplerContract extends base_contract_1.BaseContract {
    constructor(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode = UniswapSamplerContract.deployedBytecode, encodingRules) {
        super('UniswapSampler', UniswapSamplerContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode, encodingRules);
