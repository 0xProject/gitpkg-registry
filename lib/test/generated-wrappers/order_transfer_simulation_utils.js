...
var OrderTransferSimulationUtilsContract = /** @class */ (function (_super) {
    __extends(OrderTransferSimulationUtilsContract, _super);
    function OrderTransferSimulationUtilsContract(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) {
        if (deployedBytecode === void 0) { deployedBytecode = OrderTransferSimulationUtilsContract.deployedBytecode; }
        var _this = _super.call(this, 'OrderTransferSimulationUtils', OrderTransferSimulationUtilsContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) || this;
        _this._methodABIIndex = {};
        utils_1.classUtils.bindAll(_this, ['_abiEncoderByFunctionSignature', 'address', '_web3Wrapper']);
        OrderTransferSimulationUtilsContract.ABI().forEach(function (item, index) {
    ...
    OrderTransferSimulationUtilsContract.deployFrom0xArtifactAsync = function (artifact, supportedProvider, txDefaults, logDecodeDependencies, _exchange) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                ...
                return [2 /*return*/, OrderTransferSimulationUtilsContract.deployAsync(bytecode, abi, provider, txDefaults, logDecodeDependenciesAbiOnly, _exchange)];
            });
        });
    };
    OrderTransferSimulationUtilsContract.deployWithLibrariesFrom0xArtifactAsync = function (artifact, libraryArtifacts, supportedProvider, txDefaults, logDecodeDependencies, _exchange) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, OrderTransferSimulationUtilsContract._deployLibrariesAsync(artifact, libraryArtifacts, new web3_wrapper_1.Web3Wrapper(provider), txDefaults)];
                    case 1:
    ...
    OrderTransferSimulationUtilsContract.deployAsync = function (bytecode, abi, supportedProvider, txDefaults, logDecodeDependencies, _exchange) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        txReceipt = _b.sent();
                        utils_1.logUtils.log("OrderTransferSimulationUtils successfully deployed at " + txReceipt.contractAddress);
                        contractInstance = new OrderTransferSimulationUtilsContract(txReceipt.contractAddress, provider, txDefaults, logDecodeDependencies);
     ...
     */
    OrderTransferSimulationUtilsContract.ABI = function () {
        var abi = [
            {
                inputs: [
                    {
    ...
    OrderTransferSimulationUtilsContract._deployLibrariesAsync = function (artifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses) {
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, OrderTransferSimulationUtilsContract._deployLibrariesAsync(libraryArtifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses)];
                    case 5:
                        // Deploy any dependent libraries used by this library.
                        _g.sent();
    ...
    OrderTransferSimulationUtilsContract.prototype.getFunctionSignature = function (methodName) {
        var index = this._methodABIIndex[methodName];
        var methodAbi = OrderTransferSimulationUtilsContract.ABI()[index]; // tslint:disable-line:no-unnecessary-type-assertion
        var functionSignature = base_contract_1.methodAbiToFunctionSignature(methodAbi);
        return functionSignature;
    };
    OrderTransferSimulationUtilsContract.prototype.getABIDecodedTransactionData = function (methodName, callData) {
    ...
    OrderTransferSimulationUtilsContract.prototype.getABIDecodedReturnData = function (methodName, callData) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
    ...
    OrderTransferSimulationUtilsContract.prototype.getSelector = function (methodName) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
    ...
    * @returns The index of the first failed transfer (or 4 if all transfers are successful).
     */
    OrderTransferSimulationUtilsContract.prototype.getSimulatedOrderMakerTransferResults = function (order, takerAddress, takerAssetFillAmount) {
        var self = this;
    ...
    * @returns The index of the first failed transfer (or 4 if all transfers are successful).
     */
    OrderTransferSimulationUtilsContract.prototype.getSimulatedOrderTransferResults = function (order, takerAddress, takerAssetFillAmount) {
        var self = this;
        assert_1.assert.isString('takerAddress', takerAddress);
        assert_1.assert.isBigNumber('takerAssetFillAmount', takerAssetFillAmount);
    ...
    * @returns The indices of the first failed transfer (or 4 if all transfers are successful) for each order.
     */
    OrderTransferSimulationUtilsContract.prototype.getSimulatedOrdersTransferResults = function (orders, takerAddresses, takerAssetFillAmounts) {
        var self = this;
    ...
    ;
    OrderTransferSimulationUtilsContract.contractName = 'OrderTransferSimulationUtils';
    return OrderTransferSimulationUtilsContract;
}(base_contract_1.BaseContract));
exports.OrderTransferSimulationUtilsContract = OrderTransferSimulationUtilsContract;
// tslint:disable:max-file-line-count
// tslint:enable:no-unbound-method no-parameter-reassignment no-consecutive-blank-lines ordered-imports align
// tslint:enable:trailing-comma whitespace no-trailing-whitespace
//# sourceMappingURL=order_transfer_simulation_utils.js.map