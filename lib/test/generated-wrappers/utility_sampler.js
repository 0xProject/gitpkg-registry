...
class UtilitySamplerContract extends base_contract_1.BaseContract {
    constructor(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode = UtilitySamplerContract.deployedBytecode, encodingOpts) {
        super('UtilitySampler', UtilitySamplerContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode, encodingOpts);
