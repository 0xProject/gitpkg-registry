...
var KyberSamplerContract = /** @class */ (function (_super) {
     ...
     */
    KyberSamplerContract.prototype.sampleBuysFromKyberNetwork = function (takerToken, makerToken, makerTokenAmounts) {
        var self = this;
        ...
        var functionSignature = 'sampleBuysFromKyberNetwork(address,address,uint256[])';
        return {
     ...
     */
    KyberSamplerContract.prototype.sampleSellsFromKyberNetwork = function (takerToken, makerToken, takerTokenAmounts) {
        var self = this;
        assert_1.assert.isString('takerToken', takerToken);
        assert_1.assert.isString('makerToken', makerToken);
