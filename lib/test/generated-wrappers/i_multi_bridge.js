...
class IMultiBridgeContract extends base_contract_1.BaseContract {
    constructor(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode = IMultiBridgeContract.deployedBytecode) {
        super('IMultiBridge', IMultiBridgeContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode);
