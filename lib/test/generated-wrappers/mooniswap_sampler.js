...
class MooniswapSamplerContract extends base_contract_1.BaseContract {
    constructor(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode = MooniswapSamplerContract.deployedBytecode, encodingRules) {
        super('MooniswapSampler', MooniswapSamplerContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode, encodingRules);
