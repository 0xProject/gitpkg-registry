...
var DexForwarderBridgeEvents;
(function (DexForwarderBridgeEvents) {
    DexForwarderBridgeEvents["ERC20BridgeTransfer"] = "ERC20BridgeTransfer";
})(DexForwarderBridgeEvents = exports.DexForwarderBridgeEvents || (exports.DexForwarderBridgeEvents = {}));
/* istanbul ignore next */
// tslint:disable:array-type
// tslint:disable:no-parameter-reassignment
// tslint:disable-next-line:class-name
var DexForwarderBridgeContract = /** @class */ (function (_super) {
    __extends(DexForwarderBridgeContract, _super);
    function DexForwarderBridgeContract(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) {
        if (deployedBytecode === void 0) { deployedBytecode = DexForwarderBridgeContract.deployedBytecode; }
        var _this = _super.call(this, 'DexForwarderBridge', DexForwarderBridgeContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) || this;
        _this._methodABIIndex = {};
        utils_1.classUtils.bindAll(_this, ['_abiEncoderByFunctionSignature', 'address', '_web3Wrapper']);
        _this._subscriptionManager = new base_contract_1.SubscriptionManager(DexForwarderBridgeContract.ABI(), _this._web3Wrapper);
        DexForwarderBridgeContract.ABI().forEach(function (item, index) {
    ...
    DexForwarderBridgeContract.deployFrom0xArtifactAsync = function (artifact, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                ...
                return [2 /*return*/, DexForwarderBridgeContract.deployAsync(bytecode, abi, provider, txDefaults, logDecodeDependenciesAbiOnly)];
            });
        });
    };
    DexForwarderBridgeContract.deployWithLibrariesFrom0xArtifactAsync = function (artifact, libraryArtifacts, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, DexForwarderBridgeContract._deployLibrariesAsync(artifact, libraryArtifacts, new web3_wrapper_1.Web3Wrapper(provider), txDefaults)];
                    case 1:
    ...
    DexForwarderBridgeContract.deployAsync = function (bytecode, abi, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        txReceipt = _a.sent();
                        utils_1.logUtils.log("DexForwarderBridge successfully deployed at " + txReceipt.contractAddress);
                        contractInstance = new DexForwarderBridgeContract(txReceipt.contractAddress, provider, txDefaults, logDecodeDependencies);
     ...
     */
    DexForwarderBridgeContract.ABI = function () {
        var abi = [
            {
                anonymous: false,
                inputs: [
    ...
    DexForwarderBridgeContract._deployLibrariesAsync = function (artifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses) {
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, DexForwarderBridgeContract._deployLibrariesAsync(libraryArtifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses)];
                    case 5:
                        // Deploy any dependent libraries used by this library.
                        _g.sent();
    ...
    DexForwarderBridgeContract.prototype.getFunctionSignature = function (methodName) {
        var index = this._methodABIIndex[methodName];
        var methodAbi = DexForwarderBridgeContract.ABI()[index]; // tslint:disable-line:no-unnecessary-type-assertion
        var functionSignature = base_contract_1.methodAbiToFunctionSignature(methodAbi);
        return functionSignature;
    };
    DexForwarderBridgeContract.prototype.getABIDecodedTransactionData = function (methodName, callData) {
    ...
    DexForwarderBridgeContract.prototype.getABIDecodedReturnData = function (methodName, callData) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
    ...
    DexForwarderBridgeContract.prototype.getSelector = function (methodName) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
    ...
    * @returns success The magic bytes if successful.
     */
    DexForwarderBridgeContract.prototype.bridgeTransferFrom = function (outputToken, index_1, to, index_3, bridgeData) {
        var self = this;
    ...
    ;
    DexForwarderBridgeContract.prototype.executeBridgeCall = function (bridge, to, inputToken, outputToken, inputTokenAmount, outputTokenAmount, bridgeData) {
        var self = this;
 ...
 * and sign for itself in orders. Always succeeds.
    * @returns magicValue Magic success bytes, always.
     */
    DexForwarderBridgeContract.prototype.isValidSignature = function (index_0, index_1) {
        var self = this;
    ...
    ;
    /**
     * Subscribe to an event type emitted by the DexForwarderBridge contract.
     * @param eventName The DexForwarderBridge contract event you would like to subscribe to.
     ...
     */
    DexForwarderBridgeContract.prototype.subscribe = function (eventName, indexFilterValues, callback, isVerbose, blockPollingIntervalMs) {
        if (isVerbose === void 0) { isVerbose = false; }
        assert_1.assert.doesBelongToStringEnum('eventName', eventName, DexForwarderBridgeEvents);
        ...
        var subscriptionToken = this._subscriptionManager.subscribe(this.address, eventName, indexFilterValues, DexForwarderBridgeContract.ABI(), callback, isVerbose, blockPollingIntervalMs);
     ...
     */
    DexForwarderBridgeContract.prototype.unsubscribe = function (subscriptionToken) {
        this._subscriptionManager.unsubscribe(subscriptionToken);
    };
    /**
     * Cancels all existing subscriptions
     */
    DexForwarderBridgeContract.prototype.unsubscribeAll = function () {
     ...
     */
    DexForwarderBridgeContract.prototype.getLogsAsync = function (eventName, blockRange, indexFilterValues) {
        return __awaiter(this, void 0, void 0, function () {
            var logs;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        assert_1.assert.doesConformToSchema('indexFilterValues', indexFilterValues, json_schemas_1.schemas.indexFilterValuesSchema);
                        return [4 /*yield*/, this._subscriptionManager.getLogsAsync(this.address, eventName, blockRange, indexFilterValues, DexForwarderBridgeContract.ABI())];
                    case 1:
                        logs = _a.sent();
    ...
    DexForwarderBridgeContract.contractName = 'DexForwarderBridge';
    return DexForwarderBridgeContract;
}(base_contract_1.BaseContract));
exports.DexForwarderBridgeContract = DexForwarderBridgeContract;
