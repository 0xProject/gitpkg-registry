...
var OrderValidationUtilsContract = /** @class */ (function (_super) {
    __extends(OrderValidationUtilsContract, _super);
    function OrderValidationUtilsContract(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) {
        if (deployedBytecode === void 0) { deployedBytecode = OrderValidationUtilsContract.deployedBytecode; }
        var _this = _super.call(this, 'OrderValidationUtils', OrderValidationUtilsContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) || this;
        _this._methodABIIndex = {};
        utils_1.classUtils.bindAll(_this, ['_abiEncoderByFunctionSignature', 'address', '_web3Wrapper']);
        OrderValidationUtilsContract.ABI().forEach(function (item, index) {
    ...
    OrderValidationUtilsContract.deployFrom0xArtifactAsync = function (artifact, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                ...
                return [2 /*return*/, OrderValidationUtilsContract.deployAsync(bytecode, abi, provider, txDefaults, logDecodeDependenciesAbiOnly)];
            });
        });
    };
    OrderValidationUtilsContract.deployWithLibrariesFrom0xArtifactAsync = function (artifact, libraryArtifacts, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, OrderValidationUtilsContract._deployLibrariesAsync(artifact, libraryArtifacts, new web3_wrapper_1.Web3Wrapper(provider), txDefaults)];
                    case 1:
    ...
    OrderValidationUtilsContract.deployAsync = function (bytecode, abi, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        txReceipt = _a.sent();
                        utils_1.logUtils.log("OrderValidationUtils successfully deployed at " + txReceipt.contractAddress);
                        contractInstance = new OrderValidationUtilsContract(txReceipt.contractAddress, provider, txDefaults, logDecodeDependencies);
     ...
     */
    OrderValidationUtilsContract.ABI = function () {
        var abi = [
            {
                constant: true,
                inputs: [],
    ...
    OrderValidationUtilsContract._deployLibrariesAsync = function (artifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses) {
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, OrderValidationUtilsContract._deployLibrariesAsync(libraryArtifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses)];
                    case 5:
                        // Deploy any dependent libraries used by this library.
                        _g.sent();
    ...
    OrderValidationUtilsContract.prototype.getFunctionSignature = function (methodName) {
        var index = this._methodABIIndex[methodName];
        var methodAbi = OrderValidationUtilsContract.ABI()[index]; // tslint:disable-line:no-unnecessary-type-assertion
        var functionSignature = base_contract_1.methodAbiToFunctionSignature(methodAbi);
        return functionSignature;
    };
    OrderValidationUtilsContract.prototype.getABIDecodedTransactionData = function (methodName, callData) {
    ...
    OrderValidationUtilsContract.prototype.getABIDecodedReturnData = function (methodName, callData) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
    ...
    OrderValidationUtilsContract.prototype.getSelector = function (methodName) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
        return abiEncoder.getSelector();
    };
    OrderValidationUtilsContract.prototype.chaiBridgeAddress = function () {
        var self = this;
    ...
    ;
    OrderValidationUtilsContract.prototype.dydxBridgeAddress = function () {
        var self = this;
    ...
    ;
    OrderValidationUtilsContract.prototype.erc1155ProxyAddress = function () {
        var self = this;
    ...
    ;
    OrderValidationUtilsContract.prototype.erc20ProxyAddress = function () {
        var self = this;
    ...
    ;
    OrderValidationUtilsContract.prototype.erc721ProxyAddress = function () {
        var self = this;
    ...
    ;
    OrderValidationUtilsContract.prototype.exchangeAddress = function () {
        var self = this;
    ...
    * @returns Number of assets (or asset baskets) that the corresponding AssetProxy is authorized to spend.
     */
    OrderValidationUtilsContract.prototype.getAssetProxyAllowance = function (ownerAddress, assetData) {
        var self = this;
        ...
        return {
            ...
            getABIEncodedTransactionData: function () {
                return self._strictEncodeArguments(functionSignature, [ownerAddress.toLowerCase(),
                    assetData
                ]);
            },
        };
    ...
    * @returns Number of assets (or asset baskets) held by owner.
     */
    OrderValidationUtilsContract.prototype.getBalance = function (ownerAddress, assetData) {
        var self = this;
        assert_1.assert.isString('ownerAddress', ownerAddress);
        assert_1.assert.isString('assetData', assetData);
    ...
    * @returns Number of assets (or asset baskets) held by owner, and number of assets (or asset baskets) that the corresponding AssetProxy is authorized to spend.
     */
    OrderValidationUtilsContract.prototype.getBalanceAndAssetProxyAllowance = function (ownerAddress, assetData) {
        var self = this;
        assert_1.assert.isString('ownerAddress', ownerAddress);
        assert_1.assert.isString('assetData', assetData);
    ...
    * @returns An array of asset allowances from getAllowance(), with each element corresponding to the same-indexed element in the assetData input.
     */
    OrderValidationUtilsContract.prototype.getBatchAssetProxyAllowances = function (ownerAddress, assetData) {
        var self = this;
        assert_1.assert.isString('ownerAddress', ownerAddress);
    ...
    * @returns Array of asset balances from getBalance(), with each element corresponding to the same-indexed element in the assetData input.
     */
    OrderValidationUtilsContract.prototype.getBatchBalances = function (ownerAddress, assetData) {
        var self = this;
        assert_1.assert.isString('ownerAddress', ownerAddress);
        assert_1.assert.isArray('assetData', assetData);
    ...
    * @returns An array of asset balances from getBalance(), and an array of asset allowances from getAllowance(), with each element corresponding to the same-indexed element in the assetData input.
     */
    OrderValidationUtilsContract.prototype.getBatchBalancesAndAssetProxyAllowances = function (ownerAddress, assetData) {
        var self = this;
        assert_1.assert.isString('ownerAddress', ownerAddress);
        assert_1.assert.isArray('assetData', assetData);
    ...
    * @returns The orderInfo (hash, status, and &#x60;takerAssetAmount&#x60; already filled for the given order), fillableTakerAssetAmount (amount of the order&#x27;s &#x60;takerAssetAmount&#x60; that is fillable given all on-chain state), and isValidSignature (validity of the provided signature). NOTE: If the &#x60;takerAssetData&#x60; encodes data for multiple assets, &#x60;fillableTakerAssetAmount&#x60; will represent a &quot;scaled&quot; amount, meaning it must be multiplied by all the individual asset amounts within the &#x60;takerAssetData&#x60; to get the final amount of each asset that can be filled.
     */
    OrderValidationUtilsContract.prototype.getOrderRelevantState = function (order, signature) {
        var self = this;
    ...
    * @returns The ordersInfo (array of the hash, status, and &#x60;takerAssetAmount&#x60; already filled for each order), fillableTakerAssetAmounts (array of amounts for each order&#x27;s &#x60;takerAssetAmount&#x60; that is fillable given all on-chain state), and isValidSignature (array containing the validity of each provided signature). NOTE: If the &#x60;takerAssetData&#x60; encodes data for multiple assets, each element of &#x60;fillableTakerAssetAmounts&#x60; will represent a &quot;scaled&quot; amount, meaning it must be multiplied by all the individual asset amounts within the &#x60;takerAssetData&#x60; to get the final amount of each asset that can be filled.
     */
    OrderValidationUtilsContract.prototype.getOrderRelevantStates = function (orders, signatures) {
        var self = this;
    ...
    * @returns The amount of the asset tranferable by the owner. NOTE: If the &#x60;assetData&#x60; encodes data for multiple assets, the &#x60;transferableAssetAmount&#x60; will represent the amount of times the entire &#x60;assetData&#x60; can be transferred. To calculate the total individual transferable amounts, this scaled &#x60;transferableAmount&#x60; must be multiplied by the individual asset amounts located within the &#x60;assetData&#x60;.
     */
    OrderValidationUtilsContract.prototype.getTransferableAssetAmount = function (ownerAddress, assetData) {
        var self = this;
        assert_1.assert.isString('ownerAddress', ownerAddress);
        assert_1.assert.isString('assetData', assetData);
    ...
    ;
    OrderValidationUtilsContract.prototype.staticCallProxyAddress = function () {
        var self = this;
    ...
    ;
    OrderValidationUtilsContract.contractName = 'OrderValidationUtils';
    return OrderValidationUtilsContract;
}(base_contract_1.BaseContract));
exports.OrderValidationUtilsContract = OrderValidationUtilsContract;
