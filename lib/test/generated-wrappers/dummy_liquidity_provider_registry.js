...
var DummyLiquidityProviderRegistryContract = /** @class */ (function (_super) {
    ...
    * @returns Address of pool.
     */
    DummyLiquidityProviderRegistryContract.prototype.getLiquidityProviderForMarket = function (xToken, yToken) {
        var self = this;
     ...
     */
    DummyLiquidityProviderRegistryContract.prototype.setLiquidityProviderForMarket = function (xToken, yToken, poolAddress) {
        var self = this;
        assert_1.assert.isString('xToken', xToken);
        assert_1.assert.isString('yToken', yToken);
