...
class DummyLiquidityProviderRegistryContract extends base_contract_1.BaseContract {
    constructor(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode = DummyLiquidityProviderRegistryContract.deployedBytecode) {
    ...
    static deployWithLibrariesFrom0xArtifactAsync(artifact, libraryArtifacts, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const libraryAddresses = yield DummyLiquidityProviderRegistryContract._deployLibrariesAsync(artifact, libraryArtifacts, new web3_wrapper_1.Web3Wrapper(provider), txDefaults);
    ...
    static deployAsync(bytecode, abi, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const contractInstance = new DummyLiquidityProviderRegistryContract(txReceipt.contractAddress, provider, txDefaults, logDecodeDependencies);
            ...
            for (const link of Object.values(links)) {
                for (const libraryName of Object.keys(link)) {
                    if (!libraryAddresses[libraryName]) {
                        ...
                        yield DummyLiquidityProviderRegistryContract._deployLibrariesAsync(libraryArtifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses);
                        // Deploy this library.
    ...
    getFunctionSignature(methodName) {
        ...
        const methodAbi = DummyLiquidityProviderRegistryContract.ABI()[index]; // tslint:disable-line:no-unnecessary-type-assertion
    ...
    * @returns Address of pool.
     */
    getLiquidityProviderForMarket(xToken, yToken) {
        const self = this;
        assert_1.assert.isString('xToken', xToken);
        assert_1.assert.isString('yToken', yToken);
        ...
        return {
            ...
            getABIEncodedTransactionData() {
                return self._strictEncodeArguments(functionSignature, [xToken.toLowerCase(),
                    yToken.toLowerCase()
                ]);
            },
        };
     ...
     */
    setLiquidityProviderForMarket(xToken, yToken, poolAddress) {
        const self = this;
        assert_1.assert.isString('xToken', xToken);
        assert_1.assert.isString('yToken', yToken);
