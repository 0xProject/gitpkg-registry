 ...
 * intermediate pairs to trade through (if, for example, a direct pair does not exist).
    ...
    * @returns amounts The input token amount and all subsequent output token amounts.
     */
    IUniswapV2Router01Contract.prototype.swapExactTokensForTokens = function (amountIn, amountOutMin, path, to, deadline) {
        var self = this;
        ...
        var functionSignature = 'swapExactTokensForTokens(uint256,uint256,address[],address,uint256)';
        return {
