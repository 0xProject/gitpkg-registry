...
class MakerPSMSamplerContract extends base_contract_1.BaseContract {
    constructor(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode = MakerPSMSamplerContract.deployedBytecode, encodingRules) {
        super('MakerPSMSampler', MakerPSMSamplerContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode, encodingRules);
