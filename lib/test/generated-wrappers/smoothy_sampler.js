...
class SmoothySamplerContract extends base_contract_1.BaseContract {
    constructor(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode = SmoothySamplerContract.deployedBytecode) {
        super('SmoothySampler', SmoothySamplerContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode);
