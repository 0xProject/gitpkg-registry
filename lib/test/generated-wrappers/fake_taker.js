...
class FakeTakerContract extends base_contract_1.BaseContract {
    constructor(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode = FakeTakerContract.deployedBytecode, encodingOpts) {
        super('FakeTaker', FakeTakerContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode, encodingOpts);
