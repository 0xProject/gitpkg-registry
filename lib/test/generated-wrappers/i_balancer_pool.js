...
var IBalancerPoolContract = /** @class */ (function (_super) {
    __extends(IBalancerPoolContract, _super);
    function IBalancerPoolContract(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) {
        if (deployedBytecode === void 0) { deployedBytecode = IBalancerPoolContract.deployedBytecode; }
        var _this = _super.call(this, 'IBalancerPool', IBalancerPoolContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) || this;
        _this._methodABIIndex = {};
        utils_1.classUtils.bindAll(_this, ['_abiEncoderByFunctionSignature', 'address', '_web3Wrapper']);
        IBalancerPoolContract.ABI().forEach(function (item, index) {
    ...
    IBalancerPoolContract.deployFrom0xArtifactAsync = function (artifact, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                ...
                return [2 /*return*/, IBalancerPoolContract.deployAsync(bytecode, abi, provider, txDefaults, logDecodeDependenciesAbiOnly)];
            });
        });
    };
    IBalancerPoolContract.deployWithLibrariesFrom0xArtifactAsync = function (artifact, libraryArtifacts, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, IBalancerPoolContract._deployLibrariesAsync(artifact, libraryArtifacts, new web3_wrapper_1.Web3Wrapper(provider), txDefaults)];
                    case 1:
    ...
    IBalancerPoolContract.deployAsync = function (bytecode, abi, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        txReceipt = _a.sent();
                        utils_1.logUtils.log("IBalancerPool successfully deployed at " + txReceipt.contractAddress);
                        contractInstance = new IBalancerPoolContract(txReceipt.contractAddress, provider, txDefaults, logDecodeDependencies);
     ...
     */
    IBalancerPoolContract.ABI = function () {
        var abi = [
            {
                constant: false,
                inputs: [
    ...
    IBalancerPoolContract._deployLibrariesAsync = function (artifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses) {
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, IBalancerPoolContract._deployLibrariesAsync(libraryArtifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses)];
                    case 5:
                        // Deploy any dependent libraries used by this library.
                        _g.sent();
    ...
    IBalancerPoolContract.prototype.getFunctionSignature = function (methodName) {
        var index = this._methodABIIndex[methodName];
        var methodAbi = IBalancerPoolContract.ABI()[index]; // tslint:disable-line:no-unnecessary-type-assertion
        var functionSignature = base_contract_1.methodAbiToFunctionSignature(methodAbi);
        return functionSignature;
    };
    IBalancerPoolContract.prototype.getABIDecodedTransactionData = function (methodName, callData) {
    ...
    IBalancerPoolContract.prototype.getABIDecodedReturnData = function (methodName, callData) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
    ...
    IBalancerPoolContract.prototype.getSelector = function (methodName) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
    ...
    /**
     * Sell `tokenAmountIn` of `tokenIn` and receive `tokenOut`.
    ...
    * @returns tokenAmountOut The amount of &#x60;tokenOut&#x60; bought.spotPriceAfter The new marginal spot price of the given         token pair for this pool.
     */
    IBalancerPoolContract.prototype.swapExactAmountIn = function (tokenIn, tokenAmountIn, tokenOut, minAmountOut, maxPrice) {
        var self = this;
        assert_1.assert.isString('tokenIn', tokenIn);
        assert_1.assert.isBigNumber('tokenAmountIn', tokenAmountIn);
        assert_1.assert.isString('tokenOut', tokenOut);
        assert_1.assert.isBigNumber('minAmountOut', minAmountOut);
        assert_1.assert.isBigNumber('maxPrice', maxPrice);
        var functionSignature = 'swapExactAmountIn(address,uint256,address,uint256,uint256)';
        return {
            ...
            getABIEncodedTransactionData: function () {
                return self._strictEncodeArguments(functionSignature, [tokenIn.toLowerCase(),
                    tokenAmountIn,
    ...
    ;
    IBalancerPoolContract.contractName = 'IBalancerPool';
    return IBalancerPoolContract;
}(base_contract_1.BaseContract));
exports.IBalancerPoolContract = IBalancerPoolContract;
// tslint:disable:max-file-line-count
// tslint:enable:no-unbound-method no-parameter-reassignment no-consecutive-blank-lines ordered-imports align
// tslint:enable:trailing-comma whitespace no-trailing-whitespace
//# sourceMappingURL=i_balancer_pool.js.map