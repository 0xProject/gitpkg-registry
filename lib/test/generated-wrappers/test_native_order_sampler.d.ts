...
export declare class TestNativeOrderSamplerContract extends BaseContract {
    ...
    getAssetProxy(proxyId: string): ContractTxFunctionObj<string>;
    /**
    ...
    isValidHashSignature(index_0: string, index_1: string, signature: string): ContractTxFunctionObj<boolean>;
