...
describe('Utils', () => {
    describe('.getOrderHash', () => {
        ...
        test('calculates the orderhash if it does not exist', () => __awaiter(this, void 0, void 0, function* () {
            const orderHash = utils_1.utils.getOrderHash(order);
            const calculatedOrderHash = utils_1.utils.getOrderHash({ order: order, metaData: {} });
    ...
    describe('.attemptAsync', () => {
        test('attempts the operation multiple times if the operation throws', () => __awaiter(this, void 0, void 0, function* () {
            const success = 'Success';
            const mock = jest
                .fn()
                .mockRejectedValueOnce(new Error('Async Error'))
                .mockResolvedValue(success);
            const result = yield utils_1.utils.attemptAsync(mock);
