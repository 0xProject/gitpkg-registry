...
const exchangeProxyOverhead = (sourceFlags) => {
    if ([src_1.SOURCE_FLAGS.Native].includes(sourceFlags)) {
        return new utils_1.BigNumber(150e3).times(GAS_PRICE);
    }
    else {
...
describe('getComparisonPrices', () => __awaiter(this, void 0, void 0, function* () {
    it('should create a proper comparison price for Sells', () => {
        ...
        // expected outcome
        const EXPECTED_PRICE = new utils_1.BigNumber('500.925');
    ...
    it('should create a proper comparison price for Buys', () => {
        ...
        // expected outcome
        const EXPECTED_PRICE = new utils_1.BigNumber('0.0020037069');
        expect(comparisonPrices.wholeOrder).to.deep.eq(EXPECTED_PRICE);
    });
