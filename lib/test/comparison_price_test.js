...
const feeSchedule = {
    [types_2.ERC20BridgeSource.Native]: _.constant({
...
describe('getComparisonPrices', () => __awaiter(void 0, void 0, void 0, function* () {
    it('should create a proper comparison price for Sells', () => {
        ...
        const comparisonPrices = (0, comparison_price_1.getComparisonPrices)(adjustedRate, AMOUNT, sellMarketSideLiquidity, feeSchedule, exchangeProxyOverhead);
        // expected outcome
    ...
    it('should create a proper comparison price for Buys', () => {
        ...
        const comparisonPrices = (0, comparison_price_1.getComparisonPrices)(adjustedRate, AMOUNT, buyMarketSideLiquidity, feeSchedule, exchangeProxyOverhead);
        // expected outcome
