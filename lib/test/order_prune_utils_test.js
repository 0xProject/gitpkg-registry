...
describe('orderPrunerUtils', function () {
    ...
    describe('prunedForUsableSignedOrders', function () {
        it('should filter for only feeless orders if options permit only feeless orders', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        it('should filter for only takerFee in takerAsset orders if options permit only takerFee in takerAsset orders', function () { return __awaiter(void 0, void 0, void 0, function () {
            var permittedOrderFeeTypes, orders, resultPrunedOrders;
            return __generator(this, function (_a) {
        ...
        it('should filter for only makerFee in takerAsset orders if options permit only makerFee orders', function () { return __awaiter(void 0, void 0, void 0, function () {
            var permittedOrderFeeTypes, orders, resultPrunedOrders;
            return __generator(this, function (_a) {
                permittedOrderFeeTypes = new Set([
        ...
        it('should filter out non open orders', function () { return __awaiter(void 0, void 0, void 0, function () {
            var permittedOrderFeeTypes, orders, resultPrunedOrders;
            return __generator(this, function (_a) {
                permittedOrderFeeTypes = new Set([
                    types_1.OrderPrunerPermittedFeeTypes.MakerDenominatedTakerFee,
        ...
        it('should filter out expired orders', function () { return __awaiter(void 0, void 0, void 0, function () {
            var permittedOrderFeeTypes, orders, resultPrunedOrders;
            return __generator(this, function (_a) {
                permittedOrderFeeTypes = new Set([
                    types_1.OrderPrunerPermittedFeeTypes.MakerDenominatedTakerFee,
