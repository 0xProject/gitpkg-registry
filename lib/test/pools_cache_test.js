...
require("mocha");
const balancer_1 = require("../src/network/samplers/balancer");
const balancer_v2_1 = require("../src/network/samplers/balancer_v2");
...
describe.skip('Pools Caches for Balancer-based sampling', () => {
    ...
    describe('BalancerPoolsCache', () => {
        const cache = new balancer_1.BalancerPoolsCache();
    ...
    describe('BalancerV2PoolsCache', () => {
        const cache = new balancer_v2_1.BalancerV2PoolsCache('https://api.thegraph.com/subgraphs/name/balancer-labs/balancer-v2');
        it('fetches pools', () => __awaiter(void 0, void 0, void 0, function* () {
            const pairs = [
    ...
    describe('CreamPoolsCache', () => {
        const cache = new balancer_1.CreamPoolsCache();
        it('fetches pools', () => __awaiter(void 0, void 0, void 0, function* () {
            const pairs = [
