...
describe('ExchangeProxySwapQuoteConsumer', () => {
    ...
    function cleanOrders(orders) {
        return orders.map(o => _.omit(Object.assign({}, o.fillData, { order: _.omit(o.fillData.order, [
                'chainId',
                'verifyingContract',
            ]) }), [
    ...
    describe('getCalldataOrThrow()', () => {
        ...
        it('Appends a positive slippage affiliate fee transformer after the fill if the positive slippage fee feeType is specified', () => __awaiter(this, void 0, void 0, function* () {
            const quote = getRandomSellQuote();
            const affiliateFee = {
                recipient: contracts_test_utils_1.randomAddress(),
        ...
        //     });
        // });
        it('allows selling the entire balance for CFL', () => __awaiter(this, void 0, void 0, function* () {
            const quote = getRandomSellQuote();
            const callInfo = yield consumer.getCalldataOrThrowAsync(quote, {
