...
describe('ExchangeProxySwapQuoteConsumer', () => {
    ...
    const contractAddresses = Object.assign(Object.assign({}, (0, contract_addresses_1.getContractAddressesForChainOrThrow)(CHAIN_ID)), { exchangeProxy: (0, contracts_test_utils_1.randomAddress)(), exchangeProxyAllowanceTarget: (0, contracts_test_utils_1.randomAddress)(), exchangeProxyTransformerDeployer: TRANSFORMER_DEPLOYER, transformers: {
    ...
    function getRandomOrder(orderFields) {
        return Object.assign({ chainId: CHAIN_ID, verifyingContract: contractAddresses.exchangeProxy, expiry: (0, contracts_test_utils_1.getRandomInteger)(1, 2e9), feeRecipient: (0, contracts_test_utils_1.randomAddress)(), sender: (0, contracts_test_utils_1.randomAddress)(), pool: utils_1.hexUtils.random(32), maker: (0, contracts_test_utils_1.randomAddress)(), makerAmount: (0, utils_2.getRandomAmount)(), takerAmount: (0, utils_2.getRandomAmount)(), takerTokenFeeAmount: (0, utils_2.getRandomAmount)(), salt: (0, utils_2.getRandomAmount)(2e9), taker: NULL_ADDRESS, makerToken: MAKER_TOKEN, takerToken: TAKER_TOKEN }, orderFields);
    }
    function getRandomOptimizedMarketOrder(optimizerFields, orderFields) {
        ...
        return Object.assign({ source: types_2.ERC20BridgeSource.Native, fillData: {
            ...
            }, type: protocol_utils_1.FillQuoteTransformerOrderType.Limit, makerToken: order.makerToken, takerToken: order.takerToken, makerAmount: order.makerAmount, takerAmount: order.takerAmount, 
            // tslint:disable-next-line:no-object-literal-type-assertion
            fill: {} }, optimizerFields);
    }
    function getRandomQuote(side) {
        ...
        return Object.assign(Object.assign({ gasPrice: (0, contracts_test_utils_1.getRandomInteger)(1, 1e9), makerToken: MAKER_TOKEN, takerToken: TAKER_TOKEN, orders: [order], makerTokenDecimals: 18, takerTokenDecimals: 18, sourceBreakdown: {}, isTwoHop: false, bestCaseQuoteInfo: {
                ...
                feeTakerTokenAmount: (0, utils_2.getRandomAmount)(),
                slippage: 0,
            }, makerAmountPerEth: (0, contracts_test_utils_1.getRandomInteger)(1, 1e9), takerAmountPerEth: (0, contracts_test_utils_1.getRandomInteger)(1, 1e9) }, (side === types_1.MarketOperation.Buy
            ? { type: types_1.MarketOperation.Buy, makerTokenFillAmount }
            : { type: types_1.MarketOperation.Sell, takerTokenFillAmount })), { blockNumber: 1337420 });
    }
