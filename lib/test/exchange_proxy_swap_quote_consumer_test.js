...
describe('ExchangeProxySwapQuoteConsumer', () => {
    ...
    function getRandomOptimizedMarketOrder(optimizerFields, orderFields) {
        ...
        return Object.assign(Object.assign({ source: types_2.ERC20BridgeSource.Native, fillData: {
                order,
                signature: utils_2.getRandomSignature(),
                maxTakerTokenFillAmount: order.takerAmount,
            }, type: protocol_utils_1.FillQuoteTransformerOrderType.Limit, makerToken: order.makerToken, takerToken: order.takerToken, makerAmount: order.makerAmount, takerAmount: order.takerAmount, fills: [] }, optimizerFields), { gasUsed: new utils_1.BigNumber(1) });
    }
