...
describe('ExchangeProxySwapQuoteConsumer', function () {
    ...
    describe('getCalldataOrThrow()', function () {
        ...
        it('Appends an affiliate fee transformer after the fill if a buy token affiliate fee is provided', function () { return __awaiter(_this, void 0, void 0, function () {
            var quote, affiliateFee, callInfo, callArgs, affiliateFeeTransformerData;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        quote = getRandomSellQuote();
                        ...
                        return [4 /*yield*/, consumer.getCalldataOrThrowAsync(quote, {
                                extensionContractOpts: { affiliateFee: affiliateFee },
                            })];
                    case 1:
                        callInfo = _a.sent();
                        callArgs = callDataEncoder.decode(callInfo.calldataHexString);
                        expect(callArgs.transformations[1].deploymentNonce.toNumber()).to.eq(consumer.transformerNonces.affiliateFeeTransformer);
                        affiliateFeeTransformerData = order_utils_1.decodeAffiliateFeeTransformerData(callArgs.transformations[1].data);
        ...
        it('Throws if a sell token affiliate fee is provided', function () { return __awaiter(_this, void 0, void 0, function () {
            var quote, affiliateFee;
            return __generator(this, function (_a) {
                quote = getRandomSellQuote();
                affiliateFee = {
                    recipient: contracts_test_utils_1.randomAddress(),
