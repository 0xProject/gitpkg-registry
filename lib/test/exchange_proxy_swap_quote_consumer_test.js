...
describe('ExchangeProxySwapQuoteConsumer', () => {
    ...
    function getRandomQuote(side) {
        ...
        return Object.assign(Object.assign({ gasPrice: contracts_test_utils_1.getRandomInteger(1, 1e9), makerToken: MAKER_TOKEN, takerToken: TAKER_TOKEN, orders: [order], makerTokenDecimals: 18, takerTokenDecimals: 18, sourceBreakdown: {}, isTwoHop: false, bestCaseQuoteInfo: {
