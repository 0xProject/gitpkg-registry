...
describe('ExchangeProxySwapQuoteConsumer', function () {
    ...
    var contractAddresses = __assign(__assign({}, contract_addresses_1.getContractAddressesForChainOrThrow(CHAIN_ID)), { exchangeProxy: contracts_test_utils_1.randomAddress(), exchangeProxyAllowanceTarget: contracts_test_utils_1.randomAddress(), exchangeProxyTransformerDeployer: TRANSFORMER_DEPLOYER, transformers: {
            ...
            affiliateFeeTransformer: exchange_proxy_swap_quote_consumer_1.getTransformerAddress(TRANSFORMER_DEPLOYER, 4),
        } });
    var consumer;
    ...
    describe('getCalldataOrThrow()', function () {
        it('can produce a sell quote', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        fillQuoteTransformerData = order_utils_1.decodeFillQuoteTransformerData(callArgs.transformations[0].data);
                        ...
                        payTakerTransformerData = order_utils_1.decodePayTakerTransformerData(callArgs.transformations[1].data);
        ...
        it('can produce a buy quote', function () { return __awaiter(void 0, void 0, void 0, function () {
            var quote, callInfo, callArgs, fillQuoteTransformerData, payTakerTransformerData;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        it('ERC20 -> ERC20 does not have a WETH transformer', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        it('ETH -> ERC20 has a WETH transformer before the fill', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        wethTransformerData = order_utils_1.decodeWethTransformerData(callArgs.transformations[0].data);
        ...
        it('ERC20 -> ETH has a WETH transformer after the fill', function () { return __awaiter(void 0, void 0, void 0, function () {
            var quote, callInfo, callArgs, wethTransformerData;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        ...
                        wethTransformerData = order_utils_1.decodeWethTransformerData(callArgs.transformations[1].data);
