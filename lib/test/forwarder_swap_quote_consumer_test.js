...
var expectMakerAndTakerBalancesAsyncFactory = function (erc20TokenContract, makerAddress, takerAddress) { return function (expectedMakerBalance, expectedTakerBalance) { return __awaiter(void 0, void 0, void 0, function () {
...
describe('ForwarderSwapQuoteConsumer', function () {
    ...
    before(function () { return __awaiter(void 0, void 0, void 0, function () {
        var defaultOrderParams, invalidDefaultOrderParams, privateKey;
        var _a, _b, _c;
    ...
    beforeEach(function () { return __awaiter(void 0, void 0, void 0, function () {
        var UNLIMITED_ALLOWANCE, totalFillableAmount, PARTIAL_PRUNED_SIGNED_ORDERS_FEELESS_1, PARTIAL_PRUNED_SIGNED_ORDERS_FEELESS_1_1, partialOrder, order, prunedOrder, e_1_1, PARTIAL_PRUNED_SIGNED_ORDERS_FEELESS_2, PARTIAL_PRUNED_SIGNED_ORDERS_FEELESS_2_1, partialOrder, order, prunedOrder, e_2_1;
        var e_1, _a, e_2, _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 7:
                    order = _c.sent();
                    prunedOrder = __assign(__assign({}, order), partialOrder);
                ...
                case 19:
                    ...
                    return [7 /*endfinally*/];
                case 20: return [4 /*yield*/, swap_quote_1.getFullyFillableSwapQuoteWithNoFeesAsync(makerAssetData, wethAssetData, orders, types_1.MarketOperation.Sell, GAS_PRICE)];
                case 21:
                    marketSellSwapQuote = _c.sent();
                    return [4 /*yield*/, swap_quote_1.getFullyFillableSwapQuoteWithNoFeesAsync(makerAssetData, wethAssetData, orders, types_1.MarketOperation.Buy, GAS_PRICE)];
                case 22:
                    marketBuySwapQuote = _c.sent();
                    return [4 /*yield*/, swap_quote_1.getFullyFillableSwapQuoteWithNoFeesAsync(makerAssetData, takerAssetData, invalidOrders, types_1.MarketOperation.Buy, GAS_PRICE)];
                case 23:
    ...
    describe('#executeSwapQuoteOrThrowAsync', function () {
        describe('validation', function () {
            it('should throw if swapQuote provided is not a valid forwarder SwapQuote (taker asset is wEth)', function () { return __awaiter(void 0, void 0, void 0, function () {
                return __generator(this, function (_a) {
        ...
        describe('valid swap quote', function () {
             ...
             */
            it('should perform a marketBuy execution when provided a MarketBuy type swapQuote', function () { return __awaiter(void 0, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
            ...
            it('should perform a marketSell execution when provided a MarketSell type swapQuote', function () { return __awaiter(void 0, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, expectMakerAndTakerBalancesAsync(new utils_1.BigNumber(10).multipliedBy(ONE_ETH_IN_WEI), constants_1.constants.ZERO_AMOUNT)];
                        case 1:
            ...
            it('should perform a marketBuy execution with affiliate fees', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            it('should perform a marketSell execution with affiliate fees', function () { return __awaiter(void 0, void 0, void 0, function () {
                var feeRecipientEthBalanceBefore, feeRecipientEthBalanceAfter, totalEthSpent;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, expectMakerAndTakerBalancesAsync(new utils_1.BigNumber(10).multipliedBy(ONE_ETH_IN_WEI), constants_1.constants.ZERO_AMOUNT)];
    ...
    describe('#getCalldataOrThrow', function () {
        describe('validation', function () {
            it('should throw if swap quote provided is not a valid forwarder SwapQuote (taker asset is WETH)', function () { return __awaiter(void 0, void 0, void 0, function () {
                return __generator(this, function (_a) {
        ...
        describe('valid swap quote', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                it('provide correct and optimized calldata options with default options for a marketSell SwapQuote (no affiliate fees)', function () { return __awaiter(void 0, void 0, void 0, function () {
                ...
                it('provide correct and optimized calldata options with default options for a marketBuy SwapQuote (no affiliate fees)', function () { return __awaiter(void 0, void 0, void 0, function () {
                    var _a, calldataHexString, toAddress, ethAmount;
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0: return [4 /*yield*/, expectMakerAndTakerBalancesAsync(new utils_1.BigNumber(10).multipliedBy(ONE_ETH_IN_WEI), constants_1.constants.ZERO_AMOUNT)];
                ...
                it('provide correct and optimized calldata options with affiliate fees for a marketSell SwapQuote', function () { return __awaiter(void 0, void 0, void 0, function () {
                ...
                it('provide correct and optimized calldata options with affiliate fees for a marketBuy SwapQuote', function () { return __awaiter(void 0, void 0, void 0, function () {
                    var feeRecipientEthBalanceBefore, _a, calldataHexString, toAddress, ethAmount, totalEthSpent, feeRecipientEthBalanceAfter;
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0: return [4 /*yield*/, expectMakerAndTakerBalancesAsync(new utils_1.BigNumber(10).multipliedBy(ONE_ETH_IN_WEI), constants_1.constants.ZERO_AMOUNT)];
