...
var assetsToAssetPairItems = function (makerAssetData, takerAssetData) {
    ...
    return [
        {
            assetDataA: __assign(__assign({}, defaultAssetPairItem), { assetData: makerAssetData }),
            assetDataB: __assign(__assign({}, defaultAssetPairItem), { assetData: takerAssetData }),
        },
        {
            assetDataA: __assign(__assign({}, defaultAssetPairItem), { assetData: takerAssetData }),
            assetDataB: __assign(__assign({}, defaultAssetPairItem), { assetData: makerAssetData }),
        },
    ];
};
var expectLiquidityResult = function (web3Provider, orderbook, orders, expectedLiquidityResult) { return __awaiter(void 0, void 0, void 0, function () {
...
describe('SwapQuoter', function () {
    describe('getLiquidityForMakerTakerAssetDataPairAsync', function () {
        ...
        describe('validation', function () {
            it('should ensure takerAssetData is a string', function () { return __awaiter(void 0, void 0, void 0, function () {
                var swapQuoter;
                return __generator(this, function (_a) {
            ...
            it('should ensure makerAssetData is a string', function () { return __awaiter(void 0, void 0, void 0, function () {
                var swapQuoter;
                return __generator(this, function (_a) {
                    swapQuoter = src_1.SwapQuoter.getSwapQuoterForStandardRelayerAPIUrl(mockWeb3Provider.object, FAKE_SRA_URL);
        ...
        describe('asset pair not supported', function () {
            it('should return 0s when no asset pair are supported', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            it('should return 0s when only other asset pair supported', function () { return __awaiter(void 0, void 0, void 0, function () {
                var swapQuoter, liquidityResult;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
        ...
        describe('assetData is supported', function () {
            ...
            it('should return 0s when no orders available', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            it('should return correct computed value when orders provided with full fillableAmounts', function () { return __awaiter(void 0, void 0, void 0, function () {
                var orders, expectedMakerAssetAvailable, expectedTakerAssetAvailable, expectedResult;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            orders = [
                                __assign(__assign({}, sellTenTokensFor10Weth), {
            ...
            it('should return correct computed value with one partial fillableAmounts', function () { return __awaiter(void 0, void 0, void 0, function () {
                var orders, expectedResult;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
            ...
            it('should return correct computed value with multiple orders and fillable amounts', function () { return __awaiter(void 0, void 0, void 0, function () {
                var orders, expectedResult;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
            ...
            it('should return 0s when no amounts fillable', function () { return __awaiter(void 0, void 0, void 0, function () {
                var orders, expectedResult;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
