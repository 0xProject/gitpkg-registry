...
const GAS_PRICE = new utils_1.BigNumber(1);
/**
...
describe('MarketOperationUtils tests', () => {
    ...
    let DEFAULT_DEX_GAS_USED = new utils_1.BigNumber(100000);
    ...
    function createSamplesFromRates(source, inputs, rates, fillData, gasUsed) {
        const samples = [];
    ...
    function createGetMultipleSellQuotesOperationFromRates(rates, gasSchedule = {}) {
        return (sources, _makerToken, _takerToken, fillAmounts, _wethAddress) => {
            return sampler_operations_1.BATCH_SOURCE_FILTERS.getAllowed(sources).map(s => createSamplesFromRates(s, fillAmounts, rates[s], undefined, gasSchedule[s]));
        };
    }
    function createGetMultipleBuyQuotesOperationFromRates(rates, gasSchedule = {}) {
        return (sources, _makerToken, _takerToken, fillAmounts, _wethAddress) => {
            return sampler_operations_1.BATCH_SOURCE_FILTERS.getAllowed(sources).map(s => createSamplesFromRates(s, fillAmounts, rates[s].map(r => new utils_1.BigNumber(1).div(r)), gasSchedule[s]));
        };
    }
    ...
    describe('MarketOperationUtils', () => {
        ...
        describe('getMarketSellOrdersAsync()', () => {
            ...
            const DEFAULT_OPTS = Object.assign(Object.assign({}, constants_1.DEFAULT_GET_MARKET_ORDERS_OPTS), { numSamples: NUM_SAMPLES, sampleDistributionBase: 1, bridgeSlippage: 0, maxFallbackSlippage: 100, excludedSources: DEFAULT_EXCLUDED, allowFallback: false, gasPrice: GAS_PRICE });
            beforeEach(() => {
                replaceSamplerOps();
            });
            ...
            it('optimizer will send in a comparison price to RFQ providers', () => __awaiter(void 0, void 0, void 0, function* () {
                ...
                mockedMarketOpUtils
                    ...
                    const marketSellLiquidity = {
                        ...
                        outputAmountPerEth: new utils_1.BigNumber(0.00000000241319391),
                ...
                const result = yield mockedMarketOpUtils.object.getOptimizerResultAsync(ORDERS, web3_wrapper_1.Web3Wrapper.toBaseUnitAmount(10, 18), src_1.MarketOperation.Sell, Object.assign(Object.assign({}, DEFAULT_OPTS), { rfqt: {
                        isIndicative: false,
                        apiKey: 'foo',
            ...
            it('factors in fees for native orders', () => __awaiter(void 0, void 0, void 0, function* () {
                ...
                const gasPrice = new utils_1.BigNumber(1000e9);
                DEFAULT_DEX_GAS_USED = new utils_1.BigNumber(100000);
                const rates = {
                    [types_1.ERC20BridgeSource.Native]: [1, 0.96, 0.94, 0.92],
                    [types_1.ERC20BridgeSource.Uniswap]: [0.96, 0.1, 0.1, 0.1],
                    [types_1.ERC20BridgeSource.Eth2Dai]: [0.95, 0.1, 0.1, 0.1],
                    [types_1.ERC20BridgeSource.Kyber]: [0.1, 0.1, 0.1, 0.1], // [0.094]
                };
                replaceSamplerOps({
                    getSellQuotes: createGetMultipleSellQuotesOperationFromRates(rates),
                    getMedianSellRate: createGetMedianSellRate(ETH_TO_MAKER_RATE),
                });
                const improvedOrdersResponse = yield getMarketSellOrdersAsync(marketOperationUtils, createOrdersFromSellRates(FILL_AMOUNT, rates[types_1.ERC20BridgeSource.Native]), FILL_AMOUNT, Object.assign(Object.assign({}, DEFAULT_OPTS), { numSamples: 4, gasPrice }));
                const improvedOrders = improvedOrdersResponse.optimizedOrders;
                const orderSources = improvedOrders.map(o => o.fills[0].source);
                const expectedSources = [
                    types_1.ERC20BridgeSource.Native,
            ...
            it('is able to create a order from LiquidityProvider', () => __awaiter(void 0, void 0, void 0, function* () {
                ...
                ], FILL_AMOUNT, src_1.MarketOperation.Sell, Object.assign(Object.assign({}, constants_1.DEFAULT_GET_MARKET_ORDERS_OPTS), { includedSources: [types_1.ERC20BridgeSource.LiquidityProvider], excludedSources: [], numSamples: 4, bridgeSlippage: 0, gasPrice: GAS_PRICE }));
        ...
        describe('getMarketBuyOrdersAsync()', () => {
            ...
            const DEFAULT_OPTS = Object.assign(Object.assign({}, constants_1.DEFAULT_GET_MARKET_ORDERS_OPTS), { numSamples: NUM_SAMPLES, sampleDistributionBase: 1, bridgeSlippage: 0, maxFallbackSlippage: 100, excludedSources: DEFAULT_EXCLUDED, allowFallback: false });
            beforeEach(() => {
                replaceSamplerOps();
            });
            it('queries `numSamples` samples', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            it('factors in fees for native orders', () => __awaiter(void 0, void 0, void 0, function* () {
                ...
                const improvedOrdersResponse = yield getMarketBuyOrdersAsync(marketOperationUtils, createOrdersFromBuyRates(FILL_AMOUNT, rates[types_1.ERC20BridgeSource.Native]), FILL_AMOUNT, Object.assign(Object.assign({}, DEFAULT_OPTS), { numSamples: 4, gasPrice }));
                const improvedOrders = improvedOrdersResponse.optimizedOrders;
                const orderSources = improvedOrders.map(o => o.fills[0].source);
                const expectedSources = [
                    types_1.ERC20BridgeSource.Uniswap,
