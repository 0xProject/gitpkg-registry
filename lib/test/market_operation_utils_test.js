    ...
    describe('MarketOperationUtils', () => {
        ...
        describe('getMarketSellOrdersAsync()', () => {
            ...
            it('optimizer will send in a comparison price to RFQ providers', () => __awaiter(void 0, void 0, void 0, function* () {
                ...
                const result = yield mockedMarketOpUtils.object.getOptimizerResultAsync(ORDERS, web3_wrapper_1.Web3Wrapper.toBaseUnitAmount(1, 18), src_1.MarketOperation.Sell, Object.assign(Object.assign({}, DEFAULT_OPTS), { rfqt: {
                        isIndicative: false,
                        apiKey: 'foo',
