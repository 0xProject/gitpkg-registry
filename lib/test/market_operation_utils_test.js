...
describe('MarketOperationUtils tests', () => {
    ...
    const contractAddresses = Object.assign({}, contract_addresses_1.getContractAddressesForChainOrThrow(CHAIN_ID), { multiBridge: utils_1.NULL_ADDRESS }, constants_2.BRIDGE_ADDRESSES_BY_CHAIN[CHAIN_ID]);
        ...
        describe('getMarketSellOrdersAsync()', () => {
            ...
            it('optimizer will send in a comparison price to RFQ providers', constants_1.IS_PRICE_AWARE_RFQ_ENABLED
                ? () => __awaiter(this, void 0, void 0, function* () {
                    ...
                    const result = yield mockedMarketOpUtils.object.getMarketSellOrdersAsync(ORDERS, web3_wrapper_1.Web3Wrapper.toBaseUnitAmount(1, 18), Object.assign({}, DEFAULT_OPTS, { rfqt: {
                            isIndicative: false,
                            apiKey: 'foo',
            ...
            it('is able to create a order from LiquidityProvider', () => __awaiter(this, void 0, void 0, function* () {
                ...
                ], web3_wrapper_1.Web3Wrapper.toBaseUnitAmount(10, 18), {
