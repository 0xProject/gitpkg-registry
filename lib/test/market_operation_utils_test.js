    ...
    describe('MarketOperationUtils', () => {
        ...
        describe('getMarketSellOrdersAsync()', () => {
            ...
            it('optimizer will send in a comparison price to RFQ providers', () => __awaiter(void 0, void 0, void 0, function* () {
                ...
                const feeSchedule = {
                    [types_1.ERC20BridgeSource.Native]: _.constant({ gas: 1, fee: new utils_1.BigNumber(1) }),
                };
            ...
            it.skip('does not create a fallback if below maxFallbackSlippage', () => __awaiter(void 0, void 0, void 0, function* () {
                ...
                rates[types_1.ERC20BridgeSource.Curve] = [0.35, 0.2, 0.01, 0.01];
                replaceSamplerOps({
                    getSellQuotes: createGetMultipleSellQuotesOperationFromRates(rates),
                });
        ...
        describe('getMarketBuyOrdersAsync()', () => {
            ...
            it.skip('factors in fees for native orders', () => __awaiter(void 0, void 0, void 0, function* () {
                ...
                // dropping their effective rates.
                const nativeFeeRate = 0.06;
                const rates = Object.assign(Object.assign({}, ZERO_RATES), { [types_1.ERC20BridgeSource.Native]: [1, 0.99, 0.98, 0.97], [types_1.ERC20BridgeSource.Uniswap]: [0.96, 0.1, 0.1, 0.1], [types_1.ERC20BridgeSource.SushiSwap]: [0.95, 0.1, 0.1, 0.1], [types_1.ERC20BridgeSource.Curve]: [0.1, 0.1, 0.1, 0.1] });
                const feeSchedule = {
                    [types_1.ERC20BridgeSource.Native]: _.constant({
                        gas: 1,
                        fee: FILL_AMOUNT.div(4)
