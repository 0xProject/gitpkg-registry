...
describe('MarketOperationUtils tests', function () {
    var _a, _b;
    var CHAIN_ID = 1;
    var contractAddresses = __assign({}, contract_addresses_1.getContractAddressesForChainOrThrow(CHAIN_ID), { multiBridge: utils_1.NULL_ADDRESS });
    ...
    function createGetMultipleSellQuotesOperationFromRates(rates) {
        return function (sources, _makerToken, _takerToken, fillAmounts, _wethAddress) {
            return Promise.resolve(sources.map(function (s) { return createSamplesFromRates(s, fillAmounts, rates[s]); }));
        };
    }
    ...
    function createGetMultipleBuyQuotesOperationFromRates(rates) {
        return function (sources, _makerToken, _takerToken, fillAmounts, _wethAddress) {
            return Promise.resolve(sources.map(function (s) { return createSamplesFromRates(s, fillAmounts, rates[s].map(function (r) { return new utils_1.BigNumber(1).div(r); })); }));
        };
    }
    ...
    var DEFAULT_RATES = (_a = {},
        ...
        _a[types_2.ERC20BridgeSource.Bancor] = _.times(NUM_SAMPLES, function () { return 0; }),
        ...
        _a[types_2.ERC20BridgeSource.MStable] = _.times(NUM_SAMPLES, function () { return 0; }),
        _a[types_2.ERC20BridgeSource.Mooniswap] = _.times(NUM_SAMPLES, function () { return 0; }),
        _a);
    var DEFAULT_FILL_DATA = (_b = {},
        ...
        _b[types_2.ERC20BridgeSource.Bancor] = { path: [], networkAddress: contracts_test_utils_1.randomAddress() },
        _b[types_2.ERC20BridgeSource.Curve] = {
            curve: {
    ...
    describe('getRfqtIndicativeQuotesAsync', function () {
        var partialRfqt = {
            apiKey: 'foo',
        ...
        it('returns an empty array if native liquidity is excluded from the salad', function () { return __awaiter(_this, void 0, void 0, function () {
            var requestor, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        requestor = TypeMoq.Mock.ofType(src_1.QuoteRequestor, TypeMoq.MockBehavior.Strict);
                        return [4 /*yield*/, market_operation_utils_1.getRfqtIndicativeQuotesAsync(MAKER_ASSET_DATA, TAKER_ASSET_DATA, src_1.MarketOperation.Sell, new utils_1.BigNumber('100e18'), {
                                rfqt: __assign({ quoteRequestor: requestor.object }, partialRfqt),
                                excludedSources: [types_2.ERC20BridgeSource.Native],
                            })];
                    case 1:
                        result = _a.sent();
                        contracts_test_utils_1.expect(result.length).to.eql(0);
                        requestor.verify(function (r) {
                            return r.requestRfqtIndicativeQuotesAsync(TypeMoq.It.isAny(), TypeMoq.It.isAny(), TypeMoq.It.isAny(), TypeMoq.It.isAny(), TypeMoq.It.isAny());
                        }, TypeMoq.Times.never());
                        return [2 /*return*/];
                }
            });
        }); });
        it('calls RFQT if Native source is not excluded', function () { return __awaiter(_this, void 0, void 0, function () {
            var requestor;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        requestor = TypeMoq.Mock.ofType(src_1.QuoteRequestor, TypeMoq.MockBehavior.Loose);
                        requestor
                            .setup(function (r) {
                            return r.requestRfqtIndicativeQuotesAsync(TypeMoq.It.isAny(), TypeMoq.It.isAny(), TypeMoq.It.isAny(), TypeMoq.It.isAny(), TypeMoq.It.isAny());
                        })
    ...
    describe('MarketOperationUtils', function () {
        ...
        describe('getMarketSellOrdersAsync()', function () {
            ...
            it('polls all DEXes if `excludedSources` is empty', function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.sent();
                            contracts_test_utils_1.expect(sourcesPolled.sort()).to.deep.equals(constants_1.SELL_SOURCES.slice().sort());
                            return [2 /*return*/];
                    }
                });
            }); });
            it('polls the liquidity provider when the registry is provided in the arguments', function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            _b.sent();
                            contracts_test_utils_1.expect(args.sources.sort()).to.deep.equals(constants_1.SELL_SOURCES.concat([types_2.ERC20BridgeSource.LiquidityProvider]).sort());
            ...
            it('does not poll DEXes in `excludedSources`', function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.sent();
                            contracts_test_utils_1.expect(sourcesPolled.sort()).to.deep.equals(_.without.apply(_, __spread([constants_1.SELL_SOURCES], excludedSources)).sort());
                            return [2 /*return*/];
                    }
                });
            }); });
            it('generates bridge orders with correct asset data', function () { return __awaiter(_this, void 0, void 0, function () {
                var e_1, _a, improvedOrdersResponse, improvedOrders, improvedOrders_1, improvedOrders_1_1, order, makerAssetDataPrefix;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            improvedOrdersResponse = _b.sent();
                            improvedOrders = improvedOrdersResponse.optimizedOrders;
            ...
            it('generates bridge orders with correct taker amount', function () { return __awaiter(_this, void 0, void 0, function () {
                var improvedOrdersResponse, improvedOrders, totalTakerAssetAmount;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, marketOperationUtils.getMarketSellOrdersAsync(
                            // Pass in empty orders to prevent native orders from being used.
                            ORDERS.map(function (o) { return (__assign({}, o, { makerAssetAmount: contracts_test_utils_1.constants.ZERO_AMOUNT })); }), FILL_AMOUNT, DEFAULT_OPTS)];
                        case 1:
                            improvedOrdersResponse = _a.sent();
                            improvedOrders = improvedOrdersResponse.optimizedOrders;
            ...
            it('generates bridge orders with max slippage of `bridgeSlippage`', function () { return __awaiter(_this, void 0, void 0, function () {
                var e_2, _a, bridgeSlippage, improvedOrdersResponse, improvedOrders, improvedOrders_2, improvedOrders_2_1, order, expectedMakerAmount, slippage;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
            ...
            it('can mix convex sources', function () { return __awaiter(_this, void 0, void 0, function () {
                var rates, improvedOrdersResponse, improvedOrders, orderSources, expectedSources;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            rates = {};
            ...
            it('factors in fees for native orders', function () { return __awaiter(_this, void 0, void 0, function () {
                var _a, _b, nativeFeeRate, rates, feeSchedule, improvedOrdersResponse, improvedOrders, orderSources, expectedSources;
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        ...
                        case 1:
                            improvedOrdersResponse = _c.sent();
                            improvedOrders = improvedOrdersResponse.optimizedOrders;
                            orderSources = improvedOrders.map(function (o) { return o.fills[0].source; });
                            expectedSources = [
                                types_2.ERC20BridgeSource.Native,
            ...
            it('factors in fees for dexes', function () { return __awaiter(_this, void 0, void 0, function () {
                var _a, _b, uniswapFeeRate, rates, feeSchedule, improvedOrdersResponse, improvedOrders, orderSources, expectedSources;
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            uniswapFeeRate = 0.2;
            ...
            it('can mix one concave source', function () { return __awaiter(_this, void 0, void 0, function () {
                var _a, rates, improvedOrdersResponse, improvedOrders, orderSources, expectedSources;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            rates = (_a = {},
            ...
            it('fallback orders use different sources', function () { return __awaiter(_this, void 0, void 0, function () {
                var rates, improvedOrdersResponse, improvedOrders, orderSources, firstSources, secondSources;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            rates = {};
                        ...
                        case 1:
                            ...
                            improvedOrders = improvedOrdersResponse.optimizedOrders;
                            orderSources = improvedOrders.map(function (o) { return o.fills[0].source; });
                            firstSources = orderSources.slice(0, 4);
                            secondSources = orderSources.slice(4);
            ...
            it('is able to create a order from LiquidityProvider', function () { return __awaiter(_this, void 0, void 0, function () {
                var _a, registryAddress, liquidityProviderAddress, xAsset, yAsset, toSell, _b, getSellQuotesParams, getSellQuotesFn, _c, getLiquidityProviderParams, getLiquidityProviderFn, sampler, ordersAndReport, result, decodedAssetData;
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        ...
                        case 1:
                            ordersAndReport = _d.sent();
                            result = ordersAndReport.optimizedOrders;
            ...
            it('batches contiguous bridge sources', function () { return __awaiter(_this, void 0, void 0, function () {
                var rates, improvedOrdersResponse, improvedOrders, orderFillSources;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            rates = {};
        ...
        describe('getMarketBuyOrdersAsync()', function () {
            ...
            it('polls all DEXes if `excludedSources` is empty', function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.sent();
                            contracts_test_utils_1.expect(sourcesPolled.sort()).to.deep.equals(constants_1.BUY_SOURCES.sort());
                            return [2 /*return*/];
                    }
                });
            }); });
            ...
            it('does not poll DEXes in `excludedSources`', function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.sent();
                            contracts_test_utils_1.expect(sourcesPolled.sort()).to.deep.eq(_.without.apply(_, __spread([constants_1.BUY_SOURCES], excludedSources)).sort());
                            return [2 /*return*/];
                    }
                });
            }); });
            it('generates bridge orders with correct asset data', function () { return __awaiter(_this, void 0, void 0, function () {
                var e_3, _a, improvedOrdersResponse, improvedOrders, improvedOrders_3, improvedOrders_3_1, order, makerAssetDataPrefix;
                return __generator(this, function (_b) {
                    switch (_b.label) {
            ...
            it('generates bridge orders with correct maker amount', function () { return __awaiter(_this, void 0, void 0, function () {
                var improvedOrdersResponse, improvedOrders, totalMakerAssetAmount;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, marketOperationUtils.getMarketBuyOrdersAsync(
                            // Pass in empty orders to prevent native orders from being used.
            ...
            it('generates bridge orders with max slippage of `bridgeSlippage`', function () { return __awaiter(_this, void 0, void 0, function () {
                var e_4, _a, bridgeSlippage, improvedOrdersResponse, improvedOrders, improvedOrders_4, improvedOrders_4_1, order, expectedTakerAmount, slippage;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            bridgeSlippage = _.random(0.1, true);
