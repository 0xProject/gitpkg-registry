    ...
    describe('MarketOperationUtils', function () {
        ...
        describe('getMarketSellOrdersAsync()', function () {
            ...
            var DEFAULT_OPTS = {
                ...
                excludedSources: Object.keys(constants_1.DEFAULT_CURVE_OPTS),
                allowFallback: false,
            ...
            it('Kyber is exclusive against Uniswap and Eth2Dai', function () { return __awaiter(_this, void 0, void 0, function () {
                var rates, improvedOrders, orderSources;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            rates = {};
                        ...
                        case 1:
                            improvedOrders = _a.sent();
                            orderSources = improvedOrders.map(function (o) { return o.fills[0].source; });
                            if (orderSources.includes(types_2.ERC20BridgeSource.Kyber)) {
                                contracts_test_utils_1.expect(orderSources).to.not.include(types_2.ERC20BridgeSource.Uniswap);
                                contracts_test_utils_1.expect(orderSources).to.not.include(types_2.ERC20BridgeSource.Eth2Dai);
                            }
                            else {
                                contracts_test_utils_1.expect(orderSources).to.not.include(types_2.ERC20BridgeSource.Kyber);
                            }
                            return [2 /*return*/];
                    }
                });
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, marketOperationUtils.getMarketSellOrdersAsync(createOrdersFromSellRates(FILL_AMOUNT, rates[types_2.ERC20BridgeSource.Native]), FILL_AMOUNT, __assign({}, DEFAULT_OPTS, { numSamples: 4, allowFallback: true, maxFallbackSlippage: 0.5 }))];
                        case 1:
                            improvedOrders = _a.sent();
                            orderSources = improvedOrders.map(function (o) { return o.fills[0].source; });
                    ...
                    switch (_d.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, sampler.getMarketSellOrdersAsync([
                                ...
                                ], dev_utils_1.Web3Wrapper.toBaseUnitAmount(10, 18), { excludedSources: constants_1.SELL_SOURCES, numSamples: 4, bridgeSlippage: 0 })];
                        case 1:
                            result = _d.sent();
        ...
        describe('getMarketBuyOrdersAsync()', function () {
            ...
            var DEFAULT_OPTS = {
                ...
                bridgeSlippage: 0,
                maxFallbackSlippage: 100,
                excludedSources: __spread(Object.keys(constants_1.DEFAULT_CURVE_OPTS), [types_2.ERC20BridgeSource.Kyber]),
                allowFallback: false,
                shouldBatchBridgeOrders: false,
            };
            beforeEach(function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, marketOperationUtils.getMarketBuyOrdersAsync(createOrdersFromBuyRates(FILL_AMOUNT, rates[types_2.ERC20BridgeSource.Native]), FILL_AMOUNT, __assign({}, DEFAULT_OPTS, { numSamples: 4, allowFallback: true, maxFallbackSlippage: 0.5 }))];
                        case 1:
                            improvedOrders = _a.sent();
                            orderSources = improvedOrders.map(function (o) { return o.fills[0].source; });
                            firstSources = [types_2.ERC20BridgeSource.Native, types_2.ERC20BridgeSource.Native, types_2.ERC20BridgeSource.Uniswap];
