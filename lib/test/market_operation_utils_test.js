...
describe('MarketOperationUtils tests', function () {
    var _a, _b;
    var CHAIN_ID = 1;
    var contractAddresses = __assign(__assign({}, contract_addresses_1.getContractAddressesForChainOrThrow(CHAIN_ID)), { multiBridge: utils_1.NULL_ADDRESS });
    ...
    function createGetMultipleSellQuotesOperationFromRates(rates) {
        return function (sources, _makerToken, _takerToken, fillAmounts, _wethAddress) {
    ...
    function callTradeOperationAndRetainLiquidityProviderParams(tradeOperation, rates) {
        ...
        var fn = function (sources, makerToken, takerToken, fillAmounts, wethAddress, _balancerPoolsCache, liquidityProviderAddress) {
    ...
    function createGetMedianSellRate(rate) {
        return function (_sources, _makerToken, _takerToken, _fillAmounts, _wethAddress) {
            return new utils_1.BigNumber(rate);
        };
    }
    function getLiquidityProviderFromRegistry() {
        return function (_registryAddress, _takerToken, _makerToken) {
    ...
    function getLiquidityProviderFromRegistryAndReturnCallParameters(liquidityProviderAddress) {
        ...
        var fn = function (registryAddress, takerToken, makerToken) {
            ...
            if (registryAddress !== contracts_test_utils_1.constants.NULL_ADDRESS) {
    ...
    var DEFAULT_RATES = (_a = {},
        ...
        _a[types_2.ERC20BridgeSource.UniswapV2] = _.times(NUM_SAMPLES, function () { return 0; }),
        _a[types_2.ERC20BridgeSource.Balancer] = _.times(NUM_SAMPLES, function () { return 0; }),
        _a[types_2.ERC20BridgeSource.Curve] = _.times(NUM_SAMPLES, function () { return 0; }),
        _a[types_2.ERC20BridgeSource.LiquidityProvider] = _.times(NUM_SAMPLES, function () { return 0; }),
        _a[types_2.ERC20BridgeSource.MultiBridge] = _.times(NUM_SAMPLES, function () { return 0; }),
        _a);
    var DEFAULT_FILL_DATA = (_b = {},
        _b[types_2.ERC20BridgeSource.UniswapV2] = { tokenAddressPath: [] },
        _b[types_2.ERC20BridgeSource.Balancer] = { poolAddress: contracts_test_utils_1.randomAddress() },
        _b[types_2.ERC20BridgeSource.Curve] = { poolAddress: contracts_test_utils_1.randomAddress(), fromTokenIdx: 0, toTokenIdx: 1 },
        _b);
    var DEFAULT_OPS = {
    ...
    function replaceSamplerOps(ops) {
        if (ops === void 0) { ops = {}; }
        sampler_1.DexOrderSampler.ops = __assign(__assign({}, DEFAULT_OPS), ops);
    }
    var MOCK_SAMPLER = {
    ...
    describe('MarketOperationUtils', function () {
        ...
        describe('getMarketSellOrdersAsync()', function () {
            ...
            var DEFAULT_OPTS = {
                ...
                excludedSources: [types_2.ERC20BridgeSource.UniswapV2, types_2.ERC20BridgeSource.Curve, types_2.ERC20BridgeSource.Balancer],
                allowFallback: false,
            ...
            it('queries `numSamples` samples', function () { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            actualNumSamples = 0;
                            replaceSamplerOps({
                                getSellQuotesAsync: function (sources, makerToken, takerToken, amounts, wethAddress) {
                                    actualNumSamples = amounts.length;
                                    return DEFAULT_OPS.getSellQuotesAsync(sources, makerToken, takerToken, amounts, wethAddress);
                                },
                            });
                            return [4 /*yield*/, marketOperationUtils.getMarketSellOrdersAsync(ORDERS, FILL_AMOUNT, __assign(__assign({}, DEFAULT_OPTS), { numSamples: numSamples }))];
                        case 1:
                            _a.sent();
            ...
            it('polls all DEXes if `excludedSources` is empty', function () { return __awaiter(void 0, void 0, void 0, function () {
                var sourcesPolled;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, marketOperationUtils.getMarketSellOrdersAsync(ORDERS, FILL_AMOUNT, __assign(__assign({}, DEFAULT_OPTS), { excludedSources: [] }))];
                        case 1:
                            _a.sent();
            ...
            it('polls the liquidity provider when the registry is provided in the arguments', function () { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, newMarketOperationUtils.getMarketSellOrdersAsync(ORDERS, FILL_AMOUNT, __assign(__assign({}, DEFAULT_OPTS), { excludedSources: [] }))];
                        case 1:
                            _b.sent();
            ...
            it('does not poll DEXes in `excludedSources`', function () { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, marketOperationUtils.getMarketSellOrdersAsync(ORDERS, FILL_AMOUNT, __assign(__assign({}, DEFAULT_OPTS), { excludedSources: excludedSources }))];
                        case 1:
                            _a.sent();
            ...
            it('generates bridge orders with correct asset data', function () { return __awaiter(void 0, void 0, void 0, function () {
                var improvedOrders, improvedOrders_1, improvedOrders_1_1, order, makerAssetDataPrefix;
                var e_1, _a;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0: return [4 /*yield*/, marketOperationUtils.getMarketSellOrdersAsync(
                            ...
                            ORDERS.map(function (o) { return (__assign(__assign({}, o), { makerAssetAmount: contracts_test_utils_1.constants.ZERO_AMOUNT })); }), FILL_AMOUNT, DEFAULT_OPTS)];
                        case 1:
            ...
            it('generates bridge orders with correct taker amount', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            it('generates bridge orders with max slippage of `bridgeSlippage`', function () { return __awaiter(void 0, void 0, void 0, function () {
                var bridgeSlippage, improvedOrders, improvedOrders_2, improvedOrders_2_1, order, expectedMakerAmount, slippage;
                var e_2, _a;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, marketOperationUtils.getMarketSellOrdersAsync(
                                // Pass in empty orders to prevent native orders from being used.
                                ORDERS.map(function (o) { return (__assign(__assign({}, o), { makerAssetAmount: contracts_test_utils_1.constants.ZERO_AMOUNT })); }), FILL_AMOUNT, __assign(__assign({}, DEFAULT_OPTS), { bridgeSlippage: bridgeSlippage }))];
                        case 1:
                            improvedOrders = _b.sent();
                            contracts_test_utils_1.expect(improvedOrders).to.not.be.length(0);
                            try {
                                for (improvedOrders_2 = __values(improvedOrders), improvedOrders_2_1 = improvedOrders_2.next(); !improvedOrders_2_1.done; improvedOrders_2_1 = improvedOrders_2.next()) {
                                    ...
                                    slippage = new utils_1.BigNumber(1).minus(order.makerAssetAmount.div(expectedMakerAmount.plus(1)));
            ...
            it('can mix convex sources', function () { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, marketOperationUtils.getMarketSellOrdersAsync(createOrdersFromSellRates(FILL_AMOUNT, rates[types_2.ERC20BridgeSource.Native]), FILL_AMOUNT, __assign(__assign({}, DEFAULT_OPTS), { numSamples: 4 }))];
                        case 1:
                            improvedOrders = _a.sent();
            ...
            it('factors in fees for native orders', function () { return __awaiter(void 0, void 0, void 0, function () {
                var nativeFeeRate, rates, feeSchedule, improvedOrders, orderSources, expectedSources;
                var _a, _b;
                    ...
                    switch (_c.label) {
                        case 0:
                            ...
                            rates = (_a = {},
                                ...
                                _a[types_2.ERC20BridgeSource.Uniswap] = [0.96, 0.1, 0.1, 0.1],
                                _a[types_2.ERC20BridgeSource.Eth2Dai] = [0.95, 0.1, 0.1, 0.1],
                                _a[types_2.ERC20BridgeSource.Kyber] = [0.1, 0.1, 0.1, 0.1],
                                _a);
                            feeSchedule = (_b = {},
                                _b[types_2.ERC20BridgeSource.Native] = _.constant(FILL_AMOUNT.div(4)
                                    .times(nativeFeeRate)
                            ...
                            return [4 /*yield*/, marketOperationUtils.getMarketSellOrdersAsync(createOrdersFromSellRates(FILL_AMOUNT, rates[types_2.ERC20BridgeSource.Native]), FILL_AMOUNT, __assign(__assign({}, DEFAULT_OPTS), { numSamples: 4, feeSchedule: feeSchedule }))];
                        case 1:
            ...
            it('factors in fees for dexes', function () { return __awaiter(void 0, void 0, void 0, function () {
                var uniswapFeeRate, rates, feeSchedule, improvedOrders, orderSources, expectedSources;
                var _a, _b;
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            ...
                            rates = (_a = {},
                                ...
                                _a[types_2.ERC20BridgeSource.Uniswap] = [1, 0.7, 0.2, 0.2],
                                _a);
                            feeSchedule = (_b = {},
                                _b[types_2.ERC20BridgeSource.Uniswap] = _.constant(FILL_AMOUNT.div(4)
            ...
            it('can mix one concave source', function () { return __awaiter(void 0, void 0, void 0, function () {
                var rates, improvedOrders, orderSources, expectedSources;
                var _a;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            rates = (_a = {},
                                ...
                                _a[types_2.ERC20BridgeSource.Uniswap] = [0.96, 0.2, 0.1, 0.1],
            ...
            it('fallback orders use different sources', function () { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, marketOperationUtils.getMarketSellOrdersAsync(createOrdersFromSellRates(FILL_AMOUNT, rates[types_2.ERC20BridgeSource.Native]), FILL_AMOUNT, __assign(__assign({}, DEFAULT_OPTS), { numSamples: 4, allowFallback: true }))];
                        case 1:
                            improvedOrders = _a.sent();
                            orderSources = improvedOrders.map(function (o) { return o.fills[0].source; });
                            firstSources = [
            ...
            it('does not create a fallback if below maxFallbackSlippage', function () { return __awaiter(void 0, void 0, void 0, function () {
                var rates, improvedOrders, orderSources, firstSources, secondSources;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, marketOperationUtils.getMarketSellOrdersAsync(createOrdersFromSellRates(FILL_AMOUNT, rates[types_2.ERC20BridgeSource.Native]), FILL_AMOUNT, __assign(__assign({}, DEFAULT_OPTS), { numSamples: 4, allowFallback: true, maxFallbackSlippage: 0.25 }))];
                        case 1:
                            improvedOrders = _a.sent();
                            orderSources = improvedOrders.map(function (o) { return o.fills[0].source; });
                            firstSources = [types_2.ERC20BridgeSource.Native, types_2.ERC20BridgeSource.Native, types_2.ERC20BridgeSource.Uniswap];
                            secondSources = [];
                            contracts_test_utils_1.expect(orderSources.slice(0, firstSources.length).sort()).to.deep.eq(firstSources.sort());
                            contracts_test_utils_1.expect(orderSources.slice(firstSources.length).sort()).to.deep.eq(secondSources.sort());
                            return [2 /*return*/];
            ...
            it('is able to create a order from LiquidityProvider', function () { return __awaiter(void 0, void 0, void 0, function () {
                var registryAddress, liquidityProviderAddress, xAsset, yAsset, toSell, _a, getSellQuotesParams, getSellQuotesFn, _b, getLiquidityProviderParams, getLiquidityProviderFn, sampler, result, decodedAssetData;
                var _c;
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        case 0:
                            ...
                            _a = __read(callTradeOperationAndRetainLiquidityProviderParams(createGetMultipleSellQuotesOperationFromRates, (_c = {},
                                _c[types_2.ERC20BridgeSource.LiquidityProvider] = createDecreasingRates(5),
                                _c)), 2), getSellQuotesParams = _a[0], getSellQuotesFn = _a[1];
                            _b = __read(getLiquidityProviderFromRegistryAndReturnCallParameters(liquidityProviderAddress), 2), getLiquidityProviderParams = _b[0], getLiquidityProviderFn = _b[1];
                            replaceSamplerOps({
            ...
            it('batches contiguous bridge sources', function () { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, marketOperationUtils.getMarketSellOrdersAsync(createOrdersFromSellRates(FILL_AMOUNT, rates[types_2.ERC20BridgeSource.Native]), FILL_AMOUNT, __assign(__assign({}, DEFAULT_OPTS), { numSamples: 4, excludedSources: __spread([
                                        types_2.ERC20BridgeSource.Kyber
                                    ], _.without(DEFAULT_OPTS.excludedSources, types_2.ERC20BridgeSource.Curve)), shouldBatchBridgeOrders: true }))];
                        case 1:
                            improvedOrders = _a.sent();
        ...
        describe('getMarketBuyOrdersAsync()', function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            actualNumSamples = 0;
                            replaceSamplerOps({
                                getBuyQuotesAsync: function (sources, makerToken, takerToken, amounts, wethAddress) {
                                    actualNumSamples = amounts.length;
                                    return DEFAULT_OPS.getBuyQuotesAsync(sources, makerToken, takerToken, amounts, wethAddress);
                                },
                            });
                            return [4 /*yield*/, marketOperationUtils.getMarketBuyOrdersAsync(ORDERS, FILL_AMOUNT, __assign(__assign({}, DEFAULT_OPTS), { numSamples: numSamples }))];
                        case 1:
                            _a.sent();
                            contracts_test_utils_1.expect(actualNumSamples).eq(numSamples);
                            return [2 /*return*/];
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, marketOperationUtils.getMarketBuyOrdersAsync(ORDERS, FILL_AMOUNT, __assign(__assign({}, DEFAULT_OPTS), { excludedSources: [] }))];
                        case 1:
                            _a.sent();
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            registryAddress = contracts_test_utils_1.randomAddress();
                            newMarketOperationUtils = new market_operation_utils_1.MarketOperationUtils(MOCK_SAMPLER, contractAddresses, ORDER_DOMAIN, registryAddress);
                            return [4 /*yield*/, newMarketOperationUtils.getMarketBuyOrdersAsync(ORDERS, FILL_AMOUNT, __assign(__assign({}, DEFAULT_OPTS), { excludedSources: [] }))];
                        case 1:
                            _b.sent();
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, marketOperationUtils.getMarketBuyOrdersAsync(ORDERS, FILL_AMOUNT, __assign(__assign({}, DEFAULT_OPTS), { excludedSources: excludedSources }))];
                        case 1:
                            _a.sent();
            ...
            it('generates bridge orders with correct asset data', function () { return __awaiter(void 0, void 0, void 0, function () {
                var improvedOrders, improvedOrders_3, improvedOrders_3_1, order, makerAssetDataPrefix;
                var e_3, _a;
                return __generator(this, function (_b) {
                    switch (_b.label) {
            ...
            it('generates bridge orders with correct maker amount', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            it('generates bridge orders with max slippage of `bridgeSlippage`', function () { return __awaiter(void 0, void 0, void 0, function () {
                var bridgeSlippage, improvedOrders, improvedOrders_4, improvedOrders_4_1, order, expectedTakerAmount, slippage;
                var e_4, _a;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                        ...
                        case 1:
                            ...
                            try {
                                for (improvedOrders_4 = __values(improvedOrders), improvedOrders_4_1 = improvedOrders_4.next(); !improvedOrders_4_1.done; improvedOrders_4_1 = improvedOrders_4.next()) {
                                    ...
                                    slippage = order.takerAssetAmount.div(expectedTakerAmount.plus(1)).minus(1);
                                    contracts_test_utils_1.assertRoughlyEquals(slippage, bridgeSlippage, 1);
                                }
                            }
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, marketOperationUtils.getMarketBuyOrdersAsync(createOrdersFromBuyRates(FILL_AMOUNT, rates[types_2.ERC20BridgeSource.Native]), FILL_AMOUNT, __assign(__assign({}, DEFAULT_OPTS), { numSamples: 4 }))];
                        case 1:
                            improvedOrders = _a.sent();
                            orderSources = improvedOrders.map(function (o) { return o.fills[0].source; });
                            expectedSources = [
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, marketOperationUtils.getMarketBuyOrdersAsync(createOrdersFromBuyRates(FILL_AMOUNT, rates[types_2.ERC20BridgeSource.Native]), FILL_AMOUNT, __assign(__assign({}, DEFAULT_OPTS), { numSamples: 4, feeSchedule: feeSchedule }))];
                        case 1:
                            improvedOrders = _c.sent();
                            orderSources = improvedOrders.map(function (o) { return o.fills[0].source; });
                            expectedSources = [
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, marketOperationUtils.getMarketBuyOrdersAsync(createOrdersFromBuyRates(FILL_AMOUNT, rates[types_2.ERC20BridgeSource.Native]), FILL_AMOUNT, __assign(__assign({}, DEFAULT_OPTS), { numSamples: 4, allowFallback: true }))];
                        case 1:
                            improvedOrders = _a.sent();
                            orderSources = improvedOrders.map(function (o) { return o.fills[0].source; });
                            firstSources = [
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, marketOperationUtils.getMarketBuyOrdersAsync(createOrdersFromBuyRates(FILL_AMOUNT, rates[types_2.ERC20BridgeSource.Native]), FILL_AMOUNT, __assign(__assign({}, DEFAULT_OPTS), { numSamples: 4, allowFallback: true, maxFallbackSlippage: 0.25 }))];
                        case 1:
                            improvedOrders = _a.sent();
                            orderSources = improvedOrders.map(function (o) { return o.fills[0].source; });
                            firstSources = [types_2.ERC20BridgeSource.Native, types_2.ERC20BridgeSource.Native, types_2.ERC20BridgeSource.Uniswap];
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            rates[types_2.ERC20BridgeSource.Native] = [0.5, 0.01, 0.01, 0.01];
                            rates[types_2.ERC20BridgeSource.Eth2Dai] = [0.49, 0.01, 0.01, 0.01];
                            rates[types_2.ERC20BridgeSource.Uniswap] = [0.48, 0.47, 0.01, 0.01];
                            replaceSamplerOps({
                                getBuyQuotesAsync: createGetMultipleBuyQuotesOperationFromRates(rates),
                            });
                            return [4 /*yield*/, marketOperationUtils.getMarketBuyOrdersAsync(createOrdersFromBuyRates(FILL_AMOUNT, rates[types_2.ERC20BridgeSource.Native]), FILL_AMOUNT, __assign(__assign({}, DEFAULT_OPTS), { numSamples: 4, shouldBatchBridgeOrders: true }))];
                        case 1:
                            improvedOrders = _a.sent();
