...
describe('MarketOperationUtils tests', () => {
    ...
    const contractAddresses = Object.assign({}, contract_addresses_1.getContractAddressesForChainOrThrow(CHAIN_ID), { multiBridge: utils_1.NULL_ADDRESS }, constants_1.BRIDGE_ADDRESSES_BY_CHAIN[CHAIN_ID]);
    ...
    function callTradeOperationAndRetainLiquidityProviderParams(tradeOperation, rates) {
        ...
        const fn = (sources, makerToken, takerToken, fillAmounts, wethAddress, tokenAdjacencyGraph = TOKEN_ADJACENCY_GRAPH, liquidityProviderAddress) => {
            ...
            return tradeOperation(rates)(sources, makerToken, takerToken, fillAmounts, wethAddress, TOKEN_ADJACENCY_GRAPH, liquidityProviderAddress);
        };
