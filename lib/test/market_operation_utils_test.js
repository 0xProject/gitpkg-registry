...
describe('MarketOperationUtils tests', function () {
    ...
    function callTradeOperationAndRetainLiquidityProviderParams(tradeOperation, rates) {
        ...
        var fn = function (sources, makerToken, takerToken, fillAmounts, liquidityProviderAddress) {
    ...
    function getLiquidityProviderFromRegistryAndReturnCallParameters(liquidityPoolAddress) {
        if (liquidityPoolAddress === void 0) { liquidityPoolAddress = utils_1.NULL_ADDRESS; }
        var callArgs = {
    ...
    function findSourceWithMaxOutput(rates) {
        ...
        if (source !== types_2.ERC20BridgeSource.Native) {
            var nativeTotalRate = utils_1.BigNumber.sum.apply(utils_1.BigNumber, __spread(rates[types_2.ERC20BridgeSource.Native])).div(rates[types_2.ERC20BridgeSource.Native].length);
    ...
    var DEFAULT_OPS = {
        ...
        getKyberSellQuotes: createGetSellQuotesOperationFromRates(DEFAULT_RATES[types_2.ERC20BridgeSource.Kyber]),
        getUniswapSellQuotes: createGetSellQuotesOperationFromRates(DEFAULT_RATES[types_2.ERC20BridgeSource.Uniswap]),
        getEth2DaiSellQuotes: createGetSellQuotesOperationFromRates(DEFAULT_RATES[types_2.ERC20BridgeSource.Eth2Dai]),
        getUniswapBuyQuotes: createGetBuyQuotesOperationFromRates(DEFAULT_RATES[types_2.ERC20BridgeSource.Uniswap]),
        getEth2DaiBuyQuotes: createGetBuyQuotesOperationFromRates(DEFAULT_RATES[types_2.ERC20BridgeSource.Eth2Dai]),
        getCurveSellQuotes: createGetSellQuotesOperationFromRates(DEFAULT_RATES[types_2.ERC20BridgeSource.CurveUsdcDai]),
    ...
    describe('MarketOperationUtils', function () {
        ...
        describe('getMarketSellOrdersAsync()', function () {
            ...
            var DEFAULT_OPTS = {
                ...
                bridgeSlippage: 0,
                excludedSources: [
                    types_2.ERC20BridgeSource.CurveUsdcDai,
                    types_2.ERC20BridgeSource.CurveUsdcDaiUsdt,
                    types_2.ERC20BridgeSource.CurveUsdcDaiUsdtTusd,
                ],
            };
            beforeEach(function () {
                replaceSamplerOps();
            ...
            it('polls the liquidity provider when the registry is provided in the arguments', function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            _b.sent();
                            contracts_test_utils_1.expect(args.sources.sort()).to.deep.eq(SELL_SOURCES.concat([types_2.ERC20BridgeSource.LiquidityProvider]).sort());
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            rates[types_2.ERC20BridgeSource.Kyber] = [0.7, 0.05, 0.05, 0.05];
                            replaceSamplerOps({
                                getSellQuotes: createGetMultipleSellQuotesOperationFromRates(rates),
                            });
                            return [4 /*yield*/, marketOperationUtils.getMarketSellOrdersAsync(createOrdersFromSellRates(FILL_AMOUNT, rates[types_2.ERC20BridgeSource.Native]), FILL_AMOUNT, __assign({}, DEFAULT_OPTS, { numSamples: 4, runLimit: 512, noConflicts: false }))];
                        case 1:
                            improvedOrders = _a.sent();
            ...
            it('excludes Kyber when `noConflicts` enabled and Uniswap or Eth2Dai are used first', function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            rates = {};
                            rates[types_2.ERC20BridgeSource.Native] = [0.3, 0.2, 0.1, 0.05];
                            rates[types_2.ERC20BridgeSource.Uniswap] = [0.5, 0.05, 0.05, 0.05];
                            rates[types_2.ERC20BridgeSource.Eth2Dai] = [0.6, 0.05, 0.05, 0.05];
                            rates[types_2.ERC20BridgeSource.Kyber] = [0.4, 0.05, 0.05, 0.05];
                            replaceSamplerOps({
                                getSellQuotes: createGetMultipleSellQuotesOperationFromRates(rates),
                            });
                            return [4 /*yield*/, marketOperationUtils.getMarketSellOrdersAsync(createOrdersFromSellRates(FILL_AMOUNT, rates[types_2.ERC20BridgeSource.Native]), FILL_AMOUNT, __assign({}, DEFAULT_OPTS, { numSamples: 4, runLimit: 512, noConflicts: true }))];
                        case 1:
                            improvedOrders = _a.sent();
                            orderSources = improvedOrders.map(function (o) { return o.fill.source; });
                            expectedSources = [
            ...
            it('excludes Uniswap and Eth2Dai when `noConflicts` enabled and Kyber is used first', function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            rates = {};
                            rates[types_2.ERC20BridgeSource.Native] = [0.1, 0.05, 0.05, 0.05];
                            rates[types_2.ERC20BridgeSource.Uniswap] = [0.15, 0.05, 0.05, 0.05];
                            rates[types_2.ERC20BridgeSource.Eth2Dai] = [0.15, 0.05, 0.05, 0.05];
                            rates[types_2.ERC20BridgeSource.Kyber] = [0.7, 0.05, 0.05, 0.05];
                            replaceSamplerOps({
                                getSellQuotes: createGetMultipleSellQuotesOperationFromRates(rates),
                            });
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, marketOperationUtils.getMarketSellOrdersAsync(createOrdersFromSellRates(FILL_AMOUNT, rates[types_2.ERC20BridgeSource.Native]), FILL_AMOUNT, __assign({}, DEFAULT_OPTS, { numSamples: 4, runLimit: 512, noConflicts: false, fees: fees }))];
                        case 1:
                    ...
                    switch (_c.label) {
                        case 0:
                            ...
                            rates = (_a = {},
                                ...
                                _a[types_2.ERC20BridgeSource.Uniswap] = [0.1, 0.1, 0.1, 0.1],
                                _a[types_2.ERC20BridgeSource.Eth2Dai] = [0.92, 0.1, 0.1, 0.1],
                                // Effectively [0.8, ~0.5, ~0, ~0]
                                _a[types_2.ERC20BridgeSource.Kyber] = [1, 0.7, 0.2, 0.2],
                                _a);
                            fees = (_b = {},
                                _b[types_2.ERC20BridgeSource.Kyber] = FILL_AMOUNT.div(4)
                                    .times(kyberFeeRate)
                                    .dividedToIntegerBy(ETH_TO_MAKER_RATE),
                                _b);
                            replaceSamplerOps({
                        ...
                        case 1:
                            improvedOrders = _c.sent();
                            orderSources = improvedOrders.map(function (o) { return o.fill.source; });
                            expectedSources = [types_2.ERC20BridgeSource.Native, types_2.ERC20BridgeSource.Eth2Dai, types_2.ERC20BridgeSource.Kyber];
                            contracts_test_utils_1.expect(orderSources).to.deep.eq(expectedSources);
                            return [2 /*return*/];
                    }
                });
        ...
        describe('getMarketBuyOrdersAsync()', function () {
            ...
            it('polls the liquidity provider when the registry is provided in the arguments', function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            _b.sent();
                            contracts_test_utils_1.expect(args.sources.sort()).to.deep.eq(BUY_SOURCES.concat([types_2.ERC20BridgeSource.LiquidityProvider]).sort());
                            contracts_test_utils_1.expect(args.liquidityProviderAddress).to.eql(registryAddress);
                            return [2 /*return*/];
                    }
                });
            ...
            it('returns the most cost-effective single source if `runLimit == 0`', function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            bestSource = findSourceWithMaxOutput(_.omit(DEFAULT_RATES, types_2.ERC20BridgeSource.Kyber, types_2.ERC20BridgeSource.CurveUsdcDai, types_2.ERC20BridgeSource.CurveUsdcDaiUsdt, types_2.ERC20BridgeSource.CurveUsdcDaiUsdtTusd));
                            contracts_test_utils_1.expect(bestSource).to.exist('');
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, marketOperationUtils.getMarketBuyOrdersAsync(createOrdersFromBuyRates(FILL_AMOUNT, rates[types_2.ERC20BridgeSource.Native]), FILL_AMOUNT, __assign({}, DEFAULT_OPTS, { numSamples: 4, runLimit: 512 }))];
                        case 1:
                            improvedOrders = _a.sent();
                            orderSources = improvedOrders.map(function (o) { return o.fill.source; });
                            expectedSources = [
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, marketOperationUtils.getMarketBuyOrdersAsync(createOrdersFromBuyRates(FILL_AMOUNT, rates[types_2.ERC20BridgeSource.Native]), FILL_AMOUNT, __assign({}, DEFAULT_OPTS, { numSamples: 4, runLimit: 512, fees: fees }))];
                        case 1:
                            improvedOrders = _c.sent();
                            orderSources = improvedOrders.map(function (o) { return o.fill.source; });
                            expectedSources = [
            ...
            it('is able to create a order from LiquidityProvider', function () { return __awaiter(_this, void 0, void 0, function () {
                var _a, registryAddress, liquidityPoolAddress, xAsset, yAsset, toSell, _b, getSellQuiotesParams, getSellQuotesFn, _c, getLiquidityProviderParams, getLiquidityProviderFn, sampler, result, decodedAssetData;
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        case 0:
                            registryAddress = contracts_test_utils_1.randomAddress();
                            liquidityPoolAddress = contracts_test_utils_1.randomAddress();
                            xAsset = contracts_test_utils_1.randomAddress();
                            yAsset = contracts_test_utils_1.randomAddress();
                            toSell = dev_utils_1.Web3Wrapper.toBaseUnitAmount(10, 18);
                            _b = __read(callTradeOperationAndRetainLiquidityProviderParams(createGetMultipleSellQuotesOperationFromRates, (_a = {},
                                ...
                                _a)), 2), getSellQuiotesParams = _b[0], getSellQuotesFn = _b[1];
                            _c = __read(getLiquidityProviderFromRegistryAndReturnCallParameters(liquidityPoolAddress), 2), getLiquidityProviderParams = _c[0], getLiquidityProviderFn = _c[1];
                            replaceSamplerOps({
                                getOrderFillableTakerAmounts: function () { return [new utils_1.BigNumber(0)]; },
                            ...
                            return [4 /*yield*/, sampler.getMarketSellOrdersAsync([
                                ...
                                ], dev_utils_1.Web3Wrapper.toBaseUnitAmount(10, 18), { excludedSources: SELL_SOURCES, numSamples: 4 })];
                        case 1:
                            result = _d.sent();
                            contracts_test_utils_1.expect(result.length).to.eql(1);
                            contracts_test_utils_1.expect(result[0].makerAddress).to.eql(liquidityPoolAddress);
                            ...
                            contracts_test_utils_1.expect(decodedAssetData.bridgeAddress).to.eql(liquidityPoolAddress);
                            contracts_test_utils_1.expect(result[0].takerAssetAmount).to.bignumber.eql(toSell);
                            contracts_test_utils_1.expect(getSellQuiotesParams.sources).contains(types_2.ERC20BridgeSource.LiquidityProvider);
                            contracts_test_utils_1.expect(getSellQuiotesParams.liquidityProviderAddress).is.eql(registryAddress);
                            contracts_test_utils_1.expect(getLiquidityProviderParams.registryAddress).is.eql(registryAddress);
                            contracts_test_utils_1.expect(getLiquidityProviderParams.makerToken).is.eql(xAsset);
                            contracts_test_utils_1.expect(getLiquidityProviderParams.takerToken).is.eql(yAsset);
                            return [2 /*return*/];
                    }
                });
            }); });
