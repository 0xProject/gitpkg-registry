...
describe('MarketOperationUtils tests', () => {
    ...
    function createGetMultipleBuyQuotesOperationFromRates(rates) {
        return (sources, _makerToken, _takerToken, fillAmounts, _wethAddress) => {
            return sources.map(s => createSamplesFromRates(s, fillAmounts, rates[s].map(r => new utils_1.BigNumber(1).div(r))));
        };
    }
    ...
    const NUM_SAMPLES = 3;
    const DEFAULT_RATES = {
        [types_2.ERC20BridgeSource.Native]: createDecreasingRates(NUM_SAMPLES),
        [types_2.ERC20BridgeSource.Eth2Dai]: createDecreasingRates(NUM_SAMPLES),
        [types_2.ERC20BridgeSource.Kyber]: createDecreasingRates(NUM_SAMPLES),
        [types_2.ERC20BridgeSource.Uniswap]: createDecreasingRates(NUM_SAMPLES),
    ...
    const DEFAULT_OPS = {
        ...
        getBalancerSellQuotesAsync: (_makerToken, _takerToken, takerFillAmounts) => [
        ...
        getBalancerBuyQuotesAsync: (_makerToken, _takerToken, makerFillAmounts) => [
        ...
        getBancorSellQuotesAsync: (_makerToken, _takerToken, takerFillAmounts) => createSamplesFromRates(types_2.ERC20BridgeSource.Bancor, takerFillAmounts, createDecreasingRates(takerFillAmounts.length), DEFAULT_FILL_DATA[types_2.ERC20BridgeSource.Bancor]),
    ...
    describe('getRfqtIndicativeQuotesAsync', () => {
        ...
        it('returns an empty array if native liquidity is excluded from the salad', () => __awaiter(this, void 0, void 0, function* () {
            const requestor = TypeMoq.Mock.ofType(src_1.QuoteRequestor, TypeMoq.MockBehavior.Strict);
            const result = yield market_operation_utils_1.getRfqtIndicativeQuotesAsync(MAKER_ASSET_DATA, TAKER_ASSET_DATA, src_1.MarketOperation.Sell, new utils_1.BigNumber('100e18'), {
            ...
            requestor.verify(r => r.requestRfqtIndicativeQuotesAsync(TypeMoq.It.isAny(), TypeMoq.It.isAny(), TypeMoq.It.isAny(), TypeMoq.It.isAny(), TypeMoq.It.isAny()), TypeMoq.Times.never());
        }));
        it('calls RFQT if Native source is not excluded', () => __awaiter(this, void 0, void 0, function* () {
        ...
        describe('getMarketSellOrdersAsync()', () => {
            ...
            it('polls all DEXes if `excludedSources` is empty', () => __awaiter(this, void 0, void 0, function* () {
                ...
                replaceSamplerOps({
                    ...
                    getBalancerSellQuotesAsync: (makerToken, takerToken, takerFillAmounts) => {
            ...
            it('does not poll DEXes in `excludedSources`', () => __awaiter(this, void 0, void 0, function* () {
                const excludedSources = _.sampleSize(constants_1.SELL_SOURCES, _.random(1, constants_1.SELL_SOURCES.length));
                let sourcesPolled = [];
                replaceSamplerOps({
                    getSellQuotes: (sources, makerToken, takerToken, amounts, wethAddress) => {
                        sourcesPolled = sourcesPolled.concat(sources.slice());
                ...
                yield marketOperationUtils.getMarketSellOrdersAsync(ORDERS, FILL_AMOUNT, Object.assign({}, DEFAULT_OPTS, { excludedSources }));
                contracts_test_utils_1.expect(sourcesPolled.sort()).to.deep.equals(_.without(constants_1.SELL_SOURCES, ...excludedSources).sort());
            }));
            ...
            it('is able to create a order from LiquidityProvider', () => __awaiter(this, void 0, void 0, function* () {
                ...
                const ordersAndReport = yield sampler.getMarketSellOrdersAsync([
                    ...
                    excludedSources: constants_1.SELL_SOURCES.concat(types_2.ERC20BridgeSource.Bancor),
                    numSamples: 4,
                    bridgeSlippage: 0,
                    shouldBatchBridgeOrders: false,
                });
        ...
        describe('getMarketBuyOrdersAsync()', () => {
            ...
            it('polls all DEXes if `excludedSources` is empty', () => __awaiter(this, void 0, void 0, function* () {
                ...
                replaceSamplerOps({
                    ...
                    getBalancerBuyQuotesAsync: (makerToken, takerToken, makerFillAmounts) => {
                        sourcesPolled = sourcesPolled.concat(types_2.ERC20BridgeSource.Balancer);
            ...
            it('does not poll DEXes in `excludedSources`', () => __awaiter(this, void 0, void 0, function* () {
                ...
                yield marketOperationUtils.getMarketBuyOrdersAsync(ORDERS, FILL_AMOUNT, Object.assign({}, DEFAULT_OPTS, { excludedSources }));
                contracts_test_utils_1.expect(sourcesPolled.sort()).to.deep.eq(_.without(constants_1.BUY_SOURCES, ...excludedSources).sort());
            }));
            it('generates bridge orders with correct asset data', () => __awaiter(this, void 0, void 0, function* () {
