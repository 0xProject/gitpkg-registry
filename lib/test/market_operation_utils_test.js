...
describe('MarketOperationUtils tests', () => {
    ...
    const contractAddresses = Object.assign({}, (0, contract_addresses_1.getContractAddressesForChainOrThrow)(CHAIN_ID));
        ...
        if (type === 'firm') {
            ...
            requestor
                ...
                return results.map(r => {
                    return Object.assign(Object.assign({}, r.order), { makerUri: 'https://foo.bar/' });
                });
            }))
                .verifiable(verifiable);
        }
    ...
    const DEFAULT_FILL_DATA = {
        ...
        [types_1.ERC20BridgeSource.Kyber]: { hint: '0x', reserveId: '0x', networkAddress: (0, contracts_test_utils_1.randomAddress)() },
        ...
        [types_1.ERC20BridgeSource.LiquidityProvider]: { poolAddress: (0, contracts_test_utils_1.randomAddress)() },
        ...
        [types_1.ERC20BridgeSource.Cream]: { poolAddress: (0, contracts_test_utils_1.randomAddress)() },
    ...
    describe('MarketOperationUtils', () => {
        ...
        describe('getMarketSellOrdersAsync()', () => {
            ...
            it('queries `numSamples` samples', () => __awaiter(void 0, void 0, void 0, function* () {
                ...
                yield getMarketSellOrdersAsync(marketOperationUtils, ORDERS, FILL_AMOUNT, Object.assign(Object.assign({}, DEFAULT_OPTS), { numSamples, neonRouterNumSamples: numSamples }));
            ...
            it('optimizer will send in a comparison price to RFQ providers', () => __awaiter(void 0, void 0, void 0, function* () {
                ...
                (0, contracts_test_utils_1.expect)(result.optimizedOrders.length).to.eql(1);
                // tslint:disable-next-line:no-unnecessary-type-assertion
                (0, contracts_test_utils_1.expect)(requestedComparisonPrice.toString()).to.eql('320');
                (0, contracts_test_utils_1.expect)(result.optimizedOrders[0].makerAmount.toString()).to.eql('321000000');
                (0, contracts_test_utils_1.expect)(result.optimizedOrders[0].takerAmount.toString()).to.eql('1000000000000000000');
            }));
            ...
            it.skip('factors in fees for native orders', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            it.skip('does not create a fallback if below maxFallbackSlippage', () => __awaiter(void 0, void 0, void 0, function* () {
                const rates = {};
                rates[types_1.ERC20BridgeSource.Native] = [1, 1, 0.01, 0.01];
                rates[types_1.ERC20BridgeSource.Uniswap] = [1, 1, 0.01, 0.01];
                rates[types_1.ERC20BridgeSource.SushiSwap] = [0.49, 0.49, 0.49, 0.49];
                ...
                const secondSources = [];
                (0, contracts_test_utils_1.expect)(orderSources.slice(0, firstSources.length).sort()).to.deep.eq(firstSources.sort());
                (0, contracts_test_utils_1.expect)(orderSources.slice(firstSources.length).sort()).to.deep.eq(secondSources.sort());
            }));
            it('is able to create a order from LiquidityProvider', () => __awaiter(void 0, void 0, void 0, function* () {
                ...
                (0, contracts_test_utils_1.expect)(result.length).to.eql(1);
                (0, contracts_test_utils_1.expect)(result[0].fillData.poolAddress).to.eql(liquidityProviderAddress);
            ...
            it('factors in exchange proxy gas overhead', () => __awaiter(void 0, void 0, void 0, function* () {
                ...
                MOCK_SAMPLER.liquidityProviderRegistry[(0, contracts_test_utils_1.randomAddress)()] = {
                    tokens: [MAKER_TOKEN, TAKER_TOKEN],
                    gasCost: 0,
                };
                replaceSamplerOps({
        ...
        describe('getMarketBuyOrdersAsync()', () => {
            ...
            // TODO: disabled as this is not supported by neon-router
            it.skip('can mix convex sources', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            it.skip('factors in fees for native orders', () => __awaiter(void 0, void 0, void 0, function* () {
                ...
                // dropping their effective rates.
                const nativeFeeRate = 0.06;
                const rates = Object.assign(Object.assign({}, ZERO_RATES), { [types_1.ERC20BridgeSource.Native]: [1, 0.99, 0.98, 0.97], [types_1.ERC20BridgeSource.Uniswap]: [0.96, 0.1, 0.1, 0.1], [types_1.ERC20BridgeSource.SushiSwap]: [0.95, 0.1, 0.1, 0.1], [types_1.ERC20BridgeSource.Kyber]: [0.1, 0.1, 0.1, 0.1] });
                const feeSchedule = {
                    [types_1.ERC20BridgeSource.Native]: _.constant(FILL_AMOUNT.div(4)
                        .times(nativeFeeRate)
            ...
            it('factors in fees for dexes', () => __awaiter(void 0, void 0, void 0, function* () {
                ...
                const rates = Object.assign(Object.assign({}, ZERO_RATES), { [types_1.ERC20BridgeSource.Native]: [0.95, 0.1, 0.1, 0.1], 
                    // Effectively [0.8, ~0.5, ~0, ~0]
                    [types_1.ERC20BridgeSource.Uniswap]: [1, 0.7, 0.2, 0.2], [types_1.ERC20BridgeSource.SushiSwap]: [0.92, 0.1, 0.1, 0.1] });
                const feeSchedule = {
                    [types_1.ERC20BridgeSource.Uniswap]: _.constant(FILL_AMOUNT.div(4)
                        .times(uniswapFeeRate)
                        .dividedToIntegerBy(ETH_TO_TAKER_RATE)),
            ...
            it('factors in exchange proxy gas overhead', () => __awaiter(void 0, void 0, void 0, function* () {
                ...
                const exchangeProxyOverhead = (sourceFlags) => sourceFlags === constants_1.SOURCE_FLAGS.LiquidityProvider
                    ? contracts_test_utils_1.constants.ZERO_AMOUNT
                    : new utils_1.BigNumber(1.3e5).times(GAS_PRICE);
    ...
    describe('createFills', () => {
        ...
        it('penalizes native fill based on target amount when target is smaller', () => {
            const path = (0, fills_1.createFills)({
                side: src_1.MarketOperation.Sell,
                orders,
                dexQuotes: [],
            ...
            (0, contracts_test_utils_1.expect)(path[0][0].fillData.order.maker).to.eq(smallOrder.order.maker);
            (0, contracts_test_utils_1.expect)(path[0][0].input).to.be.bignumber.eq(takerAmount.minus(1));
        });
        it('penalizes native fill based on available amount when target is larger', () => {
            ...
            (0, contracts_test_utils_1.expect)(path[0][0].fillData.order.maker).to.eq(largeOrder.order.maker);
            (0, contracts_test_utils_1.expect)(path[0][1].fillData.order.maker).to.eq(smallOrder.order.maker);
        });
    });
});
