...
describe('swapQuoteConsumerUtils', function () {
    ...
    before(function () { return __awaiter(void 0, void 0, void 0, function () {
        var defaultOrderParams, defaultForwarderOrderParams, privateKey;
        var _a, _b, _c;
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 3:
                    ...
                    defaultOrderParams = __assign(__assign({}, contracts_test_utils_1.constants.STATIC_ORDER_PARAMS), { makerAddress: makerAddress, takerAddress: constants_1.constants.NULL_ADDRESS, makerAssetData: makerAssetData,
                    ...
                    defaultForwarderOrderParams = __assign(__assign({}, defaultOrderParams), {
    ...
    describe('getConsumerTypeForSwapQuoteAsync', function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 23:
                        ...
                        return [7 /*endfinally*/];
                    case 24: return [4 /*yield*/, swap_quote_1.getFullyFillableSwapQuoteWithNoFeesAsync(makerAssetData, wethAssetData, forwarderOrders, types_1.MarketOperation.Sell, GAS_PRICE)];
                    case 25:
                        forwarderSwapQuote = _d.sent();
                        return [4 /*yield*/, swap_quote_1.getFullyFillableSwapQuoteWithNoFeesAsync(makerAssetData, wethAssetData, largeForwarderOrders, types_1.MarketOperation.Sell, GAS_PRICE)];
                    case 26:
                        largeForwarderSwapQuote = _d.sent();
                        return [4 /*yield*/, swap_quote_1.getFullyFillableSwapQuoteWithNoFeesAsync(makerAssetData, takerAssetData, exchangeOrders, types_1.MarketOperation.Sell, GAS_PRICE)];
                    case 27:
        ...
        it('should return exchange consumer if takerAsset is not wEth', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        it('should return forwarder consumer if takerAsset is wEth and have enough eth balance', function () { return __awaiter(void 0, void 0, void 0, function () {
            var extensionContractType;
            return __generator(this, function (_a) {
                switch (_a.label) {
        ...
        it('should return exchange consumer if takerAsset is wEth and taker has enough weth', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        it('should return forwarder consumer if takerAsset is wEth and takerAddress has no available balance in either weth or eth (defaulting behavior)', function () { return __awaiter(void 0, void 0, void 0, function () {
            var etherInWei, extensionContractType;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
