...
describe('ExchangeSwapQuoteConsumer', function () {
    ...
    before(function () { return __awaiter(void 0, void 0, void 0, function () {
        var defaultOrderParams, privateKey;
        var _a, _b, _c;
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 3:
                    ...
                    defaultOrderParams = __assign(__assign({}, contracts_test_utils_1.constants.STATIC_ORDER_PARAMS), { makerAddress: makerAddress,
    ...
    beforeEach(function () { return __awaiter(void 0, void 0, void 0, function () {
        var PARTIAL_PRUNED_SIGNED_ORDERS_FEELESS_1, PARTIAL_PRUNED_SIGNED_ORDERS_FEELESS_1_1, partialOrder, order, prunedOrder, e_1_1;
        var e_1, _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 8:
                    ...
                    return [7 /*endfinally*/];
                case 9: return [4 /*yield*/, swap_quote_1.getFullyFillableSwapQuoteWithNoFeesAsync(makerAssetData, takerAssetData, orders, types_1.MarketOperation.Sell, GAS_PRICE)];
                case 10:
                    marketSellSwapQuote = _b.sent();
                    return [4 /*yield*/, swap_quote_1.getFullyFillableSwapQuoteWithNoFeesAsync(makerAssetData, takerAssetData, orders, types_1.MarketOperation.Buy, GAS_PRICE)];
                case 11:
