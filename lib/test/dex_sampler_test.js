...
describe('DexSampler tests', function () {
    ...
    describe('operations', function () {
        ...
        it('getKyberSellQuotes()', function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _a = __read.apply(void 0, [_b.sent(), 1]), fillableAmounts = _a[0];
                        contracts_test_utils_1.expect(fillableAmounts.map(function (q) { return q.amount; })).to.deep.eq(expectedMakerFillAmounts);
                        return [2 /*return*/];
                }
            });
        }); });
        ...
        it('getEth2DaiBuyQuotes()', function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _a = __read.apply(void 0, [_b.sent(), 1]), fillableAmounts = _a[0];
                        contracts_test_utils_1.expect(fillableAmounts.map(function (q) { return q.amount; })).to.deep.eq(expectedTakerFillAmounts);
                        return [2 /*return*/];
                }
            });
        }); });
        ...
        it('getSellQuotes() uses samples from Bancor', function () { return __awaiter(_this, void 0, void 0, function () {
            var expectedTakerToken, expectedMakerToken, networkAddress, expectedTakerFillAmounts, rate, bancorService, dexOrderSampler, _a, quotes, _b, _c, expectedQuotes;
            var _this = this;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        expectedTakerToken = contracts_test_utils_1.randomAddress();
                        expectedMakerToken = contracts_test_utils_1.randomAddress();
                        networkAddress = contracts_test_utils_1.randomAddress();
                        expectedTakerFillAmounts = sampler_1.getSampleAmounts(new utils_1.BigNumber(100e18), 3);
                        rate = contracts_test_utils_1.getRandomFloat(0, 100);
                        bancorService = new mock_bancor_service_1.MockBancorService(web3_wrapper_1.provider, {
                            getQuoteAsync: function (fromToken, toToken, amount) { return __awaiter(_this, void 0, void 0, function () {
                                return __generator(this, function (_a) {
                                    ...
                                    return [2 /*return*/, Promise.resolve({
                                            fillData: { path: [fromToken, toToken], networkAddress: networkAddress },
                    ...
                    case 2:
                        ...
                        expectedQuotes = [
                            expectedTakerFillAmounts.map(function (a) { return ({
                                ...
                                fillData: { path: [expectedTakerToken, expectedMakerToken], networkAddress: networkAddress },
                            }); }),
                        ];
