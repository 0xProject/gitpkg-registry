...
describe.skip('DexSampler tests', () => {
    ...
    describe('operations', () => {
        ...
        it('getKyberSellQuotes()', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const dexOrderSampler = new sampler_1.DexOrderSampler(chainId, sampler, undefined, undefined, undefined, undefined, () => __awaiter(void 0, void 0, void 0, function* () { return undefined; }));
            const [fillableAmounts] = yield dexOrderSampler.executeAsync(dexOrderSampler.getKyberSellQuotes({ hintHandler: (0, contracts_test_utils_1.randomAddress)(), networkProxy: (0, contracts_test_utils_1.randomAddress)(), weth: (0, contracts_test_utils_1.randomAddress)() }, new utils_1.BigNumber(0), expectedMakerToken, expectedTakerToken, expectedTakerFillAmounts));
        ...
        it('getSellQuotes()', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const ratesBySource = {
                [types_1.ERC20BridgeSource.Kyber]: (0, contracts_test_utils_1.getRandomFloat)(0, 100),
