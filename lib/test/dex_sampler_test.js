...
describe('DexSampler tests', () => {
    ...
    describe('operations', () => {
        ...
        it('getLiquidityProviderSellQuotes()', () => __awaiter(this, void 0, void 0, function* () {
            ...
            const dexOrderSampler = new sampler_1.DexOrderSampler(sampler);
            const [result] = yield dexOrderSampler.executeAsync(dexOrderSampler.getSellQuotes([types_1.ERC20BridgeSource.LiquidityProvider], expectedMakerToken, expectedTakerToken, [contracts_test_utils_1.toBaseUnitAmount(1000)], wethAddress, tokenAdjacencyGraph, registry));
        ...
        it('getLiquidityProviderBuyQuotes()', () => __awaiter(this, void 0, void 0, function* () {
            ...
            const dexOrderSampler = new sampler_1.DexOrderSampler(sampler);
            const [result] = yield dexOrderSampler.executeAsync(dexOrderSampler.getBuyQuotes([types_1.ERC20BridgeSource.LiquidityProvider], expectedMakerToken, expectedTakerToken, [contracts_test_utils_1.toBaseUnitAmount(1000)], wethAddress, tokenAdjacencyGraph, registry));
            contracts_test_utils_1.expect(result).to.deep.equal([
                [
                    {
                        source: 'LiquidityProvider',
        ...
        it('getMultiBridgeSellQuotes()', () => __awaiter(this, void 0, void 0, function* () {
            ...
            const dexOrderSampler = new sampler_1.DexOrderSampler(sampler);
            const [result] = yield dexOrderSampler.executeAsync(dexOrderSampler.getSellQuotes([types_1.ERC20BridgeSource.MultiBridge], expectedMakerToken, expectedTakerToken, [contracts_test_utils_1.toBaseUnitAmount(1000)], wethAddress, tokenAdjacencyGraph, contracts_test_utils_1.randomAddress(), multiBridge));
            contracts_test_utils_1.expect(result).to.deep.equal([
                [
                    {
                        source: 'MultiBridge',
        ...
        it('getSellQuotes()', () => __awaiter(this, void 0, void 0, function* () {
            ...
            const dexOrderSampler = new sampler_1.DexOrderSampler(sampler);
            const [quotes] = yield dexOrderSampler.executeAsync(dexOrderSampler.getSellQuotes(sources, expectedMakerToken, expectedTakerToken, expectedTakerFillAmounts, wethAddress, tokenAdjacencyGraph));
        ...
        it('getBuyQuotes()', () => __awaiter(this, void 0, void 0, function* () {
            ...
            const dexOrderSampler = new sampler_1.DexOrderSampler(sampler);
            const [quotes] = yield dexOrderSampler.executeAsync(dexOrderSampler.getBuyQuotes(sources, expectedMakerToken, expectedTakerToken, expectedMakerFillAmounts, wethAddress, tokenAdjacencyGraph));
