...
var balancer_utils_1 = require("../src/utils/market_operation_utils/balancer_utils");
var sampler_1 = require("../src/utils/market_operation_utils/sampler");
var types_1 = require("../src/utils/market_operation_utils/types");
var mock_balancer_pools_cache_1 = require("./utils/mock_balancer_pools_cache");
var mock_bancor_service_1 = require("./utils/mock_bancor_service");
...
describe('DexSampler tests', function () {
    ...
    var wethAddress = contract_addresses_1.getContractAddressesForChainOrThrow(CHAIN_ID).etherToken;
    var devUtilsAddress = contract_addresses_1.getContractAddressesForChainOrThrow(CHAIN_ID).devUtils;
    ...
    describe('operations', function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, dexOrderSampler.executeAsync(sampler_1.DexOrderSampler.ops.getOrderFillableMakerAmounts(ORDERS, devUtilsAddress))];
                    case 1:
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        dexOrderSampler = new sampler_1.DexOrderSampler(sampler);
                        return [4 /*yield*/, dexOrderSampler.executeAsync(sampler_1.DexOrderSampler.ops.getOrderFillableTakerAmounts(ORDERS, devUtilsAddress))];
                    case 1:
                        _a = __read.apply(void 0, [_b.sent(), 1]), fillableAmounts = _a[0];
                        contracts_test_utils_1.expect(fillableAmounts).to.deep.eq(expectedFillableAmounts);
                        return [2 /*return*/];
        ...
        it('getLiquidityProviderSellQuotes()', function () { return __awaiter(_this, void 0, void 0, function () {
            var expectedMakerToken, expectedTakerToken, registry, sampler, dexOrderSampler, _a, result, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        expectedMakerToken = contracts_test_utils_1.randomAddress();
                        expectedTakerToken = contracts_test_utils_1.randomAddress();
                        registry = contracts_test_utils_1.randomAddress();
                        sampler = new mock_sampler_contract_1.MockSamplerContract({
                            sampleSellsFromLiquidityProviderRegistry: function (registryAddress, takerToken, makerToken, _fillAmounts) {
                        ...
                        dexOrderSampler = new sampler_1.DexOrderSampler(sampler);
                        _c = (_b = dexOrderSampler).executeAsync;
                        return [4 /*yield*/, sampler_1.DexOrderSampler.ops.getSellQuotesAsync([types_1.ERC20BridgeSource.LiquidityProvider], expectedMakerToken, expectedTakerToken, [contracts_test_utils_1.toBaseUnitAmount(1000)], wethAddress, dexOrderSampler.balancerPoolsCache, registry)];
        ...
        it('getLiquidityProviderBuyQuotes()', function () { return __awaiter(_this, void 0, void 0, function () {
            var expectedMakerToken, expectedTakerToken, registry, sampler, dexOrderSampler, _a, result, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        registry = contracts_test_utils_1.randomAddress();
                        sampler = new mock_sampler_contract_1.MockSamplerContract({
                            sampleBuysFromLiquidityProviderRegistry: function (registryAddress, takerToken, makerToken, _fillAmounts) {
                                contracts_test_utils_1.expect(registryAddress).to.eq(registry);
                                contracts_test_utils_1.expect(takerToken).to.eq(expectedTakerToken);
                                contracts_test_utils_1.expect(makerToken).to.eq(expectedMakerToken);
                        ...
                        dexOrderSampler = new sampler_1.DexOrderSampler(sampler);
                        _c = (_b = dexOrderSampler).executeAsync;
                        return [4 /*yield*/, sampler_1.DexOrderSampler.ops.getBuyQuotesAsync([types_1.ERC20BridgeSource.LiquidityProvider], expectedMakerToken, expectedTakerToken, [contracts_test_utils_1.toBaseUnitAmount(1000)], wethAddress, dexOrderSampler.balancerPoolsCache, registry)];
                    case 1: return [4 /*yield*/, _c.apply(_b, [_d.sent()])];
                    case 2:
                        _a = __read.apply(void 0, [_d.sent(), 1]), result = _a[0];
                        contracts_test_utils_1.expect(result).to.deep.equal([
        ...
        it('getMultiBridgeSellQuotes()', function () { return __awaiter(_this, void 0, void 0, function () {
            var expectedTakerToken, expectedMakerToken, multiBridge, sampler, dexOrderSampler, _a, result, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        expectedTakerToken = contracts_test_utils_1.randomAddress();
                        expectedMakerToken = contracts_test_utils_1.randomAddress();
                        multiBridge = contracts_test_utils_1.randomAddress();
                        sampler = new mock_sampler_contract_1.MockSamplerContract({
                            sampleSellsFromMultiBridge: function (multiBridgeAddress, takerToken, _intermediateToken, makerToken, _fillAmounts) {
                        ...
                        dexOrderSampler = new sampler_1.DexOrderSampler(sampler);
                        _c = (_b = dexOrderSampler).executeAsync;
                        return [4 /*yield*/, sampler_1.DexOrderSampler.ops.getSellQuotesAsync([types_1.ERC20BridgeSource.MultiBridge], expectedMakerToken, expectedTakerToken, [contracts_test_utils_1.toBaseUnitAmount(1000)], contracts_test_utils_1.randomAddress(), dexOrderSampler.balancerPoolsCache, contracts_test_utils_1.randomAddress(), multiBridge)];
                    case 1: return [4 /*yield*/, _c.apply(_b, [_d.sent()])];
                    case 2:
                        _a = __read.apply(void 0, [_d.sent(), 1]), result = _a[0];
                        contracts_test_utils_1.expect(result).to.deep.equal([
        ...
        it('getUniswapV2SellQuotes()', function () { return __awaiter(_this, void 0, void 0, function () {
            var expectedTakerToken, expectedMakerToken, expectedTakerFillAmounts, expectedMakerFillAmounts, sampler, dexOrderSampler, _a, fillableAmounts;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        expectedMakerFillAmounts = sampler_1.getSampleAmounts(new utils_1.BigNumber(100e18), 10);
                        sampler = new mock_sampler_contract_1.MockSamplerContract({
                            sampleSellsFromUniswapV2: function (path, fillAmounts) {
                        ...
                        dexOrderSampler = new sampler_1.DexOrderSampler(sampler);
                        return [4 /*yield*/, dexOrderSampler.executeAsync(sampler_1.DexOrderSampler.ops.getUniswapV2SellQuotes([expectedMakerToken, expectedTakerToken], expectedTakerFillAmounts))];
                    case 1:
                        _a = __read.apply(void 0, [_b.sent(), 1]), fillableAmounts = _a[0];
                        contracts_test_utils_1.expect(fillableAmounts).to.deep.eq(expectedMakerFillAmounts);
                        return [2 /*return*/];
        ...
        it('getSellQuotes()', function () { return __awaiter(_this, void 0, void 0, function () {
            var _a, expectedTakerToken, expectedMakerToken, sources, ratesBySource, expectedTakerFillAmounts, sampler, dexOrderSampler, _b, quotes, _c, _d, expectedQuotes, uniswapV2ETHQuotes;
                ...
                switch (_e.label) {
                    case 0:
                        ...
                        ratesBySource = (_a = {},
                            ...
                            _a[types_1.ERC20BridgeSource.UniswapV2] = contracts_test_utils_1.getRandomFloat(0, 100),
                            _a);
                        ...
                        sampler = new mock_sampler_contract_1.MockSamplerContract({
                            ...
                            sampleSellsFromUniswapV2: function (path, fillAmounts) {
                                ...
                                contracts_test_utils_1.expect(fillAmounts).to.deep.eq(expectedTakerFillAmounts);
                                return fillAmounts.map(function (a) { return a.times(ratesBySource[types_1.ERC20BridgeSource.UniswapV2]).integerValue(); });
                            },
                        });
                        dexOrderSampler = new sampler_1.DexOrderSampler(sampler);
                        _d = (_c = dexOrderSampler).executeAsync;
                        return [4 /*yield*/, sampler_1.DexOrderSampler.ops.getSellQuotesAsync(sources, expectedMakerToken, expectedTakerToken, expectedTakerFillAmounts, wethAddress, dexOrderSampler.balancerPoolsCache)];
                    case 1: return [4 /*yield*/, _d.apply(_c, [_e.sent()])];
                    case 2:
                        _b = __read.apply(void 0, [_e.sent(), 1]), quotes = _b[0];
                        ...
                        uniswapV2ETHQuotes = [
                            expectedTakerFillAmounts.map(function (a) { return ({
        ...
        it('getSellQuotes() uses samples from Balancer', function () { return __awaiter(_this, void 0, void 0, function () {
            var expectedTakerToken, expectedMakerToken, expectedTakerFillAmounts, pools, balancerPoolsCache, dexOrderSampler, _a, quotes, _b, _c, expectedQuotes;
            var _this = this;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        expectedMakerToken = contracts_test_utils_1.randomAddress();
                        expectedTakerFillAmounts = sampler_1.getSampleAmounts(new utils_1.BigNumber(100e18), 3);
                        pools = [generateBalancerPool(), generateBalancerPool()];
                        balancerPoolsCache = new mock_balancer_pools_cache_1.MockBalancerPoolsCache({
                            getPoolsForPairAsync: function (takerToken, makerToken) { return __awaiter(_this, void 0, void 0, function () {
                                return __generator(this, function (_a) {
                                    ...
                                    return [2 /*return*/, Promise.resolve(pools)];
                                });
                            }); },
                        });
                        dexOrderSampler = new sampler_1.DexOrderSampler(new mock_sampler_contract_1.MockSamplerContract({}), undefined, // sampler overrides
                        undefined, // bancor service
                        balancerPoolsCache);
                        _c = (_b = dexOrderSampler).executeAsync;
                        return [4 /*yield*/, sampler_1.DexOrderSampler.ops.getSellQuotesAsync([types_1.ERC20BridgeSource.Balancer], expectedMakerToken, expectedTakerToken, expectedTakerFillAmounts, wethAddress, dexOrderSampler.balancerPoolsCache)];
                    case 1: return [4 /*yield*/, _c.apply(_b, [_d.sent()])];
                    case 2:
                        _a = __read.apply(void 0, [_d.sent(), 1]), quotes = _a[0];
                        expectedQuotes = pools.map(function (p) {
                            return expectedTakerFillAmounts.map(function (a) { return ({
        ...
        it('getSellQuotes() uses samples from Bancor', function () { return __awaiter(_this, void 0, void 0, function () {
            var expectedTakerToken, expectedMakerToken, expectedTakerFillAmounts, rate, bancorService, dexOrderSampler, _a, quotes, _b, _c, expectedQuotes;
            var _this = this;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        expectedMakerToken = contracts_test_utils_1.randomAddress();
                        expectedTakerFillAmounts = sampler_1.getSampleAmounts(new utils_1.BigNumber(100e18), 3);
                        rate = contracts_test_utils_1.getRandomFloat(0, 100);
                        bancorService = new mock_bancor_service_1.MockBancorService({
                            getQuoteAsync: function (fromToken, toToken, amount) { return __awaiter(_this, void 0, void 0, function () {
                                return __generator(this, function (_a) {
                        ...
                        dexOrderSampler = new sampler_1.DexOrderSampler(new mock_sampler_contract_1.MockSamplerContract({}), undefined, // sampler overrides
                        bancorService, undefined);
                        _c = (_b = dexOrderSampler).executeAsync;
                        return [4 /*yield*/, sampler_1.DexOrderSampler.ops.getSellQuotesAsync([types_1.ERC20BridgeSource.Bancor], expectedMakerToken, expectedTakerToken, expectedTakerFillAmounts, wethAddress, undefined, // balancer pools cache
                    ...
                    case 2:
                        ...
                        contracts_test_utils_1.expect(quotes).to.have.lengthOf(1); //  one set per pool
                        contracts_test_utils_1.expect(quotes).to.deep.eq(expectedQuotes);
                        return [2 /*return*/];
                }
            });
        ...
        it('getBuyQuotes()', function () { return __awaiter(_this, void 0, void 0, function () {
            var _a, expectedTakerToken, expectedMakerToken, sources, ratesBySource, expectedMakerFillAmounts, sampler, dexOrderSampler, _b, quotes, _c, _d, expectedQuotes, uniswapV2ETHQuotes;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        expectedTakerToken = contracts_test_utils_1.randomAddress();
                        expectedMakerToken = contracts_test_utils_1.randomAddress();
                        sources = [types_1.ERC20BridgeSource.Eth2Dai, types_1.ERC20BridgeSource.Uniswap, types_1.ERC20BridgeSource.UniswapV2];
                        ratesBySource = (_a = {},
                            _a[types_1.ERC20BridgeSource.Eth2Dai] = contracts_test_utils_1.getRandomFloat(0, 100),
                            _a[types_1.ERC20BridgeSource.Uniswap] = contracts_test_utils_1.getRandomFloat(0, 100),
                            _a[types_1.ERC20BridgeSource.UniswapV2] = contracts_test_utils_1.getRandomFloat(0, 100),
                        ...
                        sampler = new mock_sampler_contract_1.MockSamplerContract({
                            ...
                            sampleBuysFromUniswapV2: function (path, fillAmounts) {
                                if (path.length === 2) {
                                    contracts_test_utils_1.expect(path).to.deep.eq([expectedTakerToken, expectedMakerToken]);
                                }
                                else if (path.length === 3) {
                        ...
                        dexOrderSampler = new sampler_1.DexOrderSampler(sampler);
                        _d = (_c = dexOrderSampler).executeAsync;
                        return [4 /*yield*/, sampler_1.DexOrderSampler.ops.getBuyQuotesAsync(sources, expectedMakerToken, expectedTakerToken, expectedMakerFillAmounts, wethAddress, dexOrderSampler.balancerPoolsCache)];
                    case 1: return [4 /*yield*/, _d.apply(_c, [_e.sent()])];
                    case 2:
                        _b = __read.apply(void 0, [_e.sent(), 1]), quotes = _b[0];
                        expectedQuotes = sources.map(function (s) {
                        ...
                        uniswapV2ETHQuotes = [
                            expectedMakerFillAmounts.map(function (a) { return ({
                                source: types_1.ERC20BridgeSource.UniswapV2,
                                input: a,
                                output: a.times(ratesBySource[types_1.ERC20BridgeSource.UniswapV2]).integerValue(),
                                fillData: {
        ...
        it('getBuyQuotes() uses samples from Balancer', function () { return __awaiter(_this, void 0, void 0, function () {
            var expectedTakerToken, expectedMakerToken, expectedMakerFillAmounts, pools, balancerPoolsCache, dexOrderSampler, _a, quotes, _b, _c, expectedQuotes;
            var _this = this;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        balancerPoolsCache);
                        _c = (_b = dexOrderSampler).executeAsync;
                        return [4 /*yield*/, sampler_1.DexOrderSampler.ops.getBuyQuotesAsync([types_1.ERC20BridgeSource.Balancer], expectedMakerToken, expectedTakerToken, expectedMakerFillAmounts, wethAddress, dexOrderSampler.balancerPoolsCache)];
                    case 1: return [4 /*yield*/, _c.apply(_b, [_d.sent()])];
                    case 2:
                        _a = __read.apply(void 0, [_d.sent(), 1]), quotes = _a[0];
                        expectedQuotes = pools.map(function (p) {
        ...
        it('getBuyQuotes() uses samples from Bancor', function () { return __awaiter(_this, void 0, void 0, function () {
            var expectedTakerToken, expectedMakerToken, expectedMakerFillAmounts, rate, bancorService, dexOrderSampler, _a, quotes, _b, _c, expectedQuotes;
            var _this = this;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        bancorService = new mock_bancor_service_1.MockBancorService({
                            getQuoteAsync: function (fromToken, toToken, amount) { return __awaiter(_this, void 0, void 0, function () {
                                return __generator(this, function (_a) {
                                    contracts_test_utils_1.expect(fromToken).equal(expectedMakerToken);
                                    contracts_test_utils_1.expect(toToken).equal(expectedTakerToken);
                                    return [2 /*return*/, Promise.resolve({
                                            fillData: { path: [fromToken, toToken] },
                                            amount: amount.multipliedBy(rate),
                                        })];
                        ...
                        bancorService, undefined);
                        _c = (_b = dexOrderSampler).executeAsync;
                        return [4 /*yield*/, sampler_1.DexOrderSampler.ops.getBuyQuotesAsync([types_1.ERC20BridgeSource.Bancor], expectedMakerToken, expectedTakerToken, expectedMakerFillAmounts, wethAddress, undefined, // balancer pools cache
                            undefined, // liquidity provider registry address
                            bancorService)];
                    case 1: return [4 /*yield*/, _c.apply(_b, [_d.sent()])];
                    case 2:
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        dexOrderSampler = new sampler_1.DexOrderSampler(sampler);
                        return [4 /*yield*/, dexOrderSampler.executeAsync(sampler_1.DexOrderSampler.ops.getOrderFillableMakerAmounts(ORDERS, devUtilsAddress), sampler_1.DexOrderSampler.ops.getOrderFillableTakerAmounts(ORDERS, devUtilsAddress))];
                    case 1:
