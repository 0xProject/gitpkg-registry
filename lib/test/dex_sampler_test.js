            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        dexOrderSampler = new sampler_1.DexOrderSampler(sampler);
                        return [4 /*yield*/, dexOrderSampler.executeAsync(sampler_1.DexOrderSampler.ops.getSellQuotes([types_1.ERC20BridgeSource.LiquidityProvider], expectedMakerToken, expectedTakerToken, [contracts_test_utils_1.toBaseUnitAmount(1000)], registry))];
                    case 1:
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        dexOrderSampler = new sampler_1.DexOrderSampler(sampler);
                        return [4 /*yield*/, dexOrderSampler.executeAsync(sampler_1.DexOrderSampler.ops.getBuyQuotes([types_1.ERC20BridgeSource.LiquidityProvider], expectedMakerToken, expectedTakerToken, [contracts_test_utils_1.toBaseUnitAmount(1000)], registry))];
                    case 1:
                        _a = __read.apply(void 0, [_b.sent(), 1]), result = _a[0];
                        contracts_test_utils_1.expect(result).to.deep.equal([
                            [
