...
describe('DexSampler tests', function () {
    ...
    describe('operations', function () {
        ...
        it('getLiquidityProviderSellQuotes()', function () { return __awaiter(_this, void 0, void 0, function () {
            var expectedMakerToken, expectedTakerToken, registry, sampler, dexOrderSampler, _a, result;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        expectedMakerToken = contracts_test_utils_1.randomAddress();
                        ...
                        sampler = new mock_sampler_contract_1.MockSamplerContract({
                            sampleSellsFromLiquidityProviderRegistry: function (registryAddress, takerToken, makerToken, fillAmounts) {
                        ...
                        dexOrderSampler = new sampler_1.DexOrderSampler(sampler);
                        return [4 /*yield*/, dexOrderSampler.executeAsync(sampler_1.DexOrderSampler.ops.getSellQuotes([types_1.ERC20BridgeSource.LiquidityProvider], expectedMakerToken, expectedTakerToken, [contracts_test_utils_1.toBaseUnitAmount(1000)], wethAddress, registry))];
                    case 1:
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        registry = contracts_test_utils_1.randomAddress();
                        sampler = new mock_sampler_contract_1.MockSamplerContract({
                            sampleBuysFromLiquidityProviderRegistry: function (registryAddress, takerToken, makerToken, fillAmounts) {
                                contracts_test_utils_1.expect(registryAddress).to.eq(registry);
                                contracts_test_utils_1.expect(takerToken).to.eq(expectedTakerToken);
                                contracts_test_utils_1.expect(makerToken).to.eq(expectedMakerToken);
                        ...
                        dexOrderSampler = new sampler_1.DexOrderSampler(sampler);
                        return [4 /*yield*/, dexOrderSampler.executeAsync(sampler_1.DexOrderSampler.ops.getBuyQuotes([types_1.ERC20BridgeSource.LiquidityProvider], expectedMakerToken, expectedTakerToken, [contracts_test_utils_1.toBaseUnitAmount(1000)], wethAddress, registry))];
                    case 1:
                        _a = __read.apply(void 0, [_b.sent(), 1]), result = _a[0];
                        contracts_test_utils_1.expect(result).to.deep.equal([
                            [
        ...
        it('getMultiBridgeSellQuotes()', function () { return __awaiter(_this, void 0, void 0, function () {
            var expectedTakerToken, expectedMakerToken, multiBridge, sampler, dexOrderSampler, _a, result;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        expectedTakerToken = contracts_test_utils_1.randomAddress();
                        ...
                        dexOrderSampler = new sampler_1.DexOrderSampler(sampler);
                        return [4 /*yield*/, dexOrderSampler.executeAsync(sampler_1.DexOrderSampler.ops.getSellQuotes([types_1.ERC20BridgeSource.MultiBridge], expectedMakerToken, expectedTakerToken, [contracts_test_utils_1.toBaseUnitAmount(1000)], contracts_test_utils_1.randomAddress(), contracts_test_utils_1.randomAddress(), multiBridge))];
                    case 1:
                        _a = __read.apply(void 0, [_b.sent(), 1]), result = _a[0];
                        contracts_test_utils_1.expect(result).to.deep.equal([
                            [
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        dexOrderSampler = new sampler_1.DexOrderSampler(sampler);
                        return [4 /*yield*/, dexOrderSampler.executeAsync(sampler_1.DexOrderSampler.ops.getSellQuotes(sources, expectedMakerToken, expectedTakerToken, expectedTakerFillAmounts, wethAddress))];
                    case 1:
        ...
        it('getSellQuotes() includes ETH for Uniswap_V2_ETH', function () { return __awaiter(_this, void 0, void 0, function () {
            var _a, expectedTakerToken, expectedMakerToken, sources, ratesBySource, expectedTakerFillAmounts, sampler, dexOrderSampler, _b, quotes, expectedQuotes;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        expectedTakerToken = contracts_test_utils_1.randomAddress();
                        expectedMakerToken = contracts_test_utils_1.randomAddress();
                        sources = [types_1.ERC20BridgeSource.UniswapV2Eth];
                        ratesBySource = (_a = {},
                            _a[types_1.ERC20BridgeSource.UniswapV2Eth] = contracts_test_utils_1.getRandomFloat(0, 100),
                            _a);
                        expectedTakerFillAmounts = sampler_1.getSampleAmounts(new utils_1.BigNumber(100e18), 3);
                        sampler = new mock_sampler_contract_1.MockSamplerContract({
                            sampleSellsFromUniswapV2: function (path, fillAmounts) {
                                ...
                                contracts_test_utils_1.expect(fillAmounts).to.deep.eq(expectedTakerFillAmounts);
                                return fillAmounts.map(function (a) { return a.times(ratesBySource[types_1.ERC20BridgeSource.UniswapV2Eth]).integerValue(); });
                            },
                        });
                        dexOrderSampler = new sampler_1.DexOrderSampler(sampler);
                        return [4 /*yield*/, dexOrderSampler.executeAsync(sampler_1.DexOrderSampler.ops.getSellQuotes(sources, expectedMakerToken, expectedTakerToken, expectedTakerFillAmounts, wethAddress))];
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        dexOrderSampler = new sampler_1.DexOrderSampler(sampler);
                        return [4 /*yield*/, dexOrderSampler.executeAsync(sampler_1.DexOrderSampler.ops.getBuyQuotes(sources, expectedMakerToken, expectedTakerToken, expectedMakerFillAmounts, wethAddress))];
                    case 1:
                        _b = __read.apply(void 0, [_c.sent(), 1]), quotes = _b[0];
                        contracts_test_utils_1.expect(quotes).to.be.length(sources.length);
                        expectedQuotes = sources.map(function (s) {
        ...
        it('getBuyQuotes() includes ETH for Uniswap_V2_ETH', function () { return __awaiter(_this, void 0, void 0, function () {
            var _a, expectedTakerToken, expectedMakerToken, sources, ratesBySource, expectedMakerFillAmounts, sampler, dexOrderSampler, _b, quotes, expectedQuotes;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        expectedTakerToken = contracts_test_utils_1.randomAddress();
                        expectedMakerToken = contracts_test_utils_1.randomAddress();
                        sources = [types_1.ERC20BridgeSource.Eth2Dai, types_1.ERC20BridgeSource.Uniswap, types_1.ERC20BridgeSource.UniswapV2Eth];
                        ratesBySource = (_a = {},
                            _a[types_1.ERC20BridgeSource.Eth2Dai] = contracts_test_utils_1.getRandomFloat(0, 100),
                            _a[types_1.ERC20BridgeSource.Uniswap] = contracts_test_utils_1.getRandomFloat(0, 100),
                            _a[types_1.ERC20BridgeSource.UniswapV2Eth] = contracts_test_utils_1.getRandomFloat(0, 100),
