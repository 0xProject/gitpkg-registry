...
describe('DexSampler tests', function () {
    ...
    var exchangeAddress = contract_addresses_1.getContractAddressesForChainOrThrow(CHAIN_ID).exchange;
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, dexOrderSampler.executeAsync(sampler_1.DexOrderSampler.ops.getOrderFillableMakerAmounts(ORDERS, exchangeAddress))];
                    case 1:
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        dexOrderSampler = new sampler_1.DexOrderSampler(sampler);
                        return [4 /*yield*/, dexOrderSampler.executeAsync(sampler_1.DexOrderSampler.ops.getOrderFillableTakerAmounts(ORDERS, exchangeAddress))];
                    case 1:
                        _a = __read.apply(void 0, [_b.sent(), 1]), fillableAmounts = _a[0];
                        contracts_test_utils_1.expect(fillableAmounts).to.deep.eq(expectedFillableAmounts);
                        return [2 /*return*/];
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        dexOrderSampler = new sampler_1.DexOrderSampler(sampler);
                        return [4 /*yield*/, dexOrderSampler.executeAsync(sampler_1.DexOrderSampler.ops.getOrderFillableMakerAmounts(ORDERS, exchangeAddress), sampler_1.DexOrderSampler.ops.getOrderFillableTakerAmounts(ORDERS, exchangeAddress))];
                    case 1:
