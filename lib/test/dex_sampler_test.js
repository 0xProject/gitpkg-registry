...
describe('DexSampler tests', () => {
    ...
    function createOrder(overrides) {
        return {
            order: Object.assign({ salt: utils_2.generatePseudoRandomSalt(), expiry: contracts_test_utils_1.getRandomInteger(0, Math.pow(2, 64)), makerToken: MAKER_TOKEN, takerToken: TAKER_TOKEN, makerAmount: contracts_test_utils_1.getRandomInteger(1, 1e18), takerAmount: contracts_test_utils_1.getRandomInteger(1, 1e18), takerTokenFeeAmount: order_utils_1.ZERO_AMOUNT, chainId: CHAIN_ID, pool: utils_1.NULL_BYTES, feeRecipient: utils_1.NULL_ADDRESS, sender: utils_1.NULL_ADDRESS, maker: utils_1.NULL_ADDRESS, taker: utils_1.NULL_ADDRESS, verifyingContract: exchangeProxyAddress }, overrides),
