        ...
        it('getSellQuotes()', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const sampler = new mock_sampler_contract_1.MockSamplerContract({
                sampleSellsFromUniswapGlobal: (router, takerToken, makerToken) => {
                    ...
                    contracts_test_utils_1.expect(takerToken).to.eq(expectedTakerToken);
                    contracts_test_utils_1.expect(makerToken).to.eq(expectedMakerToken);
                    return expectedTakerFillAmounts.map(a => a.times(ratesBySource[types_1.ERC20BridgeSource.Uniswap]).integerValue());
                },
                sampleSellsFromUniswapV2Global: (router, path) => {
                    ...
                    return expectedTakerFillAmounts.map(a => a.times(ratesBySource[types_1.ERC20BridgeSource.UniswapV2]).integerValue());
                },
            });
        ...
        it('getBuyQuotes()', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const sampler = new mock_sampler_contract_1.MockSamplerContract({
                sampleBuysFromUniswapGlobal: (router, takerToken, makerToken) => {
                    ...
                    contracts_test_utils_1.expect(takerToken).to.eq(expectedTakerToken);
                    contracts_test_utils_1.expect(makerToken).to.eq(expectedMakerToken);
                    return expectedMakerFillAmounts.map(a => a.times(ratesBySource[types_1.ERC20BridgeSource.Uniswap]).integerValue());
                },
                sampleBuysFromUniswapV2Global: (router, path) => {
                    ...
                    return expectedMakerFillAmounts.map(a => a.times(ratesBySource[types_1.ERC20BridgeSource.UniswapV2]).integerValue());
                },
            });
            const dexOrderSampler = new sampler_1.DexOrderSampler(chainId, sampler, undefined, undefined, tokenAdjacencyGraph, undefined, () => __awaiter(void 0, void 0, void 0, function* () { return undefined; }));
