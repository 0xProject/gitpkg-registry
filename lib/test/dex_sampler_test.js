...
describe('DexSampler tests', () => {
    ...
    describe('operations', () => {
        ...
        it('getSellQuotes()', () => __awaiter(this, void 0, void 0, function* () {
            ...
            const dexOrderSampler = new sampler_1.DexOrderSampler(sampler, undefined, undefined, undefined, tokenAdjacencyGraph);
        ...
        it('getSellQuotes() fetches pools but not samples from Balancer', () => __awaiter(this, void 0, void 0, function* () {
            ...
            const dexOrderSampler = new sampler_1.DexOrderSampler(new mock_sampler_contract_1.MockSamplerContract({}), undefined, balancerPoolsCache);
