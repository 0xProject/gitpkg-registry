...
describe('DexSampler tests', () => {
    ...
    describe('operations', () => {
        ...
        it('getLiquidityProviderSellQuotes()', () => __awaiter(this, void 0, void 0, function* () {
            ...
            const dexOrderSampler = new sampler_1.DexOrderSampler(sampler, undefined, undefined, undefined, undefined, undefined, undefined, { [poolAddress]: { tokens: [expectedMakerToken, expectedTakerToken], gasCost } });
        ...
        it('getSellQuotes()', () => __awaiter(this, void 0, void 0, function* () {
            ...
            const dexOrderSampler = new sampler_1.DexOrderSampler(sampler, undefined, undefined, undefined, undefined, undefined, tokenAdjacencyGraph);
