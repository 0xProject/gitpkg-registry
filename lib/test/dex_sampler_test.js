...
describe('DexSampler tests', () => {
    ...
    describe('operations', () => {
        it('getLimitOrderFillableMakerAssetAmounts()', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const dexOrderSampler = new sampler_1.DexOrderSampler(sampler, undefined, undefined, undefined, undefined, undefined, () => __awaiter(void 0, void 0, void 0, function* () { return undefined; }));
        ...
        it('getSellQuotes()', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const dexOrderSampler = new sampler_1.DexOrderSampler(sampler, undefined, undefined, undefined, tokenAdjacencyGraph, undefined, () => __awaiter(void 0, void 0, void 0, function* () { return undefined; }));
        ...
        it('getSellQuotes() fetches pools but not samples from Balancer', () => __awaiter(void 0, void 0, void 0, function* () {
            // HACK
            ...
            const balancerPoolsCache = new mock_balancer_pools_cache_1.MockBalancerPoolsCache({
                getPoolsForPairAsync: (takerToken, makerToken) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const dexOrderSampler = new sampler_1.DexOrderSampler(new mock_sampler_contract_1.MockSamplerContract({}), undefined, balancerPoolsCache, undefined, undefined, undefined, () => __awaiter(void 0, void 0, void 0, function* () { return undefined; }));
        ...
        it('getBuyQuotes() uses samples from Balancer', () => __awaiter(void 0, void 0, void 0, function* () {
            const expectedTakerToken = contracts_test_utils_1.randomAddress();
            const expectedMakerToken = contracts_test_utils_1.randomAddress();
            const expectedMakerFillAmounts = sampler_1.getSampleAmounts(new utils_1.BigNumber(100e18), 3);
            const pools = [generateBalancerPool(), generateBalancerPool()];
