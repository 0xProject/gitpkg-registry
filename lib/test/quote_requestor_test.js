...
describe('QuoteRequestor', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        ...
        describe('requestRfqtFirmQuotesAsync for firm quotes', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                it('should return successful RFQT requests', function () { return __awaiter(void 0, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        ...
                        return [2 /*return*/, rfqt_mocker_1.rfqtMocker.withMockedRfqtFirmQuotes(mockedRequests, function () { return __awaiter(void 0, void 0, void 0, function () {
                                var qr, resp;
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
        ...
        describe('requestRfqtIndicativeQuotesAsync for Indicative quotes', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                it('should return successful RFQT requests', function () { return __awaiter(void 0, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        ...
                        mockedRequests.push({
                            ...
                            requestApiKey: apiKey,
                            requestParams: expectedParams,
                            responseData: __assign(__assign({}, successfulQuote1), { makerAssetData: order_utils_1.assetDataUtils.encodeERC20AssetData(otherToken1) }),
                            responseCode: types_1.StatusCodes.Success,
                        });
                        ...
                        mockedRequests.push({
                            ...
                            requestApiKey: apiKey,
                            requestParams: expectedParams,
                            responseData: __assign(__assign({}, successfulQuote1), { takerAssetData: order_utils_1.assetDataUtils.encodeERC20AssetData(otherToken1) }),
                            responseCode: types_1.StatusCodes.Success,
                        });
                        ...
                        return [2 /*return*/, rfqt_mocker_1.rfqtMocker.withMockedRfqtIndicativeQuotes(mockedRequests, function () { return __awaiter(void 0, void 0, void 0, function () {
                                var qr, resp;
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                ...
                it('should return successful RFQT indicative quote requests', function () { return __awaiter(void 0, void 0, void 0, function () {
                    var takerAddress, apiKey, mockedRequests, expectedParams, successfulQuote1;
                    return __generator(this, function (_a) {
                        takerAddress = '0xd209925defc99488e3afff1174e48b4fa628302a';
                        apiKey = 'my-ko0l-api-key';
