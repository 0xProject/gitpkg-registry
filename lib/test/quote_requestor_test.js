...
function makeOneMinuteExpiryJson() {
    var expiry = new Date(Date.now());
    expiry.setMinutes(expiry.getMinutes() + 1);
    return expiry.valueOf().toString();
}
        ...
        describe('requestRfqtFirmQuotesAsync for firm quotes', function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                it('should return successful RFQT requests', function () { return __awaiter(_this, void 0, void 0, function () {
                    var takerAddress, apiKey, mockedRequests, expectedParams, successfulOrder1, wrongMakerAssetDataOrder, wrongTakerAssetDataOrder, unsignedOrder, successfulOrder2;
                    var _this = this;
                    return __generator(this, function (_a) {
                        ...
                        successfulOrder2 = test_order_factory_1.testOrderFactory.generateTestSignedOrder({ makerAssetData: makerAssetData, takerAssetData: takerAssetData });
                        mockedRequests.push({
                ...
                it('should return successful RFQT requests', function () { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        ...
                        successfulQuote1 = {
                            makerAssetData: makerAssetData,
                            takerAssetData: takerAssetData,
                            makerAssetAmount: new utils_1.BigNumber(expectedParams.sellAmount),
                            takerAssetAmount: new utils_1.BigNumber(expectedParams.sellAmount),
                ...
                it('should return successful RFQT indicative quote requests', function () { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        ...
                        successfulQuote1 = {
                            makerAssetData: makerAssetData,
                            takerAssetData: takerAssetData,
                            makerAssetAmount: new utils_1.BigNumber(expectedParams.buyAmount),
                            takerAssetAmount: new utils_1.BigNumber(expectedParams.buyAmount),
                            expirationTimeSeconds: makeOneMinuteExpiryJson(),
                        };
                        mockedRequests.push({
                            endpoint: 'https://1337.0.0.1',
