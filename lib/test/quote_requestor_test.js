...
describe('QuoteRequestor', function () { return __awaiter(_this, void 0, void 0, function () {
    var _a, makerToken, takerToken, makerAssetData, takerAssetData;
    var _this = this;
    return __generator(this, function (_b) {
        _a = __read(dev_utils_1.tokenUtils.getDummyERC20TokenAddresses(), 2), makerToken = _a[0], takerToken = _a[1];
        ...
        describe('requestRfqtFirmQuotesAsync', function () { return __awaiter(_this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                it('should return successful RFQT requests', function () { return __awaiter(_this, void 0, void 0, function () {
                    var takerAddress, takerApiKey, mockedRequests, expectedParams, mockedOrder1, mockedOrder3;
                    var _this = this;
                    return __generator(this, function (_a) {
                        takerAddress = '0xd209925defc99488e3afff1174e48b4fa628302a';
                        takerApiKey = 'my-ko0l-api-key';
                        mockedRequests = [];
                        expectedParams = {
                        ...
                        mockedOrder1 = test_order_factory_1.testOrderFactory.generateTestSignedOrder({});
                        mockedRequests.push({
                        ...
                        mockedOrder3 = test_order_factory_1.testOrderFactory.generateTestSignedOrder({});
                        mockedRequests.push({
                        ...
                        return [2 /*return*/, rfqt_mocker_1.rfqtMocker.withMockedRfqtFirmQuotes(mockedRequests, function () { return __awaiter(_this, void 0, void 0, function () {
                                ...
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                            qr = new quote_requestor_1.QuoteRequestor(['https://1337.0.0.1', 'https://420.0.0.1', 'https://37.0.0.1']);
                                            return [4 /*yield*/, qr.requestRfqtFirmQuotesAsync(makerAssetData, takerAssetData, new utils_1.BigNumber(10000), types_2.MarketOperation.Sell, takerApiKey, takerAddress)];
                                        case 1:
                                            resp = _a.sent();
