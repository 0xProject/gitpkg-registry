...
var randomAssetData = function () { return utils_1.hexUtils.random(34); };
...
contracts_test_utils_1.blockchainTests.only('Eth2DaiBridge unit tests', function (env) {
    var weth;
    var sellToken;
    var buyToken;
    var ritualBridge;
    ...
    before(function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 2:
                    _a = __read.apply(void 0, [_c.sent(), 2]), sellToken = _a[0], buyToken = _a[1];
                ...
                case 3:
                    ritualBridge = _c.sent();
                    return [4 /*yield*/, env.getAccountAddressesAsync()];
                case 4:
                    _b = __read.apply(void 0, [_c.sent(), 3]), recurringBuyer = _b[1], taker = _b[2];
    ...
    contracts_test_utils_1.blockchainTests.resets('bridgeTransferFrom()', function () {
        ...
        it('Reverts if outside of slippage range', function () { return __awaiter(_this, void 0, void 0, function () {
            var oracleAddress, tx;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, ritualBridge.getOracleAddress().callAsync()];
                    case 1:
                        oracleAddress = _a.sent();
                        return [4 /*yield*/, new wrappers_1.TestOracleContract(oracleAddress, env.provider)
                                .setLatestAnswer(new utils_1.BigNumber(100000000))
                                .awaitTransactionSuccessAsync({ from: taker })];
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, buyToken
                    ...
                    case 3:
                        ...
                        tx = ritualBridge
                            .bridgeTransferFrom(sellToken.address, contracts_test_utils_1.constants.NULL_ADDRESS, taker, recurringBuy.sellAmount, bridgeDataEncoder.encode({ takerToken: buyToken.address, recurringBuyer: recurringBuyer }))
                            .awaitTransactionSuccessAsync({ from: taker });
                        return [2 /*return*/, contracts_test_utils_1.expect(tx).to.revertWith('RitualBridge::_validateAndUpdateRecurringBuy/EXCEEDS_MAX_ALLOWED_SLIPPAGE')];
                }
            });
        }); });
    ...
    contracts_test_utils_1.blockchainTests.resets.only('fillRecurringBuy()', function () {
        var recurringBuy = __assign({}, NULL_RECURRING_BUY, { sellAmount: contracts_test_utils_1.toBaseUnitAmount(1, 0), interval: ONE_DAY_IN_SECONDS.times(7), minBuyAmount: contracts_test_utils_1.toBaseUnitAmount(1, 0), maxSlippageBps: new utils_1.BigNumber(123), unwrapWeth: true });
        before(function () { return __awaiter(_this, void 0, void 0, function () {
            var _a, oracleAddress, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0: return [4 /*yield*/, wrappers_1.TestRitualBridgeContract.deployFrom0xArtifactAsync(artifacts_1.artifacts.TestRitualBridge, env.provider, env.txDefaults, artifacts_1.artifacts, weth.address)];
                    case 1:
                        ritualBridge = _d.sent();
                        return [4 /*yield*/, ritualBridge.getOracleAddress().callAsync()];
                    case 2:
                        oracleAddress = _d.sent();
                        return [4 /*yield*/, new wrappers_1.TestOracleContract(oracleAddress, env.provider)
                                .setLatestAnswer(new utils_1.BigNumber(100000000))
                                .awaitTransactionSuccessAsync({ from: taker })];
                    case 3:
                        ...
                        return [4 /*yield*/, env.getAccountAddressesAsync()];
                    case 4:
                        _a = __read.apply(void 0, [_d.sent(), 3]), recurringBuyer = _a[1], taker = _a[2];
                        return [4 /*yield*/, sellToken
                                .approve(ritualBridge.address, contracts_test_utils_1.constants.INITIAL_ERC20_ALLOWANCE)
                                .awaitTransactionSuccessAsync({ from: recurringBuyer })];
                    case 5:
        ...
        it('reverts when there is a mismatch between the number of orders and signatures', function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, contracts_test_utils_1.expect(tx).to.revertWith('RitualBridge::fillRecurringBuy/ORDER_AND_SIGNATURE_LENGTH_MISMATCH')];
            });
        }); });
        it('reverts to fill an order when the price is outside of the guardrails', function () { return __awaiter(_this, void 0, void 0, function () {
            var order, msgValue, tx;
            return __generator(this, function (_a) {
                order = randomOrder();
                order.makerAssetAmount = recurringBuy.sellAmount;
                order.takerAssetAmount = recurringBuy.sellAmount.div(2);
                order.makerFee = contracts_test_utils_1.constants.ZERO_AMOUNT;
                order.takerFee = contracts_test_utils_1.constants.ZERO_AMOUNT;
                msgValue = new utils_1.BigNumber(1337);
                tx = ritualBridge
        ...
        it('reverts to fill an order when their are fees', function () { return __awaiter(_this, void 0, void 0, function () {
            var order, msgValue, tx;
            return __generator(this, function (_a) {
                order = randomOrder();
                order.makerAssetAmount = recurringBuy.sellAmount;
                order.takerAssetAmount = recurringBuy.sellAmount;
                order.makerFee = contracts_test_utils_1.toBaseUnitAmount(1);
                msgValue = new utils_1.BigNumber(1337);
                tx = ritualBridge
                    .fillRecurringBuy(recurringBuyer, sellToken.address, buyToken.address, [order], ['0x'])
                    .awaitTransactionSuccessAsync({ from: taker, value: msgValue });
                return [2 /*return*/, contracts_test_utils_1.expect(tx).to.revertWith('RitualBridge::fillRecurringBuy/NO_FEES_ALLOWED')];
            });
        }); });
        it('can fill an order when the price is within the guardrails', function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        tx = _a.sent();
                        contracts_test_utils_1.verifyEventsFromLogs(tx.logs, [{ takerAssetFillAmount: contracts_test_utils_1.toBaseUnitAmount(1337), msgValue: msgValue }], wrappers_1.TestRitualBridgeEvents.MarketSellCalled);
                        return [2 /*return*/];
                }
            });
        }); });
        it('reverts when the sale is too large', function () { return __awaiter(_this, void 0, void 0, function () {
            var msgValue, order, tx;
            return __generator(this, function (_a) {
                msgValue = new utils_1.BigNumber(1337);
                order = randomOrder();
        ...
        it('reverts to fill too many orders when the price is within the guardrails', function () { return __awaiter(_this, void 0, void 0, function () {
            var msgValue, order, tx, failedTx;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        msgValue = new utils_1.BigNumber(1337);
                    ...
                    case 1:
                        tx = _a.sent();
                        contracts_test_utils_1.verifyEventsFromLogs(tx.logs, [{ takerAssetFillAmount: contracts_test_utils_1.toBaseUnitAmount(1), msgValue: msgValue }], wrappers_1.TestRitualBridgeEvents.MarketSellCalled);
                        order = randomOrder();
                        order.makerAssetAmount = recurringBuy.sellAmount;
                        order.takerAssetAmount = recurringBuy.sellAmount;
                        order.makerFee = contracts_test_utils_1.constants.ZERO_AMOUNT;
                        order.takerFee = contracts_test_utils_1.constants.ZERO_AMOUNT;
                        failedTx = ritualBridge
                            .fillRecurringBuy(recurringBuyer, sellToken.address, buyToken.address, [order], ['0x'])
                            .awaitTransactionSuccessAsync({ from: taker, value: msgValue });
                        return [2 /*return*/, contracts_test_utils_1.expect(failedTx).to.revertWith('RitualBridge::_validateAndUpdateRecurringBuy/OUTSIDE_OF_BUY_WINDOW')];
                }
            });
        }); });
    });
