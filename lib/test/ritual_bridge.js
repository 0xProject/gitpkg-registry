            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 5:
                        _a.sent();
                        return [4 /*yield*/, ritualBridge
                                .bridgeTransferFrom(sellToken.address, contracts_test_utils_1.constants.NULL_ADDRESS, taker, recurringBuy.sellAmount, bridgeDataEncoder.encode({ takerToken: weth.address, recurringBuyer: recurringBuyer }))
                                .awaitTransactionSuccessAsync({ from: taker })];
                    case 6:
                        _a.sent();
                        return [4 /*yield*/, env.web3Wrapper.getBalanceInWeiAsync(recurringBuyer)];
